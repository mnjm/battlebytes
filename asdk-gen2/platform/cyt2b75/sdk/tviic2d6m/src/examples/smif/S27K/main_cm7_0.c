...
#define HB_INITIAL_LC           CY_SMIF_HB_LC6
...
void SMIF_UserInterruptHandler(void)
{
    ...
    maskStatus = Cy_SMIF_GetInterruptStatusMasked(SMIF_USED);
    Cy_SMIF_ClearInterrupt(SMIF_USED, maskStatus);
...
int main(void)
{
    ...
    /* Interrupt settings to capture the DLL unlock */
    ...
    cy_en_cy_smif_mdl_clk_out_div_t targetSmifFreq = CY_SMIF_MDL_CLK_OUT_DIV2;
