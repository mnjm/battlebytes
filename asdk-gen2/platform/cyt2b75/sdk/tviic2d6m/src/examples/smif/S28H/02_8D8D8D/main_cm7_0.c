...
#define TEST_READ_LC                    CY_SMIF_SEMP_RD_LATENCY8        // SDR SPI: up to 156MHz, SDR OCTAL: up to 200MHz, DDR OCTAL: up to 166MHz
#define TEST_READ_REG_LC                CY_SMIF_SEMP_REG_LATENCY2       // SDR SPI: up to 133MHz, SDR OCTAL: up to 166MHz, DDR OCTAL: up to 166MHz
...
// Updates to the maximum supported speed (166MHz) on cluster platform
uint32_t gPllFrequency = 332000000ul;
