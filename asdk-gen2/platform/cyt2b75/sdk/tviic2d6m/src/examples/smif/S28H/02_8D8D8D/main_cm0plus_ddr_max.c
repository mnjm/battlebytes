...
#define TEST_READ_LC         CY_SMIF_SEMP_RD_LATENCY7  // SDR SPI: up to 81MHz, SDR OCTAL: up to 92MHz, DDR OCTAL: up to 85MHz
...
/* Register configuration at 150MHz */
uint32_t gPllFrequency = 300000000ul;
