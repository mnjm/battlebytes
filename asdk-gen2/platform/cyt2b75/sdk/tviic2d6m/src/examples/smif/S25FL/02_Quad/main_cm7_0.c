...
cy_stc_device_config_t smifDevQuad0Cfg =
{
...
cy_stc_device_config_t smifDevQuad1Cfg =
{
    .xipReadCmdId       = CY_SMIF_S25FL_ID_4QOR,
    .xipReadMode        = CY_SMIF_S25FL_RW_NON_CONTINUOUS,
    .writeEn            = true,
...
int main(void)
{
    ...
    smifDevQuad0Cfg.addr = CY_SMIF_GetXIP_Address(SMIF_USED);
    smifDevQuad1Cfg.addr = CY_SMIF_GetXIP_Address(SMIF_USED) + 0x02000000;
    /*********************************************************/
    /******** Write/Read Test (Quad Output Read) *************/
    /*********************************************************/
    ChangePLLFrequency(SMIF_CLK_FREQ_SDR_RD*2);

    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4QPP,CY_SMIF_S25FL_ID_4QOR);
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4QPP,CY_SMIF_S25FL_ID_4QOR);

    smifDevQuad0Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4QOR;
    smifDevQuad1Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4QOR;
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE0, CY_SMIF_DEV_QUAD_BIT_0To3, &smifDevQuad0Cfg, &smifDevice0Context);
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE1, CY_SMIF_DEV_QUAD_BIT_4To7, &smifDevQuad1Cfg, &smifDevice1Context);
    ...
    /********************************************************/
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4QIOR);
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4QIOR);

    smifDevQuad0Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4QIOR_CONT;
    smifDevQuad1Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4QIOR_CONT;
    smifDevQuad0Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    smifDevQuad1Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE0, CY_SMIF_DEV_QUAD_BIT_0To3, &smifDevQuad0Cfg, &smifDevice0Context);
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE1, CY_SMIF_DEV_QUAD_BIT_4To7, &smifDevQuad1Cfg, &smifDevice1Context);
    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4QIOR);
    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4QIOR);
    ...
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4DDRQIOR);
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4DDRQIOR);

    smifDevQuad0Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DDRQIOR_CONT;
    smifDevQuad1Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DDRQIOR_CONT;
    smifDevQuad0Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    smifDevQuad1Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE0, CY_SMIF_DEV_QUAD_BIT_0To3, &smifDevQuad0Cfg, &smifDevice0Context);
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE1, CY_SMIF_DEV_QUAD_BIT_4To7, &smifDevQuad1Cfg, &smifDevice1Context);
    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4DDRQIOR);
    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4QPP,  CY_SMIF_S25FL_ID_4DDRQIOR);
