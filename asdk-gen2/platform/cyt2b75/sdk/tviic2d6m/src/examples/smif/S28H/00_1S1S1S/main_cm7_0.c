...
#define TEST_READ_LC                    CY_SMIF_SEMP_RD_LATENCY15       // SDR SPI: up to 166MHz, SDR OCTAL: up to 200MHz, DDR OCTAL: up to 192MHz
#define TEST_READ_REG_LC                CY_SMIF_SEMP_REG_LATENCY3       // SDR SPI: up to 166MHz, SDR OCTAL: up to 200MHz, DDR OCTAL: up to 200MHz
