...
cy_stc_device_config_t smifDevDual0Cfg =
{
    .xipReadCmdId       = CY_SMIF_S25FL_ID_4DOR,
...
cy_stc_device_config_t smifDevDual1Cfg =
{
    .xipReadCmdId       = CY_SMIF_S25FL_ID_4DOR,
    .xipReadMode        = CY_SMIF_S25FL_RW_NON_CONTINUOUS,
    .writeEn            = true,
...
static void TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(cy_en_smif_slave_select_t slave, uint16_t wt_cmdId, uint16_t rd_cmdId);
...
int main(void)
{
    ...
    // Capture config
    Cy_SMIF_SetCaptureConfig(SMIF_USED, CY_SMIF_SLAVE_SELECT_0, false);
#endif
    ...
    smifDevDual0Cfg.addr = CY_SMIF_GetXIP_Address(SMIF_USED);
    smifDevDual1Cfg.addr = CY_SMIF_GetXIP_Address(SMIF_USED) + 0x02000000;
    /*********************************************************/
    /******** Write/Read Test (Dual Output Read) *************/
    /*********************************************************/
    ChangePLLFrequency(SMIF_CLK_FREQ_SDR_RD*2);

    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DOR);
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DOR);

    smifDevDual0Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DOR;
    smifDevDual1Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DOR;
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE0, CY_SMIF_DEV_DUAL_BIT_0To1, &smifDevDual0Cfg, &smifDevice0Context);
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE1, CY_SMIF_DEV_DUAL_BIT_4To5, &smifDevDual1Cfg, &smifDevice1Context);

    TestFor_XIP_WRITE_Then_XIP_READ(CY_SMIF_SLAVE_SELECT_0);
    TestFor_XIP_WRITE_Then_XIP_READ(CY_SMIF_SLAVE_SELECT_1);

    /******************************************************/
    /******** Write/Read Test (Dual I/O Read) *************/
    /******************************************************/
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DIOR);
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DIOR);

    smifDevDual0Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DIOR_CONT;
    smifDevDual1Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DIOR_CONT;
    smifDevDual0Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    smifDevDual1Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE0, CY_SMIF_DEV_DUAL_BIT_0To1, &smifDevDual0Cfg, &smifDevice0Context);
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE1, CY_SMIF_DEV_DUAL_BIT_4To5, &smifDevDual1Cfg, &smifDevice1Context);

    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DIOR);
    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DIOR);
    ...
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DDRDIOR);
    TestFor_MMIO_WRITE_Then_MMIO_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DDRDIOR);

    smifDevDual0Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DDRDIOR_CONT;
    smifDevDual1Cfg.xipReadCmdId = CY_SMIF_S25FL_ID_4DDRDIOR_CONT;
    smifDevDual0Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    smifDevDual1Cfg.xipReadMode = CY_SMIF_S25FL_RW_CONTINUOUS;
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE0, CY_SMIF_DEV_DUAL_BIT_0To1, &smifDevDual0Cfg, &smifDevice0Context);
    Cy_SMIF_InitXIPModeForExMem(SMIF_DEVICE1, CY_SMIF_DEV_DUAL_BIT_4To5, &smifDevDual1Cfg, &smifDevice1Context);
    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_0, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DDRDIOR);
    TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(CY_SMIF_SLAVE_SELECT_1, CY_SMIF_S25FL_ID_4PP, CY_SMIF_S25FL_ID_4DDRDIOR);
#endif
...
static void TestFor_MMIO_WRITE_Then_XIP_CONTINUOUS_READ(cy_en_smif_slave_select_t slave, uint16_t wt_cmdId, uint16_t rd_cmdId)
{
    ...
    Cy_SMIF_MMIO_Read_ExMem(SMIF_USED, slave, rd_cmdId, TEST_PROGRAM_SECTOR, 4u, (uint8_t*)&dummyRead, TEST_SPI_READ_LC, CY_SMIF_S25FL_RW_CONTINUOUS, CY_SMIF_BLOCKING, smifDeviceContext, &smifContext);

    SetModeWithBusyCheck(SMIF_USED, CY_SMIF_MEMORY);

    volatile uint32_t testBaseAddress = TestAddress + TEST_PROGRAM_SECTOR;
    // Read the programmed data
    ...
    Cy_SMIF_MMIO_Read_ExMem(SMIF_USED, slave, rd_cmdId, TEST_PROGRAM_SECTOR, 4u, (uint8_t*)&dummyRead, TEST_SPI_READ_LC, CY_SMIF_S25FL_RW_NON_CONTINUOUS, CY_SMIF_BLOCKING, smifDeviceContext, &smifContext);
