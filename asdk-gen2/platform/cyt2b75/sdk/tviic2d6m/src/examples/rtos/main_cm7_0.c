...
*****************************************************************************/
/* LEDs used for toggling */
#define TASK1_LED_PORT          CY_USER_LED1_PORT
#define TASK1_LED_PIN           CY_USER_LED1_PIN
#define TASK1_LED_PIN_MUX       CY_USER_LED1_PIN_MUX
#define TASK2_LED_PORT          CY_USER_LED2_PORT
#define TASK2_LED_PIN           CY_USER_LED2_PIN
#define TASK2_LED_PIN_MUX       CY_USER_LED2_PIN_MUX
#define TASK3_LED_PORT          CY_USER_LED3_PORT
#define TASK3_LED_PIN           CY_USER_LED3_PIN
#define TASK3_LED_PIN_MUX       CY_USER_LED3_PIN_MUX
