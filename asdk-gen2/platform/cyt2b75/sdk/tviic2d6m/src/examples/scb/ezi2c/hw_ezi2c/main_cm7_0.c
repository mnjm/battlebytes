...
#if (CY_USE_PSVP == 1)
    #define USER_I2C_SDA_PORT       GPIO_PRT0                   // TP6
    #define USER_I2C_SDA_PIN        2
    #define USER_I2C_SDA_PIN_MUX    P0_2_SCB0_I2C_SDA

    #define USER_I2C_SCL_PORT       GPIO_PRT0                   // TP7
    #define USER_I2C_SCL_PIN        3
    #define USER_I2C_SCL_PIN_MUX    P0_3_SCB0_I2C_SCL
#else
    #define USER_I2C_SDA_PORT       GPIO_PRT9
    #define USER_I2C_SDA_PIN        4
    #define USER_I2C_SDA_PIN_MUX    P9_4_SCB0_I2C_SDA

    #define USER_I2C_SCL_PORT       GPIO_PRT9
    #define USER_I2C_SCL_PIN        5
    #define USER_I2C_SCL_PIN_MUX    P9_5_SCB0_I2C_SCL
#endif
