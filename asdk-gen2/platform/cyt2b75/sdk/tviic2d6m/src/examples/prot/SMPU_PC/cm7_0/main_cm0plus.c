...
#define FAULT_STRUCT_IRQ        cpuss_interrupts_fault_1_IRQn
    ...
    #define COUNTERPART_MPU_FAULT   CY_SYSFLT_MPU_14        // the counterpart means CM7_0
#elif defined (CY_MCU_rev_b)
    #define COUNTERPART_MPU_FAULT   CY_SYSFLT_CPUSS_MPU_VIO_14        // the counterpart means CM7_0
#endif
