...
#include "prot_setting_params.h"
    ...
    #define COUNTERPART_PPU_FAULT CY_SYSFLT_MS_PPU_1            // Counterpart means CM7_0
    #define COUNTERPART_CPU_ID    CPUSS_MS_ID_CM7_0
#elif defined (CY_MCU_rev_b)
    #define COUNTERPART_PPU_FAULT CY_SYSFLT_PERI_MS_VIO_1       // Counterpart means CM7_0
    #define COUNTERPART_CPU_ID    CPUSS_MS_ID_CM7_0
#endif
