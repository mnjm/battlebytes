...
cy_stc_audiodac_config_t audio_dac_cfg =
{
    ...
    .sampFreq      = CY_AUDIODAC_FS_SEL_256FS_128OSR,     
    ...
    .fastRampCount = 10,/* 2.2uF*/
    .compRampCount = 20,/* Default*/
...
{    
    ...
    {
        uint32_t u32LeftRightSample = ((uint32_t)(WAV_DATA[u32SampleIndex]-0x7FFE) << 16) + (uint32_t)WAV_DATA[u32SampleIndex+1]-0x7FFE;
        ...
        if (u32SampleIndex >= (sizeof(WAV_DATA)/sizeof(WAV_DATA[0])))
        {
            u32SampleIndex = 0;
