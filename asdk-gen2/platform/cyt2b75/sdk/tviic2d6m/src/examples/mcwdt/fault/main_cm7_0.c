...
#include "cy_device_headers.h"
    ...
    #define CY_SRSS_MCWDT_FAULT        CY_SYSFLT_SRSS_MCWDT1
#elif defined (CY_MCU_rev_b)
    #define CY_SRSS_MCWDT_FAULT        CY_SYSFLT_SRSS_FAULT_MCWDT1
#endif
...
void irqFaultReport1Handler(void)
{
    ...
    {
        if(status == CY_SRSS_MCWDT_FAULT) // MCWDT1 fault
        {
...
int main(void)
{
    ...
    Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT1, CY_SRSS_MCWDT_FAULT); // enalbe Fault MCWDT #1
