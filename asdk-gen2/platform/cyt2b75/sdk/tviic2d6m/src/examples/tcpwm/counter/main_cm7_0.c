...
#define TCPWMx_GRPx_CNTx_COUNTER                TCPWM0_GRP0_CNT21
#define PCLK_TCPWMx_CLOCKSx_COUNTER             PCLK_TCPWM0_CLOCKS21
...
#define TCPWM_TR_ONE_CNT_INx_MUX                P6_1_TCPWM0_TR_ONE_CNT_IN21
