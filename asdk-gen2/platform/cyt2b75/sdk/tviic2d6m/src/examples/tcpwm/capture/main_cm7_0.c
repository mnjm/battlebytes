...
#define TCPWMx_GRPx_CNTx_CAPTURE           TCPWM0_GRP0_CNT21
#define PCLK_TCPWMx_CLOCKSx_CAPTURE        PCLK_TCPWM0_CLOCKS21
...
#define TCPWMx_TR_ONE_CNT_INx_MUX          P6_1_TCPWM0_TR_ONE_CNT_IN21

/* PWM Configuration definitions */
#define TCPWMx_GRPx_CNTx_PWM               TCPWM0_GRP0_CNT25
#define PCLK_TCPWMx_CLOCKSx_PWM            PCLK_TCPWM0_CLOCKS25

// LINEx: x = (256 * GrpNum) + (CntNum)
/* TCPWM0_LINE1 */
#define TCPWMx_LINEx_PORT                  GPIO_PRT6
#define TCPWMx_LINEx_PIN                   3u
#define TCPWMx_LINEx_MUX                   P6_3_TCPWM0_LINE25
...
{
    .sysIntSrc  = tcpwm_0_interrupts_21_IRQn,
