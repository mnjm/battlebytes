...
// Icu
extern void CpuBoard_Button_Left_Notification(void);
extern void CpuBoard_Button_Right_Notification(void);
extern void CpuBoard_Button_Up_Notification(void);
extern void CpuBoard_Button_Center_Notification(void);
