...
#include "cy_project.h"
    ...
    #define CY_SYSTEM_PLL1_CONFIG_REFDIV      (4UL)             //value changed to 4 from 2 . PLL_OUT = 16,000,000(Feco) / 4 * 73.72799985 / 3 = 98303999.8Hz
    ...
    // PLL_OUT = 16,000,000(Feco) / 1 * 50 / 2 = 400,000,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 16,000,000 * 50 / 1 = 800,000,000.
    ...
    // PLL_OUT = 8,000,000(Fimo) / 1 * 100 / 2 = 40,000,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 8,000,000 * 100 / 1 = 800,000,000.
    #define CY_SYSTEM_PLL2_CONFIG_REFDIV      (1UL)
    #define CY_SYSTEM_PLL2_CONFIG_FEEDBACKDIV (100UL)
    #define CY_SYSTEM_PLL2_CONFIG_OUTDIV      (2UL)
...
void SystemInit (void)
{
    ...
    SRSS->unCLK_ECO_CONFIG2.stcField.u3WDTRIM = 3u;
    ...
    SRSS->unCLK_ECO_CONFIG2.stcField.u3GTRIM  = 4u;
    ...
    struct {cy_en_hf_clk_dividers_t targetDiv; cy_en_hf_clk_sources_t source;} clkHfSetting[SRSS_NUM_HFROOT] = 
    {
        ...
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_8, .source = CY_SYSCLK_HFCLK_IN_CLKPATH2 /* PLL1: PLL400#1 */ }, // setting for clk_hf5  // Dividing by 8 to make clock equal to 12.25MHz
        ...
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH8 /* PLL7: PLL200#2 */ }, // setting for clk_hf12
