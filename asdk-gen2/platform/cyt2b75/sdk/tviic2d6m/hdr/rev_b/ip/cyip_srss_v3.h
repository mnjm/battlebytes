...
/**
  * \brief 400MHz Digital PLL Configuration Register (CLK_DPLL400M_CONFIG)
  */
typedef struct stc_CLK_DPLL400M_CONFIG_field {
  uint32_t                         u8FEEDBACK_DIV:8;
  uint32_t                         u5REFERENCE_DIV:5;
  uint32_t                         :3;
  uint32_t                         u5OUTPUT_DIV:5;
  ...
  uint32_t                         :1;
  uint32_t                         u1ENABLE:1;
} stc_CLK_DPLL400M_CONFIG_field_t;

typedef union un_CLK_DPLL400M_CONFIG {
  uint32_t                         u32Register;
  stc_CLK_DPLL400M_CONFIG_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CLK_DPLL400M_CONFIG_t;

/**
  * \brief 400MHz Digital PLL Configuration Register 2 (CLK_DPLL400M_CONFIG2)
  */
typedef struct stc_CLK_DPLL400M_CONFIG2_field {
  uint32_t                         u24FRAC_DIV:24;
  uint32_t                         :4;
  uint32_t                         u3FRAC_DITHER_EN:3;
  uint32_t                         u1FRAC_EN:1;
} stc_CLK_DPLL400M_CONFIG2_field_t;

typedef union un_CLK_DPLL400M_CONFIG2 {
  uint32_t                         u32Register;
  stc_CLK_DPLL400M_CONFIG2_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CLK_DPLL400M_CONFIG2_t;

/**
  * \brief 400MHz Digital PLL Configuration Register 3 (CLK_DPLL400M_CONFIG3)
  */
typedef struct stc_CLK_DPLL400M_CONFIG3_field {
  uint32_t                         u10SSCG_DEPTH:10;
  uint32_t                         :6;
  uint32_t                         u3SSCG_RATE:3;
  uint32_t                         :5;
  ...
  uint32_t                         :2;
  uint32_t                         u1SSCG_EN:1;
} stc_CLK_DPLL400M_CONFIG3_field_t;

typedef union un_CLK_DPLL400M_CONFIG3 {
  uint32_t                         u32Register;
  stc_CLK_DPLL400M_CONFIG3_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CLK_DPLL400M_CONFIG3_t;

/**
  * \brief 400MHz Digital PLL Status Register (CLK_DPLL400M_STATUS)
  */
typedef struct stc_CLK_DPLL400M_STATUS_field {
  uint32_t                         u1LOCKED:1;
  uint32_t                         u1UNLOCK_OCCURRED:1;
  uint32_t                         :30;
} stc_CLK_DPLL400M_STATUS_field_t;

typedef union un_CLK_DPLL400M_STATUS {
  uint32_t                         u32Register;
  stc_CLK_DPLL400M_STATUS_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CLK_DPLL400M_STATUS_t;
...
/**
  * \brief REGHC Control Register 4 (PWR_REGHC_CTL4)
  */
typedef struct stc_PWR_REGHC_CTL4_field {
  uint32_t                         :30;
  uint32_t                         u1REGHC_PMIC_VADJ_DIS:1;
  uint32_t                         u1REGHC_PMIC_DPSLP:1;
} stc_PWR_REGHC_CTL4_field_t;

typedef union un_PWR_REGHC_CTL4 {
  uint32_t                         u32Register;
  stc_PWR_REGHC_CTL4_field_t       stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_PWR_REGHC_CTL4_t;
...
/**
  * \brief PMIC Control Register 4 (PWR_PMIC_CTL4)
  */
typedef struct stc_PWR_PMIC_CTL4_field {
  uint32_t                         :30;
  uint32_t                         u1PMIC_VADJ_DIS:1;
  uint32_t                         u1PMIC_DPSLP:1;
} stc_PWR_PMIC_CTL4_field_t;

typedef union un_PWR_PMIC_CTL4 {
  uint32_t                         u32Register;
  stc_PWR_PMIC_CTL4_field_t        stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_PWR_PMIC_CTL4_t;

/**
  * \brief Hibernate Wakeup Mask Register (PWR_HIB_WAKE_CTL)
  */
typedef struct stc_PWR_HIB_WAKE_CTL_field {
  uint32_t                         u24HIB_WAKE_SRC:24;
  uint32_t                         :5;
  uint32_t                         u1HIB_WAKE_CSV_BAK:1;
  uint32_t                         u1HIB_WAKE_RTC:1;
  uint32_t                         u1HIB_WAKE_WDT:1;
} stc_PWR_HIB_WAKE_CTL_field_t;

typedef union un_PWR_HIB_WAKE_CTL {
  uint32_t                         u32Register;
  stc_PWR_HIB_WAKE_CTL_field_t     stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_PWR_HIB_WAKE_CTL_t;

/**
  * \brief Hibernate Wakeup Polarity Register (PWR_HIB_WAKE_CTL2)
  */
typedef struct stc_PWR_HIB_WAKE_CTL2_field {
  uint32_t                         u24HIB_WAKE_SRC:24;
  uint32_t                         :8;
} stc_PWR_HIB_WAKE_CTL2_field_t;

typedef union un_PWR_HIB_WAKE_CTL2 {
  uint32_t                         u32Register;
  stc_PWR_HIB_WAKE_CTL2_field_t    stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_PWR_HIB_WAKE_CTL2_t;

/**
  * \brief Hibernate Wakeup Cause Register (PWR_HIB_WAKE_CAUSE)
  */
typedef struct stc_PWR_HIB_WAKE_CAUSE_field {
  uint32_t                         u24HIB_WAKE_SRC:24;
  uint32_t                         :5;
  uint32_t                         u1HIB_WAKE_CSV_BAK:1;
  uint32_t                         u1HIB_WAKE_RTC:1;
  uint32_t                         u1HIB_WAKE_WDT:1;
} stc_PWR_HIB_WAKE_CAUSE_field_t;

typedef union un_PWR_HIB_WAKE_CAUSE {
  uint32_t                         u32Register;
  stc_PWR_HIB_WAKE_CAUSE_field_t   stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_PWR_HIB_WAKE_CAUSE_t;
...
typedef struct stc_CSV_ILO {
  stc_CSV_ILO_CSV_t                CSV;                /*!< 0x00000000 ILO0 clock DeepSleep domain Clock Supervisor registers */
...
/**
  ...
  */
typedef struct stc_CLK_DPLL400M {
  un_CLK_DPLL400M_CONFIG_t         unCONFIG;           /*!< 0x00000000 400MHz Digital PLL Configuration Register */
  un_CLK_DPLL400M_CONFIG2_t        unCONFIG2;          /*!< 0x00000004 400MHz Digital PLL Configuration Register 2 */
  un_CLK_DPLL400M_CONFIG3_t        unCONFIG3;          /*!< 0x00000008 400MHz Digital PLL Configuration Register 3 */
  uint32_t                         u32Reserved;
  un_CLK_DPLL400M_STATUS_t         unSTATUS;           /*!< 0x00000010 400MHz Digital PLL Status Register */
  uint32_t                         au32Reserved1[3];
} stc_CLK_DPLL400M_t;                                  /*!< Size = 32 (0x20) */
...
typedef struct stc_SRSS {
  ...
  un_PWR_REGHC_CTL4_t              unPWR_REGHC_CTL4;   /*!< 0x00001038 REGHC Control Register 4 */
  uint32_t                         u32Reserved6;
  un_PWR_HIB_DATA_t                unPWR_HIB_DATA[16]; /*!< 0x00001040 HIBERNATE Data Register */
  uint32_t                         au32Reserved7[16];
  ...
  un_PWR_PMIC_CTL4_t               unPWR_PMIC_CTL4;    /*!< 0x000010D0 PMIC Control Register 4 */
  uint32_t                         au32Reserved9[3];
  un_PWR_HIB_WAKE_CTL_t            unPWR_HIB_WAKE_CTL; /*!< 0x000010E0 Hibernate Wakeup Mask Register */
  un_PWR_HIB_WAKE_CTL2_t           unPWR_HIB_WAKE_CTL2; /*!< 0x000010E4 Hibernate Wakeup Polarity Register */
  uint32_t                         u32Reserved10;
  un_PWR_HIB_WAKE_CAUSE_t          unPWR_HIB_WAKE_CAUSE; /*!< 0x000010EC Hibernate Wakeup Cause Register */
  uint32_t                         au32Reserved11[68];
