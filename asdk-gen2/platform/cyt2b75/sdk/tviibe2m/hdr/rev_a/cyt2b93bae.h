...
#ifndef _CYT2B93BAE_H_
#define _CYT2B93BAE_H_

/**
* \addtogroup group_device CYT2B93BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B93BAE User Interrupt Numbers */
  ...
  /* CYT2B93BAE Internal SW Interrupt Numbers */
...
/* CYT2B93BAE peripheral interrupts */
typedef enum {
