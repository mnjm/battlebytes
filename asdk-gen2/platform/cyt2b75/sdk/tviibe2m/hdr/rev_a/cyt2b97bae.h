...
#ifndef _CYT2B97BAE_H_
#define _CYT2B97BAE_H_

/**
* \addtogroup group_device CYT2B97BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B97BAE User Interrupt Numbers */
  ...
  /* CYT2B97BAE Internal SW Interrupt Numbers */
...
/* CYT2B97BAE peripheral interrupts */
typedef enum {
