...
#ifndef _CYT2B97BAS_H_
#define _CYT2B97BAS_H_

/**
* \addtogroup group_device CYT2B97BAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B97BAS User Interrupt Numbers */
  ...
  /* CYT2B97BAS Internal SW Interrupt Numbers */
...
/* CYT2B97BAS peripheral interrupts */
typedef enum {
...
#include "gpio_cyt2b9_144_lqfp.h"

#define CY_DEVICE_TVIIBE2M
#define CY_SILICON_ID                   0xE6E11104UL
