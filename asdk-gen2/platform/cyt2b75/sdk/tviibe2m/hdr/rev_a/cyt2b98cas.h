...
#ifndef _CYT2B98CAS_H_
#define _CYT2B98CAS_H_

/**
* \addtogroup group_device CYT2B98CAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B98CAS User Interrupt Numbers */
  ...
  /* CYT2B98CAS Internal SW Interrupt Numbers */
...
/* CYT2B98CAS peripheral interrupts */
typedef enum {
...
#define CY_SRAM1_BASE                   0x08020000UL
#define CY_SRAM1_SIZE                   0x00020000UL

#include "system_cyt2b9.h"                      /*!< CYT2B9 System */
...
#include "cyt2b9_config.h"
#include "gpio_cyt2b9_176_lqfp.h"

#define CY_DEVICE_TVIIBE2M
#define CY_SILICON_ID                   0xE6EA1104UL
