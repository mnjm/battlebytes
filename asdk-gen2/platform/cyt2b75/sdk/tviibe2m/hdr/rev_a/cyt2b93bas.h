...
#ifndef _CYT2B93BAS_H_
#define _CYT2B93BAS_H_

/**
* \addtogroup group_device CYT2B93BAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B93BAS User Interrupt Numbers */
  ...
  /* CYT2B93BAS Internal SW Interrupt Numbers */
...
/* CYT2B93BAS peripheral interrupts */
typedef enum {
...
#include "gpio_cyt2b9_64_lqfp.h"

#define CY_DEVICE_TVIIBE2M
#define CY_SILICON_ID                   0xE6C91104UL
