...
#ifndef _CYT2B95BAE_H_
#define _CYT2B95BAE_H_

/**
* \addtogroup group_device CYT2B95BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B95BAE User Interrupt Numbers */
  ...
  /* CYT2B95BAE Internal SW Interrupt Numbers */
...
/* CYT2B95BAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE6D91104UL
