...
#ifndef _CYT2B94CAS_H_
#define _CYT2B94CAS_H_

/**
* \addtogroup group_device CYT2B94CAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B94CAS User Interrupt Numbers */
  ...
  /* CYT2B94CAS Internal SW Interrupt Numbers */
...
/* CYT2B94CAS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE6D21104UL
