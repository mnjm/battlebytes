...
#ifndef _CYT2B97CAS_H_
#define _CYT2B97CAS_H_

/**
* \addtogroup group_device CYT2B97CAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B97CAS User Interrupt Numbers */
  ...
  /* CYT2B97CAS Internal SW Interrupt Numbers */
...
/* CYT2B97CAS peripheral interrupts */
typedef enum {
