/***************************************************************************//**
* \file gpio_cyt2b9_176_lqfp.h
*
* \brief
* CYT2B9 device GPIO header for 176-LQFP package
*
* \note
...
#ifndef _GPIO_CYT2B9_176_LQFP_H_
#define _GPIO_CYT2B9_176_LQFP_H_
...
#define PASS0_SARMUX_PADS17_PORT        8u
#define PASS0_SARMUX_PADS17_PIN         2u
#define PASS0_SARMUX_PADS18_PORT        8u
#define PASS0_SARMUX_PADS18_PIN         3u
#define PASS0_SARMUX_PADS19_PORT        8u
#define PASS0_SARMUX_PADS19_PIN         4u
#define PASS0_SARMUX_PADS2_PORT         6u
#define PASS0_SARMUX_PADS2_PIN          2u
#define PASS0_SARMUX_PADS20_PORT        9u
#define PASS0_SARMUX_PADS20_PIN         0u
#define PASS0_SARMUX_PADS21_PORT        9u
#define PASS0_SARMUX_PADS21_PIN         1u
#define PASS0_SARMUX_PADS22_PORT        9u
#define PASS0_SARMUX_PADS22_PIN         2u
#define PASS0_SARMUX_PADS23_PORT        9u
...
typedef enum
{
    ...
    P7_5_LIN0_LIN_RX10              = 20,       /* Digital Active - lin[0].lin_rx[10]:0 */
    ...
    P7_6_LIN0_LIN_TX10              = 20,       /* Digital Active - lin[0].lin_tx[10]:0 */
    ...
    P7_7_LIN0_LIN_EN10              = 20,       /* Digital Active - lin[0].lin_en[10]:0 */
    ...
    P10_2_LIN0_LIN_RX8              = 20,       /* Digital Active - lin[0].lin_rx[8]:1 */
    ...
    P10_3_LIN0_LIN_TX8              = 20,       /* Digital Active - lin[0].lin_tx[8]:1 */
    ...
    P10_4_LIN0_LIN_EN8              = 20,       /* Digital Active - lin[0].lin_en[8]:1 */
    ...
    P10_5_CXPI0_CXPI_RX0            = 22,       /* Digital Active - cxpi[0].cxpi_rx[0]:1 */
    ...
    P10_6_TCPWM0_LINE34             =  8,       /* Digital Active - tcpwm[0].line[34]:0 */
    P10_6_TCPWM0_LINE_COMPL33       =  9,       /* Digital Active - tcpwm[0].line_compl[33]:0 */
    P10_6_TCPWM0_TR_ONE_CNT_IN102   = 10,       /* Digital Active - tcpwm[0].tr_one_cnt_in[102]:0 */
    P10_6_TCPWM0_TR_ONE_CNT_IN100   = 11,       /* Digital Active - tcpwm[0].tr_one_cnt_in[100]:0 */
    P10_6_CXPI0_CXPI_TX0            = 22,       /* Digital Active - cxpi[0].cxpi_tx[0]:1 */
    ...
    P10_7_CXPI0_CXPI_EN0            = 22,       /* Digital Active - cxpi[0].cxpi_en[0]:1 */
    ...
    P13_4_SCB3_SPI_SELECT1          = 19,       /* Digital Active - scb[3].spi_select1:0 */
    P13_4_LIN0_LIN_RX8              = 20,       /* Digital Active - lin[0].lin_rx[8]:0 */
    ...
    P13_5_SCB3_SPI_SELECT2          = 19,       /* Digital Active - scb[3].spi_select2:0 */
    P13_5_LIN0_LIN_TX8              = 20,       /* Digital Active - lin[0].lin_tx[8]:0 */
    P13_5_CXPI0_CXPI_RX2            = 22,       /* Digital Active - cxpi[0].cxpi_rx[2]:0 */
    ...
    P13_6_SCB3_SPI_SELECT3          = 19,       /* Digital Active - scb[3].spi_select3:0 */
    P13_6_LIN0_LIN_EN8              = 20,       /* Digital Active - lin[0].lin_en[8]:0 */
    P13_6_CXPI0_CXPI_TX2            = 22,       /* Digital Active - cxpi[0].cxpi_tx[2]:0 */
    ...
    P13_7_CXPI0_CXPI_EN2            = 22,       /* Digital Active - cxpi[0].cxpi_en[2]:0 */
    ...
    P14_3_SCB2_UART_CTS             = 17,       /* Digital Active - scb[2].uart_cts:0 */
    P14_3_SCB2_SPI_SELECT0          = 19,       /* Digital Active - scb[2].spi_select0:0 */
    ...
    P14_4_SCB2_SPI_SELECT1          = 19,       /* Digital Active - scb[2].spi_select1:0 */
    ...
    P14_5_SCB2_SPI_SELECT2          = 19,       /* Digital Active - scb[2].spi_select2:0 */
    P14_5_CXPI0_CXPI_RX2            = 22,       /* Digital Active - cxpi[0].cxpi_rx[2]:1 */
    ...
    P14_6_CXPI0_CXPI_TX2            = 22,       /* Digital Active - cxpi[0].cxpi_tx[2]:1 */
    ...
    P14_7_CXPI0_CXPI_EN2            = 22,       /* Digital Active - cxpi[0].cxpi_en[2]:1 */
    ...
    P15_0_CXPI0_CXPI_RX1            = 22,       /* Digital Active - cxpi[0].cxpi_rx[1]:1 */
    ...
    P15_1_CXPI0_CXPI_TX1            = 22,       /* Digital Active - cxpi[0].cxpi_tx[1]:1 */
    ...
    P15_2_CXPI0_CXPI_EN1            = 22,       /* Digital Active - cxpi[0].cxpi_en[1]:1 */
    ...
    P17_1_TCPWM0_LINE514            = 16,       /* Digital Active - tcpwm[0].line[514]:1 */
    P17_1_SCB3_UART_RX              = 17,       /* Digital Active - scb[3].uart_rx:1 */
    P17_1_SCB3_SPI_MISO             = 19,       /* Digital Active - scb[3].spi_miso:1 */
    ...
    P17_2_TCPWM0_LINE_COMPL514      = 16,       /* Digital Active - tcpwm[0].line_compl[514]:1 */
    P17_2_SCB3_UART_TX              = 17,       /* Digital Active - scb[3].uart_tx:1 */
    P17_2_SCB3_I2C_SDA              = 18,       /* Digital Active - scb[3].i2c_sda:1 */
    P17_2_SCB3_SPI_MOSI             = 19,       /* Digital Active - scb[3].spi_mosi:1 */
    ...
    P17_3_SCB3_SPI_CLK              = 19,       /* Digital Active - scb[3].spi_clk:1 */
    ...
    P17_4_SCB3_SPI_SELECT0          = 19,       /* Digital Active - scb[3].spi_select0:1 */
    ...
    P17_5_SCB3_SPI_SELECT1          = 19,       /* Digital Active - scb[3].spi_select1:1 */
    ...
    P17_6_SCB3_SPI_SELECT2          = 19,       /* Digital Active - scb[3].spi_select2:1 */
    ...
    P19_0_SCB2_UART_RX              = 17,       /* Digital Active - scb[2].uart_rx:1 */
    P19_0_SCB2_SPI_MISO             = 19,       /* Digital Active - scb[2].spi_miso:1 */
    ...
    P19_1_SCB2_UART_TX              = 17,       /* Digital Active - scb[2].uart_tx:1 */
    P19_1_SCB2_I2C_SDA              = 18,       /* Digital Active - scb[2].i2c_sda:1 */
    P19_1_SCB2_SPI_MOSI             = 19,       /* Digital Active - scb[2].spi_mosi:1 */
    P19_1_CANFD1_TTCAN_RX3          = 21,       /* Digital Active - canfd[1].ttcan_rx[3]:0 */
    P19_1_CXPI0_CXPI_RX3            = 22,       /* Digital Active - cxpi[0].cxpi_rx[3]:0 */
    ...
    P19_2_SCB2_UART_RTS             = 17,       /* Digital Active - scb[2].uart_rts:1 */
    P19_2_SCB2_I2C_SCL              = 18,       /* Digital Active - scb[2].i2c_scl:1 */
    P19_2_SCB2_SPI_CLK              = 19,       /* Digital Active - scb[2].spi_clk:1 */
    P19_2_CXPI0_CXPI_TX3            = 22,       /* Digital Active - cxpi[0].cxpi_tx[3]:0 */
    ...
    P19_3_SCB2_UART_CTS             = 17,       /* Digital Active - scb[2].uart_cts:1 */
    P19_3_SCB2_SPI_SELECT0          = 19,       /* Digital Active - scb[2].spi_select0:1 */
    P19_3_CXPI0_CXPI_EN3            = 22,       /* Digital Active - cxpi[0].cxpi_en[3]:0 */
    ...
    P19_4_SCB2_SPI_SELECT1          = 19,       /* Digital Active - scb[2].spi_select1:1 */
    ...
    P20_0_SCB2_SPI_SELECT2          = 19,       /* Digital Active - scb[2].spi_select2:1 */
    ...
    P20_5_CXPI0_CXPI_RX3            = 22,       /* Digital Active - cxpi[0].cxpi_rx[3]:1 */
    ...
    P20_6_CXPI0_CXPI_TX3            = 22,       /* Digital Active - cxpi[0].cxpi_tx[3]:1 */
    ...
    P20_7_CXPI0_CXPI_EN3            = 22,       /* Digital Active - cxpi[0].cxpi_en[3]:1 */
...
#endif /* _GPIO_CYT2B9_176_LQFP_H_ */
