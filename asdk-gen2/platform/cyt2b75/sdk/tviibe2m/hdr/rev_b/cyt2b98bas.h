...
#ifndef _CYT2B98BAS_H_
#define _CYT2B98BAS_H_

/**
* \addtogroup group_device CYT2B98BAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B98BAS User Interrupt Numbers */
  ...
  /* CYT2B98BAS Internal SW Interrupt Numbers */
...
/* CYT2B98BAS peripheral interrupts */
typedef enum {
