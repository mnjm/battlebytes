...
#ifndef _CYT2B94BAS_H_
#define _CYT2B94BAS_H_

/**
* \addtogroup group_device CYT2B94BAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B94BAS User Interrupt Numbers */
  ...
  /* CYT2B94BAS Internal SW Interrupt Numbers */
...
/* CYT2B94BAS peripheral interrupts */
typedef enum {
