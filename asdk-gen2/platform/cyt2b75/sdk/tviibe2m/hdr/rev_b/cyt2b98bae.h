...
#ifndef _CYT2B98BAE_H_
#define _CYT2B98BAE_H_

/**
* \addtogroup group_device CYT2B98BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B98BAE User Interrupt Numbers */
  ...
  /* CYT2B98BAE Internal SW Interrupt Numbers */
...
/* CYT2B98BAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0x0000E6E9UL
