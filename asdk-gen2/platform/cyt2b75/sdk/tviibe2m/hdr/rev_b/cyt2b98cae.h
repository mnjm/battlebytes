...
#ifndef _CYT2B98CAE_H_
#define _CYT2B98CAE_H_

/**
* \addtogroup group_device CYT2B98CAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B98CAE User Interrupt Numbers */
  ...
  /* CYT2B98CAE Internal SW Interrupt Numbers */
...
/* CYT2B98CAE peripheral interrupts */
typedef enum {
