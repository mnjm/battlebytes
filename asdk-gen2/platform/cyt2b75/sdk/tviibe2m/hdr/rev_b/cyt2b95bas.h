...
#ifndef _CYT2B95BAS_H_
#define _CYT2B95BAS_H_

/**
* \addtogroup group_device CYT2B95BAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B95BAS User Interrupt Numbers */
  ...
  /* CYT2B95BAS Internal SW Interrupt Numbers */
...
/* CYT2B95BAS peripheral interrupts */
typedef enum {
...
#include "gpio_cyt2b9_100_lqfp.h"

#define CY_DEVICE_TVIIBE2M
#define CY_SILICON_ID                   0x0000E6D9UL
