...
#ifndef _CYT2B94BAE_H_
#define _CYT2B94BAE_H_

/**
* \addtogroup group_device CYT2B94BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B94BAE User Interrupt Numbers */
  ...
  /* CYT2B94BAE Internal SW Interrupt Numbers */
...
/* CYT2B94BAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0x0000E6D1UL
