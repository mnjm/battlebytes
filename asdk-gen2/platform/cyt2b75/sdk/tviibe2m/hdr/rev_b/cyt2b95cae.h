...
#ifndef _CYT2B95CAE_H_
#define _CYT2B95CAE_H_

/**
* \addtogroup group_device CYT2B95CAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B95CAE User Interrupt Numbers */
  ...
  /* CYT2B95CAE Internal SW Interrupt Numbers */
...
/* CYT2B95CAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0x0000E6DAUL
