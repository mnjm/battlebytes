...
#ifndef _CYT2B94CAE_H_
#define _CYT2B94CAE_H_

/**
* \addtogroup group_device CYT2B94CAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B94CAE User Interrupt Numbers */
  ...
  /* CYT2B94CAE Internal SW Interrupt Numbers */
...
/* CYT2B94CAE peripheral interrupts */
typedef enum {
...
#include "gpio_cyt2b9_80_lqfp.h"

#define CY_DEVICE_TVIIBE2M
#define CY_SILICON_ID                   0x0000E6D2UL
