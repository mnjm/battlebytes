...
#define USER_BUTTON1_PORT    CY_CB_BUTTON_PORT
#define USER_BUTTON1_PIN     CY_CB_BUTTON_PIN
#define USER_BUTTON1_PIN_MUX CY_CB_BUTTON_PIN_MUX
#define USER_BUTTON1_IRQ     CY_CB_BUTTON_IRQN
