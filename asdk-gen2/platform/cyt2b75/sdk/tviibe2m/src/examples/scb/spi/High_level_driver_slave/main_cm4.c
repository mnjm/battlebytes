...
#define SCB_MISO_PORT     GPIO_PRT0
#define SCB_MISO_PORT_PIN (0)

#define SCB_MOSI_PORT     GPIO_PRT0
#define SCB_MOSI_PORT_PIN (1)

#define SCB_CLK_PORT      GPIO_PRT0
#define SCB_CLK_PORT_PIN  (2)

#define SCB_SEL0_PORT     GPIO_PRT0
#define SCB_SEL0_PORT_PIN (3)

#define SCB_MISO_PORT_MUX P0_0_SCB0_SPI_MISO 
#define SCB_MOSI_PORT_MUX P0_1_SCB0_SPI_MOSI 
#define SCB_CLK_PORT_MUX  P0_2_SCB0_SPI_CLK
#define SCB_SEL0_PORT_MUX P0_3_SCB0_SPI_SELECT0
