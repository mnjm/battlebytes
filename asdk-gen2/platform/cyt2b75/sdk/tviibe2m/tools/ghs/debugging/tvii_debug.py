...
#
# History:
# 2018-08-21 0.01 CHEY  Reset version history and number. Based on TVII-B-E-1M v0.16
# 2018-08-27 0.02 CHEY  Added selection of connection type (USB or Ethernet)
# 2018-11-06 0.03 CHEY  Merged changes from TVII-B-E-1M v0.18 script
# 2018-11-22 0.04 CHEY  Fixed issue that CM0+ does not halt at configured user breakpoint in case of
#                       of Flash build. Added support for routing printf() to debugger "I/O" tab.
# 2018-11-22 0.05 CHEY  Added clearing of PRIMASK before flash programming (may help for some flash issues)
# 2019-02-26 0.06 CHEY  - Added automatic determination of CM0_RESET_VECTOR_CATCH_IS_WORKING
...
# 2019-03-15 0.07 CHEY  Updated and tested external trace setup. Fixed issue in CheckProbeSettings()
# 2019-10-25 0.08 CHEY  Move SRAM base address for GHS flash kernel to support new MCU revisions
#                       with relocated SROM private RAM
# 2019-12-09 0.09 CHEY  - Migrated to 'argparser' Python module and introducing new optional parameter for script
...
# 2020-01-16 0.10 CHEY  Added API for executing DAP system calls -> added output of current life-cycle state
# 2020-01-31 0.11 CHEY  Changed trace setup and some related parts based on new CM7 trace setup
# 2020-02-07 0.12 CHEY  Adding print of SFLASH data revision, split printing of target info in 2 lines now
# 2020-07-10 0.13 CHEY  - Improve IsTpiuTraceProbe() for certain cases
...
# 2020-10-06 0.14 CHEY  Clear some control bits in DHCSR register before triggering SYSRESET to fix problem
# 2020-10-20 0.15 CHEY  Check for "Could not detect flash device" message and print potential solution
# 2021-09-22 0.16 CHEY  Add support for SFLASH user row programming
# ***********************************************************************************************/#
...
CODE_FLASH_SIZE_BYTES                      = 2112 * 1024
