...
#ifndef _CYT4BFCCJE_H_
#define _CYT4BFCCJE_H_

/**
* \addtogroup group_device CYT4BFCCJE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT4BFCCJE User Interrupt Numbers */
  ...
  /* CYT4BFCCJE Internal SW Interrupt Numbers */
...
/* CYT4BFCCJE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0x0000E5FBUL
