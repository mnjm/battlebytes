...
#ifndef _CYT4BFCCHS_H_
#define _CYT4BFCCHS_H_

/**
* \addtogroup group_device CYT4BFCCHS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT4BFCCHS User Interrupt Numbers */
  ...
  /* CYT4BFCCHS Internal SW Interrupt Numbers */
...
/* CYT4BFCCHS peripheral interrupts */
typedef enum {
...
#include "gpio_cyt4bf_320_bga.h"

#define CY_DEVICE_TVIIBH8M
#define CY_SILICON_ID                   0x0000E5FFUL
