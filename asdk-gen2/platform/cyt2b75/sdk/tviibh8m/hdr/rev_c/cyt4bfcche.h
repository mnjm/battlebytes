...
#ifndef _CYT4BFCCHE_H_
#define _CYT4BFCCHE_H_

/**
* \addtogroup group_device CYT4BFCCHE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT4BFCCHE User Interrupt Numbers */
  ...
  /* CYT4BFCCHE Internal SW Interrupt Numbers */
...
/* CYT4BFCCHE peripheral interrupts */
typedef enum {
