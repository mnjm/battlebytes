...
#ifndef _CYT4BFCCJS_H_
#define _CYT4BFCCJS_H_

/**
* \addtogroup group_device CYT4BFCCJS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT4BFCCJS User Interrupt Numbers */
  ...
  /* CYT4BFCCJS Internal SW Interrupt Numbers */
...
/* CYT4BFCCJS peripheral interrupts */
typedef enum {
