...
{
    CANFD_CONFIG_STD_ID_FILTER_CLASSIC(0x010ul, 0x7fful, CY_CANFD_ID_FILTER_ELEMNT_CONFIG_STORE_RXFIFO0),      /* ID=0x010, store into RX buffer Idx0 */
    CANFD_CONFIG_STD_ID_FILTER_CLASSIC(0x020ul, 0x7fful, CY_CANFD_ID_FILTER_ELEMNT_CONFIG_STORE_RXFIFO0),      /* ID=0x020, store into RX buffer Idx1 */
};

/* Extended ID Filter configuration */
static const cy_stc_extid_filter_t extIdFilter[] = 
{
    CANFD_CONFIG_EXT_ID_FILTER_CLASSIC(0x10010ul, 0x1ffffffful, CY_CANFD_ID_FILTER_ELEMNT_CONFIG_STORE_RXFIFO0),    /* ID=0x10010, store into RX buffer Idx2 */
    CANFD_CONFIG_EXT_ID_FILTER_CLASSIC(0x10020ul, 0x1ffffffful, CY_CANFD_ID_FILTER_ELEMNT_CONFIG_STORE_RXFIFO0),    /* ID=0x10020, store into RX buffer Idx3 */
};
...
void CAN_RxFifoWithTopCallback(uint8_t u8FifoNum, uint8_t   u8BufferSizeInWord, uint32_t* pu32RxBuf)
{
    cy_stc_canfd_msg_t msg;
    Cy_CANFD_ExtractMsgFromRXBuffer((cy_stc_canfd_rx_buffer_t *)pu32RxBuf, &msg);

    /* Just loop back to the sender with +1 ID */
    msg.idConfig.identifier += 1u;
