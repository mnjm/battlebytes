...
int main(void)
{
    ...
    {
        readSPICommand     = CY_SMIF_S25FS_RDID_1S1S1S_4ADR;
        readFastSPICommand = CY_SMIF_S25FS_RDID_1S1S1S_FAST_4ADR;
        smifDev0Cfg.size   = CY_SMIF_DEVICE_64M_BYTE;
    }
    else
    {
        readSPICommand     = CY_SMIF_S25FS_RDID_1S1S1S_3ADR;
        readFastSPICommand = CY_SMIF_S25FS_RDID_1S1S1S_FAST_3ADR;
