...
#define TRX_DATA_WIDTH         (CY_SPI_TRANSACTION_4S4S4S)
  ...
  #define TEST_DEVICE_BIT_ALLOC (CY_SMIF_DEV_QUAD_BIT_0To3)
#else
  #define TEST_SLAVE            (CY_SMIF_SLAVE_SELECT_1)
  #define TEST_SLAVE_DEVICE     (SMIF_DEVICE1)
  #define TEST_DEVICE_BIT_ALLOC (CY_SMIF_DEV_QUAD_BIT_4To7)
#endif
...
int main(void)
{
    ...
    Cy_SMIF_SEMP_ReadAnyVolatileRegister(SMIF_USED,
                                 ...
                                 TRX_DATA_WIDTH,
                                 &smifContext);
    CY_ASSERT(writeConfigReg1.field.u1QUADIT == readConfigReg1.field.u1QUADIT);
    ...
    Cy_SMIF_SEMP_ReadAnyVolatileRegister(SMIF_USED,
                                 ...
                                 TRX_DATA_WIDTH,
                                 &smifContext);
    CY_ASSERT(writeConfigReg2.field.u4MEMLAT == readConfigReg2.field.u4MEMLAT);
    CY_ASSERT(writeConfigReg2.field.u1QPI_IT == readConfigReg2.field.u1QPI_IT);
    CY_ASSERT(writeConfigReg2.field.u1ADRBYT == readConfigReg2.field.u1ADRBYT);
    ...
    Cy_SMIF_SEMP_ReadAnyVolatileRegister(SMIF_USED,
                                 ...
                                 TRX_DATA_WIDTH,
                                 &smifContext);
    CY_ASSERT(writeConfigReg3.field.u2VRGLAT == readConfigReg3.field.u2VRGLAT);
    ...
    Cy_SMIF_SEMP_ReadAnyVolatileRegister(SMIF_USED,
                                 ...
                                 TRX_DATA_WIDTH,
                                 &smifContext);
    CY_ASSERT(writeConfigReg4.field.u1RBSTWP == readConfigReg4.field.u1RBSTWP);
    ...
    {
        sdrQuadCommand0   = CY_SMIF_SEMP_RDID_4S4S4S_4ADR;
        ddrQuadCommand0   = CY_SMIF_SEMP_RDID_4D4D4D_4ADR;
        sdrQuadCmdCont    = CY_SMIF_SEMP_RDID_4S4S_4ADR;
        ddrQuadCmdCont    = CY_SMIF_SEMP_RDID_4D4D_4ADR;
        writeQuadCommand  = CY_SMIF_SEMP_WTID_4S4S4S_4ADR;
        smifDev0Cfg.size  = CY_SMIF_DEVICE_64M_BYTE;
    }
    else
    {
        sdrQuadCommand0   = CY_SMIF_SEMP_RDID_4S4S4S_3ADR;
        ddrQuadCommand0   = CY_SMIF_SEMP_RDID_4D4D4D_3ADR;
        sdrQuadCmdCont    = CY_SMIF_SEMP_RDID_4S4S_3ADR;
        ddrQuadCmdCont    = CY_SMIF_SEMP_RDID_4D4D_3ADR;
    ...
    ReadbackMMIO(ddrQuadCommand0, DEVICE_PROGRAM_BUFFER_SIZE);

    /********************************************/
    /*********  Read/Verify in XIP mode   *******/
    /********************************************/
    ReadbackXIP(sdrQuadCommand0, DEVICE_PROGRAM_BUFFER_SIZE);
    ReadbackXIP(ddrQuadCommand0, DEVICE_PROGRAM_BUFFER_SIZE);

    /*********************************************************/
    /*********  Read/Verify Using Continuous command   *******/
    /*********************************************************/
    ReadbackContinuousMode(sdrQuadCommand0, sdrQuadCmdCont, DEVICE_PROGRAM_BUFFER_SIZE);
    ReadbackContinuousMode(ddrQuadCommand0, ddrQuadCmdCont, DEVICE_PROGRAM_BUFFER_SIZE);
