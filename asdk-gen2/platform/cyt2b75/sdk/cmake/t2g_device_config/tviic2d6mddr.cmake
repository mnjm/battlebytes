...
# User Configuration
#############################################################################################
set(DEVICE CYT4ENDBQS CACHE STRING "Device part number, typically CYT4ENDBQS (for 500-BGA)")

set(MCAL_VAR_TRESOS_PROJECT_NAME TVII-C-2D-6M-DDR_BGA-500 CACHE STRING "MCAL Tresos project name")
...
set(HAVE_IP_LPDDR4              ON)      # Device supports LPDDR4 Controller
...
set(SMIF_IP_VERSION             ver4)    # Uses SMIF.4

######################################################################################
# Infineon Auto Flash Utility / OpenOCD Configuration
######################################################################################
set(AFU_OOCD_TARGET_CFG_FILE traveo2_6m_ddr.cfg)  # Config name to be used for Infineon Auto Flash Utility / OpenOCD

######################################################################################
# Lauterbach Configuration
######################################################################################
set(T32_DEVICE_NAME )   # Device name used by Lauterbach (without the CPU suffix)

######################################################################################
# IAR Debug Configuration
######################################################################################
set(IAR_DEVICE_NAME CYT4EN)   # Device name used by IAR (without the CPU suffix)
