...
# User Configuration
#############################################################################################
set(DEVICE CYT4BFCCHE CACHE STRING "Device part number, typically CYT4BF8CDE (for 176-QFP) or CYT4BFCCHE (for 320-BGA)")

if(${DEVICE} STREQUAL CYT4BF8CDE)
    set(tresos_project_name TVII-B-H-8M_QFP-176)
elseif(${DEVICE} STREQUAL CYT4BFCCHE)
    set(tresos_project_name TVII-B-H-8M_BGA-320)
endif()
...
######################################################################################
set(AFU_OOCD_TARGET_CFG_FILE traveo2_8m_b0.cfg)   # Config name to be used for Infineon Auto Flash Utility / OpenOCD

######################################################################################
# Lauterbach Configuration
######################################################################################
if(${DEVICE} STREQUAL CYT4BF8CDE)
    set(T32_DEVICE_NAME CYT4BF8)   # Device name used by Lauterbach (without the CPU suffix)
elseif(${DEVICE} STREQUAL CYT4BFCCHE)
    set(T32_DEVICE_NAME CYT4BFC)   # Device name used by Lauterbach (without the CPU suffix)
endif()

######################################################################################
# IAR Debug Configuration
######################################################################################
set(IAR_DEVICE_NAME CYT4BF)   # Device name used by IAR (without the CPU suffix)
