/***************************************************************************//**
* \file system_tviice4m_cm0plus.c
* \version 1.0
*
...
#include "cy_project.h"
    ...
    #define CY_SYSTEM_PLL0_CONFIG_FB_INT      (98UL)
    #define CY_SYSTEM_PLL0_CONFIG_FB_FRAC     (5100273UL)
    ...
    // PLL_OUT = 8,000,000(Fimo) / 1 * 98.30399996 / 4 = 196607999.92Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
...
void SystemInit (void)
{
    ...
    /* Settings for PLL400 #0 (CLK_PATH1) */
    SRSS->unCLK_PATH_SELECT[1/*PLL400M #0*/].stcField.u3PATH_MUX = CY_SYSTEM_PLL_INPUT_SOURCE;

    SRSS->CLK_PLL400M[0].unCONFIG2.stcField.u24FRAC_DIV      = CY_SYSTEM_PLL0_CONFIG_FB_FRAC;
    SRSS->CLK_PLL400M[0].unCONFIG2.stcField.u3FRAC_DITHER_EN = 1ul;                           /* Enabled */
    SRSS->CLK_PLL400M[0].unCONFIG2.stcField.u1FRAC_EN        = 1ul;                           /* Enabled */
    SRSS->CLK_PLL400M[0].unCONFIG3.stcField.u1SSCG_EN        = 0ul;                           /* Disabled */
    SRSS->CLK_PLL400M[0].unCONFIG.stcField.u5REFERENCE_DIV   = CY_SYSTEM_PLL0_CONFIG_REFDIV;
    SRSS->CLK_PLL400M[0].unCONFIG.stcField.u8FEEDBACK_DIV    = CY_SYSTEM_PLL0_CONFIG_FB_INT;
    ...
    /* Settings for PLL200 #1 (CLK_PATH2) */
    SRSS->unCLK_PATH_SELECT[2/*PLL200 #1*/].stcField.u3PATH_MUX = CY_SYSTEM_PLL_INPUT_SOURCE;

    SRSS->unCLK_PLL_CONFIG[0].stcField.u7FEEDBACK_DIV  = CY_SYSTEM_PLL1_CONFIG_FEEDBACKDIV;
    SRSS->unCLK_PLL_CONFIG[0].stcField.u5REFERENCE_DIV = CY_SYSTEM_PLL1_CONFIG_REFDIV;
    SRSS->unCLK_PLL_CONFIG[0].stcField.u5OUTPUT_DIV    = CY_SYSTEM_PLL1_CONFIG_OUTDIV;
    ...
    /* Settings for PLL200 #2 (CLK_PATH3) */
    SRSS->unCLK_PATH_SELECT[3/*PLL200 #2*/].stcField.u3PATH_MUX = CY_SYSTEM_PLL_INPUT_SOURCE;

    SRSS->unCLK_PLL_CONFIG[1].stcField.u7FEEDBACK_DIV  = CY_SYSTEM_PLL2_CONFIG_FEEDBACKDIV;
    SRSS->unCLK_PLL_CONFIG[1].stcField.u5REFERENCE_DIV = CY_SYSTEM_PLL2_CONFIG_REFDIV;
    SRSS->unCLK_PLL_CONFIG[1].stcField.u5OUTPUT_DIV    = CY_SYSTEM_PLL2_CONFIG_OUTDIV;
    ...
    /***   Setting  PATH4  source        ***/
    SRSS->unCLK_PATH_SELECT[4].stcField.u3PATH_MUX = CY_SYSCLK_CLKPATH_IN_IMO;
    ...
    {
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH2 /* PLL200#1 */   }, // setting for clk_hf0
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_2, .source = CY_SYSCLK_HFCLK_IN_CLKPATH2 /* PLL200#1 */   }, // setting for clk_hf1
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH1 /* PLL400#0 */   }, // setting for clk_hf2
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH1 /* PLL400#0 */   }, // setting for clk_hf3
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH1 /* PLL400#0 */   }, // setting for clk_hf4
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH3 /* PLL400#2 */   }, // setting for clk_hf5
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH4 /* No PLL/FLL */ }, // setting for clk_hf6
    };
    ...
    for(int8_t i_clkHfNo = 0ul; i_clkHfNo < SRSS_NUM_HFROOT; i_clkHfNo++)
    {
        SRSS->unCLK_ROOT_SELECT[i_clkHfNo].stcField.u4ROOT_MUX = CY_SYSCLK_HFCLK_IN_CLKPATH1 /* PLL0: PLL200#0 */;
