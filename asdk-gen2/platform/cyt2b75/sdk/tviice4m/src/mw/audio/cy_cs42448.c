...
{
    .sysIntSrc  = CY_BSP_AUDIOSS_I2C_IRQN,
...
static void Cy_Cs42448_Scb_I2C_IntrISR(void)
{
    ...
    Cy_SCB_I2C_Interrupt(CY_BSP_AUDIOSS_I2C_TYPE, &codec_i2c_stc_context);
}
...
void Cy_Cs42448_Init(void)
{
    ...
    Cy_SysClk_PeriphAssignDivider(CY_BSP_AUDIOSS_I2C_PCLK, CY_SYSCLK_DIV_24_5_BIT, CY_CS42448_I2C_DIVIDER_NO);
    ...
    Cy_SysClk_PeriphEnableDivider(CY_SYSCLK_DIV_24_5_BIT, CY_CS42448_I2C_DIVIDER_NO);

    /* Port pin configuration for i2c instance */
    codec_i2c_port_pin_cfg.driveMode = CY_GPIO_DM_OD_DRIVESLOW;
    codec_i2c_port_pin_cfg.hsiom     = CY_BSP_AUDIOSS_I2C_SDA_PIN_MUX;
    Cy_GPIO_Pin_Init(CY_BSP_AUDIOSS_I2C_SDA_PORT, CY_BSP_AUDIOSS_I2C_SDA_PIN, &codec_i2c_port_pin_cfg);

    codec_i2c_port_pin_cfg.driveMode = CY_GPIO_DM_OD_DRIVESLOW;
    codec_i2c_port_pin_cfg.hsiom     = CY_BSP_AUDIOSS_I2C_SCL_PIN_MUX;
    Cy_GPIO_Pin_Init(CY_BSP_AUDIOSS_I2C_SCL_PORT, CY_BSP_AUDIOSS_I2C_SCL_PIN, &codec_i2c_port_pin_cfg);
    ...
    Cy_SCB_I2C_Init(CY_BSP_AUDIOSS_I2C_TYPE, &codec_i2c_stc_config, &codec_i2c_stc_context);
    Cy_SCB_I2C_SetDataRate(CY_BSP_AUDIOSS_I2C_TYPE, CY_CS42448_I2C_DATARATE, CY_CS42448_I2C_INCLK_TARGET_FREQ);
    Cy_SCB_I2C_RegisterEventCallback(CY_BSP_AUDIOSS_I2C_TYPE, (scb_i2c_handle_events_t)Cy_Cs42448_Scb_I2C_MasterEvent, &codec_i2c_stc_context);
    Cy_SCB_I2C_Enable(CY_BSP_AUDIOSS_I2C_TYPE);
}
...
void Cy_Cs42448_WriteCtrReg(cy_en_cs42448_registers_t regAddr, uint8_t data)
{
    ...
    Cy_SCB_I2C_MasterWrite(CY_BSP_AUDIOSS_I2C_TYPE, &codec_i2c_stc_master_config, &codec_i2c_stc_context);

    // Wait until I2C Master is ready
    while (0u != (Cy_SCB_I2C_MasterGetStatus(CY_BSP_AUDIOSS_I2C_TYPE, &codec_i2c_stc_context) & CY_SCB_I2C_MASTER_BUSY));
}
...
uint8_t Cy_Cs42448_ReadCtrReg(cy_en_cs42448_registers_t regAddr)
{
    ...
    Cy_SCB_I2C_MasterRead(CY_BSP_AUDIOSS_I2C_TYPE, &codec_i2c_stc_master_config, &codec_i2c_stc_context);
