...
#define CY_I2S_INTR_TX_FIFO_TRIGGER     (TDM_TDM_STRUCT_TDM_TX_STRUCT_INTR_TX_FIFO_TRIGGER_Msk)
/** Bit 1: Attempt to write to a full TX FIFO. */
#define CY_I2S_INTR_TX_FIFO_OVERFLOW	(TDM_TDM_STRUCT_TDM_TX_STRUCT_INTR_TX_FIFO_OVERFLOW_Msk)
/** Bit 2: Attempt to read from an empty TX FIFO. */
#define CY_I2S_INTR_TX_FIFO_UNDERFLOW	(TDM_TDM_STRUCT_TDM_TX_STRUCT_INTR_TX_FIFO_UNDERFLOW_Msk)
/** Bit 8: Interface frequency is higher than PCM sample frequency. */
#define CY_I2S_INTR_TX_IF_UNDERFLOW 	(TDM_TDM_STRUCT_TDM_TX_STRUCT_INTR_TX_IF_UNDERFLOW_Msk)

/** Bit 0: Less entries in the RX FIFO than specified by Trigger Level. */
#define CY_I2S_INTR_RX_FIFO_TRIGGER	    (TDM_TDM_STRUCT_TDM_RX_STRUCT_INTR_RX_FIFO_TRIGGER_Msk)
/** Bit 1: Attempt to write to a full RX FIFO. */
#define CY_I2S_INTR_RX_FIFO_OVERFLOW	(TDM_TDM_STRUCT_TDM_RX_STRUCT_INTR_RX_FIFO_OVERFLOW_Msk)
/** Bit 2: Attempt to read from an empty RX FIFO. */
#define CY_I2S_INTR_RX_FIFO_UNDERFLOW	(TDM_TDM_STRUCT_TDM_RX_STRUCT_INTR_RX_FIFO_UNDERFLOW_Msk)
/** Bit 8: Interface frequency is higher than PCM sample frequency. */
#define CY_I2S_INTR_RX_IF_UNDERFLOW 	(TDM_TDM_STRUCT_TDM_RX_STRUCT_INTR_RX_IF_OVERFLOW_Msk)
...
typedef enum
{
    CY_I2S_WS_EXTN_ZERO	= 0U, /**< Zero extension. */
    CY_I2S_WS_EXTN_SIGN = 1U, /**< Sign extension. */
} cy_en_i2s_word_sign_extn_t;
...
typedef enum
{
    CY_I2S_FSYNC_FMT_BIT_PERIOD = 0U, /**< Duration of a single bit period. */
    CY_I2S_FSYNC_FMT_CHL_PERIOD = 1U, /**< Duration of the first channel. */
} cy_en_i2s_fsync_format_t;

/**
* I2S tx slave signalling inputs selection.
*/
typedef enum 
{
    CY_I2S_TX_DRIVEN_BY_IOSS_TX_IN  = 0U,   /**< TX slave signaling indipendent from RX signaling */
    CY_I2S_TX_DRIVEN_BY_IOSS_RX_IN  = 1U,   /**< TX slave signaling driven by RX slave */
    CY_I2S_TX_DRIVEN_BY_RX_OUT      = 2U,   /**< TX slave signaling driven by RX master */
} cy_en_i2s_route_tx_sel_t;

/**
* I2S rx slave signalling inputs selection.
*/
typedef enum 
{
    CY_I2S_RX_DRIVEN_BY_IOSS_RX_IN  = 0U,   /**< RX slave signaling indipendent from TX signaling */
    CY_I2S_RX_DRIVEN_BY_IOSS_TX_IN  = 1U,   /**< RX slave signaling driven by TX slave */
    CY_I2S_RX_DRIVEN_BY_TX_OUT      = 2U,   /**< RX slave signaling driven by TX master */
} cy_en_i2s_route_rx_sel_t;

typedef enum
{
    CY_I2S_LATE_SAMPLE_RISING   = 0U, /**< Sample PCM bit value on rising edge (SCK_POLARITY is '0') or falling edge (SCK_POLARITY is '1') of receiver "rx_sck_in". */
    CY_I2S_LATE_SAMPLE_FALLING  = 1U, /**< Sample PCM bit value on falling edge  (SCK_POLARITY is '0') or rising edge (SCK_POLARITY is '1') of receiver "rx_sck_in". */
} cy_en_i2s_late_sample_delay_t;

typedef enum
{
    CY_I2S_LATE_CAPT_EXTRA_DELAY_0 = 0U, /**< No extra delay. */
    CY_I2S_LATE_CAPT_EXTRA_DELAY_1 = 1U, /**< 1 cycle extra delay. */
    CY_I2S_LATE_CAPT_EXTRA_DELAY_2 = 2U, /**< 2 cycles extra delay. */
    CY_I2S_LATE_CAPT_EXTRA_DELAY_3 = 3U, /**< 3 cycles extra delay. */
} cy_en_i2s_late_capture_delay_t;
...
typedef struct
{
    ...
    uint8_t		                    txFsyncPolarity;		/**< Channel synchronization polarity, 0 for as is and 1 for inverted. */
    cy_en_i2s_fsync_format_t        txFsyncFormat;          /**< Channel synchronization pulse format, 0 for bit period and 1 for channel period. */
    uint8_t                         txChannelNum;           /**< Number of channels in the frame, 1->32, 0->Undefined/Illegal. */
    uint8_t		                    txChannelSize;    	    /**< TX channel length, 3(4-bits) to 31(32-bits), 0-2->Undefined or Illegal. */
        
    uint32_t                        txChannelEnable;        /**< Channel enables: channel i is controlled by CH_EN[i]. 0->Disabled, 1->Enabled. */
        
    cy_en_i2s_route_tx_sel_t       	txRouteControl;         /**< Controls routing to the TX slave signalling inputs (FSYNC/SCK). */
    uint8_t                         txFifoTriggerLevel;     /**< TX FIFO interrupt trigger level (0, 1, ..., 127). 0->EMPTY. */
        
    cy_en_i2s_ws_t                  rxWordSize;       	    /**< RX word length, see #cy_en_i2s_len_t, must be less or equal to rxChannelLength. */    
    cy_en_i2s_word_sign_extn_t      rxWsExtension;          /**< Word extension, see: #cy_en_i2s_word_sign_extn_t. */
    cy_en_i2s_format_t	            rxFormat;		        /**< RX data format, see: #cy_en_i2s_format_t. */
    ...
    uint8_t		                    rxFsyncPolarity;		/**< Channel synchronization polarity, 0 for as is and 1 for inverted. */
    cy_en_i2s_late_sample_delay_t   rxLateSampleDelay;	    /**< Interface late sample delay. see: #cy_en_i2s_late_sample_delay_t.*/
    cy_en_i2s_fsync_format_t        rxFsyncFormat;          /**< Channel synchronization pulse format, 0 for bit period and 1 for channel period. */
    uint8_t                         rxChannelNum;           /**< Number of channels in the frame, 1->32, 0->Undefined/Illegal. */
    uint8_t		                    rxChannelSize;    	    /**< RX channel length, 3(4-bits) to 31(32-bits), 0-2->Undefined or Illegal. */
    cy_en_i2s_late_capture_delay_t  rxLateCaptureDelay;	    /**< Extra delay (in "rx_sck_out" cycles) for capturing "tdm_rx_sd_in".*/

    uint32_t                        rxChannelEnable;        /**< Channel enables: channel i is controlled by CH_EN[i]. 0->Disabled, 1->Enabled. */
    
    cy_en_i2s_route_rx_sel_t       	rxRouteControl;         /**< Controls routing to the RX slave signalling inputs (FSYNC/SCK). */
    uint8_t                         rxFifoTriggerLevel;     /**< RX FIFO interrupt trigger level (0, 1, ..., 127). 0->EMPTY. */
} cy_stc_i2s_config_t;
...
#define CY_I2S_TX_CTL_DEFAULT 		        (_VAL2FLD(TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_CTL_MS, CY_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_CTL_MS_DEFAULT))
...
#define CY_I2S_TX_IF_CTL_DEFAULT 	        (_VAL2FLD(TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_IF_CTL_CLOCK_DIV, CY_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_IF_CTL_CLOCK_DIV_DEFAULT)	| \
...
#define CY_I2S_RX_CTL_DEFAULT 		        (_VAL2FLD(TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_CTL_WORD_SIGN_EXTEND, CY_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_CTL_WORD_SIGN_EXTEND_DEFAULT))
...
#define CY_I2S_RX_IF_CTL_DEFAULT 	        (_VAL2FLD(TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_IF_CTL_CLOCK_DIV, CY_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_IF_CTL_CLOCK_DIV_DEFAULT)	| \
...
__STATIC_INLINE void     Cy_I2S_EnableTx(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_DisableTx(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE uint32_t Cy_I2S_GetTxCurrentState(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_SetTxMode(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_WriteTxData(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base, uint32_t data);
__STATIC_INLINE void	 Cy_I2S_FreezeTxFifo(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_UnfreezeTxFifo(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_MuteTxFifo(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_UnmuteTxFifo(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE uint8_t  Cy_I2S_GetNumInTxFifo(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE uint8_t	 Cy_I2S_GetTxReadPointer(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE uint8_t	 Cy_I2S_GetTxWritePointer(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_EnableTxTestMode(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_DisableTxTestMode(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);

__STATIC_INLINE void     Cy_I2S_EnableRx(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_DisableRx(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE uint32_t Cy_I2S_GetRxCurrentState(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_SetRxMode(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE uint32_t Cy_I2S_ReadRxData(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_FreezeRxFifo(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_UnfreezeRxFifo(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE uint8_t  Cy_I2S_GetNumInRxFifo(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE uint8_t	 Cy_I2S_GetRxReadPointer(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE uint8_t	 Cy_I2S_GetRxWritePointer(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_EnableRxTestMode(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void	 Cy_I2S_DisableRxTestMode(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);

__STATIC_INLINE void	 Cy_I2S_ClearTxInterrupt(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base, uint32_t interrupt);
__STATIC_INLINE void     Cy_I2S_SetTxInterrupt(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base, uint32_t interrupt);
__STATIC_INLINE uint32_t Cy_I2S_GetTxInterrupt(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE uint32_t Cy_I2S_GetTxInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_SetTxInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base, uint32_t interrupt);
__STATIC_INLINE uint32_t Cy_I2S_GetTxInterruptStatusMasked(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_SetTxTriggerInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_ClearTxTriggerInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);

__STATIC_INLINE void	 Cy_I2S_ClearRxInterrupt(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base, uint32_t interrupt);
__STATIC_INLINE void     Cy_I2S_SetRxInterrupt(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base, uint32_t interrupt);
__STATIC_INLINE uint32_t Cy_I2S_GetRxInterrupt(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE uint32_t Cy_I2S_GetRxInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_SetRxInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base, uint32_t interrupt);
__STATIC_INLINE uint32_t Cy_I2S_GetRxInterruptStatusMasked(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_SetRxTriggerInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
__STATIC_INLINE void     Cy_I2S_ClearRxTriggerInterruptMask(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
...
/**************************************************************************
* Function Name: Cy_I2S_SetTxMode                                    *
***************************************************************************
*
* TX mode enable intended to set the I2S output format.
*
...
__STATIC_INLINE void Cy_I2S_SetTxMode(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base)
{
    base->unTX_IF_CTL.stcField.u1I2S_MODE = 1u;
}
...
/**************************************************************************
* Function Name: Cy_I2S_SetRxMode                                         *
***************************************************************************
*
* RX mode enable intended to set the I2S output format.
*
...
__STATIC_INLINE void Cy_I2S_SetRxMode(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base)
{
    base->unRX_IF_CTL.stcField.u1I2S_MODE = 1u;
}
...
__STATIC_INLINE uint8_t Cy_I2S_GetRxReadPointer(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base)
{
    return (uint8_t)(base->unRX_FIFO_STATUS.stcField.u7RD_PTR);
}
...
__STATIC_INLINE uint8_t Cy_I2S_GetRxWritePointer(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base)
{
    return (uint8_t)(base->unRX_FIFO_STATUS.stcField.u7WR_PTR);
}
...
/*******************************************************************************
* Function Name: Cy_I2S_GetTxInterrupt
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: Cy_I2S_GetRxInterrupt
****************************************************************************//**
*
