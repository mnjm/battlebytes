...
#define CY_TDM_DRV_VERSION_MAJOR   1
/** Driver minor version */
#define CY_TDM_DRV_VERSION_MINOR   0
...
/**
* TDM polarity selection for CLK.
*/
typedef enum 
{
    CY_TDM_CLK              = 0U, 
...
/**
* TDM polarity selection for FSYNC.
*/
typedef enum 
{
    CY_TDM_SIGN             = 0U, 
...
/**
* TDM format selection for FSYNC.
*/
typedef enum 
{
...
/**
* TDM tx slave signalling inputs selection.
*/
typedef enum 
{
    CY_TDM_TX_DRIVEN_BY_IOSS_TX_IN  = 0U,   /**< TX slave signaling indipendent from RX signaling */
    CY_TDM_TX_DRIVEN_BY_IOSS_RX_IN  = 1U,   /**< TX slave signaling driven by RX slave */
    CY_TDM_TX_DRIVEN_BY_RX_OUT      = 2U,   /**< TX slave signaling driven by RX master */
} cy_en_tdm_route_tx_sel_t;

/**
* TDM rx slave signalling inputs selection.
*/
typedef enum 
{
    CY_TDM_RX_DRIVEN_BY_IOSS_RX_IN  = 0U,   /**< RX slave signaling indipendent from TX signaling */
    CY_TDM_RX_DRIVEN_BY_IOSS_TX_IN  = 1U,   /**< RX slave signaling driven by TX slave */
    CY_TDM_RX_DRIVEN_BY_TX_OUT      = 2U,   /**< RX slave signaling driven by TX master */
} cy_en_tdm_route_rx_sel_t;
...
/**
* TDM transmitter configuration structure.
*/
typedef struct
{
	...
	cy_en_tdm_route_tx_sel_t   txRouteControl;         	/**<  Controls routing to the TX slave signalling inputs (FSYNC/SCK). */
    uint32_t                   txChEN;                  /**<  Channel enable. */                                                        
}cy_stc_tdm_config_tx_t;

/**
* TDM receiver configuration structure.
*/
typedef struct
{
    ...
    bool                        rxTestMode;             /**<  Test mode enable.'false': Disabled. Functional mode. */
                                                        ...
                                                        /**<  Note: TX_TEST_CTL.ENABLED and RX_TEST_CTL.ENABLED should not be set to '1' simultaneously. */
	cy_en_tdm_route_rx_sel_t    rxRouteControl;         /**<  Controls routing to the RX slave signalling inputs (FSYNC/SCK). */
...
__STATIC_INLINE void        Cy_AudioTDM_SetTxMode(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
...
__STATIC_INLINE void        Cy_AudioTDM_SetTxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base, cy_en_tdm_route_tx_sel_t path);
__STATIC_INLINE uint8_t     Cy_AudioTDM_GetTxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base);
...
__STATIC_INLINE void        Cy_AudioTDM_SetRxMode(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
...
__STATIC_INLINE void        Cy_AudioTDM_SetRxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base, cy_en_tdm_route_rx_sel_t path);
__STATIC_INLINE uint8_t     Cy_AudioTDM_GetRxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base);
...
__STATIC_INLINE void Cy_AudioTDM_ZeroFreezeTxFifo(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base)
{
    //rmkn: u1REPLAY is not supported base->unTX_FIFO_CTL.stcField.u1REPLAY = 0u;
...
/**************************************************************************
* Function Name: Cy_AudioTDM_SetTxMode                                    *
***************************************************************************
*
* TX mode enable intended to set the TDM output format.
*
* \param base The pointer to the TDM->TX instance address.
*
**************************************************************************/
__STATIC_INLINE void Cy_AudioTDM_SetTxMode(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base)
{
    base->unTX_IF_CTL.stcField.u1I2S_MODE = 0u;
}
...
__STATIC_INLINE void Cy_AudioTDM_ReplayTxFifo(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base)
{
     //rmkn: u1REPLAY is not supported base->unTX_FIFO_CTL.stcField.u1REPLAY = 1u;
     base->unTX_FIFO_CTL.stcField.u1FREEZE = 1u;
}
...
/**************************************************************************
* Function Name: Cy_AudioTDM_SetTxSlaveSignalPath                            
***************************************************************************
* Set the signal path for TX slave signaling.
*
* \param base The pointer to the TDM-> TX instance and address.
* 
* \param path Set the signal route, refer/ cy_en_tdm_route_tx_sel_t.
*
***************************************************************************/
__STATIC_INLINE void Cy_AudioTDM_SetTxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base, cy_en_tdm_route_tx_sel_t path) 
{
    base->unTX_ROUTE_CTL.stcField.u2MODE = path;
}

/**************************************************************************
* Function Name: Cy_AudioTDM_GetTxSlaveSignalPath                         *
***************************************************************************
*
* Get the current signal path for TX slave signaling.
*
* \param base The pointer to the TDM->TX instance address.
*
***************************************************************************/
__STATIC_INLINE uint8_t Cy_AudioTDM_GetTxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_t * base)
{
    return (base->unTX_ROUTE_CTL.stcField.u2MODE);
}
...
/**************************************************************************
* Function Name: Cy_AudioTDM_SetRxMode                                    *
***************************************************************************
*
* RX mode enable intended to set the TDM output format.
*
* \param base The pointer to the TDM->RX instance address.
*
**************************************************************************/
__STATIC_INLINE void Cy_AudioTDM_SetRxMode(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base)
{
    base->unRX_IF_CTL.stcField.u1I2S_MODE = 0u;
}
...
/**************************************************************************
* Function Name: Cy_AudioTDM_SetRxSlaveSignalPath                            
***************************************************************************
* Set the signal path for RX slave signaling.
*
* \param base The pointer to the TDM-> RX instance and address.
* 
* \param path Set the signal route, refer/ cy_en_tdm_route_rx_sel_t.
*
***************************************************************************/
__STATIC_INLINE void Cy_AudioTDM_SetRxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base, cy_en_tdm_route_rx_sel_t path) 
{
    base->unRX_ROUTE_CTL.stcField.u2MODE = path;
}

/**************************************************************************
* Function Name: Cy_AudioTDM_GetRxSlaveSignalPath                         *
***************************************************************************
*
* Get the current signal path for RX slave signaling.
*
* \param base The pointer to the TDM->RX instance address.
*
***************************************************************************/
__STATIC_INLINE uint8_t Cy_AudioTDM_GetRxSlaveSignalPath(volatile stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_t * base)
{
    return (base->unRX_ROUTE_CTL.stcField.u2MODE);
}
