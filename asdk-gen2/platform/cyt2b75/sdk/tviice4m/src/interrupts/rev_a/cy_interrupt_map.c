...
* Database revision: TVII-C-E-4M_CW2123
*
********************************************************************************
* \copyright
...
*******************************************************************************/
/*
* MPN Hash                       : 1A22D62CC6CBFDA6068417A06537ED79DF6B508AA955CCAB5530724A77C6324A
* Product File Hash              : 3BEFFE178B862EF1FE238B0235D584BF791185835759BE9AE511683B4CE97470
* Unrolled reg map File Hash     : D67370644DA01AF36FD950009EF84F8AA3F5CD5719FA4DBA93C7A17985C68E76
* Not Unrolled reg map File Hash : 0C74BA0C49B0BAACAD9CEB6D4AD21A4245847B7152379BC6B288F504E957C070
*/
       ...
       cy_systemIntr_Handler Cy_SystemIrqUserTable[] =
{
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ15                  
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ32                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ33                  
     ...
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_DPSLP_13_HANDLER,        // IRQ37                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_DPSLP_14_HANDLER,        // IRQ38                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_DPSLP_15_HANDLER,        // IRQ39                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_DPSLP_16_HANDLER,        // IRQ40                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_DPSLP_17_HANDLER,        // IRQ41                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_DPSLP_18_HANDLER,        // IRQ42                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_DPSLP_19_HANDLER,        // IRQ43                  
     ...
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_8_HANDLER,           // IRQ52                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_9_HANDLER,           // IRQ53                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ54                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ55                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ56                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ57                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ58                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ59                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ60                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ61                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ62                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ63                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ64                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ65                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ66                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ67                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ68                  
     ...
     (cy_systemIntr_Handler) CPUSS_INTERRUPTS_CM4_FP_HANDLER,              // IRQ72                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ73                  
     ...
     (cy_systemIntr_Handler) CPUSS_INTERRUPTS_CM4_CTI_0_HANDLER,           // IRQ76                  
     (cy_systemIntr_Handler) CPUSS_INTERRUPTS_CM4_CTI_1_HANDLER,           // IRQ77                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ78                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ79                  
     (cy_systemIntr_Handler) EVTGEN_0_INTERRUPT_HANDLER,                   // IRQ80                  
     (cy_systemIntr_Handler) SMIF_0_INTERRUPT_HANDLER,                     // IRQ81                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ82                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ83                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ84                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ85                  
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ150                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ151                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ152                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ153                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ154                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ155                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ292                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ293                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ294                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ295                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ586                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ587                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ588                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ589                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ696                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ697                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ698                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ699                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ700                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ701                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ702                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ703                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ704                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ705                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ706                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ707                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ708                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ709                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ710                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ711                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ744                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ745                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ746                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ747                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ748                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ749                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ750                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ751                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ756                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ757                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ758                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ759                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ776                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ789                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ790                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ791                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ792                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ793                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ794                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ795                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ796                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ797                 
};
