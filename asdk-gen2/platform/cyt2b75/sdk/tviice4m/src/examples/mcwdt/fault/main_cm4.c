...
#define USER_LED0_PORT          CY_BSP_USER_LED1_PORT
#define USER_LED0_PIN           CY_BSP_USER_LED1_PIN
#define USER_LED0_PIN_MUX       CY_BSP_USER_LED1_PIN_MUX
...
void irqFaultReport1Handler(void)
{
    ...
    {
        if(status == CY_SYSFLT_SRSS_FAULT_MCWDT1) // MCWDT1 fault
        {
            ...
            {
                Cy_GPIO_Inv(USER_LED0_PORT, USER_LED0_PIN); // subcounter 0 upper limit fault
            ...
            {
                Cy_GPIO_Inv(USER_LED1_PORT, USER_LED1_PIN); // subcounter 1 upper limit fault
...
int main(void)
{
    ...
    Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT1, CY_SYSFLT_SRSS_FAULT_MCWDT1); // enalbe Fault MCWDT #1
