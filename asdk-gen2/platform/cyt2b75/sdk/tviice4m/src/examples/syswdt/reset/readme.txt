...
After 2 seconds, WDT reset will occur. At the top of main code, if WDT reset is detected, CPU is going to blink the LED1.
Duration of LED off should be 2 seconds.


main_cm4.c
At first this program turns a LED off.
After 1 seconds, WDT reset will occur. At the top of main code, if WDT reset is detected, CPU is going to blink the LED2.
