...
#define CY_EEPROM_SCB_TYPE          SCB7
#define CY_EEPROM_SCB_PCLK          PCLK_SCB7_CLOCK
#define CY_EEPROM_SCB_IRQN          scb_7_interrupt_IRQn

#define CY_EEPROM_SCB_MISO_PORT     GPIO_PRT1
#define CY_EEPROM_SCB_MISO_PIN      2ul
#define CY_EEPROM_SCB_MISO_PIN_MUX  P1_2_SCB7_SPI_MISO
#define CY_EEPROM_SCB_MOSI_PORT     GPIO_PRT1
#define CY_EEPROM_SCB_MOSI_PIN      1ul
#define CY_EEPROM_SCB_MOSI_PIN_MUX  P1_1_SCB7_SPI_MOSI
#define CY_EEPROM_SCB_SCK_PORT      GPIO_PRT1
#define CY_EEPROM_SCB_SCK_PIN       0ul
#define CY_EEPROM_SCB_SCK_PIN_MUX   P1_0_SCB7_SPI_CLK
#define CY_EEPROM_SCB_SSEL_PORT     GPIO_PRT1
#define CY_EEPROM_SCB_SSEL_PIN      3ul
#define CY_EEPROM_SCB_SSEL_PIN_MUX  P1_3_SCB7_SPI_SELECT0
#define CY_EEPROM_HOLD_PORT         GPIO_PRT1
#define CY_EEPROM_HOLD_PIN          5ul
#define CY_EEPROM_HOLD_PIN_MUX      P1_5_GPIO
#define CY_EEPROM_WP_PORT           GPIO_PRT1
#define CY_EEPROM_WP_PIN            6ul
#define CY_EEPROM_WP_PIN_MUX        P1_6_GPIO
