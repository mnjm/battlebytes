...
/* EZI2C, remove below jumpers on LCD side
   P14_0_SCB0_I2C_SDA :: R961
   P14_1_SCB0_I2C_SCL :: R962 */
...
#define I2C_SDA_PORT            GPIO_PRT14
#define I2C_SDA_PORT_PIN        (0)
#define I2C_SDA_PORT_MUX        P14_0_SCB0_I2C_SDA		/* R961_1 */
  
#define I2C_SCL_PORT            GPIO_PRT14
#define I2C_SCL_PORT_PIN        (1)
#define I2C_SCL_PORT_MUX        P14_1_SCB0_I2C_SCL		/* R962_1 */
...
/* Local Functions to calculate the divider value for I2C baud */
