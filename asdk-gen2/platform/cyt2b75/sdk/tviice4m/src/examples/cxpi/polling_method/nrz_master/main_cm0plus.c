...
#define CY_CXPICH_RX_PORT               GPIO_PRT2               // P17_15
#define CY_CXPICH_RX_PIN                3
#define CY_CXPICH_RX_PIN_MUX            P2_3_CXPI0_CXPI_RX0
#define CY_CXPICH_TX_PORT               GPIO_PRT2               // P17_13
#define CY_CXPICH_TX_PIN                2
#define CY_CXPICH_TX_PIN_MUX            P2_2_CXPI0_CXPI_TX0
#define CY_CXPICH_EN_PORT               GPIO_PRT2               // P17_17
#define CY_CXPICH_EN_PIN                4
#define CY_CXPICH_EN_PIN_MUX            P2_4_CXPI0_CXPI_EN0

#define CY_CXPICH_CLK_PORT              GPIO_PRT3               // P16_9
#define CY_CXPICH_CLK_PIN               3
#define CY_CXPICH_CLK_PIN_MUX           P3_3_TCPWM0_LINE27
#define CY_CXPICH_CLK_TCPWM_CNT         TCPWM0_GRP0_CNT27
#define CY_CXPICH_CLK_TCPWM_PCLK        PCLK_TCPWM0_CLOCKS27

#define CY_CXPICH_SEL_PORT              GPIO_PRT2               // P17_11
#define CY_CXPICH_SEL_PIN               1
#define CY_CXPICH_SEL_PIN_MUX           P2_1_GPIO
...
int main(void)
{
  ...
  #if (CY_USE_PSVP == 1u)
    Cy_SysClk_PeriphSetDivider((cy_en_divider_types_t)CY_SYSCLK_DIV_16_BIT, CXPI_CLK_DIVIDER_NUM, 11u); // Divider 11 --> 24MHz / (11+1) = 2MHz
  #else
    Cy_SysClk_PeriphSetDivider((cy_en_divider_types_t)CY_SYSCLK_DIV_16_BIT, CXPI_CLK_DIVIDER_NUM, 39u); // Divider 39 --> 80MHz / (39+1) = 2MHz
  #endif
    Cy_SysClk_PeriphEnableDivider((cy_en_divider_types_t)CY_SYSCLK_DIV_16_BIT, CXPI_CLK_DIVIDER_NUM);
