...
/* CAN in Use */
#define CY_CANFD_TYPE                   CY_BSP_CANFD0_TYPE   
#define CY_CANFD_RX_PORT                CY_BSP_CANFD0_RX_PORT
#define CY_CANFD_RX_PIN                 CY_BSP_CANFD0_RX_PIN 
#define CY_CANFD_RX_MUX                 CY_BSP_CANFD0_RX_PIN_MUX 
#define CY_CANFD_TX_PORT                CY_BSP_CANFD0_TX_PORT
#define CY_CANFD_TX_PIN                 CY_BSP_CANFD0_TX_PIN 
#define CY_CANFD_TX_MUX                 CY_BSP_CANFD0_TX_PIN_MUX 
#define CY_CANFD_PCLK                   CY_BSP_CANFD0_PCLK
#define CY_CANFD_IRQN                   CY_BSP_CANFD0_IRQN
