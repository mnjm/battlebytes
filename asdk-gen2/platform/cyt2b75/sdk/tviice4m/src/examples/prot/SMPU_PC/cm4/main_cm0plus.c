...
#define FAULT_STRUCT_TO_BE_USED FAULT_STRUCT1
#define FAULT_STRUCT_IRQ        cpuss_interrupts_fault_1_IRQn
#define COUNTERPART_MPU_FAULT   CY_SYSFLT_CPUSS_MPU_VIO_17 /**< CM4 code error. */
