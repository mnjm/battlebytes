...
#define MASTER_ID_TO_BE_CHECKED CPUSS_MS_ID_CM4
...
int main(void)
{
    ...
    status = Cy_Prot_ConfigBusMaster(MASTER_ID_TO_BE_CHECKED, TP_PRIVIREGED, TP_SECURE, TP_PERMITTED_PC_MASK|TP_PROHIBITED_PC_MASK);
    CY_ASSERT(status == CY_PROT_SUCCESS);
