...
CM0+ will take a memory access with violation, and CM4 catch the violation details by fault reporting.
...
7. CM4 was noticed of violation details by the fault reporting system.
