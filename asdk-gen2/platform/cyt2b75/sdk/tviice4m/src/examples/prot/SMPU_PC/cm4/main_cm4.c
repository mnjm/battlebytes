...
#define MASTER_ID_OF_THIS_CPU CPUSS_MS_ID_CM4
...
const cy_stc_smpu_cfg_t smpuStruct3Config =
{
    ...
    .secure         = 0,                                       // Non secure
    .pcMatch        = 0,
    .pcMask         = 1 << (TP_PROHIBITED_CONTEXT - 1),        // enable context "TP_PERMITTED_CONTEXT"
};
...
int main(void)
{
    ...
    status = Cy_Prot_ConfigBusMaster(MASTER_ID_OF_THIS_CPU, TP_PRIVIREGED, TP_SECURE, 1 << (TP_PROT_CONTEXT-1));
