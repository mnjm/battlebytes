...
/* LIN Channel in use */
#define CY_LINCH_TYPE           CY_BSP_LINCH0_TYPE
#define CY_LINCH_RX_PORT        CY_BSP_LINCH0_RX_PORT
#define CY_LINCH_RX_PIN         CY_BSP_LINCH0_RX_PIN
#define CY_LINCH_RX_PIN_MUX     CY_BSP_LINCH0_RX_PIN_MUX
#define CY_LINCH_TX_PORT        CY_BSP_LINCH0_TX_PORT
#define CY_LINCH_TX_PIN         CY_BSP_LINCH0_TX_PIN
#define CY_LINCH_TX_PIN_MUX     CY_BSP_LINCH0_TX_PIN_MUX
#define CY_LINCH_PCLK           CY_BSP_LINCH0_PCLK
#define CY_LINCH_IRQN           CY_BSP_LINCH0_IRQN
