...
int main(void)
{
    ...
    smifDevQuad0Cfg.addr = CY_SMIF_GetXIP_Address(CY_SMIF_USED);
    smifDevQuad1Cfg.addr = CY_SMIF_GetXIP_Address(CY_SMIF_USED) + 0x02000000;
    /*********************************************************/
    ...
    Cy_SMIF_InitXIPModeForExMem(SMIF0_DEVICE0, CY_SMIF_DEV_QUAD_BIT_0To3, &smifDevQuad0Cfg, &smifDevice0Context);
    Cy_SMIF_InitXIPModeForExMem(SMIF0_DEVICE1, CY_SMIF_DEV_QUAD_BIT_4To7, &smifDevQuad1Cfg, &smifDevice1Context);
