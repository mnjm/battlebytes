...
/* Macro definition to use SAR0 peripheral */
...
int main(void)
{
    ...
    /* Initialize ADC */
    /* Use tr_sar_gen_in[0] as the generic input 0 for SAR channel */
    Cy_Adc_SetGenericTriggerInput(PASS0_EPASS_MMIO, ADC_USED_LOGICAL_CHANNEL, 0u, 0u);
