...
#define BUTTON4_MCWDT0          4

/*
 *  SW2 --  LEFT    --          USER_BUTTON1
 *  SW4 --  DOWN    --          USER_BUTTON2
 *  SW6 --  RIGHT   --          USER_BUTTON3
 *  SW7 --  UP      --          USER_BUTTON4
 */
...
{                                                  
    .outVal = 0x00,                                
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,    
    .hsiom = CY_BSP_BB_USER_LED1_PIN_MUX,                           
    .intEdge = 0,                                  
    .intMask = 0,                                  
    .vtrip = 0,                                    
    .slewRate = 0,                                 
...
{                                                  
    .outVal = 0x00,                                
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,    
    .hsiom = CY_BSP_BB_USER_LED2_PIN_MUX,                           
    .intEdge = 0,                                  
    .intMask = 0,                                  
    .vtrip = 0,                                    
    .slewRate = 0,                                 
...
cy_stc_gpio_pin_config_t user_button1_port_pin_cfg = 
{
    ...
    .hsiom = CY_BSP_USER_BUTTON1_PIN_MUX,
...
cy_stc_gpio_pin_config_t user_button2_port_pin_cfg = 
{
    .outVal = 0x00,
    .driveMode = CY_GPIO_DM_HIGHZ,
    .hsiom = CY_BSP_USER_BUTTON2_PIN_MUX,
    .intEdge = CY_GPIO_INTR_FALLING,
    .intMask = 1,
    .vtrip = 0,
    .slewRate = 0,
...
cy_stc_gpio_pin_config_t user_button3_port_pin_cfg = 
{
    .outVal = 0x00,
    .driveMode = CY_GPIO_DM_HIGHZ,
    .hsiom = CY_BSP_USER_BUTTON3_PIN_MUX,
    .intEdge = CY_GPIO_INTR_FALLING,
    .intMask = 1,
    .vtrip = 0,
    .slewRate = 0,
...
cy_stc_gpio_pin_config_t user_button4_port_pin_cfg = 
{
    .outVal = 0x00,
    .driveMode = CY_GPIO_DM_HIGHZ,
    .hsiom = CY_BSP_USER_BUTTON4_PIN_MUX,
    .intEdge = CY_GPIO_INTR_FALLING,
    .intMask = 1,
    .vtrip = 0,
    .slewRate = 0,
...
void ButtonIntHandler(void)
{
    ...
    intStatus = Cy_GPIO_GetInterruptStatusMasked(CY_BSP_USER_BUTTON1_PORT, CY_BSP_USER_BUTTON1_PIN);
    if (intStatus != 0uL)
    {
        Cy_GPIO_ClearInterrupt(CY_BSP_USER_BUTTON1_PORT, CY_BSP_USER_BUTTON1_PIN);
        sButtonNumber = 1;
    }
    
    /* If button2 rising edge detected */
    intStatus = Cy_GPIO_GetInterruptStatusMasked(CY_BSP_USER_BUTTON2_PORT, CY_BSP_USER_BUTTON2_PIN);
    if (intStatus != 0uL)
    {
        Cy_GPIO_ClearInterrupt(CY_BSP_USER_BUTTON2_PORT, CY_BSP_USER_BUTTON2_PIN);
        sButtonNumber = 2;
    }
    
    /* If button3 falling edge detected */
    intStatus = Cy_GPIO_GetInterruptStatusMasked(CY_BSP_USER_BUTTON3_PORT, CY_BSP_USER_BUTTON3_PIN);
    if (intStatus != 0uL)
    {
        Cy_GPIO_ClearInterrupt(CY_BSP_USER_BUTTON3_PORT, CY_BSP_USER_BUTTON3_PIN);
        sButtonNumber = 3;
    }
    
    /* If button4 rising edge detected */
    intStatus = Cy_GPIO_GetInterruptStatusMasked(CY_BSP_USER_BUTTON4_PORT, CY_BSP_USER_BUTTON4_PIN);
    if (intStatus != 0uL)
    {
        Cy_GPIO_ClearInterrupt(CY_BSP_USER_BUTTON4_PORT, CY_BSP_USER_BUTTON4_PIN);
        sButtonNumber = 4;
    }
}
...
int main(void)
{
    ...
    Cy_GPIO_Pin_Init(CY_BSP_BB_USER_LED0_PORT, CY_BSP_BB_USER_LED0_PIN, &user_led0_port_pin_cfg);
    Cy_GPIO_Pin_Init(CY_BSP_BB_USER_LED1_PORT, CY_BSP_BB_USER_LED1_PIN, &user_led1_port_pin_cfg);
    Cy_GPIO_Pin_Init(CY_BSP_BB_USER_LED2_PORT, CY_BSP_BB_USER_LED2_PIN, &user_led2_port_pin_cfg);
    ...
    {
        // LED210 - '001' (Button 1)
        Cy_GPIO_Write(CY_BSP_BB_USER_LED0_PORT, CY_BSP_BB_USER_LED0_PIN, 1);
        Cy_GPIO_Write(CY_BSP_BB_USER_LED1_PORT, CY_BSP_BB_USER_LED1_PIN, 0);
        Cy_GPIO_Write(CY_BSP_BB_USER_LED2_PORT, CY_BSP_BB_USER_LED2_PIN, 0);
    ...
    {
        // LED210 - '010' (Button 2)
        Cy_GPIO_Write(CY_BSP_BB_USER_LED0_PORT, CY_BSP_BB_USER_LED0_PIN, 0);
        Cy_GPIO_Write(CY_BSP_BB_USER_LED1_PORT, CY_BSP_BB_USER_LED1_PIN, 1);
        Cy_GPIO_Write(CY_BSP_BB_USER_LED2_PORT, CY_BSP_BB_USER_LED2_PIN, 0);  
    ...
    else if( ( tRstReason & CY_SYSRESET_MCWDT0 ) == CY_SYSRESET_MCWDT0 )
    {
        ...
        Cy_GPIO_Write(CY_BSP_BB_USER_LED0_PORT, CY_BSP_BB_USER_LED0_PIN, 0);
        Cy_GPIO_Write(CY_BSP_BB_USER_LED1_PORT, CY_BSP_BB_USER_LED1_PIN, 0);
        Cy_GPIO_Write(CY_BSP_BB_USER_LED2_PORT, CY_BSP_BB_USER_LED2_PIN, 1);       
...
static void Sample_ButtonInitForReset(void)
{
    ...
    Cy_GPIO_Pin_Init(CY_BSP_USER_BUTTON1_PORT, CY_BSP_USER_BUTTON1_PIN, &user_button1_port_pin_cfg);
    Cy_GPIO_Pin_Init(CY_BSP_USER_BUTTON2_PORT, CY_BSP_USER_BUTTON2_PIN, &user_button2_port_pin_cfg);
    Cy_GPIO_Pin_Init(CY_BSP_USER_BUTTON3_PORT, CY_BSP_USER_BUTTON3_PIN, &user_button3_port_pin_cfg);
    Cy_GPIO_Pin_Init(CY_BSP_USER_BUTTON4_PORT, CY_BSP_USER_BUTTON4_PIN, &user_button4_port_pin_cfg);
    ...
    cy_stc_sysint_irq_t irq_cfg =
    {
        .sysIntSrc  = CY_BSP_USER_BUTTON1_IRQN,
        .intIdx     = CPUIntIdx2_IRQn,
        .isEnabled  = true,
    };
    Cy_SysInt_InitIRQ(&irq_cfg);
    ...
    irq_cfg.sysIntSrc = CY_BSP_USER_BUTTON2_IRQN;
    Cy_SysInt_InitIRQ(&irq_cfg);
    Cy_SysInt_SetSystemIrqVector(irq_cfg.sysIntSrc, ButtonIntHandler);
    /* Setup GPIO for BUTTON3 interrupt */
    irq_cfg.sysIntSrc = CY_BSP_USER_BUTTON3_IRQN;
    Cy_SysInt_InitIRQ(&irq_cfg);
    Cy_SysInt_SetSystemIrqVector(irq_cfg.sysIntSrc, ButtonIntHandler);
    /* Setup GPIO for BUTTON4 interrupt */
    irq_cfg.sysIntSrc = CY_BSP_USER_BUTTON4_IRQN;
    Cy_SysInt_InitIRQ(&irq_cfg);
    Cy_SysInt_SetSystemIrqVector(irq_cfg.sysIntSrc, ButtonIntHandler);
  #endif
...
static void Sample_ActiveMPUAccessFaultInitForReset(void)
{
    ...
    /*********************************************************************/
    {
        ...
        Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT0, CY_SYSFLT_CPUSS_MPU_VIO_0); // enalbe Fault Master 0 (CM0+) MPU
