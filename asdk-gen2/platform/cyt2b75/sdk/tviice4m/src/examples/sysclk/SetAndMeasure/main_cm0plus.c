...
#define PLL400_0_TARGET_FREQ      (196608000ul)
...
{
    CY_SYSCLK_HFCLK_IN_CLKPATH2, /* PLL2: PLL200#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH1, /* PLL0: PLL400#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH3, /* PLL3: PLL200#1 */
    CY_SYSCLK_HFCLK_IN_CLKPATH4, /* No PLL/FLL (bypass) will be output */
    CY_SYSCLK_HFCLK_IN_CLKPATH2, /* PLL2: PLL200#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH0, /* FLL */
    CY_SYSCLK_HFCLK_IN_CLKPATH4, /* No PLL/FLL (bypass) */
};
...
#define PLL_200M_0_PATH_NO   (2ul)
#define PLL_200M_1_PATH_NO   (3ul)
#define BYPASSED_PATH_NO     (4ul)
...
static void AllClockConfiguration(void)
{
    ...
    /***** PLL200M#0(PATH2) source setting ******/
    {
        cy_en_sysclk_status_t status;
    ...
    /***** PLL200M#1(PATH3) source setting ******/
    {
        cy_en_sysclk_status_t status;
...
static void RecalucClockFrequencyValues(void)
{
    ...
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(1ul, &g_reportedFreq.pll200M0SourceFreq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(2ul, &g_reportedFreq.pll200M1SourceFreq) == CY_SYSCLK_SUCCESS);
    ...
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(1ul, &g_reportedFreq.pll200M0Freq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(2ul, &g_reportedFreq.pll200M1Freq) == CY_SYSCLK_SUCCESS);
...
static void PrepareExpectedClockFrequency(void)
{
    ...
    g_expectedFreq.OutFreqPath[2] = PLL200_0_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[3] = PLL200_1_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[4] = PATH_SOURCE_CLOCK_FREQ;
    ...
    g_expectedFreq.FastClockFreq     = (uint32_t)((double)g_expectedFreq.ClockFreqHf[0] / (CLK_FAST_DIVIDER + 1.0));
