...
#define DW_CHANNEL              19  // DW1-CH15 must be used because of trigger of scb[1].tr_rx_req
...
void DW1_CH19_TransferComplete_IntrISR(void);
...
int main(void)
{
    ...
    /* Trigger MUX */
    /***************/
    Cy_TrigMux_Connect1To1( TRIG_IN_1TO1_1_SCB_RX_TO_PDMA11,
                           0u,
...
void Peripheral_Initialization(void)
{
    ...
    stc_sysint_irq_cfg_uart.sysIntSrc = cpuss_interrupts_dw1_19_IRQn;
    ...
    Cy_SysInt_SetSystemIrqVector(stc_sysint_irq_cfg_uart.sysIntSrc, DW1_CH19_TransferComplete_IntrISR);
}
