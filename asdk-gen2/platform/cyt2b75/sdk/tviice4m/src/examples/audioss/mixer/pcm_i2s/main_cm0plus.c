...
#define CY_MIXER_SRC_STC_COUNT (MIXER_NR)
...
void MixerDst_To_I2SFifo(void)
{
    ...
    for(uint8_t data_i = 0; data_i < MIXER_DST_FIFO_TH; data_i+=2)
    {
        ...
        Cy_I2S_WriteTxData(&CY_BSP_AUDIOSS_TDM0_TYPE->TDM_TX_STRUCT, (txData&0xFFFF));
        Cy_I2S_WriteTxData(&CY_BSP_AUDIOSS_TDM0_TYPE->TDM_TX_STRUCT, (txData>>16ul));
    }
}
