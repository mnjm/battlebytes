...
#define DW_CHANNEL              19  // DW1-CH19 scb[1].tr_rx_req to cpuss.dw1_tr_in[19]
#define DW_IRQN                 cpuss_interrupts_dw1_19_IRQn
...
void DW1_CH_TransferComplete_IntrISR(void);
/*****************************************************************************/
...
static  cy_stc_pdma_descr_config_t  stcDmaDescrConfig = {
        ...
        /* DESCR_SRC                         */    .srcAddr        =   (uint32_t *)&CY_BSP_USB_SCB_UART_TYPE->unRX_FIFO_RD.u32Register,
...
int main(void)
{
    ...
    Cy_SCB_UART_Receive(CY_BSP_USB_SCB_UART_TYPE, g_uart_in_data, E_UART_RECV_THRESHOLD, &g_stc_uart_context);  // Set threshold
    ...
    /* Trigger MUX */
    /***************/
    // TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA11 corresponds to scb[1].tr_rx_req to cpuss.dw1_tr_in[19]
    Cy_TrigMux_Connect1To1( TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA11,
                            0u,
...
void Peripheral_Initialization(void)
{
    ...
    stc_sysint_irq_cfg_uart.sysIntSrc = DW_IRQN;
    ...
    Cy_SysInt_SetSystemIrqVector(stc_sysint_irq_cfg_uart.sysIntSrc, DW1_CH_TransferComplete_IntrISR);
}
