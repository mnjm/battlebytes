...
void IpcNotifyInt_ISR(void)
{
    ...
    if (interruptMasked == (1uL << CY_IPC_CHAN_USRPIPE_CM4))
    {
        ...
        if(CY_IPC_DRV_SUCCESS == Cy_IPC_Drv_ReadMsgWord(Cy_IPC_Drv_GetIpcBaseAddress(CY_IPC_CHAN_USRPIPE_CM4), &u32Led))
        {
            ...
            {
                case 0:
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED0_PORT,   CY_BSP_BB_USER_LED0_PIN,    1); //Led 0 On 
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED1_PORT,   CY_BSP_BB_USER_LED1_PIN,    0); //Led 1 Off
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED2_PORT,   CY_BSP_BB_USER_LED2_PIN,    0); //Led 2 Off
                    break;
                case 1:
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED0_PORT,   CY_BSP_BB_USER_LED0_PIN,    0); //Led 0 Off 
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED1_PORT,   CY_BSP_BB_USER_LED1_PIN,    1); //Led 1 On
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED2_PORT,   CY_BSP_BB_USER_LED2_PIN,    0); //Led 2 Off
                    break;
                case 2:
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED0_PORT,   CY_BSP_BB_USER_LED0_PIN,    0); //Led 0 Off 
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED1_PORT,   CY_BSP_BB_USER_LED1_PIN,    0); //Led 1 Off
                    Cy_GPIO_Write(CY_BSP_BB_USER_LED2_PORT,   CY_BSP_BB_USER_LED2_PIN,    1); //Led 2 On
                    break;
                default:
                    break;
            }
