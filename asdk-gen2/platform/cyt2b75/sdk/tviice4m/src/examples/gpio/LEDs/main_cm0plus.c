...
/* Select the USER LED usage */
#define CPU_BOARD_LED           0
#define BASE_BOARD_LED          1
#define CY_USE_USER_LED         CPU_BOARD_LED

#if (CY_USE_USER_LED == CPU_BOARD_LED)
...
#else   // (CY_USE_USER_LED == BASE_BOARD_LED)
