...
/**
  * \brief CM4 cache control (FLASHC_CM4_CA_CTL0)
  */
typedef struct stc_FLASHC_CM4_CA_CTL0_field {
  uint32_t                         u1RAM_ECC_EN:1;
  uint32_t                         u1RAM_ECC_INJ_EN:1;
  uint32_t                         :14;
  uint32_t                         u2WAY:2;
  ...
  uint32_t                         u1PREF_EN:1;
  uint32_t                         u1CA_EN:1;
} stc_FLASHC_CM4_CA_CTL0_field_t;

typedef union un_FLASHC_CM4_CA_CTL0 {
  uint32_t                         u32Register;
  stc_FLASHC_CM4_CA_CTL0_field_t   stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM4_CA_CTL0_t;

/**
  * \brief CM4 cache control (FLASHC_CM4_CA_CTL1)
  */
typedef struct stc_FLASHC_CM4_CA_CTL1_field {
  uint32_t                         u2PWR_MODE:2;
  uint32_t                         :14;
  uint32_t                         u16VECTKEYSTAT:16;
} stc_FLASHC_CM4_CA_CTL1_field_t;

typedef union un_FLASHC_CM4_CA_CTL1 {
  uint32_t                         u32Register;
  stc_FLASHC_CM4_CA_CTL1_field_t   stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM4_CA_CTL1_t;

/**
  * \brief CM4 cache control (FLASHC_CM4_CA_CTL2)
  */
typedef struct stc_FLASHC_CM4_CA_CTL2_field {
  uint32_t                         u10PWRUP_DELAY:10;
  uint32_t                         :22;
} stc_FLASHC_CM4_CA_CTL2_field_t;

typedef union un_FLASHC_CM4_CA_CTL2 {
  uint32_t                         u32Register;
  stc_FLASHC_CM4_CA_CTL2_field_t   stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM4_CA_CTL2_t;

/**
  * \brief CM4 cache status 0 (FLASHC_CM4_CA_STATUS0)
  */
typedef struct stc_FLASHC_CM4_CA_STATUS0_field {
  uint32_t                         u32VALID32:32;
} stc_FLASHC_CM4_CA_STATUS0_field_t;

typedef union un_FLASHC_CM4_CA_STATUS0 {
  uint32_t                         u32Register;
  stc_FLASHC_CM4_CA_STATUS0_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM4_CA_STATUS0_t;

/**
  * \brief CM4 cache status 1 (FLASHC_CM4_CA_STATUS1)
  */
typedef struct stc_FLASHC_CM4_CA_STATUS1_field {
  uint32_t                         u32TAG:32;
} stc_FLASHC_CM4_CA_STATUS1_field_t;

typedef union un_FLASHC_CM4_CA_STATUS1 {
  uint32_t                         u32Register;
  stc_FLASHC_CM4_CA_STATUS1_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM4_CA_STATUS1_t;

/**
  * \brief CM4 cache status 2 (FLASHC_CM4_CA_STATUS2)
  */
typedef struct stc_FLASHC_CM4_CA_STATUS2_field {
  uint32_t                         u6LRU:6;
  uint32_t                         :26;
} stc_FLASHC_CM4_CA_STATUS2_field_t;

typedef union un_FLASHC_CM4_CA_STATUS2 {
  uint32_t                         u32Register;
  stc_FLASHC_CM4_CA_STATUS2_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM4_CA_STATUS2_t;

/**
  * \brief CM4 interface status (FLASHC_CM4_STATUS)
  */
typedef struct stc_FLASHC_CM4_STATUS_field {
  uint32_t                         u1MAIN_INTERNAL_ERR:1;
  uint32_t                         u1WORK_INTERNAL_ERR:1;
  uint32_t                         :30;
} stc_FLASHC_CM4_STATUS_field_t;

typedef union un_FLASHC_CM4_STATUS {
  uint32_t                         u32Register;
  stc_FLASHC_CM4_STATUS_field_t    stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM4_STATUS_t;
...
/**
  * \brief External master 0 buffer control (FLASHC_EXT_MS0_BUFF_CTL)
  */
typedef struct stc_FLASHC_EXT_MS0_BUFF_CTL_field {
  uint32_t                         :30;
  uint32_t                         u1PREF_EN:1;
} stc_FLASHC_EXT_MS0_BUFF_CTL_field_t;

typedef union un_FLASHC_EXT_MS0_BUFF_CTL {
  uint32_t                         u32Register;
  stc_FLASHC_EXT_MS0_BUFF_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_EXT_MS0_BUFF_CTL_t;

/**
  * \brief External master 1 buffer control (FLASHC_EXT_MS1_BUFF_CTL)
  */
typedef struct stc_FLASHC_EXT_MS1_BUFF_CTL_field {
  uint32_t                         :30;
  uint32_t                         u1PREF_EN:1;
} stc_FLASHC_EXT_MS1_BUFF_CTL_field_t;

typedef union un_FLASHC_EXT_MS1_BUFF_CTL {
  uint32_t                         u32Register;
  stc_FLASHC_EXT_MS1_BUFF_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_EXT_MS1_BUFF_CTL_t;
...
typedef struct stc_FLASHC {
  ...
  un_FLASHC_CM4_CA_CTL0_t          unCM4_CA_CTL0;      /*!< 0x00000480 CM4 cache control */
  un_FLASHC_CM4_CA_CTL1_t          unCM4_CA_CTL1;      /*!< 0x00000484 CM4 cache control */
  un_FLASHC_CM4_CA_CTL2_t          unCM4_CA_CTL2;      /*!< 0x00000488 CM4 cache control */
  uint32_t                         au32Reserved6[13];
  un_FLASHC_CM4_CA_STATUS0_t       unCM4_CA_STATUS0;   /*!< 0x000004C0 CM4 cache status 0 */
  un_FLASHC_CM4_CA_STATUS1_t       unCM4_CA_STATUS1;   /*!< 0x000004C4 CM4 cache status 1 */
  un_FLASHC_CM4_CA_STATUS2_t       unCM4_CA_STATUS2;   /*!< 0x000004C8 CM4 cache status 2 */
  uint32_t                         au32Reserved7[5];
  un_FLASHC_CM4_STATUS_t           unCM4_STATUS;       /*!< 0x000004E0 CM4 interface status */
  uint32_t                         au32Reserved8[7];
  un_FLASHC_CRYPTO_BUFF_CTL_t      unCRYPTO_BUFF_CTL;  /*!< 0x00000500 Cryptography buffer control */
  uint32_t                         au32Reserved9[31];
  un_FLASHC_DW0_BUFF_CTL_t         unDW0_BUFF_CTL;     /*!< 0x00000580 Datawire 0 buffer control */
  uint32_t                         au32Reserved10[31];
  un_FLASHC_DW1_BUFF_CTL_t         unDW1_BUFF_CTL;     /*!< 0x00000600 Datawire 1 buffer control */
  uint32_t                         au32Reserved11[31];
  un_FLASHC_DMAC_BUFF_CTL_t        unDMAC_BUFF_CTL;    /*!< 0x00000680 DMA controller buffer control */
  uint32_t                         au32Reserved12[31];
  un_FLASHC_EXT_MS0_BUFF_CTL_t     unEXT_MS0_BUFF_CTL; /*!< 0x00000700 External master 0 buffer control */
  uint32_t                         au32Reserved13[31];
  un_FLASHC_EXT_MS1_BUFF_CTL_t     unEXT_MS1_BUFF_CTL; /*!< 0x00000780 External master 1 buffer control */
  uint32_t                         au32Reserved14[14879];
...
/* FLASHC.CM4_CA_CTL0 */
#define FLASHC_CM4_CA_CTL0_RAM_ECC_EN_Pos       0UL
#define FLASHC_CM4_CA_CTL0_RAM_ECC_EN_Msk       0x1UL
#define FLASHC_CM4_CA_CTL0_RAM_ECC_INJ_EN_Pos   1UL
#define FLASHC_CM4_CA_CTL0_RAM_ECC_INJ_EN_Msk   0x2UL
...
#define FLASHC_CM4_CA_CTL0_CA_EN_Pos            31UL
#define FLASHC_CM4_CA_CTL0_CA_EN_Msk            0x80000000UL
/* FLASHC.CM4_CA_CTL1 */
...
#define FLASHC_CM4_CA_STATUS0_VALID32_Pos       0UL
#define FLASHC_CM4_CA_STATUS0_VALID32_Msk       0xFFFFFFFFUL
...
/* FLASHC.CM4_STATUS */
#define FLASHC_CM4_STATUS_MAIN_INTERNAL_ERR_Pos 0UL
#define FLASHC_CM4_STATUS_MAIN_INTERNAL_ERR_Msk 0x1UL
#define FLASHC_CM4_STATUS_WORK_INTERNAL_ERR_Pos 1UL
#define FLASHC_CM4_STATUS_WORK_INTERNAL_ERR_Msk 0x2UL
