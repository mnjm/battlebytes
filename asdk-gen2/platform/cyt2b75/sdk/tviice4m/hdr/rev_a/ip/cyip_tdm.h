...
/**
  * \brief TX route control (TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_ROUTE_CTL)
  */
typedef struct stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_ROUTE_CTL_field {
  uint32_t                         u2MODE:2;
  uint32_t                         :30;
} stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_ROUTE_CTL_field_t;

typedef union un_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_ROUTE_CTL {
  uint32_t                         u32Register;
  stc_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_ROUTE_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_ROUTE_CTL_t;
...
/**
  * \brief RX route control (TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_ROUTE_CTL)
  */
typedef struct stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_ROUTE_CTL_field {
  uint32_t                         u2MODE:2;
  uint32_t                         :30;
} stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_ROUTE_CTL_field_t;

typedef union un_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_ROUTE_CTL {
  uint32_t                         u32Register;
  stc_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_ROUTE_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_ROUTE_CTL_t;
...
typedef struct stc_TDM_TDM_STRUCT_TDM_TX_STRUCT {
  ...
  un_TDM_TDM_STRUCT_TDM_TX_STRUCT_TX_ROUTE_CTL_t unTX_ROUTE_CTL; /*!< 0x00000024 TX route control */
...
typedef struct stc_TDM_TDM_STRUCT_TDM_RX_STRUCT {
  ...
  un_TDM_TDM_STRUCT_TDM_RX_STRUCT_RX_ROUTE_CTL_t unRX_ROUTE_CTL; /*!< 0x00000024 RX route control */
  uint32_t                         au32Reserved2[22];
