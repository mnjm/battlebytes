...
#ifndef _CYIP_GPIO_V5_H_
#define _CYIP_GPIO_V5_H_
...
/**
  * \brief Port input buffer AUTOLVL configuration register (GPIO_PRT_CFG_IN_AUTOLVL)
  */
...
/**
  * \brief Port output buffer slew extension configuration register (GPIO_PRT_CFG_SLEW_EXT)
  */
typedef struct stc_GPIO_PRT_CFG_SLEW_EXT_field {
  uint32_t                         u3SLEW0:3;
  uint32_t                         :1;
  uint32_t                         u3SLEW1:3;
  uint32_t                         :1;
  ...
  uint32_t                         :1;
  uint32_t                         u3SLEW7:3;
} stc_GPIO_PRT_CFG_SLEW_EXT_field_t;

typedef union un_GPIO_PRT_CFG_SLEW_EXT {
  uint32_t                         u32Register;
  stc_GPIO_PRT_CFG_SLEW_EXT_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_GPIO_PRT_CFG_SLEW_EXT_t;

/**
  * \brief Port output buffer drive sel extension configuration register (GPIO_PRT_CFG_DRIVE_EXT0)
  */
typedef struct stc_GPIO_PRT_CFG_DRIVE_EXT0_field {
  uint32_t                         u5DRIVE_SEL_EXT0:5;
  uint32_t                         :3;
  uint32_t                         u5DRIVE_SEL_EXT1:5;
  uint32_t                         :3;
  uint32_t                         u5DRIVE_SEL_EXT2:5;
  uint32_t                         :3;
  uint32_t                         u5DRIVE_SEL_EXT3:5;
  uint32_t                         :3;
} stc_GPIO_PRT_CFG_DRIVE_EXT0_field_t;

typedef union un_GPIO_PRT_CFG_DRIVE_EXT0 {
  uint32_t                         u32Register;
  stc_GPIO_PRT_CFG_DRIVE_EXT0_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_GPIO_PRT_CFG_DRIVE_EXT0_t;

/**
  * \brief Port output buffer drive sel extension configuration register (GPIO_PRT_CFG_DRIVE_EXT1)
  */
typedef struct stc_GPIO_PRT_CFG_DRIVE_EXT1_field {
  uint32_t                         u5DRIVE_SEL_EXT4:5;
  uint32_t                         :3;
  uint32_t                         u5DRIVE_SEL_EXT5:5;
  uint32_t                         :3;
  uint32_t                         u5DRIVE_SEL_EXT6:5;
  uint32_t                         :3;
  uint32_t                         u5DRIVE_SEL_EXT7:5;
  uint32_t                         :3;
} stc_GPIO_PRT_CFG_DRIVE_EXT1_field_t;

typedef union un_GPIO_PRT_CFG_DRIVE_EXT1 {
  uint32_t                         u32Register;
  stc_GPIO_PRT_CFG_DRIVE_EXT1_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_GPIO_PRT_CFG_DRIVE_EXT1_t;
...
/**
  * \brief External power supply level register (GPIO_VDD_LVL)
  */
typedef struct stc_GPIO_VDD_LVL_field {
  uint32_t                         u16VDDIO_LVL:16;
  uint32_t                         :16;
} stc_GPIO_VDD_LVL_field_t;

typedef union un_GPIO_VDD_LVL {
  uint32_t                         u32Register;
  stc_GPIO_VDD_LVL_field_t         stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_GPIO_VDD_LVL_t;
...
typedef struct stc_GPIO_PRT {
  ...
  un_GPIO_PRT_CFG_IN_AUTOLVL_t     unCFG_IN_AUTOLVL;   /*!< 0x00000058 Port input buffer AUTOLVL configuration register */
  uint32_t                         u32Reserved2;
  un_GPIO_PRT_CFG_OUT2_t           unCFG_OUT2;         /*!< 0x00000060 Port output buffer configuration register 2 */
  un_GPIO_PRT_CFG_SLEW_EXT_t       unCFG_SLEW_EXT;     /*!< 0x00000064 Port output buffer slew extension configuration register */
  un_GPIO_PRT_CFG_DRIVE_EXT0_t     unCFG_DRIVE_EXT0;   /*!< 0x00000068 Port output buffer drive sel extension configuration
                                                                                register */
  un_GPIO_PRT_CFG_DRIVE_EXT1_t     unCFG_DRIVE_EXT1;   /*!< 0x0000006C Port output buffer drive sel extension configuration
                                                                                register */
...
typedef struct stc_GPIO {
  ...
  un_GPIO_VDD_LVL_t                unVDD_LVL;          /*!< 0x00004024 External power supply level register */
} stc_GPIO_t;                                          /*!< Size = 16424 (0x4028) */
...
/* GPIO.VDD_LVL */
#define GPIO_VDD_LVL_VDDIO_LVL_Pos              0UL
#define GPIO_VDD_LVL_VDDIO_LVL_Msk              0xFFFFUL


#endif /* _CYIP_GPIO_V5_H_ */
