...
#
# History:
# 2018-07-13 0.01 CHEY  Reset version history and number. Based on TVII-B-E-2M v0.13
# 2020-10-06 0.02 CHEY  Clear some control bits in DHCSR register before triggering SYSRESET to fix problem
# 2020-10-20 0.03 CHEY  Check for "Could not detect flash device" message and print potential solution
# 2021-09-22 0.04 CHEY  Add support for SFLASH user row programming
# ***********************************************************************************************/#
...
CODE_FLASH_SIZE_BYTES                      = 576 * 1024
