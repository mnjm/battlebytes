...
#ifndef BB_BSP_TVIIBE512K_H
#define BB_BSP_TVIIBE512K_H
...
// tviibe512k - 100-LQFP Package devices
...
#if (CY_USE_PSVP == 0) && ( defined(CYT2B65BAS) || defined(CYT2B65BAE) || defined(CYT2B65CAS) || defined(CYT2B65CAE))
...
// tviibe512k - 80-LQFP Package devices
    
// #if (CY_USE_PSVP == 0) (--> Silicon), project setting CY_USE_PSVP should be changed to '0'
// select the supported or required device accordingly
    
#elif (CY_USE_PSVP == 0) && ( defined(CYT2B64BAS) || defined(CYT2B64BAE) || defined(CYT2B64CAS) || defined(CYT2B64CAE) )
...
// tviibe512k - 64-LQFP Package devices
    
// #if (CY_USE_PSVP == 0) (--> Silicon), project setting CY_USE_PSVP should be changed to '0'
// select the supported or required device accordingly
    
#elif (CY_USE_PSVP == 0) && ( defined(CYT2B63BAS) || defined(CYT2B63BAE) || defined(CYT2B63CAS) || defined(CYT2B63CAE) )
...
/******************************************************************************/
    ...
    #error "Choose either a Device based on TVII-B-E-512K Datasheet"
