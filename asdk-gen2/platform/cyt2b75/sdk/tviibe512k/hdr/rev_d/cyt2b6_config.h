/***************************************************************************//**
* \file cyt2b6_config.h
*
* \brief
* CYT2B6 device configuration header
*
* \note
...
#ifndef _CYT2B6_CONFIG_H_
#define _CYT2B6_CONFIG_H_
...
#define CPUSS_SYSTEM_INT_NR             234u
...
#define CPUSS_CPUSS_DW_DW_NR0_DW_CH_NR  54u
/* Width of a channel number in bits */
#define CPUSS_CPUSS_DW_DW_NR0_DW_CH_NR_WIDTH 7u
/* Number of channels in each DataWire controller */
#define CPUSS_CPUSS_DW_DW_NR1_DW_CH_NR  26u
/* Width of a channel number in bits */
...
#define IOSS_GPIO_GPIO_PORT_NR_0_31     17u
...
#define IOSS_GPIO_GPIO_PORT_NR          17u
...
#define PASS_SAR_SLICE_NR0_SAR_SAR_CHAN_NR 11u
/* Number of MUX inputs (per SAR), must be 8, 16, 24, or 32 */
#define PASS_SAR_SLICE_NR0_SAR_SAR_MUX_IN 11u
...
/* Number of SAR sequencer channels (per SAR) */
#define PASS_SAR_SLICE_NR1_SAR_SAR_CHAN_NR 13u
/* Number of MUX inputs (per SAR), must be 8, 16, 24, or 32 */
#define PASS_SAR_SLICE_NR1_SAR_SAR_MUX_IN 13u
/* Is ADC is present on slice (1 = Yes, 0 = No). Calculated from SAR_ADC_NR such
   that lower numbered slices contain the ADCs that are present. */
...
#define TCPWM_GRP_NR0_GRP_GRP_CNT_NR    46u
/* Counter width in number of bits per TCPWM group (16: 16-bits, 32: 32-bits) */
...
/* Number of counters per TCPWM group (1..256) */
#define TCPWM_GRP_NR1_GRP_GRP_CNT_NR    4u
/* Counter width in number of bits per TCPWM group (16: 16-bits, 32: 32-bits) */
...
/* Number of counters per TCPWM group (1..256) */
#define TCPWM_GRP_NR2_GRP_GRP_CNT_NR    2u
/* Number of AHB-Lite "hmaster[]" bits ([1, 8]). */
