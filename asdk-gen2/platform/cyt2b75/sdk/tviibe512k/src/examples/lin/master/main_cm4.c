...
static const stc_pin_config lin_pin_cfg[] =
{
    /* LIN RX */
    {
        .portReg = CY_LINCH1_RX_PORT, 
        .pinNum  = CY_LINCH1_RX_PIN,
        {
            .outVal = 0,
            .driveMode = CY_GPIO_DM_HIGHZ,
            .hsiom = CY_LINCH1_RX_PIN_MUX,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
    ...
    /* LIN TX */
    {
        .portReg = CY_LINCH1_TX_PORT, 
        .pinNum  = CY_LINCH1_TX_PIN,
        {
            .outVal = 1,
            .driveMode = CY_GPIO_DM_STRONG,
            .hsiom = CY_LINCH1_TX_PIN_MUX ,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
...
int main(void)
{
    ...
    /* Initialize LIN */
    {
        ...
        Cy_Lin_Init(CY_LINCH1_TYPE, &config);
...
static void LIN0_TickHandler(void)
{
    ...
    case LIN_TX_RESPONSE:
        ...
        Cy_Lin_SetDataLength(CY_LINCH1_TYPE, msgContext[scheduleIdx].dataLength);
        Cy_Lin_SetChecksumType(CY_LINCH1_TYPE, msgContext[scheduleIdx].checksumType);
        Cy_Lin_SetHeader(CY_LINCH1_TYPE, msgContext[scheduleIdx].id);
        Cy_Lin_WriteData(CY_LINCH1_TYPE, msgContext[scheduleIdx].dataBuffer, msgContext[scheduleIdx].dataLength);
        Cy_Lin_SetInterruptMask(CY_LINCH1_TYPE, CY_LIN_INTR_TX_RESPONSE_DONE | CY_LIN_INTR_ALL_ERROR_MASK_MASTER);
        lin_state = LIN_STATE_TX_HEADER_TX_RESPONSE;
        Cy_Lin_SetCmd(CY_LINCH1_TYPE, CY_LIN_CMD_TX_HEADER_TX_RESPONSE);
        break;
    case LIN_RX_RESPONSE:
        ...
        Cy_Lin_SetChecksumType(CY_LINCH1_TYPE, msgContext[scheduleIdx].checksumType);
        Cy_Lin_SetHeader(CY_LINCH1_TYPE, msgContext[scheduleIdx].id);
        Cy_Lin_SetInterruptMask(CY_LINCH1_TYPE, CY_LIN_INTR_RX_RESPONSE_DONE | CY_LIN_INTR_ALL_ERROR_MASK_MASTER);
        lin_state = LIN_STATE_TX_HEADER_RX_RESPONSE;
        Cy_Lin_SetCmd(CY_LINCH1_TYPE, CY_LIN_CMD_TX_HEADER_RX_RESPONSE);
        break;
    case LIN_TX_HEADER:
        /* Response Direction = Slave to Slave  */
        Cy_Lin_SetHeader(CY_LINCH1_TYPE, msgContext[scheduleIdx].id);
        Cy_Lin_SetInterruptMask(CY_LINCH1_TYPE, CY_LIN_INTR_TX_HEADER_DONE | CY_LIN_INTR_ALL_ERROR_MASK_MASTER);
        lin_state = LIN_STATE_TX_HEADER;
        Cy_Lin_SetCmd(CY_LINCH1_TYPE, CY_LIN_CMD_TX_HEADER);
        break;
    default:
        break;
    }
...
void LIN0_IntHandler(void)
{
    ...
    Cy_Lin_SetInterruptMask(CY_LINCH1_TYPE, 0uL);         /* Disable all interrupt. */
    ...
    else
    {
        ...
        case LIN_STATE_TX_HEADER_RX_RESPONSE:
            ...
            while(1)
            {
                apiResponse = Cy_Lin_ReadData(CY_LINCH1_TYPE, msgContext[scheduleIdx].dataBuffer);
