...
#define SCB0_MISO_PORT    GPIO_PRT6
#define SCB0_MISO_PIN     0ul
#define SCB0_MISO_PIN_MUX P6_0_SCB4_SPI_MISO

#define SCB0_MOSI_PORT    GPIO_PRT6
#define SCB0_MOSI_PIN     1ul
#define SCB0_MOSI_PIN_MUX P6_1_SCB4_SPI_MOSI

#define SCB0_CLK_PORT     GPIO_PRT6
#define SCB0_CLK_PIN      2ul
#define SCB0_CLK_PIN_MUX  P6_2_SCB4_SPI_CLK

#define SCB0_SS0_PORT     GPIO_PRT6
#define SCB0_SS0_PIN      3ul
#define SCB0_SS0_PIN_MUX  P6_3_SCB4_SPI_SELECT0
