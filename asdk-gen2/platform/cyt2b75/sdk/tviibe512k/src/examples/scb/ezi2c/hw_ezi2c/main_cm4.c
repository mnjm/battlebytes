...
#define I2C_SDA_PORT     GPIO_PRT0
#define I2C_SDA_PORT_PIN (3)
#define I2C_SDA_PORT_MUX P0_3_SCB0_I2C_SDA

#define I2C_SCL_PORT     GPIO_PRT0
#define I2C_SCL_PORT_PIN (2)
#define I2C_SCL_PORT_MUX P0_2_SCB0_I2C_SCL
