...
#define CY_SPI_SCB_TYPE      SCB4

#define CY_SPI_SCB_MISO_PORT GPIO_PRT6
#define CY_SPI_SCB_MISO_PIN  0ul
#define CY_SPI_SCB_MISO_MUX  P6_0_SCB4_SPI_MISO

#define CY_SPI_SCB_MOSI_PORT GPIO_PRT6
#define CY_SPI_SCB_MOSI_PIN  1ul
#define CY_SPI_SCB_MOSI_MUX  P6_1_SCB4_SPI_MOSI

#define CY_SPI_SCB_CLK_PORT  GPIO_PRT6
#define CY_SPI_SCB_CLK_PIN   2ul
#define CY_SPI_SCB_CLK_MUX   P6_2_SCB4_SPI_CLK

#define CY_SPI_SCB_SEL0_PORT GPIO_PRT6
#define CY_SPI_SCB_SEL0_PIN  3ul
#define CY_SPI_SCB_SEL0_MUX  P6_3_SCB4_SPI_SELECT0

#define CY_SPI_SCB_PCLK      PCLK_SCB4_CLOCK
#define CY_SPI_SCB_IRQN      scb_4_interrupt_IRQn
