...
#define SMIF_LCD_SECTION_SIZE                   0x00010000UL
...
/**
  * \brief ID & Revision (SMIF_LCD_ID)
  */
typedef struct stc_SMIF_LCD_ID_field {
  uint32_t                         u16ID:16;
  uint32_t                         u16REVISION:16;
} stc_SMIF_LCD_ID_field_t;

typedef union un_SMIF_LCD_ID {
  uint32_t                         u32Register;
  stc_SMIF_LCD_ID_field_t          stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SMIF_LCD_ID_t;

/**
  * \brief LCD Divider Register (SMIF_LCD_DIVIDER)
  */
typedef struct stc_SMIF_LCD_DIVIDER_field {
  uint32_t                         u16SUBFR_DIV:16;
  uint32_t                         u16DEAD_DIV:16;
} stc_SMIF_LCD_DIVIDER_field_t;

typedef union un_SMIF_LCD_DIVIDER {
  uint32_t                         u32Register;
  stc_SMIF_LCD_DIVIDER_field_t     stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SMIF_LCD_DIVIDER_t;

/**
  * \brief LCD Configuration Register (SMIF_LCD_CONTROL)
  */
typedef struct stc_SMIF_LCD_CONTROL_field {
  uint32_t                         u1LS_EN:1;
  uint32_t                         u1HS_EN:1;
...
} stc_SMIF_LCD_CONTROL_field_t;

typedef union un_SMIF_LCD_CONTROL {
  uint32_t                         u32Register;
  stc_SMIF_LCD_CONTROL_field_t     stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SMIF_LCD_CONTROL_t;

/**
  * \brief LCD Pin Data Registers (SMIF_LCD_DATA0)
  */
typedef struct stc_SMIF_LCD_DATA0_field {
  uint32_t                         u32DATA:32;
} stc_SMIF_LCD_DATA0_field_t;

typedef union un_SMIF_LCD_DATA0 {
  uint32_t                         u32Register;
  stc_SMIF_LCD_DATA0_field_t       stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SMIF_LCD_DATA0_t;

/**
  * \brief LCD Pin Data Registers (SMIF_LCD_DATA1)
  */
typedef struct stc_SMIF_LCD_DATA1_field {
  uint32_t                         u32DATA:32;
} stc_SMIF_LCD_DATA1_field_t;

typedef union un_SMIF_LCD_DATA1 {
  uint32_t                         u32Register;
  stc_SMIF_LCD_DATA1_field_t       stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SMIF_LCD_DATA1_t;

/**
  * \brief LCD Pin Data Registers (SMIF_LCD_DATA2)
  */
typedef struct stc_SMIF_LCD_DATA2_field {
  uint32_t                         u32DATA:32;
} stc_SMIF_LCD_DATA2_field_t;

typedef union un_SMIF_LCD_DATA2 {
  uint32_t                         u32Register;
  stc_SMIF_LCD_DATA2_field_t       stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SMIF_LCD_DATA2_t;

/**
  * \brief LCD Pin Data Registers (SMIF_LCD_DATA3)
  */
typedef struct stc_SMIF_LCD_DATA3_field {
  uint32_t                         u32DATA:32;
} stc_SMIF_LCD_DATA3_field_t;

typedef union un_SMIF_LCD_DATA3 {
  uint32_t                         u32Register;
  stc_SMIF_LCD_DATA3_field_t       stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SMIF_LCD_DATA3_t;
...
/**
  * \brief LCD Controller Block (SMIF_LCD)
  */
typedef struct stc_SMIF_LCD {
  un_SMIF_LCD_ID_t                 unID;               /*!< 0x00000000 ID & Revision */
  un_SMIF_LCD_DIVIDER_t            unDIVIDER;          /*!< 0x00000004 LCD Divider Register */
  un_SMIF_LCD_CONTROL_t            unCONTROL;          /*!< 0x00000008 LCD Configuration Register */
  uint32_t                         au32Reserved[61];
  un_SMIF_LCD_DATA0_t              unDATA0[8];         /*!< 0x00000100 LCD Pin Data Registers */
  uint32_t                         au32Reserved1[56];
  un_SMIF_LCD_DATA1_t              unDATA1[8];         /*!< 0x00000200 LCD Pin Data Registers */
  uint32_t                         au32Reserved2[56];
  un_SMIF_LCD_DATA2_t              unDATA2[8];         /*!< 0x00000300 LCD Pin Data Registers */
  uint32_t                         au32Reserved3[56];
  un_SMIF_LCD_DATA3_t              unDATA3[8];         /*!< 0x00000400 LCD Pin Data Registers */
  uint32_t                         au32Reserved4[16120];
} stc_SMIF_LCD_t;                                      /*!< Size = 65536 (0x10000) */
...
typedef struct stc_SMIF {
  ...
  stc_SMIF_LCD_t                   LCD[1];             /*!< 0x00001000 LCD Controller Block */
} stc_SMIF_t;                                          /*!< Size = 69632 (0x11000) */
...
/* SMIF_LCD.ID */
#define SMIF_LCD_ID_ID_Pos                      0UL
#define SMIF_LCD_ID_ID_Msk                      0xFFFFUL
#define SMIF_LCD_ID_REVISION_Pos                16UL
#define SMIF_LCD_ID_REVISION_Msk                0xFFFF0000UL
/* SMIF_LCD.DIVIDER */
#define SMIF_LCD_DIVIDER_SUBFR_DIV_Pos          0UL
#define SMIF_LCD_DIVIDER_SUBFR_DIV_Msk          0xFFFFUL
#define SMIF_LCD_DIVIDER_DEAD_DIV_Pos           16UL
#define SMIF_LCD_DIVIDER_DEAD_DIV_Msk           0xFFFF0000UL
/* SMIF_LCD.CONTROL */
#define SMIF_LCD_CONTROL_LS_EN_Pos              0UL
#define SMIF_LCD_CONTROL_LS_EN_Msk              0x1UL
#define SMIF_LCD_CONTROL_HS_EN_Pos              1UL
#define SMIF_LCD_CONTROL_HS_EN_Msk              0x2UL
#define SMIF_LCD_CONTROL_LCD_MODE_Pos           2UL
#define SMIF_LCD_CONTROL_LCD_MODE_Msk           0x4UL
#define SMIF_LCD_CONTROL_TYPE_Pos               3UL
#define SMIF_LCD_CONTROL_TYPE_Msk               0x8UL
#define SMIF_LCD_CONTROL_OP_MODE_Pos            4UL
#define SMIF_LCD_CONTROL_OP_MODE_Msk            0x10UL
#define SMIF_LCD_CONTROL_BIAS_Pos               5UL
#define SMIF_LCD_CONTROL_BIAS_Msk               0x60UL
#define SMIF_LCD_CONTROL_CLOCK_LS_SEL_Pos       7UL
#define SMIF_LCD_CONTROL_CLOCK_LS_SEL_Msk       0x80UL
#define SMIF_LCD_CONTROL_COM_NUM_Pos            8UL
#define SMIF_LCD_CONTROL_COM_NUM_Msk            0xF00UL
#define SMIF_LCD_CONTROL_LS_EN_STAT_Pos         31UL
#define SMIF_LCD_CONTROL_LS_EN_STAT_Msk         0x80000000UL
/* SMIF_LCD.DATA0 */
#define SMIF_LCD_DATA0_DATA_Pos                 0UL
#define SMIF_LCD_DATA0_DATA_Msk                 0xFFFFFFFFUL
/* SMIF_LCD.DATA1 */
#define SMIF_LCD_DATA1_DATA_Pos                 0UL
#define SMIF_LCD_DATA1_DATA_Msk                 0xFFFFFFFFUL
/* SMIF_LCD.DATA2 */
#define SMIF_LCD_DATA2_DATA_Pos                 0UL
#define SMIF_LCD_DATA2_DATA_Msk                 0xFFFFFFFFUL
/* SMIF_LCD.DATA3 */
#define SMIF_LCD_DATA3_DATA_Pos                 0UL
#define SMIF_LCD_DATA3_DATA_Msk                 0xFFFFFFFFUL
