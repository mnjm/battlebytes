...
#ifndef _CYT3DL9BDS_H_
#define _CYT3DL9BDS_H_

/**
* \addtogroup group_device CYT3DL9BDS
* \{
*/
...
/* CYT3DL9BDS peripheral interrupts */
typedef enum {
  ...
  ioss_interrupts_gpio_act_11_IRQn  =  52,      /*!<  52 [Active] GPIO Port Interrupt #11 */
  ioss_interrupts_gpio_act_12_IRQn  =  53,      /*!<  53 [Active] GPIO Port Interrupt #12 */
  ioss_interrupts_gpio_act_13_IRQn  =  54,      /*!<  54 [Active] GPIO Port Interrupt #13 */
  ioss_interrupts_gpio_act_14_IRQn  =  55,      /*!<  55 [Active] GPIO Port Interrupt #14 */
  ioss_interrupts_gpio_act_15_IRQn  =  56,      /*!<  56 [Active] GPIO Port Interrupt #15 */
  ioss_interrupts_gpio_act_16_IRQn  =  57,      /*!<  57 [Active] GPIO Port Interrupt #16 */
  ioss_interrupts_gpio_act_17_IRQn  =  58,      /*!<  58 [Active] GPIO Port Interrupt #17 */
  ioss_interrupts_gpio_act_18_IRQn  =  59,      /*!<  59 [Active] GPIO Port Interrupt #18 */
  ioss_interrupts_gpio_act_19_IRQn  =  60,      /*!<  60 [Active] GPIO Port Interrupt #19 */
  ioss_interrupts_gpio_act_20_IRQn  =  61,      /*!<  61 [Active] GPIO Port Interrupt #20 */
  ioss_interrupts_gpio_act_21_IRQn  =  62,      /*!<  62 [Active] GPIO Port Interrupt #21 */
...
#define CY_VIDEOSS_VRAM_SIZE            0x00200000UL
...
#define CY_SRAM1_BASE                   0x28020000UL
#define CY_SRAM1_SIZE                   0x00020000UL
#define CY_SRAM2_BASE                   0x28040000UL
#define CY_SRAM2_SIZE                   0x00020000UL

#include "system_cyt3dl.h"                      /*!< CYT3DL System */
...
#include "cyt3dl_config.h"
#include "gpio_cyt3dl_208_teqfp.h"

#define CY_DEVICE_TVIIC2D4M
#define CY_SILICON_ID                   0x0000E854UL
#define CY_HF_CLK_MAX_FREQ              240000000UL
...
#define PERI_MS_PPU_FX_PROT_MPU11_MAIN          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[61])           /* 0x40021740 */
#define PERI_MS_PPU_FX_PROT_MPU12_MAIN          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[62])           /* 0x40021780 */
#define PERI_MS_PPU_FX_PROT_MPU14_MAIN          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[63])           /* 0x400217C0 */
#define PERI_MS_PPU_FX_PROT_MPU15_MAIN          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[64])           /* 0x40021800 */
#define PERI_MS_PPU_FX_FLASHC_MAIN              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[65])           /* 0x40021840 */
#define PERI_MS_PPU_FX_FLASHC_CMD               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[66])           /* 0x40021880 */
#define PERI_MS_PPU_FX_FLASHC_DFT               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[67])           /* 0x400218C0 */
#define PERI_MS_PPU_FX_FLASHC_CM0               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[68])           /* 0x40021900 */
#define PERI_MS_PPU_FX_FLASHC_CM7_0             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[69])           /* 0x40021940 */
...
#define PERI_MS_PPU_FX_FLASHC_FlashMgmt         ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[74])           /* 0x40021A80 */
#define PERI_MS_PPU_FX_FLASHC_MainSafety        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[75])           /* 0x40021AC0 */
#define PERI_MS_PPU_FX_FLASHC_WorkSafety        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[76])           /* 0x40021B00 */
#define PERI_MS_PPU_FX_SRSS_GENERAL             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[77])           /* 0x40021B40 */
#define PERI_MS_PPU_FX_SRSS_MAIN                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[78])           /* 0x40021B80 */
#define PERI_MS_PPU_FX_SRSS_SECURE              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[79])           /* 0x40021BC0 */
#define PERI_MS_PPU_FX_MCWDT0_CONFIG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[80])           /* 0x40021C00 */
#define PERI_MS_PPU_FX_MCWDT1_CONFIG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[81])           /* 0x40021C40 */
...
#define PERI_MS_PPU_FX_WDT_CONFIG               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[84])           /* 0x40021D00 */
#define PERI_MS_PPU_FX_WDT_MAIN                 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[85])           /* 0x40021D40 */
#define PERI_MS_PPU_FX_BACKUP_BACKUP            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[86])           /* 0x40021D80 */
#define PERI_MS_PPU_FX_DW0_DW                   ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[87])           /* 0x40021DC0 */
#define PERI_MS_PPU_FX_DW1_DW                   ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[88])           /* 0x40021E00 */
#define PERI_MS_PPU_FX_DW0_DW_CRC               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[89])           /* 0x40021E40 */
#define PERI_MS_PPU_FX_DW1_DW_CRC               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[90])           /* 0x40021E80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT0_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[91])           /* 0x40021EC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT1_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[92])           /* 0x40021F00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT2_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[93])           /* 0x40021F40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT3_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[94])           /* 0x40021F80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT4_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[95])           /* 0x40021FC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT5_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[96])           /* 0x40022000 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT6_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[97])           /* 0x40022040 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT7_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[98])           /* 0x40022080 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT8_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[99])           /* 0x400220C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT9_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[100])          /* 0x40022100 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT10_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[101])          /* 0x40022140 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT11_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[102])          /* 0x40022180 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT12_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[103])          /* 0x400221C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT13_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[104])          /* 0x40022200 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT14_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[105])          /* 0x40022240 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT15_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[106])          /* 0x40022280 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT16_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[107])          /* 0x400222C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT17_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[108])          /* 0x40022300 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT18_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[109])          /* 0x40022340 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT19_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[110])          /* 0x40022380 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT20_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[111])          /* 0x400223C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT21_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[112])          /* 0x40022400 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT22_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[113])          /* 0x40022440 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT23_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[114])          /* 0x40022480 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT24_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[115])          /* 0x400224C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT25_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[116])          /* 0x40022500 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT26_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[117])          /* 0x40022540 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT27_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[118])          /* 0x40022580 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT28_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[119])          /* 0x400225C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT29_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[120])          /* 0x40022600 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT30_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[121])          /* 0x40022640 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT31_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[122])          /* 0x40022680 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT32_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[123])          /* 0x400226C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT33_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[124])          /* 0x40022700 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT34_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[125])          /* 0x40022740 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT35_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[126])          /* 0x40022780 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT36_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[127])          /* 0x400227C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT37_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[128])          /* 0x40022800 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT38_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[129])          /* 0x40022840 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT39_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[130])          /* 0x40022880 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT40_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[131])          /* 0x400228C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT41_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[132])          /* 0x40022900 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT42_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[133])          /* 0x40022940 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT43_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[134])          /* 0x40022980 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT44_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[135])          /* 0x400229C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT45_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[136])          /* 0x40022A00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT46_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[137])          /* 0x40022A40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT47_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[138])          /* 0x40022A80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT48_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[139])          /* 0x40022AC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT49_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[140])          /* 0x40022B00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT50_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[141])          /* 0x40022B40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT51_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[142])          /* 0x40022B80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT52_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[143])          /* 0x40022BC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT53_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[144])          /* 0x40022C00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT54_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[145])          /* 0x40022C40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT55_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[146])          /* 0x40022C80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT56_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[147])          /* 0x40022CC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT57_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[148])          /* 0x40022D00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT58_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[149])          /* 0x40022D40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT59_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[150])          /* 0x40022D80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT60_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[151])          /* 0x40022DC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT61_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[152])          /* 0x40022E00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT62_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[153])          /* 0x40022E40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT63_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[154])          /* 0x40022E80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT64_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[155])          /* 0x40022EC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT65_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[156])          /* 0x40022F00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT66_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[157])          /* 0x40022F40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT67_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[158])          /* 0x40022F80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT68_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[159])          /* 0x40022FC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT69_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[160])          /* 0x40023000 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT70_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[161])          /* 0x40023040 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT71_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[162])          /* 0x40023080 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT72_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[163])          /* 0x400230C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT73_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[164])          /* 0x40023100 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT74_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[165])          /* 0x40023140 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT75_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[166])          /* 0x40023180 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT0_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[167])          /* 0x400231C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT1_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[168])          /* 0x40023200 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT2_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[169])          /* 0x40023240 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT3_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[170])          /* 0x40023280 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT4_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[171])          /* 0x400232C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT5_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[172])          /* 0x40023300 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT6_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[173])          /* 0x40023340 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT7_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[174])          /* 0x40023380 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT8_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[175])          /* 0x400233C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT9_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[176])          /* 0x40023400 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT10_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[177])          /* 0x40023440 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT11_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[178])          /* 0x40023480 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT12_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[179])          /* 0x400234C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT13_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[180])          /* 0x40023500 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT14_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[181])          /* 0x40023540 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT15_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[182])          /* 0x40023580 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT16_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[183])          /* 0x400235C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT17_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[184])          /* 0x40023600 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT18_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[185])          /* 0x40023640 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT19_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[186])          /* 0x40023680 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT20_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[187])          /* 0x400236C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT21_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[188])          /* 0x40023700 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT22_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[189])          /* 0x40023740 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT23_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[190])          /* 0x40023780 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT24_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[191])          /* 0x400237C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT25_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[192])          /* 0x40023800 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT26_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[193])          /* 0x40023840 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT27_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[194])          /* 0x40023880 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT28_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[195])          /* 0x400238C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT29_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[196])          /* 0x40023900 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT30_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[197])          /* 0x40023940 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT31_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[198])          /* 0x40023980 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT32_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[199])          /* 0x400239C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT33_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[200])          /* 0x40023A00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT34_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[201])          /* 0x40023A40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT35_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[202])          /* 0x40023A80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT36_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[203])          /* 0x40023AC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT37_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[204])          /* 0x40023B00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT38_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[205])          /* 0x40023B40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT39_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[206])          /* 0x40023B80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT40_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[207])          /* 0x40023BC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT41_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[208])          /* 0x40023C00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT42_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[209])          /* 0x40023C40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT43_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[210])          /* 0x40023C80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT44_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[211])          /* 0x40023CC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT45_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[212])          /* 0x40023D00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT46_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[213])          /* 0x40023D40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT47_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[214])          /* 0x40023D80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT48_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[215])          /* 0x40023DC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT49_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[216])          /* 0x40023E00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT50_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[217])          /* 0x40023E40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT51_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[218])          /* 0x40023E80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT52_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[219])          /* 0x40023EC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT53_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[220])          /* 0x40023F00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT54_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[221])          /* 0x40023F40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT55_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[222])          /* 0x40023F80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT56_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[223])          /* 0x40023FC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT57_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[224])          /* 0x40024000 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT58_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[225])          /* 0x40024040 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT59_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[226])          /* 0x40024080 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT60_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[227])          /* 0x400240C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT61_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[228])          /* 0x40024100 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT62_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[229])          /* 0x40024140 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT63_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[230])          /* 0x40024180 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT64_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[231])          /* 0x400241C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT65_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[232])          /* 0x40024200 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT66_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[233])          /* 0x40024240 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT67_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[234])          /* 0x40024280 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT68_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[235])          /* 0x400242C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT69_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[236])          /* 0x40024300 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT70_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[237])          /* 0x40024340 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT71_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[238])          /* 0x40024380 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT72_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[239])          /* 0x400243C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT73_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[240])          /* 0x40024400 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT74_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[241])          /* 0x40024440 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT75_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[242])          /* 0x40024480 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT76_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[243])          /* 0x400244C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT77_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[244])          /* 0x40024500 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT78_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[245])          /* 0x40024540 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT79_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[246])          /* 0x40024580 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT80_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[247])          /* 0x400245C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT81_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[248])          /* 0x40024600 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT82_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[249])          /* 0x40024640 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT83_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[250])          /* 0x40024680 */
#define PERI_MS_PPU_FX_DMAC_TOP                 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[251])          /* 0x400246C0 */
#define PERI_MS_PPU_FX_DMAC_CH0_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[252])          /* 0x40024700 */
#define PERI_MS_PPU_FX_DMAC_CH1_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[253])          /* 0x40024740 */
#define PERI_MS_PPU_FX_DMAC_CH2_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[254])          /* 0x40024780 */
#define PERI_MS_PPU_FX_DMAC_CH3_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[255])          /* 0x400247C0 */
#define PERI_MS_PPU_FX_DMAC_CH4_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[256])          /* 0x40024800 */
#define PERI_MS_PPU_FX_DMAC_CH5_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[257])          /* 0x40024840 */
#define PERI_MS_PPU_FX_DMAC_CH6_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[258])          /* 0x40024880 */
#define PERI_MS_PPU_FX_DMAC_CH7_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[259])          /* 0x400248C0 */
#define PERI_MS_PPU_FX_AXI_DMAC_TOP             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[260])          /* 0x40024900 */
#define PERI_MS_PPU_FX_AXI_DMAC_SEC             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[261])          /* 0x40024940 */
#define PERI_MS_PPU_FX_AXI_DMAC_NONSEC          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[262])          /* 0x40024980 */
#define PERI_MS_PPU_FX_AXI_DMAC_CH0_CH          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[263])          /* 0x400249C0 */
#define PERI_MS_PPU_FX_AXI_DMAC_CH1_CH          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[264])          /* 0x40024A00 */
#define PERI_MS_PPU_FX_AXI_DMAC_CH2_CH          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[265])          /* 0x40024A40 */
#define PERI_MS_PPU_FX_AXI_DMAC_CH3_CH          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[266])          /* 0x40024A80 */
#define PERI_MS_PPU_FX_EFUSE_CTL                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[267])          /* 0x40024AC0 */
#define PERI_MS_PPU_FX_EFUSE_DATA               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[268])          /* 0x40024B00 */
#define PERI_MS_PPU_FX_DFT                      ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[269])          /* 0x40024B40 */
#define PERI_MS_PPU_FX_HSIOM_PRT0_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[270])          /* 0x40024B80 */
#define PERI_MS_PPU_FX_HSIOM_PRT1_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[271])          /* 0x40024BC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT2_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[272])          /* 0x40024C00 */
#define PERI_MS_PPU_FX_HSIOM_PRT3_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[273])          /* 0x40024C40 */
#define PERI_MS_PPU_FX_HSIOM_PRT4_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[274])          /* 0x40024C80 */
#define PERI_MS_PPU_FX_HSIOM_PRT5_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[275])          /* 0x40024CC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT6_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[276])          /* 0x40024D00 */
#define PERI_MS_PPU_FX_HSIOM_PRT7_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[277])          /* 0x40024D40 */
#define PERI_MS_PPU_FX_HSIOM_PRT8_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[278])          /* 0x40024D80 */
#define PERI_MS_PPU_FX_HSIOM_PRT9_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[279])          /* 0x40024DC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT10_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[280])          /* 0x40024E00 */
#define PERI_MS_PPU_FX_HSIOM_PRT11_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[281])          /* 0x40024E40 */
#define PERI_MS_PPU_FX_HSIOM_PRT12_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[282])          /* 0x40024E80 */
#define PERI_MS_PPU_FX_HSIOM_PRT13_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[283])          /* 0x40024EC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT14_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[284])          /* 0x40024F00 */
#define PERI_MS_PPU_FX_HSIOM_PRT15_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[285])          /* 0x40024F40 */
#define PERI_MS_PPU_FX_HSIOM_PRT16_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[286])          /* 0x40024F80 */
#define PERI_MS_PPU_FX_HSIOM_PRT17_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[287])          /* 0x40024FC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT18_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[288])          /* 0x40025000 */
#define PERI_MS_PPU_FX_HSIOM_PRT19_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[289])          /* 0x40025040 */
#define PERI_MS_PPU_FX_HSIOM_PRT20_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[290])          /* 0x40025080 */
#define PERI_MS_PPU_FX_HSIOM_PRT21_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[291])          /* 0x400250C0 */
#define PERI_MS_PPU_FX_HSIOM_AMUX               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[292])          /* 0x40025100 */
#define PERI_MS_PPU_FX_HSIOM_MON                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[293])          /* 0x40025140 */
#define PERI_MS_PPU_FX_GPIO_PRT0_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[294])          /* 0x40025180 */
#define PERI_MS_PPU_FX_GPIO_PRT1_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[295])          /* 0x400251C0 */
#define PERI_MS_PPU_FX_GPIO_PRT2_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[296])          /* 0x40025200 */
#define PERI_MS_PPU_FX_GPIO_PRT3_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[297])          /* 0x40025240 */
#define PERI_MS_PPU_FX_GPIO_PRT4_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[298])          /* 0x40025280 */
#define PERI_MS_PPU_FX_GPIO_PRT5_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[299])          /* 0x400252C0 */
#define PERI_MS_PPU_FX_GPIO_PRT6_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[300])          /* 0x40025300 */
#define PERI_MS_PPU_FX_GPIO_PRT7_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[301])          /* 0x40025340 */
#define PERI_MS_PPU_FX_GPIO_PRT8_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[302])          /* 0x40025380 */
#define PERI_MS_PPU_FX_GPIO_PRT9_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[303])          /* 0x400253C0 */
#define PERI_MS_PPU_FX_GPIO_PRT10_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[304])          /* 0x40025400 */
#define PERI_MS_PPU_FX_GPIO_PRT11_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[305])          /* 0x40025440 */
#define PERI_MS_PPU_FX_GPIO_PRT12_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[306])          /* 0x40025480 */
#define PERI_MS_PPU_FX_GPIO_PRT13_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[307])          /* 0x400254C0 */
#define PERI_MS_PPU_FX_GPIO_PRT14_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[308])          /* 0x40025500 */
#define PERI_MS_PPU_FX_GPIO_PRT15_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[309])          /* 0x40025540 */
#define PERI_MS_PPU_FX_GPIO_PRT16_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[310])          /* 0x40025580 */
#define PERI_MS_PPU_FX_GPIO_PRT17_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[311])          /* 0x400255C0 */
#define PERI_MS_PPU_FX_GPIO_PRT18_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[312])          /* 0x40025600 */
#define PERI_MS_PPU_FX_GPIO_PRT19_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[313])          /* 0x40025640 */
#define PERI_MS_PPU_FX_GPIO_PRT20_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[314])          /* 0x40025680 */
#define PERI_MS_PPU_FX_GPIO_PRT21_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[315])          /* 0x400256C0 */
#define PERI_MS_PPU_FX_GPIO_PRT0_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[316])          /* 0x40025700 */
#define PERI_MS_PPU_FX_GPIO_PRT1_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[317])          /* 0x40025740 */
#define PERI_MS_PPU_FX_GPIO_PRT2_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[318])          /* 0x40025780 */
#define PERI_MS_PPU_FX_GPIO_PRT3_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[319])          /* 0x400257C0 */
#define PERI_MS_PPU_FX_GPIO_PRT4_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[320])          /* 0x40025800 */
#define PERI_MS_PPU_FX_GPIO_PRT5_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[321])          /* 0x40025840 */
#define PERI_MS_PPU_FX_GPIO_PRT6_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[322])          /* 0x40025880 */
#define PERI_MS_PPU_FX_GPIO_PRT7_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[323])          /* 0x400258C0 */
#define PERI_MS_PPU_FX_GPIO_PRT8_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[324])          /* 0x40025900 */
#define PERI_MS_PPU_FX_GPIO_PRT9_CFG            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[325])          /* 0x40025940 */
#define PERI_MS_PPU_FX_GPIO_PRT10_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[326])          /* 0x40025980 */
#define PERI_MS_PPU_FX_GPIO_PRT11_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[327])          /* 0x400259C0 */
#define PERI_MS_PPU_FX_GPIO_PRT12_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[328])          /* 0x40025A00 */
#define PERI_MS_PPU_FX_GPIO_PRT13_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[329])          /* 0x40025A40 */
#define PERI_MS_PPU_FX_GPIO_PRT14_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[330])          /* 0x40025A80 */
#define PERI_MS_PPU_FX_GPIO_PRT15_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[331])          /* 0x40025AC0 */
#define PERI_MS_PPU_FX_GPIO_PRT16_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[332])          /* 0x40025B00 */
#define PERI_MS_PPU_FX_GPIO_PRT17_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[333])          /* 0x40025B40 */
#define PERI_MS_PPU_FX_GPIO_PRT18_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[334])          /* 0x40025B80 */
#define PERI_MS_PPU_FX_GPIO_PRT19_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[335])          /* 0x40025BC0 */
#define PERI_MS_PPU_FX_GPIO_PRT20_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[336])          /* 0x40025C00 */
#define PERI_MS_PPU_FX_GPIO_PRT21_CFG           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[337])          /* 0x40025C40 */
#define PERI_MS_PPU_FX_GPIO_GPIO                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[338])          /* 0x40025C80 */
#define PERI_MS_PPU_FX_GPIO_TEST                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[339])          /* 0x40025CC0 */
#define PERI_MS_PPU_FX_SMARTIO_PRT9_PRT         ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[340])          /* 0x40025D00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT0_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[341])          /* 0x40025D40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT1_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[342])          /* 0x40025D80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT2_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[343])          /* 0x40025DC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT3_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[344])          /* 0x40025E00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT4_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[345])          /* 0x40025E40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT5_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[346])          /* 0x40025E80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT6_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[347])          /* 0x40025EC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT7_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[348])          /* 0x40025F00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT8_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[349])          /* 0x40025F40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT9_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[350])          /* 0x40025F80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT10_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[351])          /* 0x40025FC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT11_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[352])          /* 0x40026000 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT12_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[353])          /* 0x40026040 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT13_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[354])          /* 0x40026080 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT14_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[355])          /* 0x400260C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT15_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[356])          /* 0x40026100 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT16_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[357])          /* 0x40026140 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT17_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[358])          /* 0x40026180 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT18_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[359])          /* 0x400261C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT19_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[360])          /* 0x40026200 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT20_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[361])          /* 0x40026240 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT21_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[362])          /* 0x40026280 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT22_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[363])          /* 0x400262C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT23_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[364])          /* 0x40026300 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT24_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[365])          /* 0x40026340 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT25_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[366])          /* 0x40026380 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT26_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[367])          /* 0x400263C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT27_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[368])          /* 0x40026400 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT28_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[369])          /* 0x40026440 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT29_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[370])          /* 0x40026480 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT30_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[371])          /* 0x400264C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT31_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[372])          /* 0x40026500 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT32_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[373])          /* 0x40026540 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT33_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[374])          /* 0x40026580 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT34_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[375])          /* 0x400265C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT35_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[376])          /* 0x40026600 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT36_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[377])          /* 0x40026640 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT37_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[378])          /* 0x40026680 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT0_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[379])          /* 0x400266C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT1_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[380])          /* 0x40026700 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT2_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[381])          /* 0x40026740 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT3_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[382])          /* 0x40026780 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT4_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[383])          /* 0x400267C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT5_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[384])          /* 0x40026800 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT6_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[385])          /* 0x40026840 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT7_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[386])          /* 0x40026880 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT8_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[387])          /* 0x400268C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT9_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[388])          /* 0x40026900 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT10_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[389])          /* 0x40026940 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT11_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[390])          /* 0x40026980 */
...
#define PERI_MS_PPU_FX_SMIF1_MAIN               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[425])          /* 0x40027240 */
#define PERI_MS_PPU_FX_ETH0                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[426])          /* 0x40027280 */
#define PERI_MS_PPU_FX_LIN0_MAIN                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[427])          /* 0x400272C0 */
#define PERI_MS_PPU_FX_LIN0_CH0_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[428])          /* 0x40027300 */
#define PERI_MS_PPU_FX_LIN0_CH1_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[429])          /* 0x40027340 */
#define PERI_MS_PPU_FX_CXPI0_MAIN               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[430])          /* 0x40027380 */
#define PERI_MS_PPU_FX_CXPI0_CH0_CH             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[431])          /* 0x400273C0 */
#define PERI_MS_PPU_FX_CXPI0_CH1_CH             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[432])          /* 0x40027400 */
#define PERI_MS_PPU_FX_CANFD0_CH0_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[433])          /* 0x40027440 */
#define PERI_MS_PPU_FX_CANFD0_CH1_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[434])          /* 0x40027480 */
#define PERI_MS_PPU_FX_CANFD1_CH0_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[435])          /* 0x400274C0 */
#define PERI_MS_PPU_FX_CANFD1_CH1_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[436])          /* 0x40027500 */
#define PERI_MS_PPU_FX_CANFD0_MAIN              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[437])          /* 0x40027540 */
#define PERI_MS_PPU_FX_CANFD1_MAIN              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[438])          /* 0x40027580 */
#define PERI_MS_PPU_FX_CANFD0_BUF               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[439])          /* 0x400275C0 */
#define PERI_MS_PPU_FX_CANFD1_BUF               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[440])          /* 0x40027600 */
#define PERI_MS_PPU_FX_SCB0                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[441])          /* 0x40027640 */
#define PERI_MS_PPU_FX_SCB1                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[442])          /* 0x40027680 */
#define PERI_MS_PPU_FX_SCB2                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[443])          /* 0x400276C0 */
#define PERI_MS_PPU_FX_SCB3                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[444])          /* 0x40027700 */
#define PERI_MS_PPU_FX_SCB4                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[445])          /* 0x40027740 */
#define PERI_MS_PPU_FX_SCB5                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[446])          /* 0x40027780 */
#define PERI_MS_PPU_FX_SCB6                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[447])          /* 0x400277C0 */
#define PERI_MS_PPU_FX_SCB7                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[448])          /* 0x40027800 */
#define PERI_MS_PPU_FX_SCB8                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[449])          /* 0x40027840 */
#define PERI_MS_PPU_FX_SCB9                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[450])          /* 0x40027880 */
#define PERI_MS_PPU_FX_SCB10                    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[451])          /* 0x400278C0 */
#define PERI_MS_PPU_FX_SCB11                    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[452])          /* 0x40027900 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT0_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[453]) /* 0x40027940 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT1_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[454]) /* 0x40027980 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT2_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[455]) /* 0x400279C0 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT3_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[456]) /* 0x40027A00 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT0_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[457]) /* 0x40027A40 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT1_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[458]) /* 0x40027A80 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT2_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[459]) /* 0x40027AC0 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT3_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[460]) /* 0x40027B00 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT0_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[461])          /* 0x40027B40 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT1_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[462])          /* 0x40027B80 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT2_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[463])          /* 0x40027BC0 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT3_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[464])          /* 0x40027C00 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT4_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[465])          /* 0x40027C40 */
#define PERI_MS_PPU_FX_PWM0_MAIN                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[466])          /* 0x40027C80 */
#define PERI_MS_PPU_FX_PWM0_TX0_TX              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[467])          /* 0x40027CC0 */
#define PERI_MS_PPU_FX_PWM0_TX1_TX              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[468])          /* 0x40027D00 */
#define PERI_MS_PPU_FX_DAC0_MAIN                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[469])          /* 0x40027D40 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT0_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[470])      /* 0x40027D80 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT1_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[471])      /* 0x40027DC0 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT2_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[472])      /* 0x40027E00 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT3_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[473])      /* 0x40027E40 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT4_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[474])      /* 0x40027E80 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT0_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[475])      /* 0x40027EC0 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT1_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[476])      /* 0x40027F00 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT2_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[477])      /* 0x40027F40 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT3_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[478])      /* 0x40027F80 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT4_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[479])      /* 0x40027FC0 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_DST_STRUCT_DST ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[480])       /* 0x40028000 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_DST_STRUCT_DST ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[481])       /* 0x40028040 */
#define PERI_MS_PPU_FX_PASS0_SAR0_SAR           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[482])          /* 0x40028080 */
#define PERI_MS_PPU_FX_PASS0_SAR1_SAR           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[483])          /* 0x400280C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH0_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[484])          /* 0x40028100 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH1_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[485])          /* 0x40028140 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH2_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[486])          /* 0x40028180 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH3_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[487])          /* 0x400281C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH4_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[488])          /* 0x40028200 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH5_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[489])          /* 0x40028240 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH6_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[490])          /* 0x40028280 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH7_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[491])          /* 0x400282C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH8_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[492])          /* 0x40028300 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH9_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[493])          /* 0x40028340 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH10_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[494])          /* 0x40028380 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH11_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[495])          /* 0x400283C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH12_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[496])          /* 0x40028400 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH13_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[497])          /* 0x40028440 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH14_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[498])          /* 0x40028480 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH15_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[499])          /* 0x400284C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH16_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[500])          /* 0x40028500 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH17_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[501])          /* 0x40028540 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH18_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[502])          /* 0x40028580 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH19_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[503])          /* 0x400285C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH20_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[504])          /* 0x40028600 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH21_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[505])          /* 0x40028640 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH22_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[506])          /* 0x40028680 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH23_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[507])          /* 0x400286C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH24_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[508])          /* 0x40028700 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH25_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[509])          /* 0x40028740 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH26_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[510])          /* 0x40028780 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH27_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[511])          /* 0x400287C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH28_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[512])          /* 0x40028800 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH29_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[513])          /* 0x40028840 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH30_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[514])          /* 0x40028880 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH31_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[515])          /* 0x400288C0 */
#define PERI_MS_PPU_FX_PASS0_TOP                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[516])          /* 0x40028900 */
#define PERI_MS_PPU_FX_VIDEOSS0_VCFG_VIDEOSSCFG ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[517])          /* 0x40028940 */
#define PERI_MS_PPU_FX_VIDEOSS0_VCFG_VRAM       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[518])          /* 0x40028980 */
#define PERI_MS_PPU_FX_VIDEOSS0_GPU_GFX2D       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[519])          /* 0x400289C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_VIDEOIOCFG_VIRQ_VIDEOIOCFG ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[520]) /* 0x40028A00 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_FRAMEDUMP ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[521])        /* 0x40028A40 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_CAPENG0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[522])          /* 0x40028A80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG_COMPENGCFG ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[523])        /* 0x40028AC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC0_CONSTFRAME0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[524])      /* 0x40028B00 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC0_EXTDST0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[525])          /* 0x40028B40 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM0_CONSTFRAME4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[526])     /* 0x40028B80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM0_EXTDST4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[527])         /* 0x40028BC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC1_CONSTFRAME1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[528])      /* 0x40028C00 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC1_EXTDST1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[529])          /* 0x40028C40 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM1_CONSTFRAME5 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[530])     /* 0x40028C80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM1_EXTDST5 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[531])         /* 0x40028CC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_EXTSRC4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[532])          /* 0x40028D00 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_STORE4  ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[533])          /* 0x40028D40 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER1_FETCHLAYER0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[534])    /* 0x40028D80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER2_FETCHDECODE4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[535])   /* 0x40028DC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER2_FETCHECO4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[536])      /* 0x40028E00 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER3_FETCHWARP1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[537])     /* 0x40028E40 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER3_FETCHECO1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[538])      /* 0x40028E80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER4_FETCHLAYER1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[539])    /* 0x40028EC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER5_FETCHDECODE0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[540])   /* 0x40028F00 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_GAMMACOR4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[541])         /* 0x40028F40 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_MATRIX4  ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[542])          /* 0x40028F80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_GPSCALER4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[543])         /* 0x40028FC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_HISTOGRAM4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[544])        /* 0x40029000 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND1_LAYERBLEND1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[545])    /* 0x40029040 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND2_LAYERBLEND2 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[546])    /* 0x40029080 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND3_LAYERBLEND3 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[547])    /* 0x400290C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND4_LAYERBLEND4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[548])    /* 0x40029100 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND5_LAYERBLEND5 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[549])    /* 0x40029140 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_EXTSRC8 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[550])          /* 0x40029180 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG0_DISENGCFG0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[551])       /* 0x400291C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPMON0_SIG0    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[552])          /* 0x40029200 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG0_FRAMEGEN0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[553])        /* 0x40029240 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL0_GAMMACOR0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[554])        /* 0x40029280 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL0_DITHER0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[555])          /* 0x400292C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPIFC0_TCON0   ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[556])          /* 0x40029300 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG1_DISENGCFG1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[557])       /* 0x40029340 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPMON1_SIG1    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[558])          /* 0x40029380 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG1_FRAMEGEN1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[559])        /* 0x400293C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL1_GAMMACOR1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[560])        /* 0x40029400 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL1_DITHER1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[561])          /* 0x40029440 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPIFC1_TCON1   ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[562])          /* 0x40029480 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPIFC0_FPDLINK0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[563])         /* 0x400294C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_MIPICSI0_MIPICSI_STRUCT_MIPICSI_WRAP_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[564]) /* 0x40029500 */
#define PERI_MS_PPU_FX_VIDEOSS0_MIPICSI0_MIPICSI_STRUCT_MIPICSI_CORE_3PIP ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[565]) /* 0x40029540 */
#define PERI_MS_PPU_FX_VIDEOSS0_VRPU_MAIN       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[566])          /* 0x40029580 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD0_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[567])         /* 0x400295C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD1_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[568])         /* 0x40029600 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD2_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[569])         /* 0x40029640 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD3_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[570])         /* 0x40029680 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD4_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[571])         /* 0x400296C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD5_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[572])         /* 0x40029700 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD6_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[573])         /* 0x40029740 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD7_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[574])         /* 0x40029780 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD8_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[575])         /* 0x400297C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD9_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[576])         /* 0x40029800 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD10_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[577])        /* 0x40029840 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD11_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[578])        /* 0x40029880 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD12_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[579])        /* 0x400298C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD13_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[580])        /* 0x40029900 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD14_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[581])        /* 0x40029940 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_RD15_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[582])        /* 0x40029980 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR0_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[583])         /* 0x400299C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR1_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[584])         /* 0x40029A00 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR2_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[585])         /* 0x40029A40 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR3_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[586])         /* 0x40029A80 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR4_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[587])         /* 0x40029AC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR5_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[588])         /* 0x40029B00 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR6_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[589])         /* 0x40029B40 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR7_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[590])         /* 0x40029B80 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR8_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[591])         /* 0x40029BC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR9_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[592])         /* 0x40029C00 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR10_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[593])        /* 0x40029C40 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR11_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[594])        /* 0x40029C80 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR12_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[595])        /* 0x40029CC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR13_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[596])        /* 0x40029D00 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR14_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[597])        /* 0x40029D40 */
#define PERI_MS_PPU_FX_VIDEOSS0_GFX_MPU_WR15_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[598])        /* 0x40029D80 */
#define PERI_MS_PPU_FX_PD_PD                    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[599])          /* 0x40029DC0 */
...
#define SMARTIO_PRT9                            ((volatile stc_SMARTIO_PRT_t*) &SMARTIO->PRT[9])                  /* 0x40320900 */
...
#define SMIF1_SMIF_CRYPTO0                      ((volatile stc_SMIF_SMIF_CRYPTO_t*) &SMIF1->SMIF_CRYPTO[0])       /* 0x40430200 */
#define SMIF1_SMIF_CRYPTO1                      ((volatile stc_SMIF_SMIF_CRYPTO_t*) &SMIF1->SMIF_CRYPTO[1])       /* 0x40430280 */
#define SMIF1_SMIF_CRYPTO2                      ((volatile stc_SMIF_SMIF_CRYPTO_t*) &SMIF1->SMIF_CRYPTO[2])       /* 0x40430300 */
#define SMIF1_SMIF_CRYPTO3                      ((volatile stc_SMIF_SMIF_CRYPTO_t*) &SMIF1->SMIF_CRYPTO[3])       /* 0x40430380 */
