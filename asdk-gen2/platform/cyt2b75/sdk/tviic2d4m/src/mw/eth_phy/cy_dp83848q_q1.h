...
#ifndef __CY_DP83848Q_Q1_H__
#define __CY_DP83848Q_Q1_H__
...
} cy_stc_dp83848q_q1_bmcr_t;


typedef union
{
    cy_stc_dp83848q_q1_bmcr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_bmcr_t;
...
} cy_stc_dp83848q_q1_bmsr_t;


typedef union
{
    cy_stc_dp83848q_q1_bmsr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_bmsr_t;
...
} cy_stc_dp83848q_q1_phyidr1_t;


typedef union
{
    cy_stc_dp83848q_q1_phyidr1_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_phyidr1_t;
...
typedef struct
{
    ...
    uint16_t u6OUI_LSB   : 6; /* Least Significant Bits:
                                 ...
                                 respectively. */
} cy_stc_dp83848q_q1_phyidr2_t;


typedef union
{
    cy_stc_dp83848q_q1_phyidr2_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_phyidr2_t;
...
} cy_stc_dp83848q_q1_anar_t;


typedef union
{
    cy_stc_dp83848q_q1_anar_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_anar_t;
...
} cy_stc_dp83848q_q1_anlpar_t;


typedef union
{
    cy_stc_dp83848q_q1_anlpar_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_anlpar_t;
...
typedef struct
{
    ...
    uint16_t u1NP      : 1; /* Next Page Indication:
                               1 = Link Partner desires Next Page Transfer.
                               0 = Link Partner does not desire Next Page Transfer. */
} cy_stc_dp83848q_q1_anlparnp_t;


typedef union
{
    cy_stc_dp83848q_q1_anlparnp_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_anlparnp_t;
...
} cy_stc_dp83848q_q1_aner_t;


typedef union
{
    cy_stc_dp83848q_q1_aner_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_aner_t;
...
} cy_stc_dp83848q_q1_annptr_t;


typedef union
{
    cy_stc_dp83848q_q1_annptr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_annptr_t;
...
typedef struct
{
    ...
    uint16_t u1RESERVED                   : 1; /* RESERVED: Writes ignored, read as 0. */
} cy_stc_dp83848q_q1_physts_t;


typedef union
{
    cy_stc_dp83848q_q1_physts_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_physts_t;
...
} cy_stc_dp83848q_q1_fcscr_t;


typedef union
{
    cy_stc_dp83848q_q1_fcscr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_fcscr_t;
...
typedef struct
{
    uint16_t u8RXERCNT   : 8; /* RX_ER Counter:
                                  ...
                                  */
    uint16_t u8RESERVED  : 8; /* RESERVED: Writes ignored, read as 0. */
} cy_stc_dp83848q_q1_recr_t;


typedef union
{
    cy_stc_dp83848q_q1_recr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_recr_t;
...
} cy_stc_dp83848q_q1_pcsr_t;


typedef union
{
    cy_stc_dp83848q_q1_pcsr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_pcsr_t;
...
} cy_stc_dp83848q_q1_rbr_t;


typedef union
{
    cy_stc_dp83848q_q1_rbr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_rbr_t;
...
} cy_stc_dp83848q_q1_ledcr_t;


typedef union
{
    cy_stc_dp83848q_q1_ledcr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_ledcr_t;
...
} cy_stc_dp83848q_q1_phycr_t;


typedef union
{
    cy_stc_dp83848q_q1_phycr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_phycr_t;
...
typedef struct
{
    ...
    uint16_t                    : 4; /* reserved */
} cy_stc_dp83848q_q1__10btscr_t;


typedef union
{
    cy_stc_dp83848q_q1__10btscr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1__10btscr_t;
...
} cy_stc_dp83848q_q1_cdctrl1_t;


typedef union
{
    cy_stc_dp83848q_q1_cdctrl1_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_cdctrl1_t;
...
} cy_stc_dp83848q_q1_edcr_t;


typedef union
{
    cy_stc_dp83848q_q1_edcr_t f;
    uint16_t u16;
} cy_un_dp83848q_q1_edcr_t;
...
typedef enum
{
    CY_DP83848Q_Q1_REG_NORMAL_BMCR       = 0x0000, // Basic Mode Control Register  \ref cy_un_dp83848q_q1_bmcr_t
    CY_DP83848Q_Q1_REG_NORMAL_BMSR       = 0x0001, // Basic Mode Status Register  \ref cy_un_dp83848q_q1_bmsr_t
    CY_DP83848Q_Q1_REG_NORMAL_PHYIDR1    = 0x0002, // PHY Identifier Register #1  \ref cy_un_dp83848q_q1_phyidr1_t
    CY_DP83848Q_Q1_REG_NORMAL_PHYIDR2    = 0x0003, // PHY Identifier Register #2  \ref cy_un_dp83848q_q1_phyidr2_t
    CY_DP83848Q_Q1_REG_NORMAL_ANAR       = 0x0004, // Auto-Negotiation Advertisement Register  \ref cy_un_dp83848q_q1_anar_t
    CY_DP83848Q_Q1_REG_NORMAL_ANLPAR     = 0x0005, // Auto-Negotiation Link Partner Ability Register (Base Page)  \ref cy_un_dp83848q_q1_anlpar_t
    CY_DP83848Q_Q1_REG_NORMAL_ANLPARNP   = 0x0005, // Auto-Negotiation Link Partner Ability Register (Next Page)  \ref cy_un_dp83848q_q1_anlparnp_t
    CY_DP83848Q_Q1_REG_NORMAL_ANER       = 0x0006, // Auto-Negotiation Expansion Register  \ref cy_un_dp83848q_q1_aner_t
    CY_DP83848Q_Q1_REG_NORMAL_ANNPTR     = 0x0007, // Auto-Negotiation Next Page TX  \ref cy_un_dp83848q_q1_annptr_t
    CY_DP83848Q_Q1_REG_NORMAL_PHYSTS     = 0x0010, // PHY Status Register  \ref cy_un_dp83848q_q1_physts_t
    CY_DP83848Q_Q1_REG_NORMAL_FCSCR      = 0x0014, // False Carrier Sense Counter Register  \ref cy_un_dp83848q_q1_fcscr_t
    CY_DP83848Q_Q1_REG_NORMAL_RECR       = 0x0015, // Receive Error Counter Register  \ref cy_un_dp83848q_q1_recr_t
    CY_DP83848Q_Q1_REG_NORMAL_PCSR       = 0x0016, // PCS Sub-Layer Configuration and Status Register  \ref cy_un_dp83848q_q1_pcsr_t
    CY_DP83848Q_Q1_REG_NORMAL_RBR        = 0x0017, // RMII and Bypass Register  \ref cy_un_dp83848q_q1_rbr_t
    CY_DP83848Q_Q1_REG_NORMAL_LEDCR      = 0x0018, // LED Direct Control Register  \ref cy_un_dp83848q_q1_ledcr_t
    CY_DP83848Q_Q1_REG_NORMAL_PHYCR      = 0x0019, // PHY Control Register  \ref cy_un_dp83848q_q1_phycr_t
    CY_DP83848Q_Q1_REG_NORMAL__10BTSCR   = 0x001A, // 10Base-T Status/Control Register  \ref cy_un_dp83848q_q1__10btscr_t
    CY_DP83848Q_Q1_REG_NORMAL_CDCTRL1    = 0x001B, // CD Test Control Register and BIST Extensions Register  \ref cy_un_dp83848q_q1_cdctrl1_t
    CY_DP83848Q_Q1_REG_NORMAL_EDCR       = 0x001D, // Energy Detect Control Register  \ref cy_un_dp83848q_q1_edcr_t
} cy_en_dp83848q_q1_reg_info_t;
...
typedef enum 
{
    CY_DP83848Q_Q1_INTERFACE_MII,    /**  MII interface */
    CY_DP83848Q_Q1_INTERFACE_RMII,   /**  RMII interface */
} cy_en_dp83848q_q1_interface_mode_t;
...
typedef enum 
{
    CY_DP83848Q_Q1_SPEED_10   = 10,   /**  10 MBit/s */
    CY_DP83848Q_Q1_SPEED_100  = 100,  /**  100 MBit/s */
} cy_en_dp83848q_q1_speed_mode_t;
...
typedef struct 
{
    cy_en_dp83848q_q1_interface_mode_t ifMode;        /**  Interface mode between MAC and PHY */
    cy_en_dp83848q_q1_speed_mode_t     speedMode;     /**  Speed mode that shall be advertised (#enableAutoNeg == true) or configured */
    bool                               enableAutoNeg; /**  Selects between auto-negotation and fixed configuration */
} cy_stc_dp83848q_q1_phy_cfg_t;
...
extern void     Cy_Dp83848q_Q1_Init(volatile stc_ETH_t* pEth, uint8_t phyAddr, cy_stc_dp83848q_q1_t* handle);
extern uint16_t Cy_Dp83848q_Q1_ReadReg(cy_en_dp83848q_q1_reg_info_t reg, cy_stc_dp83848q_q1_t* handle);
extern void     Cy_Dp83848q_Q1_WriteReg(cy_en_dp83848q_q1_reg_info_t reg, uint16_t data, cy_stc_dp83848q_q1_t* handle);
extern void     Cy_Dp83848q_Q1_ConfigurePhy(cy_stc_dp83848q_q1_phy_cfg_t * phyCfg, cy_stc_dp83848q_q1_t* handle);
extern bool     Cy_Dp83848q_Q1_IsLinkUp(cy_stc_dp83848q_q1_t* handle);

#endif // __CY_DP83848Q_Q1_H__
