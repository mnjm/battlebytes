...
#define USER_BUTTON_PORT        CY_USER_BUTTON_RIGHT_PORT
#define USER_BUTTON_PIN         CY_USER_BUTTON_RIGHT_PIN
#define USER_BUTTON_PIN_MUX     CY_USER_BUTTON_RIGHT_PIN_MUX
#define USER_BUTTON_IRQ         CY_USER_BUTTON_RIGHT_IRQN
