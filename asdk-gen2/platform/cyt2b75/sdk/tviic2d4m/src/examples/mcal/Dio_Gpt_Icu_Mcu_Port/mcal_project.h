...
#define MCAL_PROJECT_CB_BUTTON_1_ICU_IRQ_NUMBER         31
#define MCAL_PROJECT_CB_BUTTON_1_ICU_IRQ_HANDLER        Icu_Isr_Vector_31_Cat2

#define MCAL_PROJECT_CB_BUTTON_2_ICU_IRQ_NUMBER         30
#define MCAL_PROJECT_CB_BUTTON_2_ICU_IRQ_HANDLER        Icu_Isr_Vector_30_Cat2
    
#define MCAL_PROJECT_CB_BUTTON_3_ICU_IRQ_NUMBER         29
#define MCAL_PROJECT_CB_BUTTON_3_ICU_IRQ_HANDLER        Icu_Isr_Vector_29_Cat2
