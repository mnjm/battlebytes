...
#define RAM_0_ADDRESS                   (0x28000500U)
#define RAM_0_DATA                      (0x5A5A5A5AU)
#define RAM_0_MASK_VALUE                (0x00FFFFFFU)
#define RAM_0_CORRECT_PARITY            (0x10)
#define RAM_0_ONEBIT_PARITY             (0x95)
#define RAM_0_TWOBIT_PARITY             (0x16)
...
void irqFaultReport0Handler(void)
{
    ...
    if(fault_source != CY_SYSFLT_NO_FAULT)
    {
        ...
        if(fault_source == CY_SYSFLT_RAMC0_NC_ECC)
        {
        ...
        if(fault_source == CY_SYSFLT_RAMC0_C_ECC)
        {
            faultData0 = Cy_SysFlt_GetData0(FAULT_STRUCT0);
            faultData1 = Cy_SysFlt_GetData1(FAULT_STRUCT0);
            faultData2 = Cy_SysFlt_GetData2(FAULT_STRUCT0);
...
{    
    ...
    CPUSS->unECC_CTL.stcField.u24WORD_ADDR = ((RAM_0_ADDRESS & RAM_0_MASK_VALUE) >> 3);
