...
int main(void)
{
    ...
    Cy_GPIO_Pin_Init(CY_USER_LED3_PORT, CY_USER_LED3_PIN, &user_led3_port_pin_cfg);
    ...
    for(;;)
    {
        ...
        {
            count = 0u;
            Cy_GPIO_Write(CY_USER_LED3_PORT, CY_USER_LED3_PIN, 0ul);
