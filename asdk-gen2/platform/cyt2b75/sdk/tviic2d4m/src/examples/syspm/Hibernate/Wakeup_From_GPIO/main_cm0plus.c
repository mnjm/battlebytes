...
#define HIB_WAKE_BUTTON_PORT            CY_USER_BUTTON_WAKE_PORT
#define HIB_WAKE_BUTTON_PIN             CY_USER_BUTTON_WAKE_PIN
#define HIB_WAKE_BUTTON_PIN_MUX         CY_USER_BUTTON_WAKE_PIN_MUX

#define HIB_WAKE_BUTTON_IRQ             CY_USER_BUTTON_WAKE_IRQN
