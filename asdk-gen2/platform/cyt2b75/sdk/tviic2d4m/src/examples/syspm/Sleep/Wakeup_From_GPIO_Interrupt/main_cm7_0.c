...
#define USER_BUTTON2_PORT    CY_USER_BUTTON_RIGHT_PORT
#define USER_BUTTON2_PIN     CY_USER_BUTTON_RIGHT_PIN
#define USER_BUTTON2_PIN_MUX CY_USER_BUTTON_RIGHT_PIN_MUX

#define USER_BUTTON1_IRQ     CY_USER_BUTTON_LEFT_IRQN
#define USER_BUTTON2_IRQ     CY_USER_BUTTON_RIGHT_IRQN
