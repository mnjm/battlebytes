...
int main(void)
{
    ...
    Cy_GPIO_Pin_Init(CY_USER_LED1_PORT, CY_USER_LED1_PIN, &user_led0_port_pin_cfg);
    Cy_GPIO_Pin_Init(CY_USER_LED2_PORT, CY_USER_LED2_PIN, &user_led1_port_pin_cfg);
