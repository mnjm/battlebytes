...
#define TRX_DATA_WIDTH         (CY_SPI_TRANSACTION_1S1S1S)
  ...
  #define TEST_DEVICE_BIT_ALLOC (CY_SMIF_DEV_SINGLE_BIT_0To1)
#else
  #define TEST_SLAVE            (CY_SMIF_SLAVE_SELECT_1)
  #define TEST_SLAVE_DEVICE     (SMIF_DEVICE1)
  #define TEST_DEVICE_BIT_ALLOC (CY_SMIF_DEV_SINGLE_BIT_4To5)
#endif
...
int main(void)
{
    ...
    writeConfigReg2.field.u1QPI_IT = DATA_WIDTH_1_OR_2_BITS;
    ...
    ReadbackMMIO(readFastSPICommand, DEVICE_PROGRAM_BUFFER_SIZE);

    /********************************************/
    /*********  Read/Verify in XIP mode   *******/
    /********************************************/
    ReadbackXIP(readSPICommand, DEVICE_PROGRAM_BUFFER_SIZE);
    ReadbackXIP(readFastSPICommand, DEVICE_PROGRAM_BUFFER_SIZE);    // Read back with read command
