...
#define CY_SPI_SCB_MISO_PORT GPIO_PRT11
#define CY_SPI_SCB_MISO_PIN  4
#define CY_SPI_SCB_MISO_MUX  P11_4_SCB0_SPI_MISO
#define CY_SPI_SCB_MOSI_PORT GPIO_PRT11
#define CY_SPI_SCB_MOSI_PIN  3
#define CY_SPI_SCB_MOSI_MUX  P11_3_SCB0_SPI_MOSI
#define CY_SPI_SCB_CLK_PORT  GPIO_PRT11
#define CY_SPI_SCB_CLK_PIN   2
#define CY_SPI_SCB_CLK_MUX   P11_2_SCB0_SPI_CLK
#define CY_SPI_SCB_SEL_PORT  GPIO_PRT11
#define CY_SPI_SCB_SEL_PIN   5
#define CY_SPI_SCB_SEL_MUX   P11_5_SCB0_SPI_SELECT0
#define CY_SPI_SCB_SS_IDX    0
...
{
    uint32_t sysTickFrec;
    CY_ASSERT(Cy_SysClk_GetFast0Frequency(&sysTickFrec) == CY_SYSCLK_SUCCESS);
    Cy_SysTick_Init(CY_SYSTICK_CLOCK_SOURCE_CLK_CPU,  sysTickFrec / 10ul); // 100[ms]
