...
#define TCPWMx_LINEx_PORT                 GPIO_PRT9                             // J119_2
#define TCPWMx_LINEx_PIN                  5u
#define TCPWMx_LINEx_MUX                  P9_5_TCPWM0_LINE21

#define TR_ONE_CNT_NR_USE                 0u // only 0 is applied

// TR_ONE_CNT_INx: x = (256 * GrpNum) + (CntNum) + TR_ONE_CNT_NR_USE
#define TCPWMx_LINEx_IN_PORT              GPIO_PRT9                             // P9_18
#define TCPWMx_LINEx_IN_PIN               7u
#define TCPWMx_LINEx_IN_MUX               P9_7_TCPWM0_TR_ONE_CNT_IN21

#define GPIO_TOBE_COPYED_PORT             GPIO_PRT8                             // P9_17
#define GPIO_TOBE_COPYED_PIN              5u
#define GPIO_TOBE_COPYED_MUX              P8_5_GPIO
