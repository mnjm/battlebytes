...
#define TCPWMx_GRPx_CNTx_PWM            TCPWM0_GRP0_CNT23
#define PCLK_TCPWMx_CLOCKSx_PWM         PCLK_TCPWM0_CLOCKS23
...
/* TCPWM_LINE0 */
#define TCPWMx_LINEx_PORT               GPIO_PRT15                              // R651_1
#define TCPWMx_LINEx_PIN                2u
#define TCPWMx_LINEx_MUX                P15_2_TCPWM0_LINE23
