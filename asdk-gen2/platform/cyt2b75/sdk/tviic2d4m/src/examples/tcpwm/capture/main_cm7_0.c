...
/* This example uses two TCPWM. One TCPWM outputs PWM pulse with constant
   ...
   For TVIIC-2D-4M-216-CPU short jumper cable between P9_17 and J109_2.
*/

/* Capture Mode Configuration definitions */
#define TCPWMx_GRPx_CNTx_CAPTURE           TCPWM0_GRP0_CNT22
#define PCLK_TCPWMx_CLOCKSx_CAPTURE        PCLK_TCPWM0_CLOCKS22

#define TR_ONE_CNT_NR_USE                  0u // only 0 is applied

// TR_ONE_CNT_INx: x = (256 * GrpNum) + (CntNum)
#define TCPWMx_TR_ONE_CNT_INx_PORT         GPIO_PRT8
#define TCPWMx_TR_ONE_CNT_INx_PIN          5u
#define TCPWMx_TR_ONE_CNT_INx_MUX          P8_5_TCPWM0_TR_ONE_CNT_IN22

/* PWM Configuration definitions */
#define TCPWMx_GRPx_CNTx_PWM               TCPWM0_GRP0_CNT26
#define PCLK_TCPWMx_CLOCKSx_PWM            PCLK_TCPWM0_CLOCKS26

// LINEx: x = (256 * GrpNum) + (CntNum)
/* TCPWM0_LINE1 */
#define TCPWMx_LINEx_PORT                  GPIO_PRT15
#define TCPWMx_LINEx_PIN                   5u
#define TCPWMx_LINEx_MUX                   P15_5_TCPWM0_LINE26
