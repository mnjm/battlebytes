...
#define DAC_FIFO_THRESHOLD_WORDS   32
    ...
    // The core frequency is 320MHz. 22400000 / 320MHz = 0.07[s]
    #define DAG_ANALOG_STAB_DELAY_1 16000000
    #define DAG_ANALOG_STAB_DELAY_2  6400000
#endif


#include "sine440_norm_0db.c"
...
int main(void)
{
    ...
    DELAY_CORE_CYCLE(DAG_ANALOG_STAB_DELAY_1);
    DELAY_CORE_CYCLE(DAG_ANALOG_STAB_DELAY_2);
