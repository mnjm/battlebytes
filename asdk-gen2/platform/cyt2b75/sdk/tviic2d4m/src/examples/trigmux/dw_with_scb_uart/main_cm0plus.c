...
/**********************************************************************/
#define DW1_CH_TO_SCB_UART_TX    (16)
#define DW1_CH_TO_SCB_UART_RX    (17)
#define UART_TX_TO_DMA_TRIG      (TRIG_OUT_1TO1_1_SCB_TX_TO_PDMA10)
#define UART_RX_TO_DMA_TRIG      (TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA10)
