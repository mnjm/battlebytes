       ...
       cy_systemIntr_Handler Cy_SystemIrqUserTable[] =
{
     ...
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_11_HANDLER,          // IRQ52                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_12_HANDLER,          // IRQ53                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_13_HANDLER,          // IRQ54                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_14_HANDLER,          // IRQ55                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_15_HANDLER,          // IRQ56                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_16_HANDLER,          // IRQ57                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_17_HANDLER,          // IRQ58                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_18_HANDLER,          // IRQ59                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_19_HANDLER,          // IRQ60                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_20_HANDLER,          // IRQ61                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_21_HANDLER,          // IRQ62                  
