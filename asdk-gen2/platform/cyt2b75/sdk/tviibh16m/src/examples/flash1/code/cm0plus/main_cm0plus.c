...
#define LS_ADDR_SBM_BASE        CY_FLASH1_LG_SBM_BASE
#define LS_ADDR_SBM_END         (CY_FLASH1_LG_SBM_END - CY_CODE_LES_SIZE_IN_BYTE)
#define LS_ADDR_BASE            LS_ADDR_SBM_END

#define TEST_LS_ADDR            LS_ADDR_BASE
#define TEST_SS_ADDR            (CY_FLASH1_SM_SBM_END - CY_CODE_SES_SIZE_IN_BYTE)
...
void BasicCodeFlashBlockingTest(uint32_t SectorAddr, uint32_t SectorSizeInByte)
{
    ...
    /** Erasing **/
    // Erase
    Cy_FlashSectorErase1(SectorAddr, CY_FLASH_DRIVER_BLOCKING);
    ...
    {
        // Flash 
        Cy_FlashWriteCode1(i_addr, (uint32_t*)programData, CY_FLASH_PROGRAMROW_DATA_SIZE_4096BIT,CY_FLASH_DRIVER_BLOCKING);
    }
