...
{
    {0x01, LIN_RX_RESPONSE, LinChecksumTypeExtended, 8u,}, // ID on which slave sends data, 8 bytes (Enhanced, publisher)
    {0x02, LIN_TX_RESPONSE, LinChecksumTypeExtended, 8u,},
    {0x10, LIN_RX_RESPONSE, LinChecksumTypeExtended, 1u,}, // ID on which slave sends data, 1 byte (Enhanced publisher)
