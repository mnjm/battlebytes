...
For 8M 176 CPU boards
1. LED1 is connected to the configured IO (P15.1) so please short TP202 and JP7_10.

For 8M 320 CPU boards
1. LED1 is connected to the configured IO (P15.1) so please short P4_6 and JP7_10.
...
For C-2D-6M-DDR-A0 CPU boards rev A
1. Connect J203_2 and J200_1 to connect LED2
