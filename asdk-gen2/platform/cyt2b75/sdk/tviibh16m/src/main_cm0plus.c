...
int main(void)
{
    ...
    /* Enable CM7_0/1/2/3. CY_CORTEX_M7_APPL_ADDR is calculated in linker script, check it in case of problems. */
    Cy_SysEnableApplCore(CORE_CM7_0, CY_CORTEX_M7_0_APPL_ADDR);
    Cy_SysEnableApplCore(CORE_CM7_1, CY_CORTEX_M7_1_APPL_ADDR);
    Cy_SysEnableApplCore(CORE_CM7_2, CY_CORTEX_M7_2_APPL_ADDR);
    Cy_SysEnableApplCore(CORE_CM7_3, CY_CORTEX_M7_3_APPL_ADDR);
