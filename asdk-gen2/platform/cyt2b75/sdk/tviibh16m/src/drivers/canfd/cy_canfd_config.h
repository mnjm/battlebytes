...
/** Offset of CAN FD Message RAM (MRAM). Total 40k MRAM per CAN FD instance is shared by all CAN FD channels  
...
#define CY_CANFD0_4_MSGRAM_SIZE         ((CANFD0_MRAM_SIZE*1024)/CANFD0_CAN_NR)
...
#define CY_CANFD0_4_MSGRAM_OFFSET       (CY_CANFD0_3_MSGRAM_OFFSET + CY_CANFD0_3_MSGRAM_SIZE)    
...
#define CY_CANFD1_4_MSGRAM_SIZE         ((CANFD1_MRAM_SIZE*1024)/CANFD1_CAN_NR)                       
...
#define CY_CANFD1_4_MSGRAM_OFFSET       (CY_CANFD1_3_MSGRAM_OFFSET + CY_CANFD1_3_MSGRAM_SIZE)    
...
/** CANFD0 Channel 4 */             
#define CY_CANFD0_4_TYPE                ((cy_pstc_canfd_type_t)CANFD0_CH4)
...
/** CANFD1 Channel 4 */             
#define CY_CANFD1_4_TYPE                ((cy_pstc_canfd_type_t)CANFD1_CH4) 
