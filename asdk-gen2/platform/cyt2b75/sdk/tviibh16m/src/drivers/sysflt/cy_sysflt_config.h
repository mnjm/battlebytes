...
typedef enum 
{
    ...
    CY_SYSFLT_CPUSS_MPU_VIO_7                         = 0x0007u,    /**< Bus master #7 MPU/SMPU violation (when used) */
    CY_SYSFLT_CPUSS_MPU_VIO_8                         = 0x0008u,    /**< Bus master #8 MPU/SMPU violation (when used) */
    ...
    CY_SYSFLT_CPUSS_CM7_2_TCM_C_ECC                   = 0x0016u,    /**< Correctable ECC error in CM7_2 TCM memory. See CM7_0_TCM_C_ECC descripption. */
    CY_SYSFLT_CPUSS_CM7_2_TCM_NC_ECC                  = 0x0017u,    /**< Non Correctable ECC error in CM7_2 TCM memory. See CM7_0_TCM_C_ECC descripption. */
    CY_SYSFLT_CPUSS_CM7_2_CACHE_C_ECC                 = 0x0018u,    /**< Correctable ECC error in CM7_2 Cache memories. See CM7_0_CACHE_C_ECC descripption. */
    ...
    CY_SYSFLT_CPUSS_CM7_2_CACHE_NC_ECC                = 0x002Du,    /**< Non Correctable ECC error in CM7_2 Cache memories. See CM7_0_CACHE_C_ECC descripption. */
    CY_SYSFLT_PERI_MS_VIO_5                           = 0x002Eu,    /**< CM7_2 Peripheral Master Interface PPU violation */
    CY_SYSFLT_PERI_MS_VIO_6                           = 0x002Fu,    /**< CM7_3 Peripheral Master Interface PPU violation */
    ...
    CY_SYSFLT_CPUSS_CM7_3_TCM_C_ECC                   = 0x0042u,    /**< Correctable ECC error in CM7_3 TCM memory. See CM7_0_TCM_C_ECC descripption. */
    CY_SYSFLT_CPUSS_CM7_3_TCM_NC_ECC                  = 0x0043u,    /**< Non Correctable ECC error in CM7_3 TCM memory. See CM7_0_TCM_C_ECC descripption. */
    CY_SYSFLT_CPUSS_CM7_3_CACHE_C_ECC                 = 0x0044u,    /**< Correctable ECC error in CM7_3 Cache memories. See CM7_0_CACHE_C_ECC descripption. */
    CY_SYSFLT_CPUSS_CM7_3_CACHE_NC_ECC                = 0x0045u,    /**< Non Correctable ECC error in CM7_3 Cache memories. See CM7_0_CACHE_C_ECC descripption. */
    ...
    CY_SYSFLT_CPUSS_FLASHC1_MAIN_BUS_ERR              = 0x004Cu,    /**< Flash#1 controller main flash bus error */
    CY_SYSFLT_CPUSS_FLASHC1_MAIN_C_ECC                = 0x004Du,    /**< Flash#1 controller main flash correctable ECC violation */
    CY_SYSFLT_CPUSS_FLASHC1_MAIN_NC_ECC               = 0x004Eu,    /**< Flash#1 controller main flash non-correctable ECC violation */
    CY_SYSFLT_CPUSS_FLASHC1_WORK_BUS_ERR              = 0x004Fu,    /**< Flash#1 controller work flash bus error */
    ...
    CY_SYSFLT_CPUSS_FLASHC1_WORK_C_ECC                = 0x0054u,    /**< Flash#1 controller work flash correctable ECC violation */
    CY_SYSFLT_CPUSS_FLASHC1_WORK_NC_ECC               = 0x0055u,    /**< Flash#1 controller work flash non-correctable ECC violation */
    CY_SYSFLT_CPUSS_FM1_SRAM_C_ECC                    = 0x0056u,    /**< Flash1 code storage sram memory correctable ECC violation */
    CY_SYSFLT_CPUSS_FM1_SRAM_NC_ECC                   = 0x0057u,    /**< Flash1 code storage sram memory non-correctable ECC violation */
    CY_SYSFLT_CPUSS_FLASHC1_CM0_CA_C_ECC              = 0x0058u,    /**< Flash#1 controller CM0+ cache correctable ECC violation */
    CY_SYSFLT_CPUSS_FLASHC1_CM0_CA_NC_ECC             = 0x0059u,    /**< Flash#1 controller CM0+ cache non-correctable ECC violation */
    ...
    CY_SYSFLT_SRSS_FAULT_MCWDT3                       = 0x005Fu,    /**< Fault output for MCWDT3 (all sub-counters) */
	CY_SYSFLT_NO_FAULT
