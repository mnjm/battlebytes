...
#ifndef _SYSTEM_TVIIBH16M_CYT6BJ_H_
#define _SYSTEM_TVIIBH16M_CYT6BJ_H_
...
/**  Start address of the Cortex-M7_2 application */
    ...
    // This symbol is defined in the linker script
    extern char *  __cm7_2_vector_base_linker_symbol;
    #define CY_CORTEX_M7_2_APPL_ADDR      ((uint32_t) &__cm7_2_vector_base_linker_symbol)
#endif

/**  Start address of the Cortex-M7_3 application */
#ifndef CY_CORTEX_M7_3_APPL_ADDR
    // This symbol is defined in the linker script
    extern char *  __cm7_3_vector_base_linker_symbol;
    #define CY_CORTEX_M7_3_APPL_ADDR      ((uint32_t) &__cm7_3_vector_base_linker_symbol)
#endif
...
#define CORE_CM7_2			                    2 // Cortex-M7 core 2
#define CORE_CM7_3			                    3 // Cortex-M7 core 3 
#define CORE_MAX			                    4 // Error Selection
...
#endif /* _SYSTEM_TVIIBH16M_CYT6BJ_H_ */
