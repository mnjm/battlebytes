...
void SystemInit (void)
{
    ...
    FLASHC1->unFLASH_CTL.stcField.u4WS = 1u;
    ...
    /* CLK_FAST_2 */
    CPUSS->unFAST_2_CLOCK_CTL.stcField.u8INT_DIV  = 0u; /* no division */
    CPUSS->unFAST_2_CLOCK_CTL.stcField.u5FRAC_DIV = 0u; /* no division */
    
    /* CLK_FAST_3 */
    CPUSS->unFAST_3_CLOCK_CTL.stcField.u8INT_DIV  = 0u; /* no division */
    CPUSS->unFAST_3_CLOCK_CTL.stcField.u5FRAC_DIV = 0u; /* no division */
...
uint32_t Cy_SysGetApplCoreStatus(uint8_t core)
{
    ...
    case CORE_CM7_2:
        /* Get current power mode */
        regValue = CPUSS->unCM7_2_PWR_CTL.u32Register;
        regValue = (regValue >> CPUSS_CM7_2_PWR_CTL_PWR_MODE_Pos) & CPUSS_CM7_2_PWR_CTL_PWR_MODE_Msk;
		break;
    case CORE_CM7_3:
        /* Get current power mode */
        regValue = CPUSS->unCM7_3_PWR_CTL.u32Register;
        regValue = (regValue >> CPUSS_CM7_3_PWR_CTL_PWR_MODE_Pos) & CPUSS_CM7_3_PWR_CTL_PWR_MODE_Msk;
		break;
	default:
		break;
	}
...
void Cy_SysEnableApplCore(uint8_t core, uint32_t vectorTableOffset)
{
	...
	un_CPUSS_CM7_2_PWR_CTL_t tPwrCtl2;
	un_CPUSS_CM7_3_PWR_CTL_t tPwrCtl3;
    ...
    case CORE_CM7_2:
        // Adjust the vector address
        CPUSS->unCM7_2_VECTOR_TABLE_BASE.u32Register = vectorTableOffset;
        
        // Enable the Power Control Key
        tPwrCtl2.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
        tPwrCtl2.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_ENABLED;
        CPUSS->unCM7_2_PWR_CTL.u32Register = tPwrCtl2.u32Register;
        
        CPUSS->unCM7_2_CTL.stcField.u1CPU_WAIT = 0;
		break;
    case CORE_CM7_3:
        // Adjust the vector address
        CPUSS->unCM7_3_VECTOR_TABLE_BASE.u32Register = vectorTableOffset;
        
        // Enable the Power Control Key
        tPwrCtl3.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
        tPwrCtl3.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_ENABLED;
        CPUSS->unCM7_3_PWR_CTL.u32Register = tPwrCtl3.u32Register;
...
void Cy_SysDisableApplCore(uint8_t core)
{
    ...
    case CORE_CM7_2:
        tPwrCtl2.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
        tPwrCtl2.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_OFF;
        CPUSS->unCM7_2_PWR_CTL.u32Register = tPwrCtl2.u32Register; 
		break;
    case CORE_CM7_3:
        tPwrCtl3.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
        tPwrCtl3.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_OFF;
        CPUSS->unCM7_3_PWR_CTL.u32Register = tPwrCtl3.u32Register; 
		break;
	default:
		break;
...
void Cy_SysRetainApplCore(uint8_t core)
{
    ...
    if(cmStatus == CY_SYS_CM_STATUS_ENABLED)
    {
		...
		case CORE_CM7_2:
            tPwrCtl2.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
            tPwrCtl2.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_RETAINED;
            CPUSS->unCM7_2_PWR_CTL.u32Register = tPwrCtl2.u32Register;
			break;
		case CORE_CM7_3:
            tPwrCtl3.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
            tPwrCtl3.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_RETAINED;
            CPUSS->unCM7_3_PWR_CTL.u32Register = tPwrCtl3.u32Register;
			break;
		default:
			break;
...
void Cy_SysResetApplCore(uint8_t core)
{
    ...
    case CORE_CM7_2:
        tPwrCtl2.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
        tPwrCtl2.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_RESET;
        CPUSS->unCM7_2_PWR_CTL.u32Register = tPwrCtl2.u32Register; 
		break;
    case CORE_CM7_3:
        tPwrCtl3.stcField.u16VECTKEYSTAT = CY_SYS_PWR_CTL_KEY_OPEN;
        tPwrCtl3.stcField.u2PWR_MODE = CY_SYS_CM_STATUS_RESET;
        CPUSS->unCM7_3_PWR_CTL.u32Register = tPwrCtl3.u32Register; 
		break;
	default:
		break;
