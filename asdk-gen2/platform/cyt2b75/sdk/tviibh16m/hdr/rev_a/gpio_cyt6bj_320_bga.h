/***************************************************************************//**
* \file gpio_cyt6bj_320_bga.h
*
* \brief
* CYT6BJ device GPIO header for 320-BGA package
*
* \note
...
#ifndef _GPIO_CYT6BJ_320_BGA_H_
#define _GPIO_CYT6BJ_320_BGA_H_
...
typedef enum
{
    ...
    AMUX_SPLIT_CTL_2                = 0x0002u,  /* Left = AMUXBUS_TEST; Right = AMUXBUS_TESTECT_FM1 */
    AMUX_SPLIT_CTL_3                = 0x0003u   /* Left = AMUXBUS_MAIN; Right = AMUXBUS_REGHC_ISENSE */
} cy_en_amux_split_t;

/* Port List */
/* PORT 0 (AUTOLVL) */
#define P0_0_GPIO_ENH_PORT              GPIO_PRT0
#define P0_0_GPIO_ENH_PIN               0u
#define P0_0_GPIO_ENH_NUM               0u
#define P0_0_AMUXSEGMENT                AMUXBUS_MAIN
#define P0_1_GPIO_ENH_PORT              GPIO_PRT0
#define P0_1_GPIO_ENH_PIN               1u
#define P0_1_GPIO_ENH_NUM               1u
#define P0_1_AMUXSEGMENT                AMUXBUS_MAIN
#define P0_2_GPIO_ENH_PORT              GPIO_PRT0
#define P0_2_GPIO_ENH_PIN               2u
#define P0_2_GPIO_ENH_NUM               2u
#define P0_2_AMUXSEGMENT                AMUXBUS_MAIN
#define P0_3_GPIO_ENH_PORT              GPIO_PRT0
#define P0_3_GPIO_ENH_PIN               3u
#define P0_3_GPIO_ENH_NUM               3u
...
#define P3_6_GPIO_STD_PORT              GPIO_PRT3
#define P3_6_GPIO_STD_PIN               6u
#define P3_6_GPIO_STD_NUM               6u
#define P3_6_AMUXSEGMENT                AMUXBUS_MAIN
#define P3_7_GPIO_STD_PORT              GPIO_PRT3
#define P3_7_GPIO_STD_PIN               7u
#define P3_7_GPIO_STD_NUM               7u
#define P3_7_AMUXSEGMENT                AMUXBUS_MAIN
...
/* PORT 5 (AUTOLVL) */
#define P5_0_GPIO_STD_PORT              GPIO_PRT5
#define P5_0_GPIO_STD_PIN               0u
#define P5_0_GPIO_STD_NUM               0u
#define P5_0_AMUXSEGMENT                AMUXBUS_MAIN
#define P5_1_GPIO_STD_PORT              GPIO_PRT5
#define P5_1_GPIO_STD_PIN               1u
#define P5_1_GPIO_STD_NUM               1u
#define P5_1_AMUXSEGMENT                AMUXBUS_MAIN
#define P5_2_GPIO_STD_PORT              GPIO_PRT5
#define P5_2_GPIO_STD_PIN               2u
#define P5_2_GPIO_STD_NUM               2u
#define P5_2_AMUXSEGMENT                AMUXBUS_MAIN
#define P5_3_GPIO_STD_PORT              GPIO_PRT5
#define P5_3_GPIO_STD_PIN               3u
#define P5_3_GPIO_STD_NUM               3u
#define P5_3_AMUXSEGMENT                AMUXBUS_MAIN
#define P5_4_GPIO_STD_PORT              GPIO_PRT5
#define P5_4_GPIO_STD_PIN               4u
#define P5_4_GPIO_STD_NUM               4u
#define P5_4_AMUXSEGMENT                AMUXBUS_MAIN
#define P5_5_GPIO_STD_PORT              GPIO_PRT5
#define P5_5_GPIO_STD_PIN               5u
#define P5_5_GPIO_STD_NUM               5u
#define P5_5_AMUXSEGMENT                AMUXBUS_MAIN

/* PORT 6 (AUTOLVL) */
#define P6_0_GPIO_STD_PORT              GPIO_PRT6
#define P6_0_GPIO_STD_PIN               0u
#define P6_0_GPIO_STD_NUM               0u
#define P6_0_AMUXSEGMENT                AMUXBUS_MAIN
#define P6_1_GPIO_STD_PORT              GPIO_PRT6
#define P6_1_GPIO_STD_PIN               1u
#define P6_1_GPIO_STD_NUM               1u
#define P6_1_AMUXSEGMENT                AMUXBUS_MAIN
#define P6_2_GPIO_STD_PORT              GPIO_PRT6
#define P6_2_GPIO_STD_PIN               2u
#define P6_2_GPIO_STD_NUM               2u
#define P6_2_AMUXSEGMENT                AMUXBUS_MAIN
#define P6_3_GPIO_STD_PORT              GPIO_PRT6
#define P6_3_GPIO_STD_PIN               3u
#define P6_3_GPIO_STD_NUM               3u
#define P6_3_AMUXSEGMENT                AMUXBUS_MAIN
#define P6_4_GPIO_STD_PORT              GPIO_PRT6
#define P6_4_GPIO_STD_PIN               4u
#define P6_4_GPIO_STD_NUM               4u
#define P6_4_AMUXSEGMENT                AMUXBUS_MAIN
#define P6_5_GPIO_STD_PORT              GPIO_PRT6
#define P6_5_GPIO_STD_PIN               5u
#define P6_5_GPIO_STD_NUM               5u
#define P6_5_AMUXSEGMENT                AMUXBUS_MAIN
#define P6_6_GPIO_STD_PORT              GPIO_PRT6
#define P6_6_GPIO_STD_PIN               6u
#define P6_6_GPIO_STD_NUM               6u
#define P6_6_AMUXSEGMENT                AMUXBUS_MAIN
#define P6_7_GPIO_STD_PORT              GPIO_PRT6
#define P6_7_GPIO_STD_PIN               7u
#define P6_7_GPIO_STD_NUM               7u
#define P6_7_AMUXSEGMENT                AMUXBUS_MAIN

/* PORT 7 (AUTOLVL) */
#define P7_0_GPIO_STD_PORT              GPIO_PRT7
#define P7_0_GPIO_STD_PIN               0u
#define P7_0_GPIO_STD_NUM               0u
#define P7_0_AMUXSEGMENT                AMUXBUS_MAIN
#define P7_1_GPIO_STD_PORT              GPIO_PRT7
#define P7_1_GPIO_STD_PIN               1u
#define P7_1_GPIO_STD_NUM               1u
#define P7_1_AMUXSEGMENT                AMUXBUS_MAIN
#define P7_2_GPIO_STD_PORT              GPIO_PRT7
#define P7_2_GPIO_STD_PIN               2u
#define P7_2_GPIO_STD_NUM               2u
#define P7_2_AMUXSEGMENT                AMUXBUS_MAIN
#define P7_3_GPIO_STD_PORT              GPIO_PRT7
#define P7_3_GPIO_STD_PIN               3u
#define P7_3_GPIO_STD_NUM               3u
#define P7_3_AMUXSEGMENT                AMUXBUS_MAIN
#define P7_4_GPIO_STD_PORT              GPIO_PRT7
#define P7_4_GPIO_STD_PIN               4u
#define P7_4_GPIO_STD_NUM               4u
#define P7_4_AMUXSEGMENT                AMUXBUS_MAIN
#define P7_5_GPIO_STD_PORT              GPIO_PRT7
#define P7_5_GPIO_STD_PIN               5u
#define P7_5_GPIO_STD_NUM               5u
#define P7_5_AMUXSEGMENT                AMUXBUS_MAIN
#define P7_6_GPIO_STD_PORT              GPIO_PRT7
#define P7_6_GPIO_STD_PIN               6u
#define P7_6_GPIO_STD_NUM               6u
#define P7_6_AMUXSEGMENT                AMUXBUS_MAIN
#define P7_7_GPIO_STD_PORT              GPIO_PRT7
#define P7_7_GPIO_STD_PIN               7u
#define P7_7_GPIO_STD_NUM               7u
#define P7_7_AMUXSEGMENT                AMUXBUS_MAIN

/* PORT 8 (AUTOLVL) */
#define P8_0_GPIO_STD_PORT              GPIO_PRT8
#define P8_0_GPIO_STD_PIN               0u
#define P8_0_GPIO_STD_NUM               0u
#define P8_0_AMUXSEGMENT                AMUXBUS_MAIN
#define P8_1_GPIO_STD_PORT              GPIO_PRT8
#define P8_1_GPIO_STD_PIN               1u
#define P8_1_GPIO_STD_NUM               1u
#define P8_1_AMUXSEGMENT                AMUXBUS_MAIN
#define P8_2_GPIO_STD_PORT              GPIO_PRT8
#define P8_2_GPIO_STD_PIN               2u
#define P8_2_GPIO_STD_NUM               2u
#define P8_2_AMUXSEGMENT                AMUXBUS_MAIN
#define P8_3_GPIO_STD_PORT              GPIO_PRT8
#define P8_3_GPIO_STD_PIN               3u
#define P8_3_GPIO_STD_NUM               3u
#define P8_3_AMUXSEGMENT                AMUXBUS_MAIN
#define P8_4_GPIO_STD_PORT              GPIO_PRT8
#define P8_4_GPIO_STD_PIN               4u
#define P8_4_GPIO_STD_NUM               4u
#define P8_4_AMUXSEGMENT                AMUXBUS_MAIN

/* PORT 9 (AUTOLVL) */
#define P9_0_GPIO_STD_PORT              GPIO_PRT9
#define P9_0_GPIO_STD_PIN               0u
#define P9_0_GPIO_STD_NUM               0u
#define P9_0_AMUXSEGMENT                AMUXBUS_MAIN
#define P9_1_GPIO_STD_PORT              GPIO_PRT9
#define P9_1_GPIO_STD_PIN               1u
#define P9_1_GPIO_STD_NUM               1u
#define P9_1_AMUXSEGMENT                AMUXBUS_MAIN
#define P9_2_GPIO_STD_PORT              GPIO_PRT9
#define P9_2_GPIO_STD_PIN               2u
#define P9_2_GPIO_STD_NUM               2u
#define P9_2_AMUXSEGMENT                AMUXBUS_MAIN
#define P9_3_GPIO_STD_PORT              GPIO_PRT9
#define P9_3_GPIO_STD_PIN               3u
#define P9_3_GPIO_STD_NUM               3u
...
#define P10_5_GPIO_STD_PORT             GPIO_PRT10
#define P10_5_GPIO_STD_PIN              5u
#define P10_5_GPIO_STD_NUM              5u
#define P10_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P10_6_GPIO_STD_PORT             GPIO_PRT10
#define P10_6_GPIO_STD_PIN              6u
#define P10_6_GPIO_STD_NUM              6u
#define P10_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P10_7_GPIO_STD_PORT             GPIO_PRT10
#define P10_7_GPIO_STD_PIN              7u
#define P10_7_GPIO_STD_NUM              7u
...
#define P13_4_GPIO_STD_PORT             GPIO_PRT13
#define P13_4_GPIO_STD_PIN              4u
#define P13_4_GPIO_STD_NUM              4u
#define P13_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P13_5_GPIO_STD_PORT             GPIO_PRT13
#define P13_5_GPIO_STD_PIN              5u
#define P13_5_GPIO_STD_NUM              5u
#define P13_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P13_6_GPIO_STD_PORT             GPIO_PRT13
#define P13_6_GPIO_STD_PIN              6u
#define P13_6_GPIO_STD_NUM              6u
#define P13_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P13_7_GPIO_STD_PORT             GPIO_PRT13
#define P13_7_GPIO_STD_PIN              7u
#define P13_7_GPIO_STD_NUM              7u
#define P13_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 14 (AUTOLVL) */
#define P14_0_GPIO_STD_PORT             GPIO_PRT14
#define P14_0_GPIO_STD_PIN              0u
#define P14_0_GPIO_STD_NUM              0u
#define P14_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P14_1_GPIO_STD_PORT             GPIO_PRT14
#define P14_1_GPIO_STD_PIN              1u
#define P14_1_GPIO_STD_NUM              1u
#define P14_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P14_2_GPIO_STD_PORT             GPIO_PRT14
#define P14_2_GPIO_STD_PIN              2u
#define P14_2_GPIO_STD_NUM              2u
#define P14_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P14_3_GPIO_STD_PORT             GPIO_PRT14
#define P14_3_GPIO_STD_PIN              3u
#define P14_3_GPIO_STD_NUM              3u
#define P14_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P14_4_GPIO_STD_PORT             GPIO_PRT14
#define P14_4_GPIO_STD_PIN              4u
#define P14_4_GPIO_STD_NUM              4u
#define P14_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P14_5_GPIO_STD_PORT             GPIO_PRT14
#define P14_5_GPIO_STD_PIN              5u
#define P14_5_GPIO_STD_NUM              5u
#define P14_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P14_6_GPIO_STD_PORT             GPIO_PRT14
#define P14_6_GPIO_STD_PIN              6u
#define P14_6_GPIO_STD_NUM              6u
#define P14_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P14_7_GPIO_STD_PORT             GPIO_PRT14
#define P14_7_GPIO_STD_PIN              7u
#define P14_7_GPIO_STD_NUM              7u
...
#define P16_6_GPIO_STD_PORT             GPIO_PRT16
#define P16_6_GPIO_STD_PIN              6u
#define P16_6_GPIO_STD_NUM              6u
#define P16_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P16_7_GPIO_STD_PORT             GPIO_PRT16
#define P16_7_GPIO_STD_PIN              7u
#define P16_7_GPIO_STD_NUM              7u
...
/* PORT 20 (AUTOLVL) */
#define P20_0_GPIO_STD_PORT             GPIO_PRT20
#define P20_0_GPIO_STD_PIN              0u
#define P20_0_GPIO_STD_NUM              0u
#define P20_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P20_1_GPIO_STD_PORT             GPIO_PRT20
#define P20_1_GPIO_STD_PIN              1u
#define P20_1_GPIO_STD_NUM              1u
#define P20_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P20_2_GPIO_STD_PORT             GPIO_PRT20
#define P20_2_GPIO_STD_PIN              2u
#define P20_2_GPIO_STD_NUM              2u
#define P20_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P20_3_GPIO_STD_PORT             GPIO_PRT20
#define P20_3_GPIO_STD_PIN              3u
#define P20_3_GPIO_STD_NUM              3u
#define P20_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P20_4_GPIO_STD_PORT             GPIO_PRT20
#define P20_4_GPIO_STD_PIN              4u
#define P20_4_GPIO_STD_NUM              4u
#define P20_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P20_5_GPIO_STD_PORT             GPIO_PRT20
#define P20_5_GPIO_STD_PIN              5u
#define P20_5_GPIO_STD_NUM              5u
#define P20_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P20_6_GPIO_STD_PORT             GPIO_PRT20
#define P20_6_GPIO_STD_PIN              6u
#define P20_6_GPIO_STD_NUM              6u
#define P20_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P20_7_GPIO_STD_PORT             GPIO_PRT20
#define P20_7_GPIO_STD_PIN              7u
#define P20_7_GPIO_STD_NUM              7u
#define P20_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 21 (AUTOLVL) */
#define P21_0_GPIO_STD_PORT             GPIO_PRT21
#define P21_0_GPIO_STD_PIN              0u
#define P21_0_GPIO_STD_NUM              0u
#define P21_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P21_1_GPIO_STD_PORT             GPIO_PRT21
#define P21_1_GPIO_STD_PIN              1u
#define P21_1_GPIO_STD_NUM              1u
#define P21_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P21_2_GPIO_STD_PORT             GPIO_PRT21
#define P21_2_GPIO_STD_PIN              2u
#define P21_2_GPIO_STD_NUM              2u
#define P21_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P21_3_GPIO_STD_PORT             GPIO_PRT21
#define P21_3_GPIO_STD_PIN              3u
#define P21_3_GPIO_STD_NUM              3u
#define P21_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P21_4_GPIO_STD_PORT             GPIO_PRT21
#define P21_4_GPIO_STD_PIN              4u
#define P21_4_GPIO_STD_NUM              4u
#define P21_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P21_5_GPIO_STD_PORT             GPIO_PRT21
#define P21_5_GPIO_STD_PIN              5u
#define P21_5_GPIO_STD_NUM              5u
#define P21_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P21_6_GPIO_STD_PORT             GPIO_PRT21
#define P21_6_GPIO_STD_PIN              6u
#define P21_6_GPIO_STD_NUM              6u
#define P21_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P21_7_GPIO_STD_PORT             GPIO_PRT21
#define P21_7_GPIO_STD_PIN              7u
#define P21_7_GPIO_STD_NUM              7u
#define P21_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 22 (AUTOLVL) */
#define P22_0_GPIO_STD_PORT             GPIO_PRT22
#define P22_0_GPIO_STD_PIN              0u
#define P22_0_GPIO_STD_NUM              0u
#define P22_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P22_1_GPIO_STD_PORT             GPIO_PRT22
#define P22_1_GPIO_STD_PIN              1u
#define P22_1_GPIO_STD_NUM              1u
#define P22_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P22_2_GPIO_STD_PORT             GPIO_PRT22
#define P22_2_GPIO_STD_PIN              2u
#define P22_2_GPIO_STD_NUM              2u
#define P22_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P22_3_GPIO_STD_PORT             GPIO_PRT22
#define P22_3_GPIO_STD_PIN              3u
#define P22_3_GPIO_STD_NUM              3u
#define P22_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P22_4_GPIO_STD_PORT             GPIO_PRT22
#define P22_4_GPIO_STD_PIN              4u
#define P22_4_GPIO_STD_NUM              4u
#define P22_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P22_5_GPIO_STD_PORT             GPIO_PRT22
#define P22_5_GPIO_STD_PIN              5u
#define P22_5_GPIO_STD_NUM              5u
#define P22_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P22_6_GPIO_STD_PORT             GPIO_PRT22
#define P22_6_GPIO_STD_PIN              6u
#define P22_6_GPIO_STD_NUM              6u
#define P22_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P22_7_GPIO_STD_PORT             GPIO_PRT22
#define P22_7_GPIO_STD_PIN              7u
#define P22_7_GPIO_STD_NUM              7u
#define P22_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 23 (AUTOLVL) */
#define P23_0_GPIO_STD_PORT             GPIO_PRT23
#define P23_0_GPIO_STD_PIN              0u
#define P23_0_GPIO_STD_NUM              0u
#define P23_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P23_1_GPIO_STD_PORT             GPIO_PRT23
#define P23_1_GPIO_STD_PIN              1u
#define P23_1_GPIO_STD_NUM              1u
#define P23_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P23_2_GPIO_STD_PORT             GPIO_PRT23
#define P23_2_GPIO_STD_PIN              2u
#define P23_2_GPIO_STD_NUM              2u
#define P23_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P23_3_GPIO_STD_PORT             GPIO_PRT23
#define P23_3_GPIO_STD_PIN              3u
#define P23_3_GPIO_STD_NUM              3u
#define P23_3_AMUXSEGMENT               AMUXBUS_TEST
#define P23_4_GPIO_STD_PORT             GPIO_PRT23
#define P23_4_GPIO_STD_PIN              4u
#define P23_4_GPIO_STD_NUM              4u
#define P23_4_AMUXSEGMENT               AMUXBUS_TEST
#define P23_5_GPIO_STD_PORT             GPIO_PRT23
#define P23_5_GPIO_STD_PIN              5u
#define P23_5_GPIO_STD_NUM              5u
#define P23_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P23_6_GPIO_STD_PORT             GPIO_PRT23
#define P23_6_GPIO_STD_PIN              6u
#define P23_6_GPIO_STD_NUM              6u
#define P23_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P23_7_GPIO_STD_PORT             GPIO_PRT23
#define P23_7_GPIO_STD_PIN              7u
#define P23_7_GPIO_STD_NUM              7u
#define P23_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 24 (HSIO, AUTOLVL) */
#define P24_0_HSIO_STD_PORT             GPIO_PRT24
#define P24_0_HSIO_STD_PIN              0u
#define P24_0_HSIO_STD_NUM              0u
#define P24_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P24_1_HSIO_STD_PORT             GPIO_PRT24
#define P24_1_HSIO_STD_PIN              1u
#define P24_1_HSIO_STD_NUM              1u
#define P24_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P24_2_HSIO_STD_PORT             GPIO_PRT24
#define P24_2_HSIO_STD_PIN              2u
#define P24_2_HSIO_STD_NUM              2u
#define P24_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P24_3_HSIO_STD_PORT             GPIO_PRT24
#define P24_3_HSIO_STD_PIN              3u
#define P24_3_HSIO_STD_NUM              3u
#define P24_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P24_4_HSIO_STD_PORT             GPIO_PRT24
#define P24_4_HSIO_STD_PIN              4u
#define P24_4_HSIO_STD_NUM              4u
#define P24_4_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 25 (HSIO, AUTOLVL) */
#define P25_0_HSIO_STD_PORT             GPIO_PRT25
#define P25_0_HSIO_STD_PIN              0u
#define P25_0_HSIO_STD_NUM              0u
#define P25_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P25_1_HSIO_STD_PORT             GPIO_PRT25
#define P25_1_HSIO_STD_PIN              1u
#define P25_1_HSIO_STD_NUM              1u
#define P25_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P25_2_HSIO_STD_PORT             GPIO_PRT25
#define P25_2_HSIO_STD_PIN              2u
#define P25_2_HSIO_STD_NUM              2u
#define P25_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P25_3_HSIO_STD_PORT             GPIO_PRT25
#define P25_3_HSIO_STD_PIN              3u
#define P25_3_HSIO_STD_NUM              3u
#define P25_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P25_4_HSIO_STD_PORT             GPIO_PRT25
#define P25_4_HSIO_STD_PIN              4u
#define P25_4_HSIO_STD_NUM              4u
#define P25_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P25_5_HSIO_STD_PORT             GPIO_PRT25
#define P25_5_HSIO_STD_PIN              5u
#define P25_5_HSIO_STD_NUM              5u
#define P25_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P25_6_HSIO_STD_PORT             GPIO_PRT25
#define P25_6_HSIO_STD_PIN              6u
#define P25_6_HSIO_STD_NUM              6u
#define P25_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P25_7_HSIO_STD_PORT             GPIO_PRT25
#define P25_7_HSIO_STD_PIN              7u
#define P25_7_HSIO_STD_NUM              7u
#define P25_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 26 (HSIO, AUTOLVL) */
#define P26_0_HSIO_STD_PORT             GPIO_PRT26
#define P26_0_HSIO_STD_PIN              0u
#define P26_0_HSIO_STD_NUM              0u
#define P26_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P26_1_HSIO_STD_PORT             GPIO_PRT26
#define P26_1_HSIO_STD_PIN              1u
#define P26_1_HSIO_STD_NUM              1u
#define P26_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P26_2_HSIO_STD_PORT             GPIO_PRT26
#define P26_2_HSIO_STD_PIN              2u
#define P26_2_HSIO_STD_NUM              2u
#define P26_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P26_3_HSIO_STD_PORT             GPIO_PRT26
#define P26_3_HSIO_STD_PIN              3u
#define P26_3_HSIO_STD_NUM              3u
#define P26_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P26_4_HSIO_STD_PORT             GPIO_PRT26
#define P26_4_HSIO_STD_PIN              4u
#define P26_4_HSIO_STD_NUM              4u
#define P26_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P26_5_HSIO_STD_PORT             GPIO_PRT26
#define P26_5_HSIO_STD_PIN              5u
#define P26_5_HSIO_STD_NUM              5u
#define P26_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P26_6_HSIO_STD_PORT             GPIO_PRT26
#define P26_6_HSIO_STD_PIN              6u
#define P26_6_HSIO_STD_NUM              6u
#define P26_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P26_7_HSIO_STD_PORT             GPIO_PRT26
#define P26_7_HSIO_STD_PIN              7u
#define P26_7_HSIO_STD_NUM              7u
#define P26_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 27 (HSIO, AUTOLVL) */
#define P27_0_HSIO_STD_PORT             GPIO_PRT27
#define P27_0_HSIO_STD_PIN              0u
#define P27_0_HSIO_STD_NUM              0u
#define P27_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P27_1_HSIO_STD_PORT             GPIO_PRT27
#define P27_1_HSIO_STD_PIN              1u
#define P27_1_HSIO_STD_NUM              1u
#define P27_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P27_2_HSIO_STD_PORT             GPIO_PRT27
#define P27_2_HSIO_STD_PIN              2u
#define P27_2_HSIO_STD_NUM              2u
#define P27_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P27_3_HSIO_STD_PORT             GPIO_PRT27
#define P27_3_HSIO_STD_PIN              3u
#define P27_3_HSIO_STD_NUM              3u
#define P27_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P27_4_HSIO_STD_PORT             GPIO_PRT27
#define P27_4_HSIO_STD_PIN              4u
#define P27_4_HSIO_STD_NUM              4u
#define P27_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P27_5_HSIO_STD_PORT             GPIO_PRT27
#define P27_5_HSIO_STD_PIN              5u
#define P27_5_HSIO_STD_NUM              5u
#define P27_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P27_6_HSIO_STD_PORT             GPIO_PRT27
#define P27_6_HSIO_STD_PIN              6u
#define P27_6_HSIO_STD_NUM              6u
#define P27_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P27_7_HSIO_STD_PORT             GPIO_PRT27
#define P27_7_HSIO_STD_PIN              7u
#define P27_7_HSIO_STD_NUM              7u
#define P27_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 28 (AUTOLVL) */
#define P28_0_GPIO_STD_PORT             GPIO_PRT28
#define P28_0_GPIO_STD_PIN              0u
#define P28_0_GPIO_STD_NUM              0u
#define P28_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P28_1_GPIO_STD_PORT             GPIO_PRT28
#define P28_1_GPIO_STD_PIN              1u
#define P28_1_GPIO_STD_NUM              1u
#define P28_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P28_2_GPIO_STD_PORT             GPIO_PRT28
#define P28_2_GPIO_STD_PIN              2u
#define P28_2_GPIO_STD_NUM              2u
#define P28_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P28_3_GPIO_STD_PORT             GPIO_PRT28
#define P28_3_GPIO_STD_PIN              3u
#define P28_3_GPIO_STD_NUM              3u
#define P28_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P28_4_GPIO_STD_PORT             GPIO_PRT28
#define P28_4_GPIO_STD_PIN              4u
#define P28_4_GPIO_STD_NUM              4u
#define P28_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P28_5_GPIO_STD_PORT             GPIO_PRT28
#define P28_5_GPIO_STD_PIN              5u
#define P28_5_GPIO_STD_NUM              5u
#define P28_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P28_6_GPIO_STD_PORT             GPIO_PRT28
#define P28_6_GPIO_STD_PIN              6u
#define P28_6_GPIO_STD_NUM              6u
#define P28_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P28_7_GPIO_STD_PORT             GPIO_PRT28
#define P28_7_GPIO_STD_PIN              7u
#define P28_7_GPIO_STD_NUM              7u
#define P28_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 29 (AUTOLVL) */
#define P29_0_GPIO_STD_PORT             GPIO_PRT29
#define P29_0_GPIO_STD_PIN              0u
#define P29_0_GPIO_STD_NUM              0u
#define P29_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P29_1_GPIO_STD_PORT             GPIO_PRT29
#define P29_1_GPIO_STD_PIN              1u
#define P29_1_GPIO_STD_NUM              1u
#define P29_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P29_2_GPIO_STD_PORT             GPIO_PRT29
#define P29_2_GPIO_STD_PIN              2u
#define P29_2_GPIO_STD_NUM              2u
#define P29_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P29_3_GPIO_STD_PORT             GPIO_PRT29
#define P29_3_GPIO_STD_PIN              3u
#define P29_3_GPIO_STD_NUM              3u
#define P29_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P29_4_GPIO_STD_PORT             GPIO_PRT29
#define P29_4_GPIO_STD_PIN              4u
#define P29_4_GPIO_STD_NUM              4u
#define P29_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P29_5_GPIO_STD_PORT             GPIO_PRT29
#define P29_5_GPIO_STD_PIN              5u
#define P29_5_GPIO_STD_NUM              5u
#define P29_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P29_6_GPIO_STD_PORT             GPIO_PRT29
#define P29_6_GPIO_STD_PIN              6u
#define P29_6_GPIO_STD_NUM              6u
#define P29_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P29_7_GPIO_STD_PORT             GPIO_PRT29
#define P29_7_GPIO_STD_PIN              7u
#define P29_7_GPIO_STD_NUM              7u
#define P29_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 30 (AUTOLVL) */
#define P30_0_GPIO_STD_PORT             GPIO_PRT30
#define P30_0_GPIO_STD_PIN              0u
#define P30_0_GPIO_STD_NUM              0u
#define P30_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P30_1_GPIO_STD_PORT             GPIO_PRT30
#define P30_1_GPIO_STD_PIN              1u
#define P30_1_GPIO_STD_NUM              1u
#define P30_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P30_2_GPIO_STD_PORT             GPIO_PRT30
#define P30_2_GPIO_STD_PIN              2u
#define P30_2_GPIO_STD_NUM              2u
#define P30_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P30_3_GPIO_STD_PORT             GPIO_PRT30
#define P30_3_GPIO_STD_PIN              3u
#define P30_3_GPIO_STD_NUM              3u
#define P30_3_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 31 (AUTOLVL) */
#define P31_0_GPIO_STD_PORT             GPIO_PRT31
#define P31_0_GPIO_STD_PIN              0u
#define P31_0_GPIO_STD_NUM              0u
#define P31_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P31_1_GPIO_STD_PORT             GPIO_PRT31
#define P31_1_GPIO_STD_PIN              1u
#define P31_1_GPIO_STD_NUM              1u
#define P31_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P31_2_GPIO_STD_PORT             GPIO_PRT31
#define P31_2_GPIO_STD_PIN              2u
#define P31_2_GPIO_STD_NUM              2u
#define P31_2_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 32 (AUTOLVL) */
#define P32_0_GPIO_STD_PORT             GPIO_PRT32
#define P32_0_GPIO_STD_PIN              0u
#define P32_0_GPIO_STD_NUM              0u
#define P32_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P32_1_GPIO_STD_PORT             GPIO_PRT32
#define P32_1_GPIO_STD_PIN              1u
#define P32_1_GPIO_STD_NUM              1u
#define P32_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P32_2_GPIO_STD_PORT             GPIO_PRT32
#define P32_2_GPIO_STD_PIN              2u
#define P32_2_GPIO_STD_NUM              2u
#define P32_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P32_3_GPIO_STD_PORT             GPIO_PRT32
#define P32_3_GPIO_STD_PIN              3u
#define P32_3_GPIO_STD_NUM              3u
#define P32_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P32_4_GPIO_STD_PORT             GPIO_PRT32
#define P32_4_GPIO_STD_PIN              4u
#define P32_4_GPIO_STD_NUM              4u
#define P32_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P32_5_GPIO_STD_PORT             GPIO_PRT32
#define P32_5_GPIO_STD_PIN              5u
#define P32_5_GPIO_STD_NUM              5u
#define P32_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P32_6_GPIO_STD_PORT             GPIO_PRT32
#define P32_6_GPIO_STD_PIN              6u
#define P32_6_GPIO_STD_NUM              6u
#define P32_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P32_7_GPIO_STD_PORT             GPIO_PRT32
#define P32_7_GPIO_STD_PIN              7u
#define P32_7_GPIO_STD_NUM              7u
#define P32_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 33 (HSIO, AUTOLVL) */
#define P33_0_HSIO_STD_PORT             GPIO_PRT33
#define P33_0_HSIO_STD_PIN              0u
#define P33_0_HSIO_STD_NUM              0u
#define P33_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P33_1_HSIO_STD_PORT             GPIO_PRT33
#define P33_1_HSIO_STD_PIN              1u
#define P33_1_HSIO_STD_NUM              1u
#define P33_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P33_2_HSIO_STD_PORT             GPIO_PRT33
#define P33_2_HSIO_STD_PIN              2u
#define P33_2_HSIO_STD_NUM              2u
#define P33_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P33_3_HSIO_STD_PORT             GPIO_PRT33
#define P33_3_HSIO_STD_PIN              3u
#define P33_3_HSIO_STD_NUM              3u
#define P33_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P33_4_HSIO_STD_PORT             GPIO_PRT33
#define P33_4_HSIO_STD_PIN              4u
#define P33_4_HSIO_STD_NUM              4u
#define P33_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P33_5_HSIO_STD_PORT             GPIO_PRT33
#define P33_5_HSIO_STD_PIN              5u
#define P33_5_HSIO_STD_NUM              5u
#define P33_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P33_6_HSIO_STD_PORT             GPIO_PRT33
#define P33_6_HSIO_STD_PIN              6u
#define P33_6_HSIO_STD_NUM              6u
#define P33_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P33_7_HSIO_STD_PORT             GPIO_PRT33
#define P33_7_HSIO_STD_PIN              7u
#define P33_7_HSIO_STD_NUM              7u
#define P33_7_AMUXSEGMENT               AMUXBUS_MAIN

/* PORT 34 (HSIO, AUTOLVL) */
#define P34_0_HSIO_STD_PORT             GPIO_PRT34
#define P34_0_HSIO_STD_PIN              0u
#define P34_0_HSIO_STD_NUM              0u
#define P34_0_AMUXSEGMENT               AMUXBUS_MAIN
#define P34_1_HSIO_STD_PORT             GPIO_PRT34
#define P34_1_HSIO_STD_PIN              1u
#define P34_1_HSIO_STD_NUM              1u
#define P34_1_AMUXSEGMENT               AMUXBUS_MAIN
#define P34_2_HSIO_STD_PORT             GPIO_PRT34
#define P34_2_HSIO_STD_PIN              2u
#define P34_2_HSIO_STD_NUM              2u
#define P34_2_AMUXSEGMENT               AMUXBUS_MAIN
#define P34_3_HSIO_STD_PORT             GPIO_PRT34
#define P34_3_HSIO_STD_PIN              3u
#define P34_3_HSIO_STD_NUM              3u
#define P34_3_AMUXSEGMENT               AMUXBUS_MAIN
#define P34_4_HSIO_STD_PORT             GPIO_PRT34
#define P34_4_HSIO_STD_PIN              4u
#define P34_4_HSIO_STD_NUM              4u
#define P34_4_AMUXSEGMENT               AMUXBUS_MAIN
#define P34_5_HSIO_STD_PORT             GPIO_PRT34
#define P34_5_HSIO_STD_PIN              5u
#define P34_5_HSIO_STD_NUM              5u
#define P34_5_AMUXSEGMENT               AMUXBUS_MAIN
#define P34_6_HSIO_STD_PORT             GPIO_PRT34
#define P34_6_HSIO_STD_PIN              6u
#define P34_6_HSIO_STD_NUM              6u
#define P34_6_AMUXSEGMENT               AMUXBUS_MAIN
#define P34_7_HSIO_STD_PORT             GPIO_PRT34
#define P34_7_HSIO_STD_PIN              7u
#define P34_7_HSIO_STD_NUM              7u
#define P34_7_AMUXSEGMENT               AMUXBUS_MAIN
...
#define PASS0_SARMUX_PADS10_PORT        32u
#define PASS0_SARMUX_PADS10_PIN         2u
#define PASS0_SARMUX_PADS11_PORT        32u
#define PASS0_SARMUX_PADS11_PIN         3u
#define PASS0_SARMUX_PADS12_PORT        32u
#define PASS0_SARMUX_PADS12_PIN         4u
#define PASS0_SARMUX_PADS13_PORT        32u
#define PASS0_SARMUX_PADS13_PIN         5u
#define PASS0_SARMUX_PADS14_PORT        32u
#define PASS0_SARMUX_PADS14_PIN         6u
#define PASS0_SARMUX_PADS15_PORT        32u
#define PASS0_SARMUX_PADS15_PIN         7u
...
#define PASS0_SARMUX_PADS8_PORT         32u
...
#define PASS0_SARMUX_PADS9_PORT         32u
...
typedef enum
{
    ...
    P1_4_TCPWM1_LINE71              =  8,       /* Digital Active - tcpwm[1].line[71]:0 */
    P1_4_TCPWM1_LINE_COMPL70        =  9,       /* Digital Active - tcpwm[1].line_compl[70]:0 */
    P1_4_TCPWM1_TR_ONE_CNT_IN213    = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[213]:0 */
    P1_4_TCPWM1_TR_ONE_CNT_IN211    = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[211]:0 */
    P1_4_SCB8_UART_RX               = 17,       /* Digital Active - scb[8].uart_rx:1 */
    P1_4_SCB8_SPI_MISO              = 19,       /* Digital Active - scb[8].spi_miso:1 */
    P1_4_LIN0_LIN_RX8               = 22,       /* Digital Active - lin[0].lin_rx[8]:2 */
    ...
    P1_5_SCB8_UART_TX               = 17,       /* Digital Active - scb[8].uart_tx:1 */
    P1_5_SCB8_I2C_SDA               = 18,       /* Digital Active - scb[8].i2c_sda:1 */
    P1_5_SCB8_SPI_MOSI              = 19,       /* Digital Active - scb[8].spi_mosi:1 */
    P1_5_LIN0_LIN_TX8               = 22,       /* Digital Active - lin[0].lin_tx[8]:2 */

    /* P1.6 */
    P1_6_GPIO                       =  0,       /* GPIO controls 'out' */
    P1_6_AMUXA                      =  4,       /* AMUXBUS A */
    P1_6_AMUXB                      =  5,       /* AMUXBUS B */
    P1_6_AMUXA_DSI                  =  6,       /* Analog mux bus A, DSI control */
    P1_6_AMUXB_DSI                  =  7,       /* Analog mux bus B, DSI control */
    P1_6_SCB8_UART_RTS              = 17,       /* Digital Active - scb[8].uart_rts:1 */
    P1_6_SCB8_I2C_SCL               = 18,       /* Digital Active - scb[8].i2c_scl:1 */
    P1_6_SCB8_SPI_CLK               = 19,       /* Digital Active - scb[8].spi_clk:1 */
    P1_6_LIN0_LIN_EN8               = 22,       /* Digital Active - lin[0].lin_en[8]:2 */
    ...
    P2_3_AMUXA                      =  4,       /* AMUXBUS A */
    P2_3_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P2_6_AMUXA                      =  4,       /* AMUXBUS A */
    P2_6_AMUXB                      =  5,       /* AMUXBUS B */
    P2_6_AMUXA_DSI                  =  6,       /* Analog mux bus A, DSI control */
    P2_6_AMUXB_DSI                  =  7,       /* Analog mux bus B, DSI control */
    P2_6_TCPWM1_LINE72              =  8,       /* Digital Active - tcpwm[1].line[72]:0 */
    P2_6_TCPWM1_LINE_COMPL71        =  9,       /* Digital Active - tcpwm[1].line_compl[71]:0 */
    P2_6_TCPWM1_TR_ONE_CNT_IN216    = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[216]:0 */
    P2_6_TCPWM1_TR_ONE_CNT_IN214    = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[214]:0 */
    P2_6_SCB8_UART_CTS              = 17,       /* Digital Active - scb[8].uart_cts:1 */
    P2_6_SCB8_SPI_SELECT0           = 19,       /* Digital Active - scb[8].spi_select0:1 */

    /* P2.7 */
    P2_7_GPIO                       =  0,       /* GPIO controls 'out' */
    P2_7_AMUXA                      =  4,       /* AMUXBUS A */
    P2_7_AMUXB                      =  5,       /* AMUXBUS B */
    P2_7_AMUXA_DSI                  =  6,       /* Analog mux bus A, DSI control */
    P2_7_AMUXB_DSI                  =  7,       /* Analog mux bus B, DSI control */
    P2_7_TCPWM1_LINE73              =  8,       /* Digital Active - tcpwm[1].line[73]:0 */
    P2_7_TCPWM1_LINE_COMPL72        =  9,       /* Digital Active - tcpwm[1].line_compl[72]:0 */
    P2_7_TCPWM1_TR_ONE_CNT_IN219    = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[219]:0 */
    P2_7_TCPWM1_TR_ONE_CNT_IN217    = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[217]:0 */
    P2_7_SCB8_SPI_SELECT1           = 19,       /* Digital Active - scb[8].spi_select1:1 */
    P2_7_LIN0_LIN_RX11              = 20,       /* Digital Active - lin[0].lin_rx[11]:1 */
    ...
    P3_2_AMUXA                      =  4,       /* AMUXBUS A */
    P3_2_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P3_3_AMUXA                      =  4,       /* AMUXBUS A */
    P3_3_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P3_4_AMUXA                      =  4,       /* AMUXBUS A */
    P3_4_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P3_5_AMUXA                      =  4,       /* AMUXBUS A */
    P3_5_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P3_6_AMUXA                      =  4,       /* AMUXBUS A */
    P3_6_AMUXB                      =  5,       /* AMUXBUS B */
    P3_6_AMUXA_DSI                  =  6,       /* Analog mux bus A, DSI control */
    P3_6_AMUXB_DSI                  =  7,       /* Analog mux bus B, DSI control */
    P3_6_TCPWM1_LINE74              =  8,       /* Digital Active - tcpwm[1].line[74]:0 */
    P3_6_TCPWM1_LINE_COMPL73        =  9,       /* Digital Active - tcpwm[1].line_compl[73]:0 */
    P3_6_TCPWM1_TR_ONE_CNT_IN222    = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[222]:0 */
    P3_6_TCPWM1_TR_ONE_CNT_IN220    = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[220]:0 */
    P3_6_SCB8_SPI_SELECT2           = 19,       /* Digital Active - scb[8].spi_select2:0 */
    P3_6_LIN0_LIN_TX11              = 20,       /* Digital Active - lin[0].lin_tx[11]:1 */
    P3_6_CANFD1_TTCAN_TX2           = 21,       /* Digital Active - canfd[1].ttcan_tx[2]:2 */

    /* P3.7 */
    P3_7_GPIO                       =  0,       /* GPIO controls 'out' */
    P3_7_AMUXA                      =  4,       /* AMUXBUS A */
    P3_7_AMUXB                      =  5,       /* AMUXBUS B */
    P3_7_AMUXA_DSI                  =  6,       /* Analog mux bus A, DSI control */
    P3_7_AMUXB_DSI                  =  7,       /* Analog mux bus B, DSI control */
    P3_7_TCPWM1_LINE75              =  8,       /* Digital Active - tcpwm[1].line[75]:0 */
    P3_7_TCPWM1_LINE_COMPL74        =  9,       /* Digital Active - tcpwm[1].line_compl[74]:0 */
    P3_7_TCPWM1_TR_ONE_CNT_IN225    = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[225]:0 */
    P3_7_TCPWM1_TR_ONE_CNT_IN223    = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[223]:0 */
    P3_7_LIN0_LIN_EN11              = 20,       /* Digital Active - lin[0].lin_en[11]:1 */
    P3_7_CANFD1_TTCAN_RX2           = 21,       /* Digital Active - canfd[1].ttcan_rx[2]:2 */
    ...
    P4_5_AMUXA_DSI                  =  6,       /* Analog mux bus A, DSI control */
    P4_5_AMUXB_DSI                  =  7,       /* Analog mux bus B, DSI control */
    P4_5_SCB9_UART_RX               = 17,       /* Digital Active - scb[9].uart_rx:1 */
    P4_5_SCB9_SPI_MISO              = 19,       /* Digital Active - scb[9].spi_miso:1 */
    P4_5_PERI_TR_IO_INPUT32         = 26,       /* Digital Active - peri.tr_io_input[32]:0 */

    /* P4.6 */
    P4_6_GPIO                       =  0,       /* GPIO controls 'out' */
    P4_6_AMUXA                      =  4,       /* AMUXBUS A */
    P4_6_AMUXB                      =  5,       /* AMUXBUS B */
    P4_6_AMUXA_DSI                  =  6,       /* Analog mux bus A, DSI control */
    P4_6_AMUXB_DSI                  =  7,       /* Analog mux bus B, DSI control */
    P4_6_SCB9_UART_TX               = 17,       /* Digital Active - scb[9].uart_tx:1 */
    P4_6_SCB9_I2C_SDA               = 18,       /* Digital Active - scb[9].i2c_sda:1 */
    P4_6_SCB9_SPI_MOSI              = 19,       /* Digital Active - scb[9].spi_mosi:1 */
    P4_6_PERI_TR_IO_INPUT33         = 26,       /* Digital Active - peri.tr_io_input[33]:0 */
    ...
    P6_4_AMUXA                      =  4,       /* AMUXBUS A */
    P6_4_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P6_5_AMUXA                      =  4,       /* AMUXBUS A */
    P6_5_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P6_6_AMUXA                      =  4,       /* AMUXBUS A */
    P6_6_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P6_7_AMUXA                      =  4,       /* AMUXBUS A */
    P6_7_AMUXB                      =  5,       /* AMUXBUS B */
    ...
    P13_2_AMUXA                     =  4,       /* AMUXBUS A */
    P13_2_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P13_3_AMUXA                     =  4,       /* AMUXBUS A */
    P13_3_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P13_4_AMUXA                     =  4,       /* AMUXBUS A */
    P13_4_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P13_5_AMUXA                     =  4,       /* AMUXBUS A */
    P13_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P13_6_AMUXA                     =  4,       /* AMUXBUS A */
    P13_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P13_7_AMUXA                     =  4,       /* AMUXBUS A */
    P13_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P14_5_AMUXA                     =  4,       /* AMUXBUS A */
    P14_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P14_6_AMUXA                     =  4,       /* AMUXBUS A */
    P14_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P14_7_AMUXA                     =  4,       /* AMUXBUS A */
    P14_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P15_2_AMUXA                     =  4,       /* AMUXBUS A */
    P15_2_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P15_3_AMUXA                     =  4,       /* AMUXBUS A */
    P15_3_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P16_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P16_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P16_1_TCPWM1_LINE61             =  8,       /* Digital Active - tcpwm[1].line[61]:0 */
    P16_1_TCPWM1_LINE_COMPL60       =  9,       /* Digital Active - tcpwm[1].line_compl[60]:0 */
    P16_1_TCPWM1_TR_ONE_CNT_IN183   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[183]:0 */
    P16_1_TCPWM1_TR_ONE_CNT_IN181   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[181]:0 */
    P16_1_TCPWM1_LINE_COMPL512      = 16,       /* Digital Active - tcpwm[1].line_compl[512]:1 */
    P16_1_SCB9_SPI_SELECT2          = 19,       /* Digital Active - scb[9].spi_select2:0 */
    P16_1_LIN0_LIN_TX11             = 20,       /* Digital Active - lin[0].lin_tx[11]:0 */

    /* P16.2 */
    P16_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P16_2_AMUXA                     =  4,       /* AMUXBUS A */
    P16_2_AMUXB                     =  5,       /* AMUXBUS B */
    P16_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P16_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P16_2_TCPWM1_LINE62             =  8,       /* Digital Active - tcpwm[1].line[62]:0 */
    P16_2_TCPWM1_LINE_COMPL61       =  9,       /* Digital Active - tcpwm[1].line_compl[61]:0 */
    P16_2_TCPWM1_TR_ONE_CNT_IN186   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[186]:0 */
    P16_2_TCPWM1_TR_ONE_CNT_IN184   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[184]:0 */
    P16_2_TCPWM1_LINE513            = 16,       /* Digital Active - tcpwm[1].line[513]:1 */
    P16_2_SCB9_SPI_SELECT3          = 19,       /* Digital Active - scb[9].spi_select3:0 */
    P16_2_LIN0_LIN_EN11             = 20,       /* Digital Active - lin[0].lin_en[11]:0 */
    ...
    P16_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P16_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P16_4_TCPWM1_LINE68             =  8,       /* Digital Active - tcpwm[1].line[68]:1 */
    P16_4_TCPWM1_LINE_COMPL69       =  9,       /* Digital Active - tcpwm[1].line_compl[69]:1 */
    P16_4_TCPWM1_TR_ONE_CNT_IN204   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[204]:1 */
    P16_4_TCPWM1_TR_ONE_CNT_IN208   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[208]:1 */

    /* P16.5 */
    P16_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P16_5_AMUXA                     =  4,       /* AMUXBUS A */
    P16_5_AMUXB                     =  5,       /* AMUXBUS B */
    P16_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P16_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P16_5_TCPWM1_LINE67             =  8,       /* Digital Active - tcpwm[1].line[67]:1 */
    P16_5_TCPWM1_LINE_COMPL68       =  9,       /* Digital Active - tcpwm[1].line_compl[68]:1 */
    P16_5_TCPWM1_TR_ONE_CNT_IN201   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[201]:1 */
    P16_5_TCPWM1_TR_ONE_CNT_IN205   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[205]:1 */

    /* P16.6 */
    P16_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P16_6_AMUXA                     =  4,       /* AMUXBUS A */
    P16_6_AMUXB                     =  5,       /* AMUXBUS B */
    P16_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P16_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P16_6_TCPWM1_LINE66             =  8,       /* Digital Active - tcpwm[1].line[66]:1 */
    P16_6_TCPWM1_LINE_COMPL67       =  9,       /* Digital Active - tcpwm[1].line_compl[67]:1 */
    P16_6_TCPWM1_TR_ONE_CNT_IN198   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[198]:1 */
    P16_6_TCPWM1_TR_ONE_CNT_IN202   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[202]:1 */

    /* P16.7 */
    P16_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P16_7_AMUXA                     =  4,       /* AMUXBUS A */
    P16_7_AMUXB                     =  5,       /* AMUXBUS B */
    P16_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P16_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P16_7_TCPWM1_LINE65             =  8,       /* Digital Active - tcpwm[1].line[65]:1 */
    P16_7_TCPWM1_LINE_COMPL66       =  9,       /* Digital Active - tcpwm[1].line_compl[66]:1 */
    P16_7_TCPWM1_TR_ONE_CNT_IN195   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[195]:1 */
    P16_7_TCPWM1_TR_ONE_CNT_IN199   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[199]:1 */
    ...
    P17_5_AMUXA                     =  4,       /* AMUXBUS A */
    P17_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P17_6_AMUXA                     =  4,       /* AMUXBUS A */
    P17_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P17_7_AMUXA                     =  4,       /* AMUXBUS A */
    P17_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P18_2_AMUXA                     =  4,       /* AMUXBUS A */
    P18_2_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P18_3_AMUXA                     =  4,       /* AMUXBUS A */
    P18_3_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P18_4_AMUXA                     =  4,       /* AMUXBUS A */
    P18_4_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P18_5_AMUXA                     =  4,       /* AMUXBUS A */
    P18_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P18_6_AMUXA                     =  4,       /* AMUXBUS A */
    P18_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P18_7_AMUXA                     =  4,       /* AMUXBUS A */
    P18_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_0_AMUXA                     =  4,       /* AMUXBUS A */
    P20_0_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_1_AMUXA                     =  4,       /* AMUXBUS A */
    P20_1_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_2_AMUXA                     =  4,       /* AMUXBUS A */
    P20_2_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_3_AMUXA                     =  4,       /* AMUXBUS A */
    P20_3_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_4_AMUXA                     =  4,       /* AMUXBUS A */
    P20_4_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_5_AMUXA                     =  4,       /* AMUXBUS A */
    P20_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_6_AMUXA                     =  4,       /* AMUXBUS A */
    P20_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P20_7_AMUXA                     =  4,       /* AMUXBUS A */
    P20_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_0_AMUXA                     =  4,       /* AMUXBUS A */
    P21_0_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_1_AMUXA                     =  4,       /* AMUXBUS A */
    P21_1_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_2_AMUXA                     =  4,       /* AMUXBUS A */
    P21_2_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_3_AMUXA                     =  4,       /* AMUXBUS A */
    P21_3_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_4_AMUXA                     =  4,       /* AMUXBUS A */
    P21_4_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_5_AMUXA                     =  4,       /* AMUXBUS A */
    P21_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_6_AMUXA                     =  4,       /* AMUXBUS A */
    P21_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P21_7_AMUXA                     =  4,       /* AMUXBUS A */
    P21_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_0_AMUXA                     =  4,       /* AMUXBUS A */
    P22_0_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_1_AMUXA                     =  4,       /* AMUXBUS A */
    P22_1_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_2_AMUXA                     =  4,       /* AMUXBUS A */
    P22_2_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_3_AMUXA                     =  4,       /* AMUXBUS A */
    P22_3_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_4_AMUXA                     =  4,       /* AMUXBUS A */
    P22_4_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_5_AMUXA                     =  4,       /* AMUXBUS A */
    P22_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_6_AMUXA                     =  4,       /* AMUXBUS A */
    P22_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P22_7_AMUXA                     =  4,       /* AMUXBUS A */
    P22_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_0_AMUXA                     =  4,       /* AMUXBUS A */
    P23_0_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_1_AMUXA                     =  4,       /* AMUXBUS A */
    P23_1_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_2_AMUXA                     =  4,       /* AMUXBUS A */
    P23_2_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_3_AMUXA                     =  4,       /* AMUXBUS A */
    P23_3_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_4_AMUXA                     =  4,       /* AMUXBUS A */
    P23_4_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_5_AMUXA                     =  4,       /* AMUXBUS A */
    P23_5_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_6_AMUXA                     =  4,       /* AMUXBUS A */
    P23_6_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P23_7_AMUXA                     =  4,       /* AMUXBUS A */
    P23_7_AMUXB                     =  5,       /* AMUXBUS B */
    ...
    P24_0_AMUXA                     =  4,       /* AMUXBUS A */
    P24_0_AMUXB                     =  5,       /* AMUXBUS B */
    P24_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P24_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P24_0_LIN0_LIN_RX16             = 20,       /* Digital Active - lin[0].lin_rx[16]:0 */
    P24_0_SRSS_EXT_CLK              = 22,       /* Digital Active - srss.ext_clk:2 */
    P24_0_SDHC0_CARD_DETECT_N       = 25,       /* Digital Active - sdhc[0].card_detect_n:1 */

    /* P24.1 */
    P24_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P24_1_AMUXA                     =  4,       /* AMUXBUS A */
    P24_1_AMUXB                     =  5,       /* AMUXBUS B */
    P24_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P24_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P24_1_SMIF0_SPIHB_CLK           = 23,       /* Digital Active - smif[0].spihb_clk:1 */
    P24_1_SDHC0_CARD_MECH_WRITE_PROT = 25,      /* Digital Active - sdhc[0].card_mech_write_prot:1 */

    /* P24.2 */
    P24_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P24_2_AMUXA                     =  4,       /* AMUXBUS A */
    P24_2_AMUXB                     =  5,       /* AMUXBUS B */
    P24_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P24_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P24_2_SMIF0_SPIHB_RWDS          = 23,       /* Digital Active - smif[0].spihb_rwds:1 */
    P24_2_SDHC0_CLK_CARD            = 25,       /* Digital Active - sdhc[0].clk_card:1 */

    /* P24.3 */
    P24_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P24_3_AMUXA                     =  4,       /* AMUXBUS A */
    P24_3_AMUXB                     =  5,       /* AMUXBUS B */
    P24_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P24_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P24_3_LIN0_LIN_TX16             = 20,       /* Digital Active - lin[0].lin_tx[16]:0 */
    P24_3_SMIF0_SPIHB_SELECT0       = 23,       /* Digital Active - smif[0].spihb_select0:1 */
    P24_3_SDHC0_CARD_CMD            = 25,       /* Digital Active - sdhc[0].card_cmd:1 */

    /* P24.4 */
    P24_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P24_4_AMUXA                     =  4,       /* AMUXBUS A */
    P24_4_AMUXB                     =  5,       /* AMUXBUS B */
    P24_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P24_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P24_4_LIN0_LIN_EN16             = 20,       /* Digital Active - lin[0].lin_en[16]:0 */
    P24_4_SRSS_DDFT_CLK_DIRECT      = 22,       /* Digital Active - srss.ddft_clk_direct */
    P24_4_SMIF0_SPIHB_SELECT1       = 23,       /* Digital Active - smif[0].spihb_select1:1 */
    P24_4_SDHC0_CARD_IF_PWR_EN      = 25,       /* Digital Active - sdhc[0].card_if_pwr_en:1 */

    /* P25.0 */
    P25_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_0_AMUXA                     =  4,       /* AMUXBUS A */
    P25_0_AMUXB                     =  5,       /* AMUXBUS B */
    P25_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_0_SMIF0_SPIHB_DATA0         = 23,       /* Digital Active - smif[0].spihb_data0:1 */
    P25_0_SDHC0_CARD_DAT_3TO00      = 25,       /* Digital Active - sdhc[0].card_dat_3to0[0]:1 */

    /* P25.1 */
    P25_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_1_AMUXA                     =  4,       /* AMUXBUS A */
    P25_1_AMUXB                     =  5,       /* AMUXBUS B */
    P25_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_1_SMIF0_SPIHB_DATA1         = 23,       /* Digital Active - smif[0].spihb_data1:1 */
    P25_1_SDHC0_CARD_DAT_3TO01      = 25,       /* Digital Active - sdhc[0].card_dat_3to0[1]:1 */

    /* P25.2 */
    P25_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_2_AMUXA                     =  4,       /* AMUXBUS A */
    P25_2_AMUXB                     =  5,       /* AMUXBUS B */
    P25_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_2_SMIF0_SPIHB_DATA2         = 23,       /* Digital Active - smif[0].spihb_data2:1 */
    P25_2_SDHC0_CARD_DAT_3TO02      = 25,       /* Digital Active - sdhc[0].card_dat_3to0[2]:1 */

    /* P25.3 */
    P25_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_3_AMUXA                     =  4,       /* AMUXBUS A */
    P25_3_AMUXB                     =  5,       /* AMUXBUS B */
    P25_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_3_SMIF0_SPIHB_DATA3         = 23,       /* Digital Active - smif[0].spihb_data3:1 */
    P25_3_SDHC0_CARD_DAT_3TO03      = 25,       /* Digital Active - sdhc[0].card_dat_3to0[3]:1 */

    /* P25.4 */
    P25_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_4_AMUXA                     =  4,       /* AMUXBUS A */
    P25_4_AMUXB                     =  5,       /* AMUXBUS B */
    P25_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_4_SMIF0_SPIHB_DATA4         = 23,       /* Digital Active - smif[0].spihb_data4:1 */
    P25_4_SDHC0_CARD_DAT_7TO40      = 25,       /* Digital Active - sdhc[0].card_dat_7to4[0]:1 */

    /* P25.5 */
    P25_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_5_AMUXA                     =  4,       /* AMUXBUS A */
    P25_5_AMUXB                     =  5,       /* AMUXBUS B */
    P25_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_5_SMIF0_SPIHB_DATA5         = 23,       /* Digital Active - smif[0].spihb_data5:1 */
    P25_5_SDHC0_CARD_DAT_7TO41      = 25,       /* Digital Active - sdhc[0].card_dat_7to4[1]:1 */

    /* P25.6 */
    P25_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_6_AMUXA                     =  4,       /* AMUXBUS A */
    P25_6_AMUXB                     =  5,       /* AMUXBUS B */
    P25_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_6_SMIF0_SPIHB_DATA6         = 23,       /* Digital Active - smif[0].spihb_data6:1 */
    P25_6_SDHC0_CARD_DAT_7TO42      = 25,       /* Digital Active - sdhc[0].card_dat_7to4[2]:1 */

    /* P25.7 */
    P25_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P25_7_AMUXA                     =  4,       /* AMUXBUS A */
    P25_7_AMUXB                     =  5,       /* AMUXBUS B */
    P25_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P25_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P25_7_SMIF0_SPIHB_DATA7         = 23,       /* Digital Active - smif[0].spihb_data7:1 */
    P25_7_SDHC0_CARD_DAT_7TO43      = 25,       /* Digital Active - sdhc[0].card_dat_7to4[3]:1 */

    /* P26.0 */
    P26_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_0_AMUXA                     =  4,       /* AMUXBUS A */
    P26_0_AMUXB                     =  5,       /* AMUXBUS B */
    P26_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_0_ETH1_REF_CLK              = 27,       /* Digital Active - eth[1].ref_clk:0 */

    /* P26.1 */
    P26_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_1_AMUXA                     =  4,       /* AMUXBUS A */
    P26_1_AMUXB                     =  5,       /* AMUXBUS B */
    P26_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_1_ETH1_TX_CTL               = 27,       /* Digital Active - eth[1].tx_ctl:0 */

    /* P26.2 */
    P26_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_2_AMUXA                     =  4,       /* AMUXBUS A */
    P26_2_AMUXB                     =  5,       /* AMUXBUS B */
    P26_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_2_ETH1_TX_CLK               = 27,       /* Digital Active - eth[1].tx_clk:0 */

    /* P26.3 */
    P26_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_3_AMUXA                     =  4,       /* AMUXBUS A */
    P26_3_AMUXB                     =  5,       /* AMUXBUS B */
    P26_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_3_ETH1_TXD0                 = 27,       /* Digital Active - eth[1].txd[0]:0 */

    /* P26.4 */
    P26_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_4_AMUXA                     =  4,       /* AMUXBUS A */
    P26_4_AMUXB                     =  5,       /* AMUXBUS B */
    P26_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_4_ETH1_TXD1                 = 27,       /* Digital Active - eth[1].txd[1]:0 */

    /* P26.5 */
    P26_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_5_AMUXA                     =  4,       /* AMUXBUS A */
    P26_5_AMUXB                     =  5,       /* AMUXBUS B */
    P26_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_5_ETH1_TXD2                 = 27,       /* Digital Active - eth[1].txd[2]:0 */

    /* P26.6 */
    P26_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_6_AMUXA                     =  4,       /* AMUXBUS A */
    P26_6_AMUXB                     =  5,       /* AMUXBUS B */
    P26_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_6_ETH1_TXD3                 = 27,       /* Digital Active - eth[1].txd[3]:0 */

    /* P26.7 */
    P26_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P26_7_AMUXA                     =  4,       /* AMUXBUS A */
    P26_7_AMUXB                     =  5,       /* AMUXBUS B */
    P26_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P26_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P26_7_ETH1_RXD0                 = 27,       /* Digital Active - eth[1].rxd[0]:0 */

    /* P27.0 */
    P27_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_0_AMUXA                     =  4,       /* AMUXBUS A */
    P27_0_AMUXB                     =  5,       /* AMUXBUS B */
    P27_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_0_ETH1_RXD1                 = 27,       /* Digital Active - eth[1].rxd[1]:0 */

    /* P27.1 */
    P27_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_1_AMUXA                     =  4,       /* AMUXBUS A */
    P27_1_AMUXB                     =  5,       /* AMUXBUS B */
    P27_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_1_ETH1_RXD2                 = 27,       /* Digital Active - eth[1].rxd[2]:0 */

    /* P27.2 */
    P27_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_2_AMUXA                     =  4,       /* AMUXBUS A */
    P27_2_AMUXB                     =  5,       /* AMUXBUS B */
    P27_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_2_ETH1_RXD3                 = 27,       /* Digital Active - eth[1].rxd[3]:0 */

    /* P27.3 */
    P27_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_3_AMUXA                     =  4,       /* AMUXBUS A */
    P27_3_AMUXB                     =  5,       /* AMUXBUS B */
    P27_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_3_ETH1_RX_CTL               = 27,       /* Digital Active - eth[1].rx_ctl:0 */

    /* P27.4 */
    P27_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_4_AMUXA                     =  4,       /* AMUXBUS A */
    P27_4_AMUXB                     =  5,       /* AMUXBUS B */
    P27_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_4_ETH1_RX_CLK               = 27,       /* Digital Active - eth[1].rx_clk:0 */

    /* P27.5 */
    P27_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_5_AMUXA                     =  4,       /* AMUXBUS A */
    P27_5_AMUXB                     =  5,       /* AMUXBUS B */
    P27_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_5_ETH1_MDIO                 = 27,       /* Digital Active - eth[1].mdio:0 */

    /* P27.6 */
    P27_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_6_AMUXA                     =  4,       /* AMUXBUS A */
    P27_6_AMUXB                     =  5,       /* AMUXBUS B */
    P27_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_6_ETH1_MDC                  = 27,       /* Digital Active - eth[1].mdc:0 */

    /* P27.7 */
    P27_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P27_7_AMUXA                     =  4,       /* AMUXBUS A */
    P27_7_AMUXB                     =  5,       /* AMUXBUS B */
    P27_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P27_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P27_7_SRSS_IO_CLK_HF5           = 25,       /* Digital Active - srss.io_clk_hf[5]:1 */
    P27_7_ETH1_ETH_TSU_TIMER_CMP_VAL = 27,      /* Digital Active - eth[1].eth_tsu_timer_cmp_val:0 */

    /* P28.0 */
    P28_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_0_AMUXA                     =  4,       /* AMUXBUS A */
    P28_0_AMUXB                     =  5,       /* AMUXBUS B */
    P28_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_0_TCPWM1_LINE63             =  8,       /* Digital Active - tcpwm[1].line[63]:0 */
    P28_0_TCPWM1_LINE_COMPL65       =  9,       /* Digital Active - tcpwm[1].line_compl[65]:1 */
    P28_0_TCPWM1_TR_ONE_CNT_IN189   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[189]:0 */
    P28_0_TCPWM1_TR_ONE_CNT_IN196   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[196]:1 */
    P28_0_TCPWM1_LINE524            = 16,       /* Digital Active - tcpwm[1].line[524]:1 */
    P28_0_SCB10_UART_RX             = 17,       /* Digital Active - scb[10].uart_rx:0 */
    P28_0_SCB10_SPI_MISO            = 19,       /* Digital Active - scb[10].spi_miso:0 */

    /* P28.1 */
    P28_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_1_AMUXA                     =  4,       /* AMUXBUS A */
    P28_1_AMUXB                     =  5,       /* AMUXBUS B */
    P28_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_1_TCPWM1_LINE64             =  8,       /* Digital Active - tcpwm[1].line[64]:0 */
    P28_1_TCPWM1_LINE_COMPL63       =  9,       /* Digital Active - tcpwm[1].line_compl[63]:0 */
    P28_1_TCPWM1_TR_ONE_CNT_IN192   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[192]:0 */
    P28_1_TCPWM1_TR_ONE_CNT_IN190   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[190]:0 */
    P28_1_TCPWM1_LINE_COMPL524      = 16,       /* Digital Active - tcpwm[1].line_compl[524]:1 */
    P28_1_SCB10_UART_TX             = 17,       /* Digital Active - scb[10].uart_tx:0 */
    P28_1_SCB10_I2C_SDA             = 18,       /* Digital Active - scb[10].i2c_sda:0 */
    P28_1_SCB10_SPI_MOSI            = 19,       /* Digital Active - scb[10].spi_mosi:0 */
    P28_1_LIN0_LIN_RX17             = 20,       /* Digital Active - lin[0].lin_rx[17]:0 */

    /* P28.2 */
    P28_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_2_AMUXA                     =  4,       /* AMUXBUS A */
    P28_2_AMUXB                     =  5,       /* AMUXBUS B */
    P28_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_2_TCPWM1_LINE65             =  8,       /* Digital Active - tcpwm[1].line[65]:0 */
    P28_2_TCPWM1_LINE_COMPL64       =  9,       /* Digital Active - tcpwm[1].line_compl[64]:0 */
    P28_2_TCPWM1_TR_ONE_CNT_IN195   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[195]:0 */
    P28_2_TCPWM1_TR_ONE_CNT_IN193   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[193]:0 */
    P28_2_TCPWM1_TR_ONE_CNT_IN1572  = 16,       /* Digital Active - tcpwm[1].tr_one_cnt_in[1572]:1 */
    P28_2_SCB10_UART_RTS            = 17,       /* Digital Active - scb[10].uart_rts:0 */
    P28_2_SCB10_I2C_SCL             = 18,       /* Digital Active - scb[10].i2c_scl:0 */
    P28_2_SCB10_SPI_CLK             = 19,       /* Digital Active - scb[10].spi_clk:0 */
    P28_2_LIN0_LIN_TX17             = 20,       /* Digital Active - lin[0].lin_tx[17]:0 */

    /* P28.3 */
    P28_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_3_AMUXA                     =  4,       /* AMUXBUS A */
    P28_3_AMUXB                     =  5,       /* AMUXBUS B */
    P28_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_3_TCPWM1_LINE66             =  8,       /* Digital Active - tcpwm[1].line[66]:0 */
    P28_3_TCPWM1_LINE_COMPL65       =  9,       /* Digital Active - tcpwm[1].line_compl[65]:0 */
    P28_3_TCPWM1_TR_ONE_CNT_IN198   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[198]:0 */
    P28_3_TCPWM1_TR_ONE_CNT_IN196   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[196]:0 */
    P28_3_TCPWM1_TR_ONE_CNT_IN1573  = 16,       /* Digital Active - tcpwm[1].tr_one_cnt_in[1573]:1 */
    P28_3_SCB10_UART_CTS            = 17,       /* Digital Active - scb[10].uart_cts:0 */
    P28_3_SCB10_SPI_SELECT0         = 19,       /* Digital Active - scb[10].spi_select0:0 */
    P28_3_LIN0_LIN_EN17             = 20,       /* Digital Active - lin[0].lin_en[17]:0 */

    /* P28.4 */
    P28_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_4_AMUXA                     =  4,       /* AMUXBUS A */
    P28_4_AMUXB                     =  5,       /* AMUXBUS B */
    P28_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_4_TCPWM1_LINE67             =  8,       /* Digital Active - tcpwm[1].line[67]:0 */
    P28_4_TCPWM1_LINE_COMPL66       =  9,       /* Digital Active - tcpwm[1].line_compl[66]:0 */
    P28_4_TCPWM1_TR_ONE_CNT_IN201   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[201]:0 */
    P28_4_TCPWM1_TR_ONE_CNT_IN199   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[199]:0 */
    P28_4_SCB10_SPI_SELECT1         = 19,       /* Digital Active - scb[10].spi_select1:0 */
    P28_4_LIN0_LIN_RX18             = 20,       /* Digital Active - lin[0].lin_rx[18]:0 */

    /* P28.5 */
    P28_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_5_AMUXA                     =  4,       /* AMUXBUS A */
    P28_5_AMUXB                     =  5,       /* AMUXBUS B */
    P28_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_5_TCPWM1_LINE68             =  8,       /* Digital Active - tcpwm[1].line[68]:0 */
    P28_5_TCPWM1_LINE_COMPL67       =  9,       /* Digital Active - tcpwm[1].line_compl[67]:0 */
    P28_5_TCPWM1_TR_ONE_CNT_IN204   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[204]:0 */
    P28_5_TCPWM1_TR_ONE_CNT_IN202   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[202]:0 */
    P28_5_SCB10_SPI_SELECT2         = 19,       /* Digital Active - scb[10].spi_select2:0 */
    P28_5_LIN0_LIN_TX18             = 20,       /* Digital Active - lin[0].lin_tx[18]:0 */

    /* P28.6 */
    P28_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_6_AMUXA                     =  4,       /* AMUXBUS A */
    P28_6_AMUXB                     =  5,       /* AMUXBUS B */
    P28_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_6_TCPWM1_LINE69             =  8,       /* Digital Active - tcpwm[1].line[69]:0 */
    P28_6_TCPWM1_LINE_COMPL68       =  9,       /* Digital Active - tcpwm[1].line_compl[68]:0 */
    P28_6_TCPWM1_TR_ONE_CNT_IN207   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[207]:0 */
    P28_6_TCPWM1_TR_ONE_CNT_IN205   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[205]:0 */
    P28_6_SCB10_SPI_SELECT3         = 19,       /* Digital Active - scb[10].spi_select3:0 */
    P28_6_LIN0_LIN_EN18             = 20,       /* Digital Active - lin[0].lin_en[18]:0 */

    /* P28.7 */
    P28_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P28_7_AMUXA                     =  4,       /* AMUXBUS A */
    P28_7_AMUXB                     =  5,       /* AMUXBUS B */
    P28_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P28_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P28_7_TCPWM1_LINE70             =  8,       /* Digital Active - tcpwm[1].line[70]:0 */
    P28_7_TCPWM1_LINE_COMPL69       =  9,       /* Digital Active - tcpwm[1].line_compl[69]:0 */
    P28_7_TCPWM1_TR_ONE_CNT_IN210   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[210]:0 */
    P28_7_TCPWM1_TR_ONE_CNT_IN208   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[208]:0 */
    P28_7_LIN0_LIN_RX19             = 20,       /* Digital Active - lin[0].lin_rx[19]:0 */

    /* P29.0 */
    P29_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_0_AMUXA                     =  4,       /* AMUXBUS A */
    P29_0_AMUXB                     =  5,       /* AMUXBUS B */
    P29_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_0_TCPWM1_LINE76             =  8,       /* Digital Active - tcpwm[1].line[76]:0 */
    P29_0_TCPWM1_LINE_COMPL75       =  9,       /* Digital Active - tcpwm[1].line_compl[75]:0 */
    P29_0_TCPWM1_TR_ONE_CNT_IN228   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[228]:0 */
    P29_0_TCPWM1_TR_ONE_CNT_IN226   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[226]:0 */
    P29_0_LIN0_LIN_TX19             = 20,       /* Digital Active - lin[0].lin_tx[19]:0 */

    /* P29.1 */
    P29_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_1_AMUXA                     =  4,       /* AMUXBUS A */
    P29_1_AMUXB                     =  5,       /* AMUXBUS B */
    P29_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_1_TCPWM1_LINE77             =  8,       /* Digital Active - tcpwm[1].line[77]:0 */
    P29_1_TCPWM1_LINE_COMPL76       =  9,       /* Digital Active - tcpwm[1].line_compl[76]:0 */
    P29_1_TCPWM1_TR_ONE_CNT_IN231   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[231]:0 */
    P29_1_TCPWM1_TR_ONE_CNT_IN229   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[229]:0 */
    P29_1_LIN0_LIN_EN19             = 20,       /* Digital Active - lin[0].lin_en[19]:0 */

    /* P29.2 */
    P29_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_2_AMUXA                     =  4,       /* AMUXBUS A */
    P29_2_AMUXB                     =  5,       /* AMUXBUS B */
    P29_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_2_TCPWM1_LINE78             =  8,       /* Digital Active - tcpwm[1].line[78]:0 */
    P29_2_TCPWM1_LINE_COMPL77       =  9,       /* Digital Active - tcpwm[1].line_compl[77]:0 */
    P29_2_TCPWM1_TR_ONE_CNT_IN234   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[234]:0 */
    P29_2_TCPWM1_TR_ONE_CNT_IN232   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[232]:0 */

    /* P29.3 */
    P29_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_3_AMUXA                     =  4,       /* AMUXBUS A */
    P29_3_AMUXB                     =  5,       /* AMUXBUS B */
    P29_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_3_TCPWM1_LINE79             =  8,       /* Digital Active - tcpwm[1].line[79]:0 */
    P29_3_TCPWM1_LINE_COMPL78       =  9,       /* Digital Active - tcpwm[1].line_compl[78]:0 */
    P29_3_TCPWM1_TR_ONE_CNT_IN237   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[237]:0 */
    P29_3_TCPWM1_TR_ONE_CNT_IN235   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[235]:0 */

    /* P29.4 */
    P29_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_4_AMUXA                     =  4,       /* AMUXBUS A */
    P29_4_AMUXB                     =  5,       /* AMUXBUS B */
    P29_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_4_TCPWM1_LINE80             =  8,       /* Digital Active - tcpwm[1].line[80]:0 */
    P29_4_TCPWM1_LINE_COMPL79       =  9,       /* Digital Active - tcpwm[1].line_compl[79]:0 */
    P29_4_TCPWM1_TR_ONE_CNT_IN240   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[240]:0 */
    P29_4_TCPWM1_TR_ONE_CNT_IN238   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[238]:0 */

    /* P29.5 */
    P29_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_5_AMUXA                     =  4,       /* AMUXBUS A */
    P29_5_AMUXB                     =  5,       /* AMUXBUS B */
    P29_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_5_TCPWM1_LINE81             =  8,       /* Digital Active - tcpwm[1].line[81]:0 */
    P29_5_TCPWM1_LINE_COMPL80       =  9,       /* Digital Active - tcpwm[1].line_compl[80]:0 */
    P29_5_TCPWM1_TR_ONE_CNT_IN243   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[243]:0 */
    P29_5_TCPWM1_TR_ONE_CNT_IN241   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[241]:0 */

    /* P29.6 */
    P29_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_6_AMUXA                     =  4,       /* AMUXBUS A */
    P29_6_AMUXB                     =  5,       /* AMUXBUS B */
    P29_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_6_TCPWM1_LINE82             =  8,       /* Digital Active - tcpwm[1].line[82]:0 */
    P29_6_TCPWM1_LINE_COMPL81       =  9,       /* Digital Active - tcpwm[1].line_compl[81]:0 */
    P29_6_TCPWM1_TR_ONE_CNT_IN246   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[246]:0 */
    P29_6_TCPWM1_TR_ONE_CNT_IN244   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[244]:0 */

    /* P29.7 */
    P29_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P29_7_AMUXA                     =  4,       /* AMUXBUS A */
    P29_7_AMUXB                     =  5,       /* AMUXBUS B */
    P29_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P29_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P29_7_TCPWM1_LINE83             =  8,       /* Digital Active - tcpwm[1].line[83]:0 */
    P29_7_TCPWM1_LINE_COMPL82       =  9,       /* Digital Active - tcpwm[1].line_compl[82]:0 */
    P29_7_TCPWM1_TR_ONE_CNT_IN249   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[249]:0 */
    P29_7_TCPWM1_TR_ONE_CNT_IN247   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[247]:0 */

    /* P30.0 */
    P30_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P30_0_AMUXA                     =  4,       /* AMUXBUS A */
    P30_0_AMUXB                     =  5,       /* AMUXBUS B */
    P30_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P30_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P30_0_TCPWM1_LINE83             =  8,       /* Digital Active - tcpwm[1].line[83]:1 */
    P30_0_TCPWM1_LINE_COMPL83       =  9,       /* Digital Active - tcpwm[1].line_compl[83]:0 */
    P30_0_TCPWM1_TR_ONE_CNT_IN249   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[249]:1 */
    P30_0_TCPWM1_TR_ONE_CNT_IN250   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[250]:0 */
    P30_0_SCB9_UART_RTS             = 17,       /* Digital Active - scb[9].uart_rts:1 */
    P30_0_SCB9_I2C_SCL              = 18,       /* Digital Active - scb[9].i2c_scl:1 */
    P30_0_SCB9_SPI_CLK              = 19,       /* Digital Active - scb[9].spi_clk:1 */
    P30_0_PERI_TR_IO_INPUT34        = 26,       /* Digital Active - peri.tr_io_input[34]:0 */

    /* P30.1 */
    P30_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P30_1_AMUXA                     =  4,       /* AMUXBUS A */
    P30_1_AMUXB                     =  5,       /* AMUXBUS B */
    P30_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P30_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P30_1_TCPWM1_LINE82             =  8,       /* Digital Active - tcpwm[1].line[82]:1 */
    P30_1_TCPWM1_LINE_COMPL83       =  9,       /* Digital Active - tcpwm[1].line_compl[83]:1 */
    P30_1_TCPWM1_TR_ONE_CNT_IN246   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[246]:1 */
    P30_1_TCPWM1_TR_ONE_CNT_IN250   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[250]:1 */
    P30_1_SCB9_UART_CTS             = 17,       /* Digital Active - scb[9].uart_cts:1 */
    P30_1_SCB9_SPI_SELECT0          = 19,       /* Digital Active - scb[9].spi_select0:1 */
    P30_1_LIN0_LIN_RX16             = 20,       /* Digital Active - lin[0].lin_rx[16]:2 */
    P30_1_PERI_TR_IO_INPUT35        = 26,       /* Digital Active - peri.tr_io_input[35]:0 */

    /* P30.2 */
    P30_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P30_2_AMUXA                     =  4,       /* AMUXBUS A */
    P30_2_AMUXB                     =  5,       /* AMUXBUS B */
    P30_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P30_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P30_2_TCPWM1_LINE81             =  8,       /* Digital Active - tcpwm[1].line[81]:1 */
    P30_2_TCPWM1_LINE_COMPL82       =  9,       /* Digital Active - tcpwm[1].line_compl[82]:1 */
    P30_2_TCPWM1_TR_ONE_CNT_IN243   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[243]:1 */
    P30_2_TCPWM1_TR_ONE_CNT_IN247   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[247]:1 */
    P30_2_SCB9_SPI_SELECT1          = 19,       /* Digital Active - scb[9].spi_select1:1 */
    P30_2_LIN0_LIN_TX16             = 20,       /* Digital Active - lin[0].lin_tx[16]:2 */
    P30_2_CANFD1_TTCAN_TX3          = 21,       /* Digital Active - canfd[1].ttcan_tx[3]:2 */
    P30_2_PERI_TR_IO_INPUT36        = 26,       /* Digital Active - peri.tr_io_input[36]:0 */

    /* P30.3 */
    P30_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P30_3_AMUXA                     =  4,       /* AMUXBUS A */
    P30_3_AMUXB                     =  5,       /* AMUXBUS B */
    P30_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P30_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P30_3_TCPWM1_LINE80             =  8,       /* Digital Active - tcpwm[1].line[80]:1 */
    P30_3_TCPWM1_LINE_COMPL81       =  9,       /* Digital Active - tcpwm[1].line_compl[81]:1 */
    P30_3_TCPWM1_TR_ONE_CNT_IN240   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[240]:1 */
    P30_3_TCPWM1_TR_ONE_CNT_IN244   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[244]:1 */
    P30_3_SCB9_SPI_SELECT2          = 19,       /* Digital Active - scb[9].spi_select2:1 */
    P30_3_LIN0_LIN_EN16             = 20,       /* Digital Active - lin[0].lin_en[16]:2 */
    P30_3_CANFD1_TTCAN_RX3          = 21,       /* Digital Active - canfd[1].ttcan_rx[3]:2 */
    P30_3_PERI_TR_IO_INPUT37        = 26,       /* Digital Active - peri.tr_io_input[37]:0 */

    /* P31.0 */
    P31_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P31_0_AMUXA                     =  4,       /* AMUXBUS A */
    P31_0_AMUXB                     =  5,       /* AMUXBUS B */
    P31_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P31_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P31_0_TCPWM1_LINE79             =  8,       /* Digital Active - tcpwm[1].line[79]:1 */
    P31_0_TCPWM1_LINE_COMPL80       =  9,       /* Digital Active - tcpwm[1].line_compl[80]:1 */
    P31_0_TCPWM1_TR_ONE_CNT_IN237   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[237]:1 */
    P31_0_TCPWM1_TR_ONE_CNT_IN241   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[241]:1 */
    P31_0_LIN0_LIN_RX17             = 20,       /* Digital Active - lin[0].lin_rx[17]:1 */

    /* P31.1 */
    P31_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P31_1_AMUXA                     =  4,       /* AMUXBUS A */
    P31_1_AMUXB                     =  5,       /* AMUXBUS B */
    P31_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P31_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P31_1_TCPWM1_LINE78             =  8,       /* Digital Active - tcpwm[1].line[78]:1 */
    P31_1_TCPWM1_LINE_COMPL79       =  9,       /* Digital Active - tcpwm[1].line_compl[79]:1 */
    P31_1_TCPWM1_TR_ONE_CNT_IN234   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[234]:1 */
    P31_1_TCPWM1_TR_ONE_CNT_IN238   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[238]:1 */
    P31_1_LIN0_LIN_TX17             = 20,       /* Digital Active - lin[0].lin_tx[17]:1 */

    /* P31.2 */
    P31_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P31_2_AMUXA                     =  4,       /* AMUXBUS A */
    P31_2_AMUXB                     =  5,       /* AMUXBUS B */
    P31_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P31_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P31_2_TCPWM1_LINE77             =  8,       /* Digital Active - tcpwm[1].line[77]:1 */
    P31_2_TCPWM1_LINE_COMPL78       =  9,       /* Digital Active - tcpwm[1].line_compl[78]:1 */
    P31_2_TCPWM1_TR_ONE_CNT_IN231   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[231]:1 */
    P31_2_TCPWM1_TR_ONE_CNT_IN235   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[235]:1 */
    P31_2_LIN0_LIN_EN17             = 20,       /* Digital Active - lin[0].lin_en[17]:1 */

    /* P32.0 */
    P32_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_0_AMUXA                     =  4,       /* AMUXBUS A */
    P32_0_AMUXB                     =  5,       /* AMUXBUS B */
    P32_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_0_TCPWM1_LINE76             =  8,       /* Digital Active - tcpwm[1].line[76]:1 */
    P32_0_TCPWM1_LINE_COMPL77       =  9,       /* Digital Active - tcpwm[1].line_compl[77]:1 */
    P32_0_TCPWM1_TR_ONE_CNT_IN228   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[228]:1 */
    P32_0_TCPWM1_TR_ONE_CNT_IN232   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[232]:1 */
    P32_0_SCB10_UART_RX             = 17,       /* Digital Active - scb[10].uart_rx:1 */
    P32_0_SCB10_SPI_MISO            = 19,       /* Digital Active - scb[10].spi_miso:1 */
    P32_0_PERI_TR_IO_INPUT40        = 26,       /* Digital Active - peri.tr_io_input[40]:0 */

    /* P32.1 */
    P32_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_1_AMUXA                     =  4,       /* AMUXBUS A */
    P32_1_AMUXB                     =  5,       /* AMUXBUS B */
    P32_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_1_TCPWM1_LINE75             =  8,       /* Digital Active - tcpwm[1].line[75]:1 */
    P32_1_TCPWM1_LINE_COMPL76       =  9,       /* Digital Active - tcpwm[1].line_compl[76]:1 */
    P32_1_TCPWM1_TR_ONE_CNT_IN225   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[225]:1 */
    P32_1_TCPWM1_TR_ONE_CNT_IN229   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[229]:1 */
    P32_1_SCB10_UART_TX             = 17,       /* Digital Active - scb[10].uart_tx:1 */
    P32_1_SCB10_I2C_SDA             = 18,       /* Digital Active - scb[10].i2c_sda:1 */
    P32_1_SCB10_SPI_MOSI            = 19,       /* Digital Active - scb[10].spi_mosi:1 */
    P32_1_PERI_TR_IO_INPUT41        = 26,       /* Digital Active - peri.tr_io_input[41]:0 */

    /* P32.2 */
    P32_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_2_AMUXA                     =  4,       /* AMUXBUS A */
    P32_2_AMUXB                     =  5,       /* AMUXBUS B */
    P32_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_2_TCPWM1_LINE74             =  8,       /* Digital Active - tcpwm[1].line[74]:1 */
    P32_2_TCPWM1_LINE_COMPL75       =  9,       /* Digital Active - tcpwm[1].line_compl[75]:1 */
    P32_2_TCPWM1_TR_ONE_CNT_IN222   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[222]:1 */
    P32_2_TCPWM1_TR_ONE_CNT_IN226   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[226]:1 */
    P32_2_SCB10_UART_RTS            = 17,       /* Digital Active - scb[10].uart_rts:1 */
    P32_2_SCB10_I2C_SCL             = 18,       /* Digital Active - scb[10].i2c_scl:1 */
    P32_2_SCB10_SPI_CLK             = 19,       /* Digital Active - scb[10].spi_clk:1 */
    P32_2_LIN0_LIN_RX18             = 20,       /* Digital Active - lin[0].lin_rx[18]:1 */
    P32_2_PERI_TR_IO_INPUT42        = 26,       /* Digital Active - peri.tr_io_input[42]:0 */

    /* P32.3 */
    P32_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_3_AMUXA                     =  4,       /* AMUXBUS A */
    P32_3_AMUXB                     =  5,       /* AMUXBUS B */
    P32_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_3_TCPWM1_LINE73             =  8,       /* Digital Active - tcpwm[1].line[73]:1 */
    P32_3_TCPWM1_LINE_COMPL74       =  9,       /* Digital Active - tcpwm[1].line_compl[74]:1 */
    P32_3_TCPWM1_TR_ONE_CNT_IN219   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[219]:1 */
    P32_3_TCPWM1_TR_ONE_CNT_IN223   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[223]:1 */
    P32_3_SCB10_UART_CTS            = 17,       /* Digital Active - scb[10].uart_cts:1 */
    P32_3_SCB10_SPI_SELECT0         = 19,       /* Digital Active - scb[10].spi_select0:1 */
    P32_3_LIN0_LIN_TX18             = 20,       /* Digital Active - lin[0].lin_tx[18]:1 */
    P32_3_PERI_TR_IO_INPUT43        = 26,       /* Digital Active - peri.tr_io_input[43]:0 */

    /* P32.4 */
    P32_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_4_AMUXA                     =  4,       /* AMUXBUS A */
    P32_4_AMUXB                     =  5,       /* AMUXBUS B */
    P32_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_4_TCPWM1_LINE72             =  8,       /* Digital Active - tcpwm[1].line[72]:1 */
    P32_4_TCPWM1_LINE_COMPL73       =  9,       /* Digital Active - tcpwm[1].line_compl[73]:1 */
    P32_4_TCPWM1_TR_ONE_CNT_IN216   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[216]:1 */
    P32_4_TCPWM1_TR_ONE_CNT_IN220   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[220]:1 */
    P32_4_LIN0_LIN_RX10             = 18,       /* Digital Active - lin[0].lin_rx[10]:1 */
    P32_4_SCB10_SPI_SELECT1         = 19,       /* Digital Active - scb[10].spi_select1:1 */
    P32_4_LIN0_LIN_EN18             = 20,       /* Digital Active - lin[0].lin_en[18]:1 */
    P32_4_PERI_TR_IO_INPUT44        = 26,       /* Digital Active - peri.tr_io_input[44]:0 */

    /* P32.5 */
    P32_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_5_AMUXA                     =  4,       /* AMUXBUS A */
    P32_5_AMUXB                     =  5,       /* AMUXBUS B */
    P32_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_5_TCPWM1_LINE71             =  8,       /* Digital Active - tcpwm[1].line[71]:1 */
    P32_5_TCPWM1_LINE_COMPL72       =  9,       /* Digital Active - tcpwm[1].line_compl[72]:1 */
    P32_5_TCPWM1_TR_ONE_CNT_IN213   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[213]:1 */
    P32_5_TCPWM1_TR_ONE_CNT_IN217   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[217]:1 */
    P32_5_LIN0_LIN_TX10             = 18,       /* Digital Active - lin[0].lin_tx[10]:1 */
    P32_5_SCB10_SPI_SELECT2         = 19,       /* Digital Active - scb[10].spi_select2:1 */
    P32_5_LIN0_LIN_RX19             = 20,       /* Digital Active - lin[0].lin_rx[19]:1 */
    P32_5_PERI_TR_IO_INPUT45        = 26,       /* Digital Active - peri.tr_io_input[45]:0 */

    /* P32.6 */
    P32_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_6_AMUXA                     =  4,       /* AMUXBUS A */
    P32_6_AMUXB                     =  5,       /* AMUXBUS B */
    P32_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_6_TCPWM1_LINE70             =  8,       /* Digital Active - tcpwm[1].line[70]:1 */
    P32_6_TCPWM1_LINE_COMPL71       =  9,       /* Digital Active - tcpwm[1].line_compl[71]:1 */
    P32_6_TCPWM1_TR_ONE_CNT_IN210   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[210]:1 */
    P32_6_TCPWM1_TR_ONE_CNT_IN214   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[214]:1 */
    P32_6_LIN0_LIN_EN10             = 18,       /* Digital Active - lin[0].lin_en[10]:1 */
    P32_6_SCB10_SPI_SELECT3         = 19,       /* Digital Active - scb[10].spi_select3:1 */
    P32_6_LIN0_LIN_TX19             = 20,       /* Digital Active - lin[0].lin_tx[19]:1 */
    P32_6_CANFD1_TTCAN_TX4          = 21,       /* Digital Active - canfd[1].ttcan_tx[4]:1 */
    P32_6_PERI_TR_IO_INPUT46        = 26,       /* Digital Active - peri.tr_io_input[46]:0 */

    /* P32.7 */
    P32_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P32_7_AMUXA                     =  4,       /* AMUXBUS A */
    P32_7_AMUXB                     =  5,       /* AMUXBUS B */
    P32_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P32_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P32_7_TCPWM1_LINE69             =  8,       /* Digital Active - tcpwm[1].line[69]:1 */
    P32_7_TCPWM1_LINE_COMPL70       =  9,       /* Digital Active - tcpwm[1].line_compl[70]:1 */
    P32_7_TCPWM1_TR_ONE_CNT_IN207   = 10,       /* Digital Active - tcpwm[1].tr_one_cnt_in[207]:1 */
    P32_7_TCPWM1_TR_ONE_CNT_IN211   = 11,       /* Digital Active - tcpwm[1].tr_one_cnt_in[211]:1 */
    P32_7_LIN0_LIN_EN19             = 20,       /* Digital Active - lin[0].lin_en[19]:1 */
    P32_7_CANFD1_TTCAN_RX4          = 21,       /* Digital Active - canfd[1].ttcan_rx[4]:1 */
    P32_7_PERI_TR_IO_INPUT47        = 26,       /* Digital Active - peri.tr_io_input[47]:0 */

    /* P33.0 */
    P33_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_0_AMUXA                     =  4,       /* AMUXBUS A */
    P33_0_AMUXB                     =  5,       /* AMUXBUS B */
    P33_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_0_ETH0_REF_CLK              = 24,       /* Digital Active - eth[0].ref_clk:1 */

    /* P33.1 */
    P33_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_1_AMUXA                     =  4,       /* AMUXBUS A */
    P33_1_AMUXB                     =  5,       /* AMUXBUS B */
    P33_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_1_ETH0_TX_CTL               = 24,       /* Digital Active - eth[0].tx_ctl:1 */
    P33_1_ETH1_TX_ER                = 27,       /* Digital Active - eth[1].tx_er:0 */

    /* P33.2 */
    P33_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_2_AMUXA                     =  4,       /* AMUXBUS A */
    P33_2_AMUXB                     =  5,       /* AMUXBUS B */
    P33_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_2_ETH0_TX_CLK               = 24,       /* Digital Active - eth[0].tx_clk:1 */

    /* P33.3 */
    P33_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_3_AMUXA                     =  4,       /* AMUXBUS A */
    P33_3_AMUXB                     =  5,       /* AMUXBUS B */
    P33_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_3_ETH0_TXD0                 = 24,       /* Digital Active - eth[0].txd[0]:1 */
    P33_3_ETH1_TXD4                 = 27,       /* Digital Active - eth[1].txd[4]:0 */

    /* P33.4 */
    P33_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_4_AMUXA                     =  4,       /* AMUXBUS A */
    P33_4_AMUXB                     =  5,       /* AMUXBUS B */
    P33_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_4_ETH0_TXD1                 = 24,       /* Digital Active - eth[0].txd[1]:1 */
    P33_4_ETH1_TXD5                 = 27,       /* Digital Active - eth[1].txd[5]:0 */

    /* P33.5 */
    P33_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_5_AMUXA                     =  4,       /* AMUXBUS A */
    P33_5_AMUXB                     =  5,       /* AMUXBUS B */
    P33_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_5_ETH0_TXD2                 = 24,       /* Digital Active - eth[0].txd[2]:1 */
    P33_5_ETH1_TXD6                 = 27,       /* Digital Active - eth[1].txd[6]:0 */

    /* P33.6 */
    P33_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_6_AMUXA                     =  4,       /* AMUXBUS A */
    P33_6_AMUXB                     =  5,       /* AMUXBUS B */
    P33_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_6_ETH0_TXD3                 = 24,       /* Digital Active - eth[0].txd[3]:1 */
    P33_6_ETH1_TXD7                 = 27,       /* Digital Active - eth[1].txd[7]:0 */

    /* P33.7 */
    P33_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P33_7_AMUXA                     =  4,       /* AMUXBUS A */
    P33_7_AMUXB                     =  5,       /* AMUXBUS B */
    P33_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P33_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P33_7_ETH0_RXD0                 = 24,       /* Digital Active - eth[0].rxd[0]:1 */
    P33_7_ETH1_RXD4                 = 27,       /* Digital Active - eth[1].rxd[4]:0 */

    /* P34.0 */
    P34_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_0_AMUXA                     =  4,       /* AMUXBUS A */
    P34_0_AMUXB                     =  5,       /* AMUXBUS B */
    P34_0_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_0_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_0_ETH0_RXD1                 = 24,       /* Digital Active - eth[0].rxd[1]:1 */
    P34_0_ETH1_RXD5                 = 27,       /* Digital Active - eth[1].rxd[5]:0 */

    /* P34.1 */
    P34_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_1_AMUXA                     =  4,       /* AMUXBUS A */
    P34_1_AMUXB                     =  5,       /* AMUXBUS B */
    P34_1_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_1_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_1_ETH0_RXD2                 = 24,       /* Digital Active - eth[0].rxd[2]:1 */
    P34_1_ETH1_RXD6                 = 27,       /* Digital Active - eth[1].rxd[6]:0 */

    /* P34.2 */
    P34_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_2_AMUXA                     =  4,       /* AMUXBUS A */
    P34_2_AMUXB                     =  5,       /* AMUXBUS B */
    P34_2_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_2_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_2_ETH0_RXD3                 = 24,       /* Digital Active - eth[0].rxd[3]:1 */
    P34_2_ETH1_RXD7                 = 27,       /* Digital Active - eth[1].rxd[7]:0 */

    /* P34.3 */
    P34_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_3_AMUXA                     =  4,       /* AMUXBUS A */
    P34_3_AMUXB                     =  5,       /* AMUXBUS B */
    P34_3_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_3_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_3_ETH0_RX_CTL               = 24,       /* Digital Active - eth[0].rx_ctl:1 */
    P34_3_ETH1_RX_ER                = 27,       /* Digital Active - eth[1].rx_er:0 */

    /* P34.4 */
    P34_4_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_4_AMUXA                     =  4,       /* AMUXBUS A */
    P34_4_AMUXB                     =  5,       /* AMUXBUS B */
    P34_4_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_4_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_4_ETH0_RX_CLK               = 24,       /* Digital Active - eth[0].rx_clk:1 */

    /* P34.5 */
    P34_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_5_AMUXA                     =  4,       /* AMUXBUS A */
    P34_5_AMUXB                     =  5,       /* AMUXBUS B */
    P34_5_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_5_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_5_ETH0_MDIO                 = 24,       /* Digital Active - eth[0].mdio:1 */

    /* P34.6 */
    P34_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_6_AMUXA                     =  4,       /* AMUXBUS A */
    P34_6_AMUXB                     =  5,       /* AMUXBUS B */
    P34_6_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_6_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_6_ETH0_MDC                  = 24,       /* Digital Active - eth[0].mdc:1 */

    /* P34.7 */
    P34_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P34_7_AMUXA                     =  4,       /* AMUXBUS A */
    P34_7_AMUXB                     =  5,       /* AMUXBUS B */
    P34_7_AMUXA_DSI                 =  6,       /* Analog mux bus A, DSI control */
    P34_7_AMUXB_DSI                 =  7,       /* Analog mux bus B, DSI control */
    P34_7_ETH0_ETH_TSU_TIMER_CMP_VAL = 24,      /* Digital Active - eth[0].eth_tsu_timer_cmp_val:1 */
    P34_7_SRSS_IO_CLK_HF5           = 25        /* Digital Active - srss.io_clk_hf[5]:0 */
} en_hsiom_sel_t;

#endif /* _GPIO_CYT6BJ_320_BGA_H_ */
