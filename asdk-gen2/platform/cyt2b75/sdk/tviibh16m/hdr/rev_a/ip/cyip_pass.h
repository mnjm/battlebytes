...
/**
  * \brief Test control bits (PASS_TEST_CTL)
  */
typedef struct stc_PASS_TEST_CTL_field {
  uint32_t                         u1TS_CAL_CUR_IN:1;
  uint32_t                         :1;
  uint32_t                         u1TS_CAL_VB_OUT:1;
  uint32_t                         u1TS_CAL_VE_OUT:1;
  uint32_t                         u1TS_CAL_DIODE_EN:1;
  uint32_t                         u1TS_CAL_DIODE_PNP_EN:1;
  uint32_t                         u1TS_CAL_VI_SEL:1;
  uint32_t                         :1;
  uint32_t                         u2TS_CAL_CUR_SEL:2;
  uint32_t                         :2;
  uint32_t                         u1TS_CAL_SPARE:1;
  uint32_t                         :19;
} stc_PASS_TEST_CTL_field_t;

typedef union un_PASS_TEST_CTL {
  uint32_t                         u32Register;
  stc_PASS_TEST_CTL_field_t        stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_PASS_TEST_CTL_t;
...
typedef struct stc_PASS_EPASS_MMIO {
  ...
  un_PASS_TEST_CTL_t               unTEST_CTL;         /*!< 0x00000080 Test control bits */
  uint32_t                         au32Reserved3[991];
