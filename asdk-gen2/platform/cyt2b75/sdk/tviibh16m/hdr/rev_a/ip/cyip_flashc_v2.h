...
/**
  * \brief CM7 #2 interface status (FLASHC_CM7_2_STATUS)
  */
typedef struct stc_FLASHC_CM7_2_STATUS_field {
  uint32_t                         u1MAIN_INTERNAL_ERR:1;
  uint32_t                         u1WORK_INTERNAL_ERR:1;
  uint32_t                         :30;
} stc_FLASHC_CM7_2_STATUS_field_t;

typedef union un_FLASHC_CM7_2_STATUS {
  uint32_t                         u32Register;
  stc_FLASHC_CM7_2_STATUS_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM7_2_STATUS_t;

/**
  * \brief CM7 #3 interface status (FLASHC_CM7_3_STATUS)
  */
typedef struct stc_FLASHC_CM7_3_STATUS_field {
  uint32_t                         u1MAIN_INTERNAL_ERR:1;
  uint32_t                         u1WORK_INTERNAL_ERR:1;
  uint32_t                         :30;
} stc_FLASHC_CM7_3_STATUS_field_t;

typedef union un_FLASHC_CM7_3_STATUS {
  uint32_t                         u32Register;
  stc_FLASHC_CM7_3_STATUS_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_FLASHC_CM7_3_STATUS_t;
...
/**
  * \brief Flash Macro Registers (FLASHC)
  */
typedef struct stc_FLASHC {
  ...
  un_FLASHC_CM7_2_STATUS_t         unCM7_2_STATUS;     /*!< 0x00000564 CM7 #2 interface status */
  un_FLASHC_CM7_3_STATUS_t         unCM7_3_STATUS;     /*!< 0x00000568 CM7 #3 interface status */
...
/* FLASHC.CM7_2_STATUS */
#define FLASHC_CM7_2_STATUS_MAIN_INTERNAL_ERR_Pos 0UL
#define FLASHC_CM7_2_STATUS_MAIN_INTERNAL_ERR_Msk 0x1UL
#define FLASHC_CM7_2_STATUS_WORK_INTERNAL_ERR_Pos 1UL
#define FLASHC_CM7_2_STATUS_WORK_INTERNAL_ERR_Msk 0x2UL
/* FLASHC.CM7_3_STATUS */
#define FLASHC_CM7_3_STATUS_MAIN_INTERNAL_ERR_Pos 0UL
#define FLASHC_CM7_3_STATUS_MAIN_INTERNAL_ERR_Msk 0x1UL
#define FLASHC_CM7_3_STATUS_WORK_INTERNAL_ERR_Pos 1UL
#define FLASHC_CM7_3_STATUS_WORK_INTERNAL_ERR_Msk 0x2UL
