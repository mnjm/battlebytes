...
typedef struct stc_CPUSS_CM7_0_STATUS_field {
  ...
  uint32_t                         :3;
  uint32_t                         u1TCMC_CM7_2_MS:1;
  uint32_t                         u1TCMC_CM7_3_MS:1;
  uint32_t                         :14;
...
/**
  * \brief CM7 2 status (CPUSS_CM7_2_STATUS)
  */
typedef struct stc_CPUSS_CM7_2_STATUS_field {
  uint32_t                         u1SLEEPING:1;
  uint32_t                         u1SLEEPDEEP:1;
  uint32_t                         :2;
  uint32_t                         u1PWR_DONE:1;
  ...
  uint32_t                         u1TCMC_CM7_3_MS:1;
  uint32_t                         :14;
} stc_CPUSS_CM7_2_STATUS_field_t;

typedef union un_CPUSS_CM7_2_STATUS {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_STATUS_field_t   stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_STATUS_t;

/**
  * \brief Fast 2 clock control (CPUSS_FAST_2_CLOCK_CTL)
  */
typedef struct stc_CPUSS_FAST_2_CLOCK_CTL_field {
  uint32_t                         :3;
  uint32_t                         u5FRAC_DIV:5;
  uint32_t                         u8INT_DIV:8;
  uint32_t                         :16;
} stc_CPUSS_FAST_2_CLOCK_CTL_field_t;

typedef union un_CPUSS_FAST_2_CLOCK_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_FAST_2_CLOCK_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_FAST_2_CLOCK_CTL_t;

/**
  * \brief CM7 2 control (CPUSS_CM7_2_CTL)
  */
typedef struct stc_CPUSS_CM7_2_CTL_field {
  uint32_t                         u4PPB_LOCK:4;
  uint32_t                         u1CPU_WAIT:1;
  uint32_t                         :3;
  uint32_t                         u2INIT_TCM_EN:2;
  ...
  uint32_t                         :2;
  uint32_t                         u1IDC_MASK:1;
} stc_CPUSS_CM7_2_CTL_field_t;

typedef union un_CPUSS_CM7_2_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_CTL_field_t      stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_CTL_t;

/**
  * \brief CM7 2 interrupt status (CPUSS_CM7_2_INT_STATUS)
  */
typedef struct stc_CPUSS_CM7_2_INT_STATUS_field {
  uint32_t                         u10SYSTEM_INT_IDX:10;
  uint32_t                         :21;
  uint32_t                         u1SYSTEM_INT_VALID:1;
} stc_CPUSS_CM7_2_INT_STATUS_field_t;

typedef union un_CPUSS_CM7_2_INT_STATUS {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_INT_STATUS_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_INT_STATUS_t;

/**
  * \brief CM7 2 vector table base (CPUSS_CM7_2_VECTOR_TABLE_BASE)
  */
typedef struct stc_CPUSS_CM7_2_VECTOR_TABLE_BASE_field {
  uint32_t                         :7;
  uint32_t                         u25ADDR25:25;
} stc_CPUSS_CM7_2_VECTOR_TABLE_BASE_field_t;

typedef union un_CPUSS_CM7_2_VECTOR_TABLE_BASE {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_VECTOR_TABLE_BASE_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_VECTOR_TABLE_BASE_t;

/**
  * \brief CM7 2 NMI control (CPUSS_CM7_2_NMI_CTL)
  */
typedef struct stc_CPUSS_CM7_2_NMI_CTL_field {
  uint32_t                         u10SYSTEM_INT_IDX:10;
  uint32_t                         :22;
} stc_CPUSS_CM7_2_NMI_CTL_field_t;

typedef union un_CPUSS_CM7_2_NMI_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_NMI_CTL_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_NMI_CTL_t;

/**
  * \brief CM7 3 status (CPUSS_CM7_3_STATUS)
  */
typedef struct stc_CPUSS_CM7_3_STATUS_field {
  uint32_t                         u1SLEEPING:1;
  uint32_t                         u1SLEEPDEEP:1;
  uint32_t                         :2;
  uint32_t                         u1PWR_DONE:1;
  ...
  uint32_t                         u1TCMC_CM7_2_MS:1;
  uint32_t                         :15;
} stc_CPUSS_CM7_3_STATUS_field_t;

typedef union un_CPUSS_CM7_3_STATUS {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_STATUS_field_t   stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_STATUS_t;

/**
  * \brief Fast 3 clock control (CPUSS_FAST_3_CLOCK_CTL)
  */
typedef struct stc_CPUSS_FAST_3_CLOCK_CTL_field {
  uint32_t                         :3;
  uint32_t                         u5FRAC_DIV:5;
  uint32_t                         u8INT_DIV:8;
  uint32_t                         :16;
} stc_CPUSS_FAST_3_CLOCK_CTL_field_t;

typedef union un_CPUSS_FAST_3_CLOCK_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_FAST_3_CLOCK_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_FAST_3_CLOCK_CTL_t;

/**
  * \brief CM7 3 control (CPUSS_CM7_3_CTL)
  */
typedef struct stc_CPUSS_CM7_3_CTL_field {
  uint32_t                         u4PPB_LOCK:4;
  uint32_t                         u1CPU_WAIT:1;
  uint32_t                         :3;
  uint32_t                         u2INIT_TCM_EN:2;
  ...
  uint32_t                         :2;
  uint32_t                         u1IDC_MASK:1;
} stc_CPUSS_CM7_3_CTL_field_t;

typedef union un_CPUSS_CM7_3_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_CTL_field_t      stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_CTL_t;

/**
  * \brief CM7 3 interrupt status (CPUSS_CM7_3_INT_STATUS)
  */
typedef struct stc_CPUSS_CM7_3_INT_STATUS_field {
  uint32_t                         u10SYSTEM_INT_IDX:10;
  uint32_t                         :21;
  uint32_t                         u1SYSTEM_INT_VALID:1;
} stc_CPUSS_CM7_3_INT_STATUS_field_t;

typedef union un_CPUSS_CM7_3_INT_STATUS {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_INT_STATUS_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_INT_STATUS_t;

/**
  * \brief CM7 3 vector table base (CPUSS_CM7_3_VECTOR_TABLE_BASE)
  */
typedef struct stc_CPUSS_CM7_3_VECTOR_TABLE_BASE_field {
  uint32_t                         :7;
  uint32_t                         u25ADDR25:25;
} stc_CPUSS_CM7_3_VECTOR_TABLE_BASE_field_t;

typedef union un_CPUSS_CM7_3_VECTOR_TABLE_BASE {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_VECTOR_TABLE_BASE_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_VECTOR_TABLE_BASE_t;

/**
  * \brief CM7 3 NMI control (CPUSS_CM7_3_NMI_CTL)
  */
typedef struct stc_CPUSS_CM7_3_NMI_CTL_field {
  uint32_t                         u10SYSTEM_INT_IDX:10;
  uint32_t                         :22;
} stc_CPUSS_CM7_3_NMI_CTL_field_t;

typedef union un_CPUSS_CM7_3_NMI_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_NMI_CTL_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_NMI_CTL_t;
...
/**
  * \brief CM7 2 power control (CPUSS_CM7_2_PWR_CTL)
  */
typedef struct stc_CPUSS_CM7_2_PWR_CTL_field {
  uint32_t                         u2PWR_MODE:2;
  uint32_t                         :14;
  uint32_t                         u16VECTKEYSTAT:16;
} stc_CPUSS_CM7_2_PWR_CTL_field_t;

typedef union un_CPUSS_CM7_2_PWR_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_PWR_CTL_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_PWR_CTL_t;

/**
  * \brief CM7 2 power delay control (CPUSS_CM7_2_PWR_DELAY_CTL)
  */
typedef struct stc_CPUSS_CM7_2_PWR_DELAY_CTL_field {
  uint32_t                         u10UP:10;
  uint32_t                         :22;
} stc_CPUSS_CM7_2_PWR_DELAY_CTL_field_t;

typedef union un_CPUSS_CM7_2_PWR_DELAY_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_PWR_DELAY_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_PWR_DELAY_CTL_t;

/**
  * \brief CM7 3 power control (CPUSS_CM7_3_PWR_CTL)
  */
typedef struct stc_CPUSS_CM7_3_PWR_CTL_field {
  uint32_t                         u2PWR_MODE:2;
  uint32_t                         :14;
  uint32_t                         u16VECTKEYSTAT:16;
} stc_CPUSS_CM7_3_PWR_CTL_field_t;

typedef union un_CPUSS_CM7_3_PWR_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_PWR_CTL_field_t  stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_PWR_CTL_t;

/**
  * \brief CM7 3 power delay control (CPUSS_CM7_3_PWR_DELAY_CTL)
  */
typedef struct stc_CPUSS_CM7_3_PWR_DELAY_CTL_field {
  uint32_t                         u10UP:10;
  uint32_t                         :22;
} stc_CPUSS_CM7_3_PWR_DELAY_CTL_field_t;

typedef union un_CPUSS_CM7_3_PWR_DELAY_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_PWR_DELAY_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_PWR_DELAY_CTL_t;
...
/**
  * \brief CM7 2 system interrupt control (CPUSS_CM7_2_SYSTEM_INT_CTL)
  */
typedef struct stc_CPUSS_CM7_2_SYSTEM_INT_CTL_field {
  uint32_t                         u4CPU_INT_IDX:4;
  uint32_t                         :27;
  uint32_t                         u1CPU_INT_VALID:1;
} stc_CPUSS_CM7_2_SYSTEM_INT_CTL_field_t;

typedef union un_CPUSS_CM7_2_SYSTEM_INT_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_2_SYSTEM_INT_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_2_SYSTEM_INT_CTL_t;

/**
  * \brief CM7 3 system interrupt control (CPUSS_CM7_3_SYSTEM_INT_CTL)
  */
typedef struct stc_CPUSS_CM7_3_SYSTEM_INT_CTL_field {
  uint32_t                         u4CPU_INT_IDX:4;
  uint32_t                         :27;
  uint32_t                         u1CPU_INT_VALID:1;
} stc_CPUSS_CM7_3_SYSTEM_INT_CTL_field_t;

typedef union un_CPUSS_CM7_3_SYSTEM_INT_CTL {
  uint32_t                         u32Register;
  stc_CPUSS_CM7_3_SYSTEM_INT_CTL_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_CPUSS_CM7_3_SYSTEM_INT_CTL_t;
...
typedef struct stc_CPUSS {
  ...
  uint32_t                         au32Reserved9[109];
  un_CPUSS_CM7_2_STATUS_t          unCM7_2_STATUS;     /*!< 0x00000804 CM7 2 status */
  un_CPUSS_FAST_2_CLOCK_CTL_t      unFAST_2_CLOCK_CTL; /*!< 0x00000808 Fast 2 clock control */
  un_CPUSS_CM7_2_CTL_t             unCM7_2_CTL;        /*!< 0x0000080C CM7 2 control */
  uint32_t                         au32Reserved10[60];
  un_CPUSS_CM7_2_INT_STATUS_t      unCM7_2_INT_STATUS[16]; /*!< 0x00000900 CM7 2 interrupt status */
  uint32_t                         au32Reserved11[48];
  un_CPUSS_CM7_2_VECTOR_TABLE_BASE_t unCM7_2_VECTOR_TABLE_BASE; /*!< 0x00000A00 CM7 2 vector table base */
  uint32_t                         au32Reserved12[15];
  un_CPUSS_CM7_2_NMI_CTL_t         unCM7_2_NMI_CTL[4]; /*!< 0x00000A40 CM7 2 NMI control */
  uint32_t                         au32Reserved13[109];
  un_CPUSS_CM7_3_STATUS_t          unCM7_3_STATUS;     /*!< 0x00000C04 CM7 3 status */
  un_CPUSS_FAST_3_CLOCK_CTL_t      unFAST_3_CLOCK_CTL; /*!< 0x00000C08 Fast 3 clock control */
  un_CPUSS_CM7_3_CTL_t             unCM7_3_CTL;        /*!< 0x00000C0C CM7 3 control */
  uint32_t                         au32Reserved14[60];
  un_CPUSS_CM7_3_INT_STATUS_t      unCM7_3_INT_STATUS[16]; /*!< 0x00000D00 CM7 3 interrupt status */
  uint32_t                         au32Reserved15[48];
  un_CPUSS_CM7_3_VECTOR_TABLE_BASE_t unCM7_3_VECTOR_TABLE_BASE; /*!< 0x00000E00 CM7 3 vector table base */
  uint32_t                         au32Reserved16[15];
  un_CPUSS_CM7_3_NMI_CTL_t         unCM7_3_NMI_CTL[4]; /*!< 0x00000E40 CM7 3 NMI control */
  uint32_t                         au32Reserved17[108];
  ...
  un_CPUSS_CM7_2_PWR_CTL_t         unCM7_2_PWR_CTL;    /*!< 0x00001220 CM7 2 power control */
  un_CPUSS_CM7_2_PWR_DELAY_CTL_t   unCM7_2_PWR_DELAY_CTL; /*!< 0x00001224 CM7 2 power delay control */
  uint32_t                         au32Reserved23[2];
  un_CPUSS_CM7_3_PWR_CTL_t         unCM7_3_PWR_CTL;    /*!< 0x00001230 CM7 3 power control */
  un_CPUSS_CM7_3_PWR_DELAY_CTL_t   unCM7_3_PWR_DELAY_CTL; /*!< 0x00001234 CM7 3 power delay control */
  uint32_t                         au32Reserved24[50];
  un_CPUSS_RAM0_CTL0_t             unRAM0_CTL0;        /*!< 0x00001300 RAM 0 control */
  un_CPUSS_RAM0_STATUS_t           unRAM0_STATUS;      /*!< 0x00001304 RAM 0 status */
  uint32_t                         au32Reserved25[14];
  ...
  uint32_t                         au32Reserved38[6076];
  un_CPUSS_CM0_SYSTEM_INT_CTL_t    unCM0_SYSTEM_INT_CTL[1023]; /*!< 0x00008000 CM0+ system interrupt control */
  uint32_t                         au32Reserved39[1025];
  un_CPUSS_CM7_0_SYSTEM_INT_CTL_t  unCM7_0_SYSTEM_INT_CTL[1023]; /*!< 0x0000A000 CM7 0 system interrupt control */
  uint32_t                         au32Reserved40[1025];
  un_CPUSS_CM7_1_SYSTEM_INT_CTL_t  unCM7_1_SYSTEM_INT_CTL[1023]; /*!< 0x0000C000 CM7 1 system interrupt control */
  uint32_t                         u32Reserved41;
  un_CPUSS_CM7_2_SYSTEM_INT_CTL_t  unCM7_2_SYSTEM_INT_CTL[1023]; /*!< 0x0000D000 CM7 2 system interrupt control */
  uint32_t                         u32Reserved42;
  un_CPUSS_CM7_3_SYSTEM_INT_CTL_t  unCM7_3_SYSTEM_INT_CTL[1023]; /*!< 0x0000E000 CM7 3 system interrupt control */
} stc_CPUSS_t;                                         /*!< Size = 61436 (0xEFFC) */
...
#define CPUSS_CM7_0_STATUS_TCMC_CM7_2_MS_Pos    16UL
#define CPUSS_CM7_0_STATUS_TCMC_CM7_2_MS_Msk    0x10000UL
#define CPUSS_CM7_0_STATUS_TCMC_CM7_3_MS_Pos    17UL
#define CPUSS_CM7_0_STATUS_TCMC_CM7_3_MS_Msk    0x20000UL
...
#define CPUSS_CM7_1_STATUS_TCMC_CM7_2_MS_Pos    16UL
#define CPUSS_CM7_1_STATUS_TCMC_CM7_2_MS_Msk    0x10000UL
#define CPUSS_CM7_1_STATUS_TCMC_CM7_3_MS_Pos    17UL
#define CPUSS_CM7_1_STATUS_TCMC_CM7_3_MS_Msk    0x20000UL
...
/* CPUSS.CM7_2_STATUS */
#define CPUSS_CM7_2_STATUS_SLEEPING_Pos         0UL
#define CPUSS_CM7_2_STATUS_SLEEPING_Msk         0x1UL
#define CPUSS_CM7_2_STATUS_SLEEPDEEP_Pos        1UL
#define CPUSS_CM7_2_STATUS_SLEEPDEEP_Msk        0x2UL
#define CPUSS_CM7_2_STATUS_PWR_DONE_Pos         4UL
#define CPUSS_CM7_2_STATUS_PWR_DONE_Msk         0x10UL
#define CPUSS_CM7_2_STATUS_TCMC_CM7_0_MS_Pos    8UL
#define CPUSS_CM7_2_STATUS_TCMC_CM7_0_MS_Msk    0x100UL
#define CPUSS_CM7_2_STATUS_TCMC_CM7_1_MS_Pos    9UL
#define CPUSS_CM7_2_STATUS_TCMC_CM7_1_MS_Msk    0x200UL
#define CPUSS_CM7_2_STATUS_TCMC_EXT_MS_2_TO_0_Pos 10UL
#define CPUSS_CM7_2_STATUS_TCMC_EXT_MS_2_TO_0_Msk 0x400UL
#define CPUSS_CM7_2_STATUS_TCMC_EXT_MS_3_Pos    11UL
#define CPUSS_CM7_2_STATUS_TCMC_EXT_MS_3_Msk    0x800UL
#define CPUSS_CM7_2_STATUS_TCMC_AHB_MS_Pos      12UL
#define CPUSS_CM7_2_STATUS_TCMC_AHB_MS_Msk      0x1000UL
#define CPUSS_CM7_2_STATUS_TCMC_CM7_3_MS_Pos    17UL
#define CPUSS_CM7_2_STATUS_TCMC_CM7_3_MS_Msk    0x20000UL
/* CPUSS.FAST_2_CLOCK_CTL */
#define CPUSS_FAST_2_CLOCK_CTL_FRAC_DIV_Pos     3UL
#define CPUSS_FAST_2_CLOCK_CTL_FRAC_DIV_Msk     0xF8UL
#define CPUSS_FAST_2_CLOCK_CTL_INT_DIV_Pos      8UL
#define CPUSS_FAST_2_CLOCK_CTL_INT_DIV_Msk      0xFF00UL
/* CPUSS.CM7_2_CTL */
#define CPUSS_CM7_2_CTL_PPB_LOCK_Pos            0UL
#define CPUSS_CM7_2_CTL_PPB_LOCK_Msk            0xFUL
#define CPUSS_CM7_2_CTL_CPU_WAIT_Pos            4UL
#define CPUSS_CM7_2_CTL_CPU_WAIT_Msk            0x10UL
#define CPUSS_CM7_2_CTL_INIT_TCM_EN_Pos         8UL
#define CPUSS_CM7_2_CTL_INIT_TCM_EN_Msk         0x300UL
#define CPUSS_CM7_2_CTL_INIT_RMW_EN_Pos         10UL
#define CPUSS_CM7_2_CTL_INIT_RMW_EN_Msk         0xC00UL
#define CPUSS_CM7_2_CTL_ITCM_ECC_EN_Pos         16UL
#define CPUSS_CM7_2_CTL_ITCM_ECC_EN_Msk         0x10000UL
#define CPUSS_CM7_2_CTL_ITCM_ECC_INJ_EN_Pos     17UL
#define CPUSS_CM7_2_CTL_ITCM_ECC_INJ_EN_Msk     0x20000UL
#define CPUSS_CM7_2_CTL_ITCM_READ_WS_Pos        18UL
#define CPUSS_CM7_2_CTL_ITCM_READ_WS_Msk        0x40000UL
#define CPUSS_CM7_2_CTL_ITCM_ECC_CHECK_DIS_Pos  19UL
#define CPUSS_CM7_2_CTL_ITCM_ECC_CHECK_DIS_Msk  0x80000UL
#define CPUSS_CM7_2_CTL_DTCM_ECC_EN_Pos         20UL
#define CPUSS_CM7_2_CTL_DTCM_ECC_EN_Msk         0x100000UL
#define CPUSS_CM7_2_CTL_DTCM_ECC_INJ_EN_Pos     21UL
#define CPUSS_CM7_2_CTL_DTCM_ECC_INJ_EN_Msk     0x200000UL
#define CPUSS_CM7_2_CTL_DTCM_READ_WS_Pos        22UL
#define CPUSS_CM7_2_CTL_DTCM_READ_WS_Msk        0x400000UL
#define CPUSS_CM7_2_CTL_TCMC_EN_Pos             23UL
#define CPUSS_CM7_2_CTL_TCMC_EN_Msk             0x800000UL
#define CPUSS_CM7_2_CTL_IOC_MASK_Pos            24UL
#define CPUSS_CM7_2_CTL_IOC_MASK_Msk            0x1000000UL
#define CPUSS_CM7_2_CTL_DZC_MASK_Pos            25UL
#define CPUSS_CM7_2_CTL_DZC_MASK_Msk            0x2000000UL
#define CPUSS_CM7_2_CTL_OFC_MASK_Pos            26UL
#define CPUSS_CM7_2_CTL_OFC_MASK_Msk            0x4000000UL
#define CPUSS_CM7_2_CTL_UFC_MASK_Pos            27UL
#define CPUSS_CM7_2_CTL_UFC_MASK_Msk            0x8000000UL
#define CPUSS_CM7_2_CTL_IXC_MASK_Pos            28UL
#define CPUSS_CM7_2_CTL_IXC_MASK_Msk            0x10000000UL
#define CPUSS_CM7_2_CTL_IDC_MASK_Pos            31UL
#define CPUSS_CM7_2_CTL_IDC_MASK_Msk            0x80000000UL
/* CPUSS.CM7_2_INT_STATUS */
#define CPUSS_CM7_2_INT_STATUS_SYSTEM_INT_IDX_Pos 0UL
#define CPUSS_CM7_2_INT_STATUS_SYSTEM_INT_IDX_Msk 0x3FFUL
#define CPUSS_CM7_2_INT_STATUS_SYSTEM_INT_VALID_Pos 31UL
#define CPUSS_CM7_2_INT_STATUS_SYSTEM_INT_VALID_Msk 0x80000000UL
/* CPUSS.CM7_2_VECTOR_TABLE_BASE */
#define CPUSS_CM7_2_VECTOR_TABLE_BASE_ADDR25_Pos 7UL
#define CPUSS_CM7_2_VECTOR_TABLE_BASE_ADDR25_Msk 0xFFFFFF80UL
/* CPUSS.CM7_2_NMI_CTL */
#define CPUSS_CM7_2_NMI_CTL_SYSTEM_INT_IDX_Pos  0UL
#define CPUSS_CM7_2_NMI_CTL_SYSTEM_INT_IDX_Msk  0x3FFUL
/* CPUSS.CM7_3_STATUS */
#define CPUSS_CM7_3_STATUS_SLEEPING_Pos         0UL
#define CPUSS_CM7_3_STATUS_SLEEPING_Msk         0x1UL
#define CPUSS_CM7_3_STATUS_SLEEPDEEP_Pos        1UL
#define CPUSS_CM7_3_STATUS_SLEEPDEEP_Msk        0x2UL
#define CPUSS_CM7_3_STATUS_PWR_DONE_Pos         4UL
#define CPUSS_CM7_3_STATUS_PWR_DONE_Msk         0x10UL
#define CPUSS_CM7_3_STATUS_TCMC_CM7_0_MS_Pos    8UL
#define CPUSS_CM7_3_STATUS_TCMC_CM7_0_MS_Msk    0x100UL
#define CPUSS_CM7_3_STATUS_TCMC_CM7_1_MS_Pos    9UL
#define CPUSS_CM7_3_STATUS_TCMC_CM7_1_MS_Msk    0x200UL
#define CPUSS_CM7_3_STATUS_TCMC_EXT_MS_2_TO_0_Pos 10UL
#define CPUSS_CM7_3_STATUS_TCMC_EXT_MS_2_TO_0_Msk 0x400UL
#define CPUSS_CM7_3_STATUS_TCMC_EXT_MS_3_Pos    11UL
#define CPUSS_CM7_3_STATUS_TCMC_EXT_MS_3_Msk    0x800UL
#define CPUSS_CM7_3_STATUS_TCMC_AHB_MS_Pos      12UL
#define CPUSS_CM7_3_STATUS_TCMC_AHB_MS_Msk      0x1000UL
#define CPUSS_CM7_3_STATUS_TCMC_CM7_2_MS_Pos    16UL
#define CPUSS_CM7_3_STATUS_TCMC_CM7_2_MS_Msk    0x10000UL
/* CPUSS.FAST_3_CLOCK_CTL */
#define CPUSS_FAST_3_CLOCK_CTL_FRAC_DIV_Pos     3UL
#define CPUSS_FAST_3_CLOCK_CTL_FRAC_DIV_Msk     0xF8UL
#define CPUSS_FAST_3_CLOCK_CTL_INT_DIV_Pos      8UL
#define CPUSS_FAST_3_CLOCK_CTL_INT_DIV_Msk      0xFF00UL
/* CPUSS.CM7_3_CTL */
#define CPUSS_CM7_3_CTL_PPB_LOCK_Pos            0UL
#define CPUSS_CM7_3_CTL_PPB_LOCK_Msk            0xFUL
#define CPUSS_CM7_3_CTL_CPU_WAIT_Pos            4UL
#define CPUSS_CM7_3_CTL_CPU_WAIT_Msk            0x10UL
#define CPUSS_CM7_3_CTL_INIT_TCM_EN_Pos         8UL
#define CPUSS_CM7_3_CTL_INIT_TCM_EN_Msk         0x300UL
#define CPUSS_CM7_3_CTL_INIT_RMW_EN_Pos         10UL
#define CPUSS_CM7_3_CTL_INIT_RMW_EN_Msk         0xC00UL
#define CPUSS_CM7_3_CTL_ITCM_ECC_EN_Pos         16UL
#define CPUSS_CM7_3_CTL_ITCM_ECC_EN_Msk         0x10000UL
#define CPUSS_CM7_3_CTL_ITCM_ECC_INJ_EN_Pos     17UL
#define CPUSS_CM7_3_CTL_ITCM_ECC_INJ_EN_Msk     0x20000UL
#define CPUSS_CM7_3_CTL_ITCM_READ_WS_Pos        18UL
#define CPUSS_CM7_3_CTL_ITCM_READ_WS_Msk        0x40000UL
#define CPUSS_CM7_3_CTL_ITCM_ECC_CHECK_DIS_Pos  19UL
#define CPUSS_CM7_3_CTL_ITCM_ECC_CHECK_DIS_Msk  0x80000UL
#define CPUSS_CM7_3_CTL_DTCM_ECC_EN_Pos         20UL
#define CPUSS_CM7_3_CTL_DTCM_ECC_EN_Msk         0x100000UL
#define CPUSS_CM7_3_CTL_DTCM_ECC_INJ_EN_Pos     21UL
#define CPUSS_CM7_3_CTL_DTCM_ECC_INJ_EN_Msk     0x200000UL
#define CPUSS_CM7_3_CTL_DTCM_READ_WS_Pos        22UL
#define CPUSS_CM7_3_CTL_DTCM_READ_WS_Msk        0x400000UL
#define CPUSS_CM7_3_CTL_TCMC_EN_Pos             23UL
#define CPUSS_CM7_3_CTL_TCMC_EN_Msk             0x800000UL
#define CPUSS_CM7_3_CTL_IOC_MASK_Pos            24UL
#define CPUSS_CM7_3_CTL_IOC_MASK_Msk            0x1000000UL
#define CPUSS_CM7_3_CTL_DZC_MASK_Pos            25UL
#define CPUSS_CM7_3_CTL_DZC_MASK_Msk            0x2000000UL
#define CPUSS_CM7_3_CTL_OFC_MASK_Pos            26UL
#define CPUSS_CM7_3_CTL_OFC_MASK_Msk            0x4000000UL
#define CPUSS_CM7_3_CTL_UFC_MASK_Pos            27UL
#define CPUSS_CM7_3_CTL_UFC_MASK_Msk            0x8000000UL
#define CPUSS_CM7_3_CTL_IXC_MASK_Pos            28UL
#define CPUSS_CM7_3_CTL_IXC_MASK_Msk            0x10000000UL
#define CPUSS_CM7_3_CTL_IDC_MASK_Pos            31UL
#define CPUSS_CM7_3_CTL_IDC_MASK_Msk            0x80000000UL
/* CPUSS.CM7_3_INT_STATUS */
#define CPUSS_CM7_3_INT_STATUS_SYSTEM_INT_IDX_Pos 0UL
#define CPUSS_CM7_3_INT_STATUS_SYSTEM_INT_IDX_Msk 0x3FFUL
#define CPUSS_CM7_3_INT_STATUS_SYSTEM_INT_VALID_Pos 31UL
#define CPUSS_CM7_3_INT_STATUS_SYSTEM_INT_VALID_Msk 0x80000000UL
/* CPUSS.CM7_3_VECTOR_TABLE_BASE */
#define CPUSS_CM7_3_VECTOR_TABLE_BASE_ADDR25_Pos 7UL
#define CPUSS_CM7_3_VECTOR_TABLE_BASE_ADDR25_Msk 0xFFFFFF80UL
/* CPUSS.CM7_3_NMI_CTL */
#define CPUSS_CM7_3_NMI_CTL_SYSTEM_INT_IDX_Pos  0UL
#define CPUSS_CM7_3_NMI_CTL_SYSTEM_INT_IDX_Msk  0x3FFUL
/* CPUSS.CM0_CTL */
...
/* CPUSS.CM7_2_PWR_CTL */
#define CPUSS_CM7_2_PWR_CTL_PWR_MODE_Pos        0UL
#define CPUSS_CM7_2_PWR_CTL_PWR_MODE_Msk        0x3UL
#define CPUSS_CM7_2_PWR_CTL_VECTKEYSTAT_Pos     16UL
#define CPUSS_CM7_2_PWR_CTL_VECTKEYSTAT_Msk     0xFFFF0000UL
/* CPUSS.CM7_2_PWR_DELAY_CTL */
#define CPUSS_CM7_2_PWR_DELAY_CTL_UP_Pos        0UL
#define CPUSS_CM7_2_PWR_DELAY_CTL_UP_Msk        0x3FFUL
/* CPUSS.CM7_3_PWR_CTL */
#define CPUSS_CM7_3_PWR_CTL_PWR_MODE_Pos        0UL
#define CPUSS_CM7_3_PWR_CTL_PWR_MODE_Msk        0x3UL
#define CPUSS_CM7_3_PWR_CTL_VECTKEYSTAT_Pos     16UL
#define CPUSS_CM7_3_PWR_CTL_VECTKEYSTAT_Msk     0xFFFF0000UL
/* CPUSS.CM7_3_PWR_DELAY_CTL */
#define CPUSS_CM7_3_PWR_DELAY_CTL_UP_Pos        0UL
#define CPUSS_CM7_3_PWR_DELAY_CTL_UP_Msk        0x3FFUL
/* CPUSS.RAM0_CTL0 */
...
/* CPUSS.CM7_2_SYSTEM_INT_CTL */
#define CPUSS_CM7_2_SYSTEM_INT_CTL_CPU_INT_IDX_Pos 0UL
#define CPUSS_CM7_2_SYSTEM_INT_CTL_CPU_INT_IDX_Msk 0xFUL
#define CPUSS_CM7_2_SYSTEM_INT_CTL_CPU_INT_VALID_Pos 31UL
#define CPUSS_CM7_2_SYSTEM_INT_CTL_CPU_INT_VALID_Msk 0x80000000UL
/* CPUSS.CM7_3_SYSTEM_INT_CTL */
#define CPUSS_CM7_3_SYSTEM_INT_CTL_CPU_INT_IDX_Pos 0UL
#define CPUSS_CM7_3_SYSTEM_INT_CTL_CPU_INT_IDX_Msk 0xFUL
#define CPUSS_CM7_3_SYSTEM_INT_CTL_CPU_INT_VALID_Pos 31UL
#define CPUSS_CM7_3_SYSTEM_INT_CTL_CPU_INT_VALID_Msk 0x80000000UL
