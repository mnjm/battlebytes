...
/**
  * \brief Marker for Security Updates (SFLASH_TOC2_SECURITY_UPDATES_MARKER)
  */
typedef struct stc_SFLASH_TOC2_SECURITY_UPDATES_MARKER_field {
  uint32_t                         u32DATA32:32;
} stc_SFLASH_TOC2_SECURITY_UPDATES_MARKER_field_t;

typedef union un_SFLASH_TOC2_SECURITY_UPDATES_MARKER {
  uint32_t                         u32Register;
  stc_SFLASH_TOC2_SECURITY_UPDATES_MARKER_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_SFLASH_TOC2_SECURITY_UPDATES_MARKER_t;
...
typedef struct stc_SFLASH {
  ...
  un_SFLASH_TOC2_SECOND_CMX_2_USER_APP_ADDR_t unTOC2_SECOND_CMX_2_USER_APP_ADDR; /*!< 0x00007C28 Address of Second CM4 or CM7 core2 User Application
                                                                                Object */
  uint32_t                         au32Reserved13[52];
  un_SFLASH_TOC2_SECURITY_UPDATES_MARKER_t unTOC2_SECURITY_UPDATES_MARKER; /*!< 0x00007CFC Marker for Security Updates */
