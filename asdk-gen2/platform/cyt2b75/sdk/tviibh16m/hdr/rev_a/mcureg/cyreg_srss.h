...
/**
  * \brief MCWDT Configuration for Subcounter 0 and 1 (MCWDT_CTR0)
  */
#define CYREG_MCWDT3_CTR0_CTL           ((volatile un_MCWDT_CTR_CTL_t*) 0x40268300UL)
#define CYREG_MCWDT3_CTR0_LOWER_LIMIT   ((volatile un_MCWDT_CTR_LOWER_LIMIT_t*) 0x40268304UL)
#define CYREG_MCWDT3_CTR0_UPPER_LIMIT   ((volatile un_MCWDT_CTR_UPPER_LIMIT_t*) 0x40268308UL)
#define CYREG_MCWDT3_CTR0_WARN_LIMIT    ((volatile un_MCWDT_CTR_WARN_LIMIT_t*) 0x4026830CUL)
#define CYREG_MCWDT3_CTR0_CONFIG        ((volatile un_MCWDT_CTR_CONFIG_t*) 0x40268310UL)
#define CYREG_MCWDT3_CTR0_CNT           ((volatile un_MCWDT_CTR_CNT_t*) 0x40268314UL)

/**
  * \brief MCWDT Configuration for Subcounter 0 and 1 (MCWDT_CTR1)
  */
#define CYREG_MCWDT3_CTR1_CTL           ((volatile un_MCWDT_CTR_CTL_t*) 0x40268320UL)
#define CYREG_MCWDT3_CTR1_LOWER_LIMIT   ((volatile un_MCWDT_CTR_LOWER_LIMIT_t*) 0x40268324UL)
#define CYREG_MCWDT3_CTR1_UPPER_LIMIT   ((volatile un_MCWDT_CTR_UPPER_LIMIT_t*) 0x40268328UL)
#define CYREG_MCWDT3_CTR1_WARN_LIMIT    ((volatile un_MCWDT_CTR_WARN_LIMIT_t*) 0x4026832CUL)
#define CYREG_MCWDT3_CTR1_CONFIG        ((volatile un_MCWDT_CTR_CONFIG_t*) 0x40268330UL)
#define CYREG_MCWDT3_CTR1_CNT           ((volatile un_MCWDT_CTR_CNT_t*) 0x40268334UL)

/**
  * \brief Multi-Counter Watchdog Timer (MCWDT3)
  */
#define CYREG_MCWDT3_CPU_SELECT         ((volatile un_MCWDT_CPU_SELECT_t*) 0x40268340UL)
#define CYREG_MCWDT3_CTR2_CTL           ((volatile un_MCWDT_CTR2_CTL_t*) 0x40268380UL)
#define CYREG_MCWDT3_CTR2_CONFIG        ((volatile un_MCWDT_CTR2_CONFIG_t*) 0x40268384UL)
#define CYREG_MCWDT3_CTR2_CNT           ((volatile un_MCWDT_CTR2_CNT_t*) 0x40268388UL)
#define CYREG_MCWDT3_LOCK               ((volatile un_MCWDT_LOCK_t*) 0x40268390UL)
#define CYREG_MCWDT3_SERVICE            ((volatile un_MCWDT_SERVICE_t*) 0x40268394UL)
#define CYREG_MCWDT3_INTR               ((volatile un_MCWDT_INTR_t*) 0x402683A0UL)
#define CYREG_MCWDT3_INTR_SET           ((volatile un_MCWDT_INTR_SET_t*) 0x402683A4UL)
#define CYREG_MCWDT3_INTR_MASK          ((volatile un_MCWDT_INTR_MASK_t*) 0x402683A8UL)
#define CYREG_MCWDT3_INTR_MASKED        ((volatile un_MCWDT_INTR_MASKED_t*) 0x402683ACUL)
...
/**
  * \brief SRSS Core Registers (ver3p3) (SRSS0)
  */
...
#define CYREG_PWR_HIB_WAKE_CTL          ((volatile un_PWR_HIB_WAKE_CTL_t*) 0x402610E0UL)
#define CYREG_PWR_HIB_WAKE_CTL2         ((volatile un_PWR_HIB_WAKE_CTL2_t*) 0x402610E4UL)
#define CYREG_PWR_HIB_WAKE_CAUSE        ((volatile un_PWR_HIB_WAKE_CAUSE_t*) 0x402610ECUL)
