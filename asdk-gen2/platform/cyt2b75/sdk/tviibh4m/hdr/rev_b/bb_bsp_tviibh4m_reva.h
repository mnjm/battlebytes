...
#elif (CY_USE_PSVP == 0) && ( defined(CYT3BBBCEE) || defined(CYT3BBBCES) )
	
//rmkn: Below are temporarily added for compilation purpose. TBD
...
#elif (CY_USE_PSVP == 0) && ( defined(CYT3BB8CEE) || defined(CYT3BB8CES) )
