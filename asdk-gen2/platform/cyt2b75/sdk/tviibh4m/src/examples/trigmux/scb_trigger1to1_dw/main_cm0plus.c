...
// scb[1].tr_rx_req => SCB_RX_TO_PDMA1[1] (TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA11) => cpuss.dw1_tr_in[19] => DW_CHANNEL = 19
// scb[3].tr_rx_req => SCB_RX_TO_PDMA1[3] (TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA13) => cpuss.dw1_tr_in[23] => DW_CHANNEL = 23

/* for DW */
#define BUFFER_SIZE             36  // This needs that BUFFER_SIZE can be divisible by E_UART_RECV_THRESHOLD

#if (TEST_SCB == TEST_SCB1)
    #define DW_CHANNEL                                  19 // scb[1].tr_rx_req
    #define TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA              TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA11
    #define TRIG_IN_1TO1_2_SCB_RX_TO_PDMA               TRIG_IN_1TO1_2_SCB_RX_TO_PDMA11
    #define cpuss_interrupts_dw1                        cpuss_interrupts_dw1_19_IRQn
#else // (TEST_SCB == TEST_SCB3)
    #define DW_CHANNEL                                  23 // scb[3].tr_rx_req
    #define TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA              TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA13
    #define TRIG_IN_1TO1_2_SCB_RX_TO_PDMA               TRIG_IN_1TO1_2_SCB_RX_TO_PDMA13
