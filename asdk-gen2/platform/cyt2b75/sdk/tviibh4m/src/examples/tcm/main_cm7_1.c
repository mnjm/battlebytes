...
// DTCM Access Size
    ...
    #define DTCM_RAM_ACCESS_SIZE    16383
#else // (DTCM_RAM_ACCESS == DTCM_RAM_ACCESS_WORD)
    #define DTCM_RAM_ACCESS_SIZE    4095
#endif
...
int main(void)
{
    ...
    temp = CPUSS->unCM7_1_CTL.stcField.u4PPB_LOCK;
    temp = temp & 0xC;
    CPUSS->unCM7_1_CTL.stcField.u4PPB_LOCK = temp;
    
    // Enable DTCM
    Cy_Cpu_TcmEnable(CY_CPU_CM7_1, CY_CPU_DTCM);
    // Enable DTCM RMW
    Cy_Cpu_TcmReadModifyWriteEnable(CY_CPU_CM7_1, CY_CPU_DTCM);    
