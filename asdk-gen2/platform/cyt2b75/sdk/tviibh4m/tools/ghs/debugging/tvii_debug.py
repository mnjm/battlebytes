...
#
# History:
# 2019-12-09 0.01 CHEY  Initial version for TVII-B-H-4M series (based on v0.22 of TVII-B-H-8M tvii_debug.py)
# 2020-01-16 0.02 CHEY  Added API for executing DAP system calls -> added output of current life-cycle state
# 2020-01-31 0.03 CHEY  Changed trace setup and some related parts (see Readme.txt of SDL for version/tool information)
# 2020-02-07 0.04 CHEY  Adding print of SFLASH data revision, split printing of target info in 2 lines now
# 2020-07-10 0.05 CHEY  - Improve IsTpiuTraceProbe() for certain cases
...
# 2020-10-06 0.06 CHEY  Clear some control bits in DHCSR register before triggering SYSRESET to fix problem
# 2020-10-20 0.07 CHEY  Check for "Could not detect flash device" message and print potential solution
# 2021-09-22 0.08 CHEY  Add support for SFLASH user row programming
# ***********************************************************************************************/#
...
CPU_BOARD_TYPE = 'CPU_BOARD_176_QFP'  # Set 'CPU_BOARD_176_QFP' or 'CPU_BOARD_272_BGA'
...
if EXECUTION_MODE == "ERASE":
    if IS_PSVP is True:
        pass # flash size to be erased is tbd
    else:
        EraseCodeFlash() 
    ResetMcuViaCm0AircrSysResetReqAndHalt()
