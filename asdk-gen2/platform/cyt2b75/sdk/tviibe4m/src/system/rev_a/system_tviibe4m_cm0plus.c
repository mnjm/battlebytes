/***************************************************************************//**
* \file system_tviibe4m_cm0plus.c
* \version 1.0
*
...
void SystemInit (void)
{
    ...
    SRSS->unCLK_ROOT_SELECT[0].stcField.u1DIRECT_MUX = 1u; /* Select ROOT_MUX */
    ...
    SRSS->unCLK_ROOT_SELECT[1].stcField.u1DIRECT_MUX = 1u; /* Select ROOT_MUX */
