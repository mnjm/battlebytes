...
cy_stc_tcpwm_pwm_config_t const MyPWM_config =
{
    ...
    .period             = CXPI_OVERSAMPLING - 1,             // PCLK_CXPI / CXPI_OVERSAMPLING (0x190) = CXPI_BAUDRATE (PWM frequency)
    .period_buff        = 0,
    .enablePeriodSwap   = false,
    .compare0           = (uint32_t)(CXPI_OVERSAMPLING/2),   // 50% (PWM duty)
    .compare1           = 0,
...
static void CxpiClockInit(void)
{
    ...
    Cy_SysClk_PeriphAssignDivider(CY_CXPICH_CLK_TCPWM_PCLK, CY_SYSCLK_DIV_24_5_BIT, 0u);
