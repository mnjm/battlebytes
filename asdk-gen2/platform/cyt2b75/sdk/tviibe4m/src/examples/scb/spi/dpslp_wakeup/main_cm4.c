...
#define SCB0_MISO_PORT    GPIO_PRT0
#define SCB0_MISO_PIN     0ul
#define SCB0_MISO_PIN_MUX P0_0_SCB0_SPI_MISO
#define SCB0_MOSI_PORT    GPIO_PRT0
#define SCB0_MOSI_PIN     1ul
#define SCB0_MOSI_PIN_MUX P0_1_SCB0_SPI_MOSI
#define SCB0_CLK_PORT     GPIO_PRT0
#define SCB0_CLK_PIN      2ul
#define SCB0_CLK_PIN_MUX  P0_2_SCB0_SPI_CLK
#define SCB0_SS0_PORT     GPIO_PRT0
#define SCB0_SS0_PIN      3ul
#define SCB0_SS0_PIN_MUX  P0_3_SCB0_SPI_SELECT0
