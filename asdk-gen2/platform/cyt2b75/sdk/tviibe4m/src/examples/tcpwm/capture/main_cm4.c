...
/*****************************************************************************/
  ...
  /* If you use 176 pin MCU on Rev.A CPU board, please short J2.10 (Capture) and  J10.7 (PWM) on the base board. */
  /* If you use 176 pin MCU on Rev.C CPU board, please short J2.10 (Capture) and J2.13 (PWM) on the base board. */
  /* If you use  64 pin MCU, please short J2.10 (Capture) and J10.10 (PWM) on the base board. */

  /* Capture Mode Configuration def */
  #define TCPWM0_GRPx_CNTx_CAPTURE                TCPWM0_GRP0_CNT0
  #define PCLK_TCPWM0_CLOCKSx_CAPTURE             PCLK_TCPWM0_CLOCKS0
  ...
  #define TCPWM0_GRPx_CNTx_PWM                    TCPWM0_GRP0_CNT1
  #define PCLK_TCPWM0_CLOCKSx_PWM                 PCLK_TCPWM0_CLOCKS1
  ...
  #define TCPWM_LINEx_MUX                         P6_3_TCPWM0_LINE1
