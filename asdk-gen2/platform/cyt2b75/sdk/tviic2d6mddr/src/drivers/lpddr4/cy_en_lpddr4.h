/***************************************************************************
* \file cy_en_lpddr4.h
*   $Date: 2022-12-16 20:12:53 +0530 (Fri, 16 Dec 2022) $
*   $Revision: 320214 $
*
* Provides the enumerated type definitions for the API declaration of the lpddr4 controller driver.
* This file was automatically created by mxs40elpddr4.xlsm on 16.11.2021 07:15:52 with the following latest Dolphin register import:
* C:\svn\chips\trunk\s40\MXS40\Platform\mxs40elpddr4\Dolphin\fromDolphin\Releases\210930_dynamo_cypress_rev0p0p40\reg_block_def_lpdd4.xlsx
*
********************************************************************************
* \copyright
...
#define SVN_REV_CY_EN_LPDDR4_H 		"$Revision: 320214 $"
#define SVN_DATE_CY_EN_LPDDR4_H		"$Date: 2022-12-16 20:12:53 +0530 (Fri, 16 Dec 2022) $"
...
typedef enum {
    ...
    /* got confirmation that only 6 drivers are selectable*/
