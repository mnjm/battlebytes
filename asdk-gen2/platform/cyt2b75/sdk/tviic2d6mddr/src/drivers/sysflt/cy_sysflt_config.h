...
typedef enum 
{
    ...
    CY_SYSFLT_CPUSS_MPU_VIO_5                         = 0x0005u,    /**< Bus master #5 MPU/SMPU violation - See MPU_0 description */
    ...
    CY_SYSFLT_CPUSS_CM7_1_TCM_C_ECC                   = 0x0016u,    /**< Correctable ECC error in CM7_1 TCM memory. See CM7_0_TCM_C_ECC descripption. */
    CY_SYSFLT_CPUSS_CM7_1_TCM_NC_ECC                  = 0x0017u,    /**< Non Correctable ECC error in CM7_1 TCM memory. See CM7_0_TCM_C_ECC descripption. */
    ...
    CY_SYSFLT_PERI_GROUP_VIO_4                        = 0x0024u,    /**< Peripheral group #4 violation. See GROUP_FAULT_0 description. */
    ...
    CY_SYSFLT_PERI_GROUP_VIO_8                        = 0x0028u,    /**< Peripheral group #8 violation. See GROUP_FAULT_0 description. */
    CY_SYSFLT_PERI_GROUP_VIO_9                        = 0x0029u,    /**< Peripheral group #9 violation. See GROUP_FAULT_0 description. */
    CY_SYSFLT_PERI_GROUP_VIO_10                       = 0x002Au,    /**< Peripheral group #10 violation. See GROUP_FAULT_0 description. */
    ...
    CY_SYSFLT_LPDDR4_0_LPDDR4_FATAL_FAULT             = 0x004Fu,    /**< LPDDR4 fatal fault
                                                                           DATA0[0]: 0: non-correctable ECC fault  1: PLL unlock fault
                                                                           DATA0[31:1]: "0". Reserved */
    CY_SYSFLT_LPDDR4_0_LPDDR4_NONFATAL_GSM_FAULT      = 0x0050u,    /**< description to be updated (CDT 363058) 
                                                                           LPDDR4 correctable ECC fault
                                                                           DATA0[0]: 0: State Machine fault  1: correctable ECC fault
                                                                           DATA0[31:1]: "0". Reserved */
    CY_SYSFLT_LPDDR4_0_LPDDR4_NONFATAL_ECC_SEC_FAULT  = 0x0051u,    /**< description to be updated (CDT 363058) 
                                                                           LPDDR4 correctable ECC fault
                                                                           DATA0[0]: 0: State Machine fault  1: correctable ECC fault
                                                                           DATA0[31:1]: "0". Reserved */
    ...
    CY_SYSFLT_SRSS_FAULT_SSV                          = 0x005Bu,    /**< Consolidated fault output for supply supervisors. Multiple CSV can detect a violation at the same time.
                                                                           DATA0[0]: BOD on VDDA
                                                                           DATA[1]: OVD on VDDA
                                                                           DATA[16]: LVD/HVD #1
                                                                           DATA0[17]: LVD/HVD #2 */
