...
/* for DW */
#define BUFFER_SIZE                                     16  // This needs that BUFFER_SIZE can be divisible by E_UART_RECV_THRESHOLD

#if (CY_USE_PSVP == 1) // uses SCB1
    #define DW_CHANNEL                                  19 // scb[1].tr_rx_req
    #define TRIG_OUT_1TO1_SCB_RX_TO_PDMA                TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA11
    #define TRIG_IN_1TO1_SCB_RX_TO_PDMA                 TRIG_IN_1TO1_1_SCB_RX_TO_PDMA11
    #define cpuss_interrupts_dw1                        cpuss_interrupts_dw1_19_IRQn
#else // uses SCB11
    #define DW_CHANNEL                                  39
    #define TRIG_OUT_1TO1_SCB_RX_TO_PDMA                TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA111
    #define TRIG_IN_1TO1_SCB_RX_TO_PDMA                 TRIG_IN_1TO1_1_SCB_RX_TO_PDMA111
...
int main(void)
{
    ...
    TERM_PRINT_H("\n\r DW Test");
    TERM_PRINT_H("\n\r Transfer data from UART to memory(DestBuffer) via DW1");
    TERM_PRINT_H("\n\r Please Input %d Characters\n\n\r", E_UART_RECV_THRESHOLD);
    ...
    /* Trigger MUX */
    /***************/
    Cy_TrigMux_Connect1To1( TRIG_OUT_1TO1_SCB_RX_TO_PDMA,
                            0u,
...
void Peripheral_Initialization(void)
{
    ...
    cy_stc_sysint_irq_t         stc_sysint_irq_cfg_dw;
    ...
    stc_sysint_irq_cfg_dw.sysIntSrc = cpuss_interrupts_dw1;
    stc_sysint_irq_cfg_dw.intIdx    = CPUIntIdx2_IRQn;
    stc_sysint_irq_cfg_dw.isEnabled = true;
    Cy_SysInt_InitIRQ(&stc_sysint_irq_cfg_dw);
    Cy_SysInt_SetSystemIrqVector(stc_sysint_irq_cfg_dw.sysIntSrc, DW1_TransferComplete_IntrISR);
}
