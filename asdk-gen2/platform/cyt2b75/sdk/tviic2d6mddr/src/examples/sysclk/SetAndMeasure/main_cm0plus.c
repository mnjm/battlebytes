...
#define PLL400_0_TARGET_FREQ   (320000000ul)
#define PLL400_1_TARGET_FREQ   (196608000ul)
#define PLL400_2_TARGET_FREQ   (360000000ul) 
#define PLL400_3_TARGET_FREQ   (250000000ul)
...
{
    CY_SYSCLK_HFCLK_IN_CLKPATH6, /* PLL5: PLL200#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH1, /* PLL0: PLL400#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH7, /* PLL6: PLL200#1 */
    CY_SYSCLK_HFCLK_IN_CLKPATH6, /* PLL5: PLL200#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH6, /* PLL5: PLL200#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH2, /* PLL1: PLL400#1 */
    CY_SYSCLK_HFCLK_IN_CLKPATH2, /* PLL1: PLL400#1 */
    CY_SYSCLK_HFCLK_IN_CLKPATH2, /* PLL1: PLL400#1 */   
    CY_SYSCLK_HFCLK_IN_CLKPATH3, /* PLL2: PLL400#2 */
    CY_SYSCLK_HFCLK_IN_CLKPATH3, /* PLL2: PLL400#2 */   
    CY_SYSCLK_HFCLK_IN_CLKPATH4, /* PLL3: PLL400#3 */
    CY_SYSCLK_HFCLK_IN_CLKPATH5, /* PLL4: PLL400#4 */
    CY_SYSCLK_HFCLK_IN_CLKPATH8, /* PLL7: PLL200#2 */
    CY_SYSCLK_HFCLK_IN_CLKPATH7, /* PLL5: PLL200#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH6, /* PLL5: PLL200#0 */
    CY_SYSCLK_HFCLK_IN_CLKPATH9, /* No PLL/FLL (bypass) */
};
...
cy_stc_pll_config_t g_pll200_2_Config = 
{
    .inputFreq  = PATH_SOURCE_CLOCK_FREQ,       // ECO: 16MHz
...
cy_stc_pll_400M_config_t g_pll400_2_Config =
{
    .inputFreq    = PATH_SOURCE_CLOCK_FREQ,
...
cy_stc_pll_400M_config_t g_pll400_3_Config =
{
    .inputFreq    = PATH_SOURCE_CLOCK_FREQ,
...
cy_stc_pll_400M_config_t g_pll400_4_Config =
{
    .inputFreq    = PATH_SOURCE_CLOCK_FREQ,
...
stc_clock_measure g_clockMeasuredInfo[] = 
{
    ...
    {.name = CY_SYSCLK_MEAS_CLK_PATH6,   .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_PATH7,   .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_PATH8,   .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_PATH9,   .measuredFreq= 0ul},
    ...
    {.name = CY_SYSCLK_MEAS_CLK_HFCLK8,  .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_HFCLK9,  .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_HFCLK10, .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_HFCLK11, .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_HFCLK12, .measuredFreq= 0ul},
    {.name = CY_SYSCLK_MEAS_CLK_HFCLK13, .measuredFreq= 0ul},
};
...
/******   EXT CLK PORT   ******/
#define CY_HF3_CLK_OUT_PORT                         GPIO_PRT12
#define CY_HF3_CLK_OUT_PIN                          5
#define CY_HF3_CLK_OUT_PIN_MUX                      P12_5_SRSS_EXT_CLK
...
static void AllClockConfiguration(void)
{
    ...
    /***** PLL400M#2(PATH3) source setting ******/
    {
        cy_en_sysclk_status_t status;
        status = Cy_SysClk_ClkPathSetSource(PLL_400M_2_PATH_NO, PATH_SOURCE_CLOCK_IN);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        status = Cy_SysClk_Pll400MConfigure(PLL_400M_2_PATH_NO, &g_pll400_2_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        status = Cy_SysClk_Pll400MEnable(PLL_400M_2_PATH_NO, WAIT_FOR_STABILIZATION);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        static cy_stc_pll_400M_manual_config_t monitor_pll400_2_Config;
        status = Cy_SysClk_Pll400MGetConfiguration(PLL_400M_2_PATH_NO, &monitor_pll400_2_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);
    }

    /***** PLL400M#3(PATH4) source setting ******/
    {
        cy_en_sysclk_status_t status;
        status = Cy_SysClk_ClkPathSetSource(PLL_400M_3_PATH_NO, PATH_SOURCE_CLOCK_IN);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        status = Cy_SysClk_Pll400MConfigure(PLL_400M_3_PATH_NO, &g_pll400_3_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        status = Cy_SysClk_Pll400MEnable(PLL_400M_3_PATH_NO, WAIT_FOR_STABILIZATION);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        static cy_stc_pll_400M_manual_config_t monitor_pll400_3_Config;
        status = Cy_SysClk_Pll400MGetConfiguration(PLL_400M_3_PATH_NO, &monitor_pll400_3_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);
    }

    /***** PLL400M#4(PATH5) source setting ******/
    {
        cy_en_sysclk_status_t status;
        status = Cy_SysClk_ClkPathSetSource(PLL_400M_4_PATH_NO, PATH_SOURCE_CLOCK_IN);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        status = Cy_SysClk_Pll400MConfigure(PLL_400M_4_PATH_NO, &g_pll400_4_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        status = Cy_SysClk_Pll400MEnable(PLL_400M_4_PATH_NO, WAIT_FOR_STABILIZATION);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        static cy_stc_pll_400M_manual_config_t monitor_pll400_4_Config;
        status = Cy_SysClk_Pll400MGetConfiguration(PLL_400M_4_PATH_NO, &monitor_pll400_4_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);
    }

    /***** PLL200M#0(PATH6) source setting ******/
    {
        cy_en_sysclk_status_t status;
    ...
    /***** PLL200M#1(PATH7) source setting ******/
    {
        cy_en_sysclk_status_t status;
    ...
    /***** PLL200M#2(PATH8) source setting ******/
    {
        cy_en_sysclk_status_t status;
        status = Cy_SysClk_ClkPathSetSource(PLL_200M_2_PATH_NO, PATH_SOURCE_CLOCK_IN);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);

        status = Cy_SysClk_PllConfigure(PLL_200M_2_PATH_NO , &g_pll200_2_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);
        ...
        static cy_stc_pll_manual_config_t monitor_pll200_1_Config;
        status = Cy_SysClk_PllGetConfiguration(PLL_200M_2_PATH_NO, &monitor_pll200_1_Config);
        CY_ASSERT(status == CY_SYSCLK_SUCCESS);
    }

    /***** PATH9 source setting ******/
    {
...
static void CompareExpectedAndMeasured(void)
{
    for(uint32_t i = 0ul; i < NUM_OF_MEASURED_CLOCK; i++)
    {
        ...
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_PATH6)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.OutFreqPath[6], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_PATH7)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.OutFreqPath[7], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_PATH8)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.OutFreqPath[8], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_PATH9)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.OutFreqPath[9], g_clockMeasuredInfo[i].measuredFreq));
        }
        ...
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_HFCLK8)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.ClockFreqHf[8], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_HFCLK9)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.ClockFreqHf[9], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_HFCLK10)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.ClockFreqHf[10], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_HFCLK11)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.ClockFreqHf[11], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_HFCLK12)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.ClockFreqHf[12], g_clockMeasuredInfo[i].measuredFreq));
        }
        if(g_clockMeasuredInfo[i].name == CY_SYSCLK_MEAS_CLK_HFCLK13)
        {
            CY_ASSERT(LooseCompare(g_expectedFreq.ClockFreqHf[13], g_clockMeasuredInfo[i].measuredFreq));
        }
    }
}
...
static void RecalucClockFrequencyValues(void)
{
    ...
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(2ul, &g_reportedFreq.pll400M2SourceFreq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(3ul, &g_reportedFreq.pll400M3SourceFreq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(4ul, &g_reportedFreq.pll400M4SourceFreq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(5ul, &g_reportedFreq.pll200M0SourceFreq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(6ul, &g_reportedFreq.pll200M1SourceFreq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllInputFrequency(7ul, &g_reportedFreq.pll200M2SourceFreq) == CY_SYSCLK_SUCCESS);
    ...
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(2ul, &g_reportedFreq.pll400M2Freq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(3ul, &g_reportedFreq.pll400M3Freq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(4ul, &g_reportedFreq.pll400M4Freq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(5ul, &g_reportedFreq.pll200M0Freq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(6ul, &g_reportedFreq.pll200M1Freq) == CY_SYSCLK_SUCCESS);
    CY_ASSERT(Cy_SysClk_GetPllOutputFrequency(7ul, &g_reportedFreq.pll200M2Freq) == CY_SYSCLK_SUCCESS);
...
static void CompareExpectedAndCaluclated(void)
{
    ...
    CY_ASSERT(LooseCompare(g_reportedFreq.pll400M2SourceFreq, g_expectedFreq.pll400M2SourceFreq));
    CY_ASSERT(LooseCompare(g_reportedFreq.pll400M3SourceFreq, g_expectedFreq.pll400M3SourceFreq));
    CY_ASSERT(LooseCompare(g_reportedFreq.pll400M4SourceFreq, g_expectedFreq.pll400M4SourceFreq));
    ...
    CY_ASSERT(LooseCompare(g_reportedFreq.pll200M2SourceFreq, g_expectedFreq.pll200M2SourceFreq));
    ...
    CY_ASSERT(LooseCompare(g_reportedFreq.pll400M2Freq, g_expectedFreq.pll400M2Freq));
    CY_ASSERT(LooseCompare(g_reportedFreq.pll400M3Freq, g_expectedFreq.pll400M3Freq));
    CY_ASSERT(LooseCompare(g_reportedFreq.pll400M4Freq, g_expectedFreq.pll400M4Freq));
    ...
    CY_ASSERT(LooseCompare(g_reportedFreq.pll200M2Freq, g_expectedFreq.pll200M2Freq));
...
static void PrepareExpectedClockFrequency(void)
{
    ...
    g_expectedFreq.OutFreqPath[3] = PLL400_2_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[4] = PLL400_3_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[5] = PLL400_4_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[6] = PLL200_0_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[7] = PLL200_1_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[8] = PLL200_2_TARGET_FREQ;
    g_expectedFreq.OutFreqPath[9] = PATH_SOURCE_CLOCK_FREQ;
    ...
    g_expectedFreq.pll400M2SourceFreq = PATH_SOURCE_CLOCK_FREQ;
    g_expectedFreq.pll400M3SourceFreq = PATH_SOURCE_CLOCK_FREQ;
    g_expectedFreq.pll400M4SourceFreq = PATH_SOURCE_CLOCK_FREQ;
    g_expectedFreq.pll200M0SourceFreq = PATH_SOURCE_CLOCK_FREQ;
    g_expectedFreq.pll200M1SourceFreq = PATH_SOURCE_CLOCK_FREQ;
    g_expectedFreq.pll200M2SourceFreq = PATH_SOURCE_CLOCK_FREQ;
    ...
    g_expectedFreq.pll400M2Freq       = PLL400_2_TARGET_FREQ;
    g_expectedFreq.pll400M3Freq       = PLL400_3_TARGET_FREQ;
    g_expectedFreq.pll400M4Freq       = PLL400_4_TARGET_FREQ;
    g_expectedFreq.pll200M0Freq       = PLL200_0_TARGET_FREQ;
    g_expectedFreq.pll200M1Freq       = PLL200_1_TARGET_FREQ;
    g_expectedFreq.pll200M2Freq       = PLL200_2_TARGET_FREQ;
