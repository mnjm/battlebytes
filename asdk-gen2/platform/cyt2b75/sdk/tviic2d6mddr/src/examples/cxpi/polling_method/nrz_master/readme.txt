...
For CYTVII-C-2D-6M-DDR-500-RevA Board
--------------------------------------------------------------------------------
1. Connect J89, Connect J192(2-3).
2. Connect J124(2-3), J125(2-3), J126(2-3), J127(2-3)
3. Flash another CPU board with Slave example and connect DB9 cable from master to 
slave board to test the Master firmware.
