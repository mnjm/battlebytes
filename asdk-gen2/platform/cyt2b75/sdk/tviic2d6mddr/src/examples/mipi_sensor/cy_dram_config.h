...
#define USE_PLL_FREQ_400MHZ     0
#define USE_PLL_FREQ_746MHZ     1
#define USE_PLL_FREQ_750MHZ     2
#define USE_PLL_FREQ_MHZ        USE_PLL_FREQ_400MHZ


#if(USE_PLL_FREQ_CALCULATION==ENABLED)
/*LPDDR4 PLL Settings */
    //FSP[0]=53.57 MHz  and FSP[1]= 750 MHz
    #if (USE_PLL_FREQ_MHZ == USE_PLL_FREQ_750MHZ)
        #define LPDDR4_PLL_FIN_HZ           20000000    //  PLL Input Frequency (CLK_HF14 )                 <--set PLL input freq.
    ...
    #endif
    //FSP[0]=53.33 MHz  and FSP[1]= 746.67 MHz
    #if (USE_PLL_FREQ_MHZ == USE_PLL_FREQ_746MHZ)
        #define LPDDR4_PLL_FIN_HZ           20000000    //  PLL Input Frequency (CLK_HF14 )                 <--set PLL input freq.
        #define LPDDR4_PLL_REF_DIV          3           //  PLL Reference Divider  valid values 1..18       <--set PLL Reference Divider 
        #define LPDDR4_PLL_FDBK_DIV         112         //  PLL  Feedback Divider  valid values 16..200     <--set PLL Fdbk Divider 
        #define LPDDR4_PLL_OUT_DIV_FSP0     14          //  OutPut Divider for FSP[0] frequency             <--set PLL Output Divder for FSP[0]
                                                        //  valid values 2..16 
        #define LPDDR4_PLL_OUT_DIV_FSP1     14          //  OUTPUT_DIV for FSP[1] is actually don´t         <-- set PLL Output Divder for FSP[1]
                                                        //  (this is actually a don´t care) might be deleted later valid values 2..16 
    ...
    #if (USE_PLL_FREQ_MHZ == USE_PLL_FREQ_400MHZ)
        #define LPDDR4_PLL_FIN_HZ           20000000    //  PLL Input Frequency (CLK_HF14 )                 <--set PLL input freq.
        #define LPDDR4_PLL_REF_DIV          3           //  PLL Reference Divider  valid values 1..18       <--set PLL Reference Divider 
        #define LPDDR4_PLL_FDBK_DIV         60          //  PLL  Feedback Divider  valid values 16..200     <--set PLL Fdbk Divider 
...
#define JESD209_4B_FSP0_MR12_DEFAULT_VREFCA_VALUE   0x1d
...
#define JESD209_4B_FSP0_MR14_DEFAULT_VREFDQ_VALUE   0x1d
