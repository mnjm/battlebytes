...
#include "cy_device_headers.h"
    ...
    #define USER_BUTTON1_PORT        CY_BSP_BB_USER_BUTTON_3_PORT
    #define USER_BUTTON1_PIN         CY_BSP_BB_USER_BUTTON_3_PIN
    #define USER_BUTTON1_PIN_MUX     CY_BSP_BB_USER_BUTTON_3_PIN_MUX
    #define USER_BUTTON1_IRQN        CY_BSP_BB_USER_BUTTON_3_IRQN
    
    #define USER_BUTTON2_PORT        CY_BSP_BB_USER_BUTTON_4_PORT
    #define USER_BUTTON2_PIN         CY_BSP_BB_USER_BUTTON_4_PIN
    #define USER_BUTTON2_PIN_MUX     CY_BSP_BB_USER_BUTTON_4_PIN_MUX
    #define USER_BUTTON2_IRQN        CY_BSP_BB_USER_BUTTON_4_IRQN
#else
