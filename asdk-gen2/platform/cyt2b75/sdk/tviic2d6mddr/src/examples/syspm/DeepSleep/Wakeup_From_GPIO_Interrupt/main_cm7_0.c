...
#include "cy_device_headers.h"
    ...
    #define USER_BUTTON_PORT        CY_BSP_BB_USER_BUTTON_2_PORT
    #define USER_BUTTON_PIN         CY_BSP_BB_USER_BUTTON_2_PIN
    #define USER_BUTTON_PIN_MUX     CY_BSP_BB_USER_BUTTON_2_PIN_MUX
    #define USER_BUTTON_IRQ         CY_BSP_BB_USER_BUTTON_2_IRQN
#else
