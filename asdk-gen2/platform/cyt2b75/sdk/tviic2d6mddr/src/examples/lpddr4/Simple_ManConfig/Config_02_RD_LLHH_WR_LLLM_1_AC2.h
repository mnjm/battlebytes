/***************************************************************************//**
* \file Config_02_RD_LLHH_WR_LLLM_1_AC2.h
*   $Date: 2023-01-24 14:49:26 +0530 (Tue, 24 Jan 2023) $
*   $Revision: 320854 $
*
...
#ifndef CONFIG_02_RD_LLHH_WR_LLLM_1_AC2_H_INCLUDED
#define CONFIG_02_RD_LLHH_WR_LLLM_1_AC2_H_INCLUDED

#include "drivers/lpddr4/cy_en_lpddr4.h"

#define SVN_REV_LPDDR4_CONFIG_FILE          "$Date: 2023-01-24 14:49:26 +0530 (Tue, 24 Jan 2023) $"
#define SVN_DATE_LPDDR4_CONFIG_FILE         "$Revision: 320854 $"
#define SVN_LPDDR4_CONFIG_FILE_NAME         "Config_02_RD_LLHH_WR_LLLM_1_AC2.h"
...
{ 
    ...
    .pllconfig =
    {
        ...
        .waittime   = CY_LPDDR4_PLL_WAIT_TIME_8_16MHZ,           /*   */
    ...
    .unLPMR12.stcField = 
    {
        ...
        .u6FS1_VREFCAS = 0xd,                                           /*  VREF-CA Settings for FSP1 01101b:Range1 : 27.2% of VDD2 (modify according user need  )check JESD209-4B-LPDDR4 Table 13*/
    ...
    .unLPMR14.stcField = 
    { 
        .u6FS0_VREFDQS = JESD209_4B_FSP0_MR14_DEFAULT_VREFDQ_VALUE,     /*  VREF(DQ) value for FSP0 (default) 001101b: JESD209-4b default Range 1 : 27.2% of VDDQ ( do not change )*/
        ...
        .u6FS1_VREFDQS = 0xd,                                           /*  VREF(DQ) value for FSP1 (change according user needs) check JESD209-4B-LPDDR4 Table 14*/
        .u1FS1_VREFDQR = CY_LPDDR4_VREF_RANGE_RANGE0                    /*  VREF(DQ) range for FSP1 (change according user needs)*/
    },
    ...
    .dqsOscRuntimeClkCyls =  CY_LPDDR4_MR23_63X16CLK_COUNTS,   /*   when set to CY_LPDDR4_MR23_STOP_BY_MPC_COMMAND the DQS OSCillator must be stopped manually by MPC command
    ...
    .unTREG5.stcField = { 
        ...
        .u14T_REFI = CY_LPDDR4_CLOCKCYCLES_TREFI_COMPENSATED(JESD209_4B_NS_TREFI,CY_LPDDR4_FSP1_FREQ,CY_LPDDR4_TREFI_NCK_COMPENSATE),
...
#endif // CONFIG_02_RD_LLHH_WR_LLLM_1_AC2_H_INCLUDED
