...
#if (CY_USE_PSVP == 1)
    #define DW1_CH_TO_SCB_UART_TX    (18)
    #define DW1_CH_TO_SCB_UART_RX    (19)
    #define UART_TX_TO_DMA_TRIG      (TRIG_IN_1TO1_1_SCB_TX_TO_PDMA11)
    #define UART_RX_TO_DMA_TRIG      (TRIG_IN_1TO1_1_SCB_RX_TO_PDMA11)
    #define UART_PCLK_CLK_FREQ       24000000ul
#else
    #define DW1_CH_TO_SCB_UART_TX    (38)
    #define DW1_CH_TO_SCB_UART_RX    (39)
    #define UART_TX_TO_DMA_TRIG      (TRIG_IN_1TO1_1_SCB_TX_TO_PDMA111)
    #define UART_RX_TO_DMA_TRIG      (TRIG_IN_1TO1_1_SCB_RX_TO_PDMA111)
    #define UART_PCLK_CLK_FREQ       80000000ul
#endif
...
void UART_Initialization(uint32_t boadrate, uint32_t sourceFreq)
{
    ...
    /* Sets the 24.5 divider */
    {
        ...
        Cy_SysClk_PeriphSetFracDivider(Cy_SysClk_GetClockGroup(CY_BSP_USB_UART_PCLK),
...
static  cy_stc_pdma_descr_config_t  dw1ChUartTxConfig =
{
    ...
    .destAddr       =   (void *)&CY_BSP_USB_UART_TYPE->unTX_FIFO_WR.u32Register,
    .srcXincr       =   1ul,
    .destXincr      =   0ul,
...
static  cy_stc_pdma_descr_config_t  dw1ChUartRxConfig =
{
    ...
    .descrType      =   CY_PDMA_2D_TRANSFER,
    .srcAddr        =   (void *)&CY_BSP_USB_UART_TYPE->unRX_FIFO_RD.u32Register,
...
int main(void)
{
    ...
    // Disables D cache because DMA also reads descriptor in the SRAM.
    SCB_DisableDCache();
    ...
    UART_Initialization( 115200ul, UART_PCLK_CLK_FREQ);
