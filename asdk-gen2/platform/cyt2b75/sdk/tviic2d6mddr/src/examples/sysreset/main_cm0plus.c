...
#include "cy_device_headers.h"
...
#if (CY_USE_PSVP == 1)
    #define USER_LED1_PORT           CY_BSP_BB_USER_LED0_PORT
    #define USER_LED1_PIN            CY_BSP_BB_USER_LED0_PIN
    #define USER_LED1_PIN_MUX        CY_BSP_BB_USER_LED0_PIN_MUX

    #define USER_LED2_PORT           CY_BSP_BB_USER_LED1_PORT
    #define USER_LED2_PIN            CY_BSP_BB_USER_LED1_PIN
    #define USER_LED2_PIN_MUX        CY_BSP_BB_USER_LED1_PIN_MUX

    #define USER_LED3_PORT           CY_BSP_BB_USER_LED2_PORT
    #define USER_LED3_PIN            CY_BSP_BB_USER_LED2_PIN
    #define USER_LED3_PIN_MUX        CY_BSP_BB_USER_LED2_PIN_MUX
    
    #define USER_BUTTON1_PORT        CY_BSP_BB_USER_BUTTON_1_PORT
    #define USER_BUTTON1_PIN         CY_BSP_BB_USER_BUTTON_1_PIN
    #define USER_BUTTON1_PIN_MUX     CY_BSP_BB_USER_BUTTON_1_PIN_MUX
    #define USER_BUTTON1_IRQN        CY_BSP_BB_USER_BUTTON_1_IRQN

    #define USER_BUTTON2_PORT        CY_BSP_BB_USER_BUTTON_2_PORT
    #define USER_BUTTON2_PIN         CY_BSP_BB_USER_BUTTON_2_PIN
    #define USER_BUTTON2_PIN_MUX     CY_BSP_BB_USER_BUTTON_2_PIN_MUX
    #define USER_BUTTON2_IRQN        CY_BSP_BB_USER_BUTTON_2_IRQN

    #define USER_BUTTON3_PORT        CY_BSP_BB_USER_BUTTON_3_PORT
    #define USER_BUTTON3_PIN         CY_BSP_BB_USER_BUTTON_3_PIN
    #define USER_BUTTON3_PIN_MUX     CY_BSP_BB_USER_BUTTON_3_PIN_MUX
    #define USER_BUTTON3_IRQN        CY_BSP_BB_USER_BUTTON_3_IRQN

    #define USER_BUTTON4_PORT        CY_BSP_BB_USER_BUTTON_4_PORT
    #define USER_BUTTON4_PIN         CY_BSP_BB_USER_BUTTON_4_PIN
    #define USER_BUTTON4_PIN_MUX     CY_BSP_BB_USER_BUTTON_4_PIN_MUX
    #define USER_BUTTON4_IRQN        CY_BSP_BB_USER_BUTTON_4_IRQN
#else
    ...
    #define USER_BUTTON1_PORT        CY_USER_BUTTON_LEFT_PORT
    #define USER_BUTTON1_PIN         CY_USER_BUTTON_LEFT_PIN
    #define USER_BUTTON1_PIN_MUX     CY_USER_BUTTON_LEFT_PIN_MUX
    #define USER_BUTTON1_IRQN        CY_USER_BUTTON_LEFT_IRQN
    ...
    #define USER_BUTTON4_PORT        CY_USER_BUTTON_UP_PORT
    #define USER_BUTTON4_PIN         CY_USER_BUTTON_UP_PIN
    #define USER_BUTTON4_PIN_MUX     CY_USER_BUTTON_UP_PIN_MUX
    #define USER_BUTTON4_IRQN        CY_USER_BUTTON_UP_IRQN
#endif
