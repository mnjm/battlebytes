...
#if (CY_USE_PSVP == 1)
    #define USER_LED1_PORT           CY_LED4_PORT
    #define USER_LED1_PIN            CY_LED4_PIN
    #define USER_LED1_PIN_MUX        CY_LED4_PIN_MUX

    #define USER_LED2_PORT           CY_LED5_PORT
    #define USER_LED2_PIN            CY_LED5_PIN
    #define USER_LED2_PIN_MUX        CY_LED5_PIN_MUX
    
    #define USER_LED3_PORT           CY_LED6_PORT
    #define USER_LED3_PIN            CY_LED6_PIN
    #define USER_LED3_PIN_MUX        CY_LED6_PIN_MUX
#else
