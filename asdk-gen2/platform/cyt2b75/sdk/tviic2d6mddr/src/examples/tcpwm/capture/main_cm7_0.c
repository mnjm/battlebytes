...
#define TCPWMx_GRPx_CNTx_CAPTURE           TCPWM0_GRP2_CNT21
#define PCLK_TCPWMx_CLOCKSx_CAPTURE        PCLK_TCPWM0_CLOCKS533
#define TCPWMx_GRPx_IRQx		   tcpwm_0_interrupts_533_IRQn
#define TR_ONE_CNT_NR_USE                  0u // from 0 to 2

// TR_ONE_CNT_INx: x = (256 * GrpNum) + (CntNum)
#define TCPWMx_TR_ONE_CNT_INx_PORT         GPIO_PRT7
#define TCPWMx_TR_ONE_CNT_INx_PIN          1u
#define TCPWMx_TR_ONE_CNT_INx_MUX          P7_1_TCPWM0_TR_ONE_CNT_IN533

/* PWM Configuration definitions */
#define TCPWMx_GRPx_CNTx_PWM               TCPWM0_GRP2_CNT17
#define PCLK_TCPWMx_CLOCKSx_PWM            PCLK_TCPWM0_CLOCKS529

/* TCPWM0_LINE1 */
#define TCPWMx_LINEx_PORT                  GPIO_PRT7
#define TCPWMx_LINEx_PIN                   3u
#define TCPWMx_LINEx_MUX                   P7_3_TCPWM0_LINE529
