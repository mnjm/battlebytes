...
#define TCPWMx_GRPx_CNTx_PWM_SR           TCPWM0_GRP2_CNT16
#define PCLK_TCPWMx_CLOCKSx_PWM_SR        PCLK_TCPWM0_CLOCKS528
#define TCPWMx_PERI_CLK_DIVIDER_NO_PWM_SR 0

#define TCPWMx_LINEx_PORT                 GPIO_PRT7
#define TCPWMx_LINEx_PIN                  1u
#define TCPWMx_LINEx_MUX                  P7_1_TCPWM0_LINE528

#define TR_ONE_CNT_NR_USE                 0u // from 0 to 2
// TR_ONE_CNT_INx: x = (256 * GrpNum) + (CntNum)
#define TCPWMx_LINEx_IN_PORT              GPIO_PRT7
#define TCPWMx_LINEx_IN_PIN               3u
#define TCPWMx_LINEx_IN_MUX               P7_3_TCPWM0_TR_ONE_CNT_IN528 

#define GPIO_TOBE_COPYED_PORT             GPIO_PRT7
#define GPIO_TOBE_COPYED_PIN              2u
#define GPIO_TOBE_COPYED_MUX              P7_2_GPIO
