...
#define TCPWMx_GRPx_CNTx_COUNTER                TCPWM0_GRP2_CNT21
#define PCLK_TCPWMx_CLOCKSx_COUNTER             PCLK_TCPWM0_CLOCKS533
#define TCPWM_PERI_CLK_DIVIDER_NO_COUNTER       0u

#define TR_ONE_CNT_NR_USE                       0u // from 0 to 2

// TR_ONE_CNT_INx: x = (256 * GrpNum) + (CntNum)
#define TCPWM_TR_ONE_CNT_INx_PORT               GPIO_PRT7
#define TCPWM_TR_ONE_CNT_INx_PIN                1u
#define TCPWM_TR_ONE_CNT_INx_MUX                P7_1_TCPWM0_TR_ONE_CNT_IN533

/* GPIO for the pulse counted */
#define GPIO_FOR_COUNT_PORT                     GPIO_PRT5
#define GPIO_FOR_COUNT_PIN                      3u
#define GPIO_FOR_COUNT_MUX                      P5_3_GPIO
...
{
    .sysIntSrc  = tcpwm_0_interrupts_533_IRQn,
