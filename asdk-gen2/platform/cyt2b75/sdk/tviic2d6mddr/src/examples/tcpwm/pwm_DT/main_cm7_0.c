...
#define TCPWMx_GRPx_CNTx_PWM_DT           TCPWM0_GRP1_CNT1
#define PCLK_TCPWMx_CLOCKSx_PWM_DT        PCLK_TCPWM0_CLOCKS257
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_DT  0u

// LINEx: x = (256 * GrpNum) + (CntNum)
/* TCPWM_LINE */
#define TCPWMx_LINEx_PORT      GPIO_PRT7
#define TCPWMx_LINEx_PIN       2u
#define TCPWMx_LINEx_MUX       P7_2_TCPWM0_LINE257

// LINE_COMPLx: x = (256 * GrpNum) + (CntNum)
/* TCPWM_LINE_COMPL */
#define TCPWMx_LINE_CMPLx_PORT GPIO_PRT7
#define TCPWMx_LINE_CMPLx_PIN  3u
#define TCPWMx_LINE_CMPLx_MUX  P7_3_TCPWM0_LINE_COMPL257
