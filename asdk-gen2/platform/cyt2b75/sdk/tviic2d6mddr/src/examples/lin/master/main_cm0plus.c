...
/* LIN Channel in use */
#if (CY_USE_PSVP == 1)
    #define CY_LINCH_TYPE       CY_BSP_BB_LIN0_TYPE
    #define CY_LINCH_RX_PORT    CY_BSP_BB_LIN0_RX_PORT
    #define CY_LINCH_RX_PIN     CY_BSP_BB_LIN0_RX_PIN
    #define CY_LINCH_RX_PIN_MUX CY_BSP_BB_LIN0_RX_PIN_MUX
    #define CY_LINCH_TX_PORT    CY_BSP_BB_LIN0_TX_PORT
    #define CY_LINCH_TX_PIN     CY_BSP_BB_LIN0_TX_PIN
    #define CY_LINCH_TX_PIN_MUX CY_BSP_BB_LIN0_TX_PIN_MUX
    #define CY_LINCH_PCLK       CY_BSP_BB_LIN0_PCLK
    #define CY_LINCH_IRQN       CY_BSP_BB_LIN0_IRQN
#else
 ...
 * Please short J58, J59, J60, J61, J62, J63 for LIN Ch2 Master Mode.
 */
int main(void)
{
    SystemInit();
    ...
    /* LIN baudrate setting */
    {
         ...
         */
        Cy_SysClk_PeriphAssignDivider(CY_LINCH_PCLK, CY_SYSCLK_DIV_16_BIT, 0u);
      #if (CY_USE_PSVP == 1)  
        Cy_SysClk_PeriphSetDivider(Cy_SysClk_GetClockGroup(CY_LINCH_PCLK), CY_SYSCLK_DIV_16_BIT, 0u, 75u);
      #else  
        Cy_SysClk_PeriphSetDivider(Cy_SysClk_GetClockGroup(CY_LINCH_PCLK), CY_SYSCLK_DIV_16_BIT, 0u, 259u); // 80 MHz / 260 / 16 (oversampling) = 19231 Hz
      #endif 
        Cy_SysClk_PeriphEnableDivider(Cy_SysClk_GetClockGroup(CY_LINCH_PCLK), CY_SYSCLK_DIV_16_BIT, 0u);
    }
