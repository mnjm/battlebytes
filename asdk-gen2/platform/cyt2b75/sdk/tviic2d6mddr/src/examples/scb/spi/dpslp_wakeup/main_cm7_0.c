...
#define USER_SPI_MISO_PORT              GPIO_PRT5
#define USER_SPI_MISO_PIN               2
#define USER_SPI_MISO_PIN_MUX           P5_2_SCB0_SPI_MISO

#define USER_SPI_MOSI_PORT              GPIO_PRT5
#define USER_SPI_MOSI_PIN               1
#define USER_SPI_MOSI_PIN_MUX           P5_1_SCB0_SPI_MOSI

#define USER_SPI_CLK_PORT               GPIO_PRT5
#define USER_SPI_CLK_PIN                0
#define USER_SPI_CLK_PIN_MUX            P5_0_SCB0_SPI_CLK

#define USER_SPI_SS0_PORT               GPIO_PRT5
#define USER_SPI_SS0_PIN                3
#define USER_SPI_SS0_PIN_MUX            P5_3_SCB0_SPI_SELECT0
