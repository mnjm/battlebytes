...
#define TEST_SCB11      0
#define TEST_SCB3       1
#define TEST_SCB        TEST_SCB11

#if (CY_USE_PSVP == 1)
    #define DW_CHANNEL                                  19 // scb[11].tr_rx_req
    #define TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA              TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA11
    #define TRIG_IN_1TO1_2_SCB_RX_TO_PDMA               TRIG_IN_1TO1_1_SCB_RX_TO_PDMA11
    #define cpuss_interrupts_dw1                        cpuss_interrupts_dw1_19_IRQn
#else
    #if (TEST_SCB == TEST_SCB11)
        #define DW_CHANNEL                              39 // scb[11].tr_rx_req
        #define TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA          TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA111
        #define TRIG_IN_1TO1_2_SCB_RX_TO_PDMA           TRIG_IN_1TO1_1_SCB_RX_TO_PDMA111
        #define cpuss_interrupts_dw1                    cpuss_interrupts_dw1_39_IRQn
    #else // (TEST_SCB == TEST_SCB3)
        #define DW_CHANNEL                              23 // scb[3].tr_rx_req
        #define TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA          TRIG_OUT_1TO1_1_SCB_RX_TO_PDMA13
        #define TRIG_IN_1TO1_2_SCB_RX_TO_PDMA           TRIG_IN_1TO1_1_SCB_RX_TO_PDMA13
        #define cpuss_interrupts_dw1                    cpuss_interrupts_dw1_23_IRQn
    #endif
#endif
...
/* for DW */
#define BUFFER_SIZE             4  // This needs that BUFFER_SIZE can be divisible by E_UART_RECV_THRESHOLD
...
void DW1_TransferComplete_IntrISR(void);
...
static  cy_stc_pdma_descr_config_t  stcDmaDescrConfig = {
        ...
        /* DESCR_SRC                         */    .srcAddr        =   (uint32_t *)&CY_BSP_USB_UART_TYPE->unRX_FIFO_RD.u32Register,
...
int main(void)
{
    ...
    Cy_SCB_UART_Receive(CY_BSP_USB_UART_TYPE, g_uart_in_data, E_UART_RECV_THRESHOLD, &g_stc_uart_context);  // Set threshold
    ...
    /* Trigger MUX */
    /***************/
    Cy_TrigMux_Connect1To1( TRIG_OUT_1TO1_2_SCB_RX_TO_PDMA,
                            0u,
...
void Peripheral_Initialization(void)
{
    ...
    #if (CY_USE_PSVP == 1)
        Cy_SysClk_PeriphSetFracDivider(Cy_SysClk_GetClockGroup(CY_BSP_USB_UART_PCLK), CY_SYSCLK_DIV_24_5_BIT, 0u, 25u,  1u);   // 115246
    #else
        Cy_SysClk_PeriphSetFracDivider(Cy_SysClk_GetClockGroup(CY_BSP_USB_UART_PCLK), CY_SYSCLK_DIV_24_5_BIT, 0u, 85u, 26u); // Divider 86.8125 --> 80MHz / 86.8125 / 8 (oversampling) = 115190 Hz
    #endif

    /* Enable peripheral divider */
    Cy_SysClk_PeriphEnableDivider(Cy_SysClk_GetClockGroup(CY_BSP_USB_UART_PCLK), CY_SYSCLK_DIV_24_5_BIT, 0u);
    ...
    /* Int1 -> UART(SCB1/3) */
    stc_sysint_irq_cfg_uart.sysIntSrc = cpuss_interrupts_dw1;
    ...
    Cy_SysInt_SetSystemIrqVector(stc_sysint_irq_cfg_uart.sysIntSrc, DW1_TransferComplete_IntrISR);
}
...
void DW1_TransferComplete_IntrISR(void)
{
    ...
    Term_Dump_32bit((unsigned int *)au8DestBuffer, E_UART_RECV_THRESHOLD);
