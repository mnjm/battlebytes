...
#define USER_I2C_SDA_PORT       GPIO_PRT4
#define USER_I2C_SDA_PIN        5
#define USER_I2C_SDA_PIN_MUX    P4_5_SCB0_I2C_SDA

#define USER_I2C_SCL_PORT       GPIO_PRT4
#define USER_I2C_SCL_PIN        6
#define USER_I2C_SCL_PIN_MUX    P4_6_SCB0_I2C_SCL
