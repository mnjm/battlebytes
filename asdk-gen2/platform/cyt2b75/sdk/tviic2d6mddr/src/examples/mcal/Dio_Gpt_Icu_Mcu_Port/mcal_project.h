...
#define MCAL_PROJECT_CB_BUTTON_CENTER_ICU_IRQ_NUMBER    30
#define MCAL_PROJECT_CB_BUTTON_CENTER_ICU_IRQ_HANDLER   Icu_Isr_Vector_30_Cat2

#define MCAL_PROJECT_CB_BUTTON_LEFT_ICU_IRQ_NUMBER      32
#define MCAL_PROJECT_CB_BUTTON_LEFT_ICU_IRQ_HANDLER     Icu_Isr_Vector_32_Cat2

#define MCAL_PROJECT_CB_BUTTON_RIGHT_ICU_IRQ_NUMBER     32
#define MCAL_PROJECT_CB_BUTTON_RIGHT_ICU_IRQ_HANDLER    Icu_Isr_Vector_32_Cat2

#define MCAL_PROJECT_CB_BUTTON_UP_ICU_IRQ_NUMBER        32
#define MCAL_PROJECT_CB_BUTTON_UP_ICU_IRQ_HANDLER       Icu_Isr_Vector_32_Cat2
