...
#if (defined CY_MCU_rev_a && defined tviic2d6m)
    #define COUNTERPART_MPU_FAULT   CY_SYSFLT_MPU_0 // the counterpart means CM0+
#elif (defined CY_MCU_rev_a && defined tviic2d6m) || (defined CY_MCU_rev_a && defined tviic2d6mddr)
