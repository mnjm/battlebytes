...
/* CAN in Use */
#if (CY_USE_PSVP == 1)
    #define CY_CANFD_TYPE                   CY_BSP_BB_CAN0_TYPE   
    #define CY_CANFD_RX_PORT                CY_BSP_BB_CAN0_RX_PORT
    #define CY_CANFD_RX_PIN                 CY_BSP_BB_CAN0_RX_PIN 
    #define CY_CANFD_TX_PORT                CY_BSP_BB_CAN0_TX_PORT
    #define CY_CANFD_TX_PIN                 CY_BSP_BB_CAN0_TX_PIN 
    #define CY_CANFD_RX_MUX                 CY_BSP_BB_CAN0_RX_PIN_MUX 
    #define CY_CANFD_TX_MUX                 CY_BSP_BB_CAN0_TX_PIN_MUX 
    #define CY_CANFD_PCLK                   CY_BSP_BB_CAN0_PCLK
    #define CY_CANFD_IRQN                   CY_BSP_BB_CAN0_IRQN
#else
...
int main(void)
{
    ...
    /* Now a ch configured as CAN is working. */

    cy_stc_canfd_msg_t stcMsg;
    
    stcMsg.canFDFormat = false;
    stcMsg.idConfig.extended = false;
    stcMsg.idConfig.identifier = 0x12;
    stcMsg.dataConfig.dataLengthCode = 8;
