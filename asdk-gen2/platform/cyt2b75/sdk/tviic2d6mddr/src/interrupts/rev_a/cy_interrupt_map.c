       ...
       cy_systemIntr_Handler Cy_SystemIrqUserTable[] =
{
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ34                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ35                  
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ36                  
     ...
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_9_HANDLER,           // IRQ51                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_10_HANDLER,          // IRQ52                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_11_HANDLER,          // IRQ53                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_12_HANDLER,          // IRQ54                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_13_HANDLER,          // IRQ55                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_14_HANDLER,          // IRQ56                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_15_HANDLER,          // IRQ57                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_16_HANDLER,          // IRQ58                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_17_HANDLER,          // IRQ59                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_18_HANDLER,          // IRQ60                  
     (cy_systemIntr_Handler) IOSS_INTERRUPTS_GPIO_ACT_19_HANDLER,          // IRQ61                  
     ...
     (cy_systemIntr_Handler) SMIF_0_SMIF0_INTERRUPT_HANDLER,               // IRQ81                  
     (cy_systemIntr_Handler) SMIF_0_SMIF1_INTERRUPT_HANDLER,               // IRQ82                  
     ...
     (cy_systemIntr_Handler) VIDEOSS_0_INTERRUPT_JPEGDEC_HANDLER,          // IRQ156                 
     ...
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_0_HANDLER,              // IRQ280                 
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_1_HANDLER,              // IRQ281                 
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_2_HANDLER,              // IRQ282                 
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_3_HANDLER,              // IRQ283                 
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_4_HANDLER,              // IRQ284                 
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_5_HANDLER,              // IRQ285                 
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_6_HANDLER,              // IRQ286                 
     (cy_systemIntr_Handler) AXI_DMAC_0_INTERRUPTS_7_HANDLER,              // IRQ287                 
     ...
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ624                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ625                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ626                 
     (cy_systemIntr_Handler) NC_HANDLER,                                   // IRQ627                 
     ...
     (cy_systemIntr_Handler) SDHC_0_INTERRUPT_GENERAL_HANDLER,             // IRQ798                 
     (cy_systemIntr_Handler) SDHC_0_INTERRUPT_WAKEUP_HANDLER,              // IRQ799                 
};
