...
#define GFXENV_SMIF_SDL_TAP_XSPI333               1
#define GFXENV_SMIF_SDL_TAP_XSPI266               2
#define GFXENV_SMIF_SDL_TAP_XSPI200               3
...
#endif
//============================================================================================================================================================================================
#ifdef CY_SMIF0_AVAILABLE
    { .enGroup = Smif0,    .pstcPort = CY_SMIF0_CLK_PORT,        .u8Pin = CY_SMIF0_CLK_PIN,        .enMuxCfg = HSIOM_SEL_GPIO,           .u8DriveMode = CY_GPIO_DM_STRONG_IN_OFF, .u8GpioOutVal = 0 },
...
#endif
//============================================================================================================================================================================================
#ifdef CY_SMIF1_AVAILABLE
    { .enGroup = Smif1,    .pstcPort = CY_SMIF1_CLK_PORT,        .u8Pin = CY_SMIF1_CLK_PIN,        .enMuxCfg = HSIOM_SEL_GPIO,           .u8DriveMode = CY_GPIO_DM_STRONG_IN_OFF, .u8GpioOutVal = 0 },
    { .enGroup = Smif0,    .pstcPort = CY_SMIF1_CLK_INV_PORT,    .u8Pin = CY_SMIF1_CLK_INV_PIN,    .enMuxCfg = CY_SMIF1_CLK_INV_PIN_MUX, .u8DriveMode = CY_GPIO_DM_STRONG,        .u8GpioOutVal = 0 },
...
//============================================================================================================================================================================================
    ...
    { .enGroup = Button,   .pstcPort = CY_BSP_BB_USER_BUTTON_1_PORT,          .u8Pin = CY_BSP_BB_USER_BUTTON_1_PIN,          .enMuxCfg = CY_BSP_BB_USER_BUTTON_1_PIN_MUX,          .u8DriveMode = CY_GPIO_DM_HIGHZ,  .u8GpioOutVal = 0 },
    { .enGroup = Button,   .pstcPort = CY_BSP_BB_USER_BUTTON_2_PORT,          .u8Pin = CY_BSP_BB_USER_BUTTON_2_PIN,          .enMuxCfg = CY_BSP_BB_USER_BUTTON_2_PIN_MUX,          .u8DriveMode = CY_GPIO_DM_HIGHZ,  .u8GpioOutVal = 0 },
    { .enGroup = Button,   .pstcPort = CY_BSP_BB_USER_BUTTON_3_PORT,          .u8Pin = CY_BSP_BB_USER_BUTTON_3_PIN,          .enMuxCfg = CY_BSP_BB_USER_BUTTON_3_PIN_MUX,          .u8DriveMode = CY_GPIO_DM_HIGHZ,  .u8GpioOutVal = 0 },
    { .enGroup = Button,   .pstcPort = CY_BSP_BB_USER_BUTTON_4_PORT,          .u8Pin = CY_BSP_BB_USER_BUTTON_4_PIN,          .enMuxCfg = CY_BSP_BB_USER_BUTTON_4_PIN_MUX,          .u8DriveMode = CY_GPIO_DM_HIGHZ,  .u8GpioOutVal = 0 },
    { .enGroup = Button,   .pstcPort = CY_BSP_BB_USER_BUTTON_5_PORT,          .u8Pin = CY_BSP_BB_USER_BUTTON_5_PIN,          .enMuxCfg = CY_BSP_BB_USER_BUTTON_5_PIN_MUX,          .u8DriveMode = CY_GPIO_DM_HIGHZ,  .u8GpioOutVal = 0 },
#endif
//============================================================================================================================================================================================
};
...
static const cy_button_stc_definition_t m_astcButtonDef[] =
{
    ...
    { .pstcPort = CY_BSP_BB_USER_BUTTON_1_PORT,              .u8Pin = CY_BSP_BB_USER_BUTTON_1_PIN,                .u8ButtonId = CY_GFXENV_BUTTON_ID_BB_1  },
    { .pstcPort = CY_BSP_BB_USER_BUTTON_2_PORT,              .u8Pin = CY_BSP_BB_USER_BUTTON_2_PIN,                .u8ButtonId = CY_GFXENV_BUTTON_ID_BB_2  },
    { .pstcPort = CY_BSP_BB_USER_BUTTON_3_PORT,              .u8Pin = CY_BSP_BB_USER_BUTTON_3_PIN,                .u8ButtonId = CY_GFXENV_BUTTON_ID_BB_3  },
    { .pstcPort = CY_BSP_BB_USER_BUTTON_4_PORT,              .u8Pin = CY_BSP_BB_USER_BUTTON_4_PIN,                .u8ButtonId = CY_GFXENV_BUTTON_ID_BB_4  },
    { .pstcPort = CY_BSP_BB_USER_BUTTON_5_PORT,              .u8Pin = CY_BSP_BB_USER_BUTTON_5_PIN,                .u8ButtonId = CY_GFXENV_BUTTON_ID_BB_5  },
#endif
};
...
{
    .addr         = 0,               // Region will cover 0x60000000 - 0x7fffffff and 0xc0000000 - 0xdfffffff
    .size         = CY_MPU_SIZE_4GB, // Region will cover 0x60000000 - 0x7fffffff and 0xc0000000 - 0xdfffffff
    .srd          = 0xb7,            // Region will cover 0x60000000 - 0x7fffffff and 0xc0000000 - 0xdfffffff
...
cy_gfxenv_en_result_t Cy_GfxEnv_EnableTestImage(cy_gfxenv_en_disp_type_t enDisp0Type, cy_gfxenv_en_disp_type_t enDisp1Type)
{
    ...
    uint32_t u32Disp0PixelClkHz = 0;
    uint32_t u32Disp1PixelClkHz = 0;
    uint32_t u32Disp0ClkPllHz = 0;
    uint32_t u32Disp1ClkPllHz = 0;
    uint32_t disp0PllInputFreq = 0;
    uint32_t disp1PllInputFreq = 0;
