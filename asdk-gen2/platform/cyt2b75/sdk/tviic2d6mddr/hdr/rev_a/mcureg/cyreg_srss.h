...
/**
  * \brief Active domain Clock Supervisor (CSV) registers (CSV_HF_CSV14)
  */
#define CYREG_CSV_HF_CSV14_REF_CTL      ((volatile un_CSV_HF_CSV_REF_CTL_t*) 0x402614E0UL)
#define CYREG_CSV_HF_CSV14_REF_LIMIT    ((volatile un_CSV_HF_CSV_REF_LIMIT_t*) 0x402614E4UL)
#define CYREG_CSV_HF_CSV14_MON_CTL      ((volatile un_CSV_HF_CSV_MON_CTL_t*) 0x402614E8UL)

/**
  * \brief Active domain Clock Supervisor (CSV) registers (CSV_HF_CSV15)
  */
#define CYREG_CSV_HF_CSV15_REF_CTL      ((volatile un_CSV_HF_CSV_REF_CTL_t*) 0x402614F0UL)
#define CYREG_CSV_HF_CSV15_REF_LIMIT    ((volatile un_CSV_HF_CSV_REF_LIMIT_t*) 0x402614F4UL)
#define CYREG_CSV_HF_CSV15_MON_CTL      ((volatile un_CSV_HF_CSV_MON_CTL_t*) 0x402614F8UL)
...
/**
  * \brief 400MHz Digital PLL Configuration Register (CLK_DPLL400M0)
  */
#define CYREG_CLK_DPLL400M0_CONFIG      ((volatile un_CLK_DPLL400M_CONFIG_t*) 0x40261A00UL)
#define CYREG_CLK_DPLL400M0_CONFIG2     ((volatile un_CLK_DPLL400M_CONFIG2_t*) 0x40261A04UL)
#define CYREG_CLK_DPLL400M0_CONFIG3     ((volatile un_CLK_DPLL400M_CONFIG3_t*) 0x40261A08UL)
#define CYREG_CLK_DPLL400M0_STATUS      ((volatile un_CLK_DPLL400M_STATUS_t*) 0x40261A10UL)
...
#define CYREG_PWR_PMIC_CTL4             ((volatile un_PWR_PMIC_CTL4_t*) 0x402610D0UL)
...
#define CYREG_CLK_ROOT_SELECT14         ((volatile un_CLK_ROOT_SELECT_t*) 0x40261278UL)
#define CYREG_CLK_ROOT_SELECT15         ((volatile un_CLK_ROOT_SELECT_t*) 0x4026127CUL)
