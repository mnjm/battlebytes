...
#
# History:
# 2022-08-03 0.01 CHEY  Initial version for silicon
# ***********************************************************************************************/#
...
CPU_BOARD_TYPE = 'CPU_BOARD_500_BGA'  # Set 'CPU_BOARD_500_BGA', no other CPU board available at the moment
...
TRACE_PIN_CONFIG = {
                        'CPU_BOARD_500_BGA' : {
                                                'CLK'    : { 'PORT' : 18, 'PIN' : 0, 'HSIOM_SEL' : 22 },
                                                'DATA_0' : { 'PORT' : 18, 'PIN' : 1, 'HSIOM_SEL' : 22 },
                                                'DATA_1' : { 'PORT' : 18, 'PIN' : 2, 'HSIOM_SEL' : 22 },
                                                'DATA_2' : { 'PORT' : 18, 'PIN' : 3, 'HSIOM_SEL' : 22 },
                                                'DATA_3' : { 'PORT' : 18, 'PIN' : 4, 'HSIOM_SEL' : 22 },
                                            }
                    }                        
