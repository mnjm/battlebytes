...
#define TCPWMx_LINEx_IN_MUX               P6_2_TCPWM0_TR_ONE_CNT_IN1
...
int main(void)
{
    ...
    Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_16_BIT, TCPWMx_PERI_CLK_DIVIDER_NO_PWM_SR, (divNum-1ul));
    /* Enable the divider */
    Cy_SysClk_PeriphEnableDivider(CY_SYSCLK_DIV_16_BIT, TCPWMx_PERI_CLK_DIVIDER_NO_PWM_SR);
