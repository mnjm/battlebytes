...
#define TCPWMx_GRPx_CNTx_PWM_PR               TCPWM0_GRP0_CNT0
#define PCLK_TCPWMx_CLOCKSx_PWM_PR            PCLK_TCPWM0_CLOCKS0
...
int main(void)
{
    ...
    Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_16_BIT, TCPWMx_PERI_CLK_DIVIDER_NO_PWM_PR, (divNum-1ul));
    /* Enable the divider */
    Cy_SysClk_PeriphEnableDivider(CY_SYSCLK_DIV_16_BIT, TCPWMx_PERI_CLK_DIVIDER_NO_PWM_PR);
