...
//  {            tcpwm,               clkDest,       port, pin,                hsiom },
    { TCPWM0_GRP0_CNT0,   PCLK_TCPWM0_CLOCKS0,  GPIO_PRT6, 1ul,    P6_1_TCPWM0_LINE0 },
    { TCPWM0_GRP0_CNT1,   PCLK_TCPWM0_CLOCKS1,  GPIO_PRT6, 3ul,    P6_3_TCPWM0_LINE1 },
    { TCPWM0_GRP0_CNT2,   PCLK_TCPWM0_CLOCKS2,  GPIO_PRT6, 5ul,    P6_5_TCPWM0_LINE2 },
    { TCPWM0_GRP0_CNT3,   PCLK_TCPWM0_CLOCKS3,  GPIO_PRT6, 7ul,    P6_7_TCPWM0_LINE3 },
    { TCPWM0_GRP0_CNT4,   PCLK_TCPWM0_CLOCKS4,  GPIO_PRT2, 3ul,    P2_3_TCPWM0_LINE4 },
    { TCPWM0_GRP0_CNT5,   PCLK_TCPWM0_CLOCKS5,  GPIO_PRT4, 1ul,    P4_1_TCPWM0_LINE5 },
    { TCPWM0_GRP1_CNT0, PCLK_TCPWM0_CLOCKS256,  GPIO_PRT3, 5ul,  P3_5_TCPWM0_LINE256 },
    { TCPWM0_GRP1_CNT1, PCLK_TCPWM0_CLOCKS257,  GPIO_PRT3, 4ul,  P3_4_TCPWM0_LINE257 },
    { TCPWM0_GRP2_CNT0, PCLK_TCPWM0_CLOCKS512, GPIO_PRT18, 0ul, P18_0_TCPWM0_LINE512 },
    { TCPWM0_GRP2_CNT1, PCLK_TCPWM0_CLOCKS513, GPIO_PRT18, 2ul, P18_2_TCPWM0_LINE513 },
};
...
int main(void)
{
    ...
    Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_16_BIT, TCPWM_PERI_CLK_DIVIDER_COMMON_NO, (divNum - 1ul));
    /* Enable the divider */
    Cy_SysClk_PeriphEnableDivider(CY_SYSCLK_DIV_16_BIT, TCPWM_PERI_CLK_DIVIDER_COMMON_NO);
