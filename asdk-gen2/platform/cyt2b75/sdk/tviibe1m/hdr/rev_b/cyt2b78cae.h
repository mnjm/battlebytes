...
#ifndef _CYT2B78CAE_H_
#define _CYT2B78CAE_H_

/**
* \addtogroup group_device CYT2B78CAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B78CAE User Interrupt Numbers */
  ...
  /* CYT2B78CAE Internal SW Interrupt Numbers */
...
/* CYT2B78CAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE3EA2101UL
