...
/**
  * \brief Flash Memory Geometry (SFLASH_FLASHC_GEOMETRY)
  */
...
typedef struct stc_SFLASH_TOC2_FLAGS_field {
  ...
  uint32_t                         u1SWJ_PINS_CTL:1;
  uint32_t                         u2APP_AUTH_DISABLE:2;
  uint32_t                         :1;
  uint32_t                         u1FB_BOOTLOADER_DISABLE:1;
  uint32_t                         :22;
...
typedef struct stc_SFLASH {
  ...
  uint8_t                          u8Reserved2;
  un_SFLASH_FLASHC_GEOMETRY_t      unFLASHC_GEOMETRY;  /*!< 0x00000010 Flash Memory Geometry */
...
#define SFLASH_TOC2_FLAGS_SWJ_PINS_CTL_Msk      0x20UL
#define SFLASH_TOC2_FLAGS_APP_AUTH_DISABLE_Pos  6UL
#define SFLASH_TOC2_FLAGS_APP_AUTH_DISABLE_Msk  0xC0UL
#define SFLASH_TOC2_FLAGS_FB_BOOTLOADER_DISABLE_Pos 9UL
#define SFLASH_TOC2_FLAGS_FB_BOOTLOADER_DISABLE_Msk 0x200UL
