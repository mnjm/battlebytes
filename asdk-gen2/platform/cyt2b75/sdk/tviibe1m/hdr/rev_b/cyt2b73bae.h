...
#ifndef _CYT2B73BAE_H_
#define _CYT2B73BAE_H_

/**
* \addtogroup group_device CYT2B73BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B73BAE User Interrupt Numbers */
  ...
  /* CYT2B73BAE Internal SW Interrupt Numbers */
...
/* CYT2B73BAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE3C92101UL
