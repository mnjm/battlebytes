...
#ifndef _CYT2B73CAE_H_
#define _CYT2B73CAE_H_

/**
* \addtogroup group_device CYT2B73CAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B73CAE User Interrupt Numbers */
  ...
  /* CYT2B73CAE Internal SW Interrupt Numbers */
...
/* CYT2B73CAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE3CA2101UL
