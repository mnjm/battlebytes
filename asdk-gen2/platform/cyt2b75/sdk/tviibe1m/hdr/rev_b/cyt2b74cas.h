...
#ifndef _CYT2B74CAS_H_
#define _CYT2B74CAS_H_

/**
* \addtogroup group_device CYT2B74CAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B74CAS User Interrupt Numbers */
  ...
  /* CYT2B74CAS Internal SW Interrupt Numbers */
...
/* CYT2B74CAS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE3D22101UL
