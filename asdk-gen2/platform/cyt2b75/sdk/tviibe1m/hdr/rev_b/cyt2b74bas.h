...
#ifndef _CYT2B74BAS_H_
#define _CYT2B74BAS_H_

/**
* \addtogroup group_device CYT2B74BAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B74BAS User Interrupt Numbers */
  ...
  /* CYT2B74BAS Internal SW Interrupt Numbers */
...
/* CYT2B74BAS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE3D12101UL
