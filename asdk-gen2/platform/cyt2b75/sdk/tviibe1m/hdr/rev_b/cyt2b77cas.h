...
#ifndef _CYT2B77CAS_H_
#define _CYT2B77CAS_H_

/**
* \addtogroup group_device CYT2B77CAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B77CAS User Interrupt Numbers */
  ...
  /* CYT2B77CAS Internal SW Interrupt Numbers */
...
/* CYT2B77CAS peripheral interrupts */
typedef enum {
