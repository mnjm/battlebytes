...
#ifndef _CYT2B78BAE_H_
#define _CYT2B78BAE_H_

/**
* \addtogroup group_device CYT2B78BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B78BAE User Interrupt Numbers */
  ...
  /* CYT2B78BAE Internal SW Interrupt Numbers */
...
/* CYT2B78BAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0x0000E3E9UL
