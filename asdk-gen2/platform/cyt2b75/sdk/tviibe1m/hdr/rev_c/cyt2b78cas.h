...
#ifndef _CYT2B78CAS_H_
#define _CYT2B78CAS_H_

/**
* \addtogroup group_device CYT2B78CAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B78CAS User Interrupt Numbers */
  ...
  /* CYT2B78CAS Internal SW Interrupt Numbers */
...
/* CYT2B78CAS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0x0000E3EAUL
