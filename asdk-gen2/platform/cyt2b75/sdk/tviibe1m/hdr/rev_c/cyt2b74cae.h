...
#ifndef _CYT2B74CAE_H_
#define _CYT2B74CAE_H_

/**
* \addtogroup group_device CYT2B74CAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B74CAE User Interrupt Numbers */
  ...
  /* CYT2B74CAE Internal SW Interrupt Numbers */
...
/* CYT2B74CAE peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0x0000E3D2UL
