...
#ifndef _CYT2B74BAE_H_
#define _CYT2B74BAE_H_

/**
* \addtogroup group_device CYT2B74BAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B74BAE User Interrupt Numbers */
  ...
  /* CYT2B74BAE Internal SW Interrupt Numbers */
...
/* CYT2B74BAE peripheral interrupts */
typedef enum {
...
#include "gpio_cyt2b7_80_lqfp.h"

#define CY_DEVICE_TVIIBE1M
#define CY_SILICON_ID                   0x0000E3D1UL
