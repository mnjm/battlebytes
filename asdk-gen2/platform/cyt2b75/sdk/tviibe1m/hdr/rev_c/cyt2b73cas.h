...
#ifndef _CYT2B73CAS_H_
#define _CYT2B73CAS_H_

/**
* \addtogroup group_device CYT2B73CAS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B73CAS User Interrupt Numbers */
  ...
  /* CYT2B73CAS Internal SW Interrupt Numbers */
...
/* CYT2B73CAS peripheral interrupts */
typedef enum {
...
#include "gpio_cyt2b7_64_lqfp.h"

#define CY_DEVICE_TVIIBE1M
#define CY_SILICON_ID                   0x0000E3CAUL
