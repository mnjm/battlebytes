...
#ifndef _CYT2B77CAE_H_
#define _CYT2B77CAE_H_

/**
* \addtogroup group_device CYT2B77CAE
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2B77CAE User Interrupt Numbers */
  ...
  /* CYT2B77CAE Internal SW Interrupt Numbers */
...
/* CYT2B77CAE peripheral interrupts */
typedef enum {
...
#include "gpio_cyt2b7_144_lqfp.h"

#define CY_DEVICE_TVIIBE1M
#define CY_SILICON_ID                   0x0000E3E2UL
