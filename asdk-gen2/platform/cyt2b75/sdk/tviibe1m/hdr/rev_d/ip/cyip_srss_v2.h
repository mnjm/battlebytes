...
/**
  * \brief SIMO Buck Control Register (PWR_BUCK_CTL)
  */
...
/**
  * \brief SIMO Buck Control Register 2 (PWR_BUCK_CTL2)
  */
...
/**
  * \brief SRSS Core Registers (ver2) (SRSS)
  */
typedef struct stc_SRSS {
  ...
  un_PWR_BUCK_CTL_t                unPWR_BUCK_CTL;     /*!< 0x00001010 SIMO Buck Control Register */
  un_PWR_BUCK_CTL2_t               unPWR_BUCK_CTL2;    /*!< 0x00001014 SIMO Buck Control Register 2 */
